...
public final  class agendanovedades_impl extends GXDataArea
{
   public void initenv( )
   {
      if ( GxWebError != 0 )
   ...
   public void inittrn( )
   {
      ...
      else if ( GXutil.strcmp(gxfirstwebparm, "gxJX_Action29") == 0 )
      {
         ...
         xc_29_063( AV21CliCod, AV7EmpCod, AV8LegNumero, A26ConCodigo, A112AgeFecHas, A111AgeFecDes, A25AgeOrden, Gx_mode) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel4"+"_"+"CLICOD") == 0 )
      {
         ...
         gx4asaclicod063( AV21CliCod) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel10"+"_"+"AGEORDEN") == 0 )
      {
         ...
         gx10asaageorden063( AV9AgeOrden) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel11"+"_"+"AGEORDEN") == 0 )
      {
         AV7EmpCod = (short)(GXutil.lval( httpContext.GetPar( "EmpCod"))) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV7EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV7EmpCod), 4, 0));
         web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV7EmpCod), "ZZZ9")));
         ...
         gx11asaageorden063( AV7EmpCod, A6LegNumero) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_34") == 0 )
      {
         ...
         gxload_34( A3CliCod, A26ConCodigo) ;
         return  ;
      }
      ...
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_33") == 0 )
      {
         ...
         gxload_33( A3CliCod, A1EmpCod, A6LegNumero) ;
         return  ;
      }
   ...
   public agendanovedades_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public agendanovedades_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( agendanovedades_impl.class ));
   }
   ...
   public void drawControls( )
   {
      ...
      /* Text block */
      web.GxWebStd.gx_label_ctrl( httpContext, lblTextblockconcodigo_Internalname, httpContext.getMessage( "Código", ""), "", "", lblTextblockconcodigo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, (short)(0), "HLP_AgendaNovedades.htm");
      ...
      web.GxWebStd.gx_single_line_edit( httpContext, edtConCodigo_Internalname, GXutil.rtrim( A26ConCodigo), GXutil.rtrim( localUtil.format( A26ConCodigo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,28);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConCodigo_Jsonclick, 0, "Attribute", "", "", "", "", edtConCodigo_Visible, edtConCodigo_Enabled, 1, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "CodConcepto", "left", true, "", "HLP_AgendaNovedades.htm");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
      /* Text block */
      web.GxWebStd.gx_label_ctrl( httpContext, lblTextblockageimporte_Internalname, httpContext.getMessage( "Importe", ""), "", "", lblTextblockageimporte_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, (short)(0), "HLP_AgendaNovedades.htm");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
      /* Table start */
      ...
      web.GxWebStd.gx_single_line_edit( httpContext, edtAgeImporte_Internalname, GXutil.ltrim( localUtil.ntoc( A113AgeImporte, (byte)(17), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtAgeImporte_Enabled!=0) ? localUtil.format( A113AgeImporte, "ZZ,ZZZ,ZZZ,ZZ9.99") : localUtil.format( A113AgeImporte, "ZZ,ZZZ,ZZZ,ZZ9.99"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'2');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'2');"+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeImporte_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAgeImporte_Enabled, 0, "text", "", 17, "chr", 1, "row", 17, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Importes", "right", false, "", "HLP_AgendaNovedades.htm");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      httpContext.writeText( "</td>") ;
      httpContext.writeText( "<td>") ;
      /* Text block */
      web.GxWebStd.gx_label_ctrl( httpContext, lblAgeimporte_righttext_Internalname, httpContext.getMessage( "Si ingresa valor en importe, se sobreescribirá la fórmula con este valor", ""), "", "", lblAgeimporte_righttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescription", 0, "", 1, 1, 0, (short)(0), "HLP_AgendaNovedades.htm");
      httpContext.writeText( "</td>") ;
      httpContext.writeText( "</tr>") ;
      /* End of table */
      ...
      web.GxWebStd.gx_single_line_edit( httpContext, edtAgeFecDes_Internalname, localUtil.format(A111AgeFecDes, "99/99/9999"), localUtil.format( A111AgeFecDes, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,52);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeFecDes_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtAgeFecDes_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Fecha", "right", false, "", "HLP_AgendaNovedades.htm");
      web.GxWebStd.gx_bitmap( httpContext, edtAgeFecDes_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtAgeFecDes_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_AgendaNovedades.htm");
      ...
      web.GxWebStd.gx_single_line_edit( httpContext, edtAgeFecHas_Internalname, localUtil.format(A112AgeFecHas, "99/99/9999"), localUtil.format( A112AgeFecHas, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeFecHas_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtAgeFecHas_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Fecha", "right", false, "", "HLP_AgendaNovedades.htm");
      web.GxWebStd.gx_bitmap( httpContext, edtAgeFecHas_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtAgeFecHas_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_AgendaNovedades.htm");
      httpContext.writeTextNL( "</div>") ;
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void standaloneStartupServer( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
         {
            ...
            AV27Insert_AgeLiqNro = (int)(localUtil.ctol( httpContext.cgiGet( "vINSERT_AGELIQNRO"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
            ...
            AV26existe = GXutil.strtobool( httpContext.cgiGet( "vEXISTE")) ;
            ...
            A143ConCanti = GXutil.strtobool( httpContext.cgiGet( "CONCANTI")) ;
            A158ConValUni = GXutil.strtobool( httpContext.cgiGet( "CONVALUNI")) ;
            A152ConImporte = GXutil.strtobool( httpContext.cgiGet( "CONIMPORTE")) ;
            ...
            forbiddenHiddens.add("hshsalt", "hsh"+"AgendaNovedades");
            ...
            {
               GXutil.writeLogError("agendanovedades:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
               GxWebError = (byte)(1) ;
   ...
   public void e11062( )
   {
      ...
      if ( GXutil.strcmp(Gx_mode, "INS") == 0 )
      {
         ...
         agendanovedades_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
      ...
      if ( ( GXutil.strcmp(AV11TrnContext.getgxTv_SdtWWPTransactionContext_Transactionname(), AV29Pgmname) == 0 ) && ( GXutil.strcmp(Gx_mode, "INS") == 0 ) )
      {
         ...
         while ( AV30GXV1 <= AV11TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().size() )
         {
            ...
            else if ( GXutil.strcmp(AV14TrnContextAtt.getgxTv_SdtWWPTransactionContext_Attribute_Attributename(), "AgeLiqNro") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri("", false, "AV27Insert_AgeLiqNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV27Insert_AgeLiqNro), 8, 0));
            }
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      GXt_objcol_SdtDVB_SDTComboData_Item4 = AV15ConCodigo_Data ;
      GXv_char5[0] = AV17ComboSelectedValue ;
      GXv_objcol_SdtDVB_SDTComboData_Item6[0] = GXt_objcol_SdtDVB_SDTComboData_Item4 ;
      new web.agendanovedadesloaddvcombo(remoteHandle, context).execute( "ConCodigo", Gx_mode, AV21CliCod, AV7EmpCod, AV8LegNumero, AV9AgeOrden, GXv_char5, GXv_objcol_SdtDVB_SDTComboData_Item6) ;
      agendanovedades_impl.this.AV17ComboSelectedValue = GXv_char5[0] ;
      GXt_objcol_SdtDVB_SDTComboData_Item4 = GXv_objcol_SdtDVB_SDTComboData_Item6[0] ;
      AV15ConCodigo_Data = GXt_objcol_SdtDVB_SDTComboData_Item4 ;
   ...
   public void zm063( int GX_JID )
   {
      if ( ( GX_JID == 31 ) || ( GX_JID == 0 ) )
      {
         if ( ! isIns( ) )
         {
            Z1254AgeLiqNro = T00063_A1254AgeLiqNro[0] ;
            Z110AgeCanti = T00063_A110AgeCanti[0] ;
            Z115AgeVUnit = T00063_A115AgeVUnit[0] ;
            Z113AgeImporte = T00063_A113AgeImporte[0] ;
            Z111AgeFecDes = T00063_A111AgeFecDes[0] ;
            Z112AgeFecHas = T00063_A112AgeFecHas[0] ;
            Z26ConCodigo = T00063_A26ConCodigo[0] ;
         }
         else
         {
   ...
   public void standaloneNotModal( )
   {
      ...
      else
      {
         if ( GXutil.strcmp(Gx_mode, httpContext.getMessage( httpContext.getMessage( "INS", ""), "")) == 0 )
         {
            ...
            agendanovedades_impl.this.GXt_int7 = GXv_int8[0] ;
            A3CliCod = GXt_int7 ;
            httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
         }
      }
   ...
   public void standaloneModal( )
   {
      ...
      if ( ( GXutil.strcmp(Gx_mode, "INS") == 0 ) && ! (0==AV27Insert_AgeLiqNro) )
      {
         A1254AgeLiqNro = AV27Insert_AgeLiqNro ;
         n1254AgeLiqNro = false ;
      ...
      if ( ( GXutil.strcmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
      {
         ...
         A2EmpNom = T00064_A2EmpNom[0] ;
         pr_default.close(2);
         /* Using cursor T00065 */
         pr_default.execute(3, new Object[] {Integer.valueOf(A3CliCod), Short.valueOf(A1EmpCod), Integer.valueOf(A6LegNumero)});
         A250LegIdNomApe = T00065_A250LegIdNomApe[0] ;
         A591LegNomApe = T00065_A591LegNomApe[0] ;
         A230LegApellido = T00065_A230LegApellido[0] ;
         A251LegNombre = T00065_A251LegNombre[0] ;
         A244LegFecEgreso = T00065_A244LegFecEgreso[0] ;
         n244LegFecEgreso = T00065_n244LegFecEgreso[0] ;
         A93LegId = T00065_A93LegId[0] ;
         n93LegId = T00065_n93LegId[0] ;
         pr_default.close(3);
         /* Using cursor T00066 */
         pr_default.execute(4, new Object[] {Integer.valueOf(A3CliCod), A26ConCodigo});
         A42ConCodYDesc = T00066_A42ConCodYDesc[0] ;
         n42ConCodYDesc = T00066_n42ConCodYDesc[0] ;
         A41ConDescrip = T00066_A41ConDescrip[0] ;
         A143ConCanti = T00066_A143ConCanti[0] ;
         A158ConValUni = T00066_A158ConValUni[0] ;
         A152ConImporte = T00066_A152ConImporte[0] ;
         pr_default.close(4);
      }
   }
   ...
   public void load063( )
   {
      ...
      {
         RcdFound3 = (short)(1) ;
         A42ConCodYDesc = T00067_A42ConCodYDesc[0] ;
         n42ConCodYDesc = T00067_n42ConCodYDesc[0] ;
         A250LegIdNomApe = T00067_A250LegIdNomApe[0] ;
         A591LegNomApe = T00067_A591LegNomApe[0] ;
         A1254AgeLiqNro = T00067_A1254AgeLiqNro[0] ;
         n1254AgeLiqNro = T00067_n1254AgeLiqNro[0] ;
         A2EmpNom = T00067_A2EmpNom[0] ;
         A230LegApellido = T00067_A230LegApellido[0] ;
         A251LegNombre = T00067_A251LegNombre[0] ;
         A244LegFecEgreso = T00067_A244LegFecEgreso[0] ;
         n244LegFecEgreso = T00067_n244LegFecEgreso[0] ;
         A41ConDescrip = T00067_A41ConDescrip[0] ;
         A110AgeCanti = T00067_A110AgeCanti[0] ;
         n110AgeCanti = T00067_n110AgeCanti[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A110AgeCanti", GXutil.ltrimstr( A110AgeCanti, 9, 2));
         A115AgeVUnit = T00067_A115AgeVUnit[0] ;
         n115AgeVUnit = T00067_n115AgeVUnit[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A115AgeVUnit", GXutil.ltrimstr( A115AgeVUnit, 14, 2));
         A113AgeImporte = T00067_A113AgeImporte[0] ;
         n113AgeImporte = T00067_n113AgeImporte[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A113AgeImporte", GXutil.ltrimstr( A113AgeImporte, 14, 2));
         A111AgeFecDes = T00067_A111AgeFecDes[0] ;
         n111AgeFecDes = T00067_n111AgeFecDes[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A111AgeFecDes", localUtil.format(A111AgeFecDes, "99/99/9999"));
         A112AgeFecHas = T00067_A112AgeFecHas[0] ;
         n112AgeFecHas = T00067_n112AgeFecHas[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A112AgeFecHas", localUtil.format(A112AgeFecHas, "99/99/9999"));
         A93LegId = T00067_A93LegId[0] ;
         n93LegId = T00067_n93LegId[0] ;
         A143ConCanti = T00067_A143ConCanti[0] ;
         A158ConValUni = T00067_A158ConValUni[0] ;
         A152ConImporte = T00067_A152ConImporte[0] ;
         A26ConCodigo = T00067_A26ConCodigo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A26ConCodigo", A26ConCodigo);
         zm063( -31) ;
      }
      pr_default.close(5);
   ...
   public void checkExtendedTable063( )
   {
      ...
      if ( ( GXutil.strcmp(Gx_mode, httpContext.getMessage( "INS", "")) == 0 ) || ( GXutil.strcmp(Gx_mode, httpContext.getMessage( "UPD", "")) == 0 ) )
      {
         ...
         GXv_boolean3[0] = AV26existe ;
         new web.getagendavalorenrango(remoteHandle, context).execute( AV21CliCod, AV7EmpCod, AV8LegNumero, A26ConCodigo, A112AgeFecHas, A111AgeFecDes, A25AgeOrden, true, GXv_decimal9, GXv_decimal10, GXv_decimal11, GXv_boolean3) ;
         agendanovedades_impl.this.AV26existe = GXv_boolean3[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "AV26existe", AV26existe);
      }
      if ( ( AV26existe ) && ( GXutil.strcmp(Gx_mode, httpContext.getMessage( "INS", "")) == 0 ) || ( GXutil.strcmp(Gx_mode, httpContext.getMessage( "UPD", "")) == 0 ) )
      {
   ...
   public void gxload_34( int A3CliCod ,
                          String A26ConCodigo )
   {
      /* Using cursor T00068 */
      ...
      A42ConCodYDesc = T00068_A42ConCodYDesc[0] ;
      n42ConCodYDesc = T00068_n42ConCodYDesc[0] ;
      A41ConDescrip = T00068_A41ConDescrip[0] ;
      A143ConCanti = T00068_A143ConCanti[0] ;
      A158ConValUni = T00068_A158ConValUni[0] ;
      A152ConImporte = T00068_A152ConImporte[0] ;
      web.GxWebStd.set_html_headers( httpContext, 0, "", "");
      addString( "[[") ;
      addString( "\""+PrivateUtilities.encodeJSConstant( A42ConCodYDesc)+"\""+","+"\""+PrivateUtilities.encodeJSConstant( A41ConDescrip)+"\""+","+"\""+PrivateUtilities.encodeJSConstant( GXutil.booltostr( A143ConCanti))+"\""+","+"\""+PrivateUtilities.encodeJSConstant( GXutil.booltostr( A158ConValUni))+"\""+","+"\""+PrivateUtilities.encodeJSConstant( GXutil.booltostr( A152ConImporte))+"\"") ;
      addString( "]") ;
      if ( (pr_default.getStatus(6) == 101) )
      {
         addString( ",") ;
   ...
   public void gxload_32( int A3CliCod ,
                          short A1EmpCod )
   {
      /* Using cursor T00069 */
                          ...
                          int A6LegNumero )
   {
      ...
      A250LegIdNomApe = T000610_A250LegIdNomApe[0] ;
      A591LegNomApe = T000610_A591LegNomApe[0] ;
      A230LegApellido = T000610_A230LegApellido[0] ;
      A251LegNombre = T000610_A251LegNombre[0] ;
      A244LegFecEgreso = T000610_A244LegFecEgreso[0] ;
      n244LegFecEgreso = T000610_n244LegFecEgreso[0] ;
      A93LegId = T000610_A93LegId[0] ;
      n93LegId = T000610_n93LegId[0] ;
      web.GxWebStd.set_html_headers( httpContext, 0, "", "");
      addString( "[[") ;
      addString( "\""+PrivateUtilities.encodeJSConstant( A250LegIdNomApe)+"\""+","+"\""+PrivateUtilities.encodeJSConstant( A591LegNomApe)+"\""+","+"\""+PrivateUtilities.encodeJSConstant( A230LegApellido)+"\""+","+"\""+PrivateUtilities.encodeJSConstant( A251LegNombre)+"\""+","+"\""+PrivateUtilities.encodeJSConstant( localUtil.format(A244LegFecEgreso, "99/99/9999"))+"\""+","+"\""+PrivateUtilities.encodeJSConstant( GXutil.rtrim( A93LegId))+"\"") ;
      addString( "]") ;
      if ( (pr_default.getStatus(8) == 101) )
      {
         addString( ",") ;
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm063( 31) ;
         RcdFound3 = (short)(1) ;
         A25AgeOrden = T00063_A25AgeOrden[0] ;
         A1254AgeLiqNro = T00063_A1254AgeLiqNro[0] ;
         n1254AgeLiqNro = T00063_n1254AgeLiqNro[0] ;
         A110AgeCanti = T00063_A110AgeCanti[0] ;
         n110AgeCanti = T00063_n110AgeCanti[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A110AgeCanti", GXutil.ltrimstr( A110AgeCanti, 9, 2));
         A115AgeVUnit = T00063_A115AgeVUnit[0] ;
         n115AgeVUnit = T00063_n115AgeVUnit[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A115AgeVUnit", GXutil.ltrimstr( A115AgeVUnit, 14, 2));
         A113AgeImporte = T00063_A113AgeImporte[0] ;
         n113AgeImporte = T00063_n113AgeImporte[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A113AgeImporte", GXutil.ltrimstr( A113AgeImporte, 14, 2));
         A111AgeFecDes = T00063_A111AgeFecDes[0] ;
         n111AgeFecDes = T00063_n111AgeFecDes[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A111AgeFecDes", localUtil.format(A111AgeFecDes, "99/99/9999"));
         A112AgeFecHas = T00063_A112AgeFecHas[0] ;
         n112AgeFecHas = T00063_n112AgeFecHas[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A112AgeFecHas", localUtil.format(A112AgeFecHas, "99/99/9999"));
         A3CliCod = T00063_A3CliCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
         A1EmpCod = T00063_A1EmpCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
         A6LegNumero = T00063_A6LegNumero[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
         A26ConCodigo = T00063_A26ConCodigo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A26ConCodigo", A26ConCodigo);
         Z3CliCod = A3CliCod ;
         Z1EmpCod = A1EmpCod ;
         Z6LegNumero = A6LegNumero ;
   ...
   public void move_next( )
   {
      ...
      {
         while ( (pr_default.getStatus(10) != 101) && ( ( T000612_A25AgeOrden[0] < A25AgeOrden ) || ( T000612_A25AgeOrden[0] == A25AgeOrden ) && ( T000612_A3CliCod[0] < A3CliCod ) || ( T000612_A3CliCod[0] == A3CliCod ) && ( T000612_A25AgeOrden[0] == A25AgeOrden ) && ( T000612_A1EmpCod[0] < A1EmpCod ) || ( T000612_A1EmpCod[0] == A1EmpCod ) && ( T000612_A3CliCod[0] == A3CliCod ) && ( T000612_A25AgeOrden[0] == A25AgeOrden ) && ( T000612_A6LegNumero[0] < A6LegNumero ) ) )
         {
            pr_default.readNext(10);
         }
         if ( (pr_default.getStatus(10) != 101) && ( ( T000612_A25AgeOrden[0] > A25AgeOrden ) || ( T000612_A25AgeOrden[0] == A25AgeOrden ) && ( T000612_A3CliCod[0] > A3CliCod ) || ( T000612_A3CliCod[0] == A3CliCod ) && ( T000612_A25AgeOrden[0] == A25AgeOrden ) && ( T000612_A1EmpCod[0] > A1EmpCod ) || ( T000612_A1EmpCod[0] == A1EmpCod ) && ( T000612_A3CliCod[0] == A3CliCod ) && ( T000612_A25AgeOrden[0] == A25AgeOrden ) && ( T000612_A6LegNumero[0] > A6LegNumero ) ) )
         {
            A25AgeOrden = T000612_A25AgeOrden[0] ;
            A3CliCod = T000612_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = T000612_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A6LegNumero = T000612_A6LegNumero[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
            RcdFound3 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      ...
      {
         while ( (pr_default.getStatus(11) != 101) && ( ( T000613_A25AgeOrden[0] > A25AgeOrden ) || ( T000613_A25AgeOrden[0] == A25AgeOrden ) && ( T000613_A3CliCod[0] > A3CliCod ) || ( T000613_A3CliCod[0] == A3CliCod ) && ( T000613_A25AgeOrden[0] == A25AgeOrden ) && ( T000613_A1EmpCod[0] > A1EmpCod ) || ( T000613_A1EmpCod[0] == A1EmpCod ) && ( T000613_A3CliCod[0] == A3CliCod ) && ( T000613_A25AgeOrden[0] == A25AgeOrden ) && ( T000613_A6LegNumero[0] > A6LegNumero ) ) )
         {
            pr_default.readNext(11);
         }
         if ( (pr_default.getStatus(11) != 101) && ( ( T000613_A25AgeOrden[0] < A25AgeOrden ) || ( T000613_A25AgeOrden[0] == A25AgeOrden ) && ( T000613_A3CliCod[0] < A3CliCod ) || ( T000613_A3CliCod[0] == A3CliCod ) && ( T000613_A25AgeOrden[0] == A25AgeOrden ) && ( T000613_A1EmpCod[0] < A1EmpCod ) || ( T000613_A1EmpCod[0] == A1EmpCod ) && ( T000613_A3CliCod[0] == A3CliCod ) && ( T000613_A25AgeOrden[0] == A25AgeOrden ) && ( T000613_A6LegNumero[0] < A6LegNumero ) ) )
         {
            A25AgeOrden = T000613_A25AgeOrden[0] ;
            A3CliCod = T000613_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = T000613_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A6LegNumero = T000613_A6LegNumero[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
            RcdFound3 = (short)(1) ;
         }
      }
   ...
   public void checkOptimisticConcurrency063( )
   {
      if ( ! isIns( ) )
      {
         ...
         Gx_longc = false ;
         if ( (pr_default.getStatus(0) == 101) || ( Z1254AgeLiqNro != T00062_A1254AgeLiqNro[0] ) || ( DecimalUtil.compareTo(Z110AgeCanti, T00062_A110AgeCanti[0]) != 0 ) || ( DecimalUtil.compareTo(Z115AgeVUnit, T00062_A115AgeVUnit[0]) != 0 ) || ( DecimalUtil.compareTo(Z113AgeImporte, T00062_A113AgeImporte[0]) != 0 ) || !( GXutil.dateCompare(GXutil.resetTime(Z111AgeFecDes), GXutil.resetTime(T00062_A111AgeFecDes[0])) ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || !( GXutil.dateCompare(GXutil.resetTime(Z112AgeFecHas), GXutil.resetTime(T00062_A112AgeFecHas[0])) ) || ( GXutil.strcmp(Z26ConCodigo, T00062_A26ConCodigo[0]) != 0 ) )
         {
            if ( Z1254AgeLiqNro != T00062_A1254AgeLiqNro[0] )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"AgeLiqNro");
               GXutil.writeLogRaw("Old: ",Z1254AgeLiqNro);
               GXutil.writeLogRaw("Current: ",T00062_A1254AgeLiqNro[0]);
            }
            if ( DecimalUtil.compareTo(Z110AgeCanti, T00062_A110AgeCanti[0]) != 0 )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"AgeCanti");
               GXutil.writeLogRaw("Old: ",Z110AgeCanti);
               GXutil.writeLogRaw("Current: ",T00062_A110AgeCanti[0]);
            }
            if ( DecimalUtil.compareTo(Z115AgeVUnit, T00062_A115AgeVUnit[0]) != 0 )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"AgeVUnit");
               GXutil.writeLogRaw("Old: ",Z115AgeVUnit);
               GXutil.writeLogRaw("Current: ",T00062_A115AgeVUnit[0]);
            }
            if ( DecimalUtil.compareTo(Z113AgeImporte, T00062_A113AgeImporte[0]) != 0 )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"AgeImporte");
               GXutil.writeLogRaw("Old: ",Z113AgeImporte);
               GXutil.writeLogRaw("Current: ",T00062_A113AgeImporte[0]);
            }
            if ( !( GXutil.dateCompare(GXutil.resetTime(Z111AgeFecDes), GXutil.resetTime(T00062_A111AgeFecDes[0])) ) )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"AgeFecDes");
               GXutil.writeLogRaw("Old: ",Z111AgeFecDes);
               GXutil.writeLogRaw("Current: ",T00062_A111AgeFecDes[0]);
            }
            if ( !( GXutil.dateCompare(GXutil.resetTime(Z112AgeFecHas), GXutil.resetTime(T00062_A112AgeFecHas[0])) ) )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"AgeFecHas");
               GXutil.writeLogRaw("Old: ",Z112AgeFecHas);
               GXutil.writeLogRaw("Current: ",T00062_A112AgeFecHas[0]);
            }
            if ( GXutil.strcmp(Z26ConCodigo, T00062_A26ConCodigo[0]) != 0 )
            {
               GXutil.writeLogln("agendanovedades:[seudo value changed for attri]"+"ConCodigo");
               GXutil.writeLogRaw("Old: ",Z26ConCodigo);
               GXutil.writeLogRaw("Current: ",T00062_A26ConCodigo[0]);
            }
   ...
   public void onDeleteControls063( )
   {
      ...
      if ( AnyError == 0 )
      {
         ...
         A250LegIdNomApe = T000618_A250LegIdNomApe[0] ;
         A591LegNomApe = T000618_A591LegNomApe[0] ;
         A230LegApellido = T000618_A230LegApellido[0] ;
         A251LegNombre = T000618_A251LegNombre[0] ;
         A244LegFecEgreso = T000618_A244LegFecEgreso[0] ;
         n244LegFecEgreso = T000618_n244LegFecEgreso[0] ;
         A93LegId = T000618_A93LegId[0] ;
         n93LegId = T000618_n93LegId[0] ;
         pr_default.close(16);
         /* Using cursor T000619 */
         pr_default.execute(17, new Object[] {Integer.valueOf(A3CliCod), A26ConCodigo});
         A42ConCodYDesc = T000619_A42ConCodYDesc[0] ;
         n42ConCodYDesc = T000619_n42ConCodYDesc[0] ;
         A41ConDescrip = T000619_A41ConDescrip[0] ;
         A143ConCanti = T000619_A143ConCanti[0] ;
         A158ConValUni = T000619_A158ConValUni[0] ;
         A152ConImporte = T000619_A152ConImporte[0] ;
         pr_default.close(17);
      }
   }
   ...
   public void endLevel063( )
   {
      ...
      if ( AnyError == 0 )
      {
         Application.commitDataStores(context, remoteHandle, pr_default, "agendanovedades");
         if ( AnyError == 0 )
         {
            confirmValues060( ) ;
         }
      ...
      {
         Application.rollbackDataStores(context, remoteHandle, pr_default, "agendanovedades");
      }
      IsModified = (short)(0) ;
      if ( AnyError != 0 )
      {
   ...
   public void scanStart063( )
   {
      ...
      {
         RcdFound3 = (short)(1) ;
         A3CliCod = T000620_A3CliCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
         A1EmpCod = T000620_A1EmpCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
         A6LegNumero = T000620_A6LegNumero[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
         A25AgeOrden = T000620_A25AgeOrden[0] ;
      }
      /* Load Subordinate Levels */
   }

   public void scanNext063( )
   {
      /* Scan next routine */
   ...
   {
      /* Before Insert Rules */
      GXt_int12 = A25AgeOrden ;
      GXv_int13[0] = GXt_int12 ;
      new web.getnextorden(remoteHandle, context).execute( AV7EmpCod, A6LegNumero, GXv_int13) ;
      agendanovedades_impl.this.GXt_int12 = GXv_int13[0] ;
      A25AgeOrden = GXt_int12 ;
      httpContext.ajax_rsp_assign_attri("", false, "A25AgeOrden", GXutil.ltrimstr( DecimalUtil.doubleToDec(A25AgeOrden), 4, 0));
   }
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      GXutil.writeLogInfo("agendanovedades:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vINSERT_AGELIQNRO", GXutil.ltrim( localUtil.ntoc( AV27Insert_AgeLiqNro, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "vEXISTE", AV26existe);
      ...
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "CONCANTI", A143ConCanti);
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "CONVALUNI", A158ConValUni);
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "CONIMPORTE", A152ConImporte);
   ...
   {
      return formatLink("web.agendanovedades", new String[] {GXutil.URLEncode(GXutil.rtrim(Gx_mode)),GXutil.URLEncode(GXutil.ltrimstr(AV21CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV7EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV8LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9AgeOrden,4,0))}, new String[] {"Gx_mode","CliCod","EmpCod","LegNumero","AgeOrden"})  ;
   }

   public String getPgmname( )
   {
      return "AgendaNovedades" ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713251523", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("agendanovedades.js", "?20251713251524", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void gx4asaclicod063( int AV21CliCod )
   {
      if ( ! (0==AV21CliCod) )
      {
         A3CliCod = AV21CliCod ;
   ...
   public void gx10asaageorden063( short AV9AgeOrden )
   {
      if ( ! (0==AV9AgeOrden) )
      {
         A25AgeOrden = AV9AgeOrden ;
   ...
   public void gx11asaageorden063( short AV7EmpCod ,
                                   int A6LegNumero )
   {
      GXt_int12 = A25AgeOrden ;
      GXv_int13[0] = GXt_int12 ;
   ...
   public void xc_29_063( int AV21CliCod ,
                          short AV7EmpCod ,
                          int AV8LegNumero ,
                          String A26ConCodigo ,
                          ...
                          String Gx_mode )
   {
      if ( ( GXutil.strcmp(Gx_mode, httpContext.getMessage( "INS", "")) == 0 ) || ( GXutil.strcmp(Gx_mode, httpContext.getMessage( "UPD", "")) == 0 ) )
      {
         ...
         GXv_decimal9[0] = DecimalUtil.doubleToDec(0) ;
         GXv_boolean3[0] = AV26existe ;
         new web.getagendavalorenrango(remoteHandle, context).execute( AV21CliCod, AV7EmpCod, AV8LegNumero, A26ConCodigo, A112AgeFecHas, A111AgeFecDes, A25AgeOrden, true, GXv_decimal11, GXv_decimal10, GXv_decimal9, GXv_boolean3) ;
         AV26existe = GXv_boolean3[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "AV26existe", AV26existe);
      }
      web.GxWebStd.set_html_headers( httpContext, 0, "", "");
      addString( "[[") ;
      addString( "\""+PrivateUtilities.encodeJSConstant( GXutil.booltostr( AV26existe))+"\"") ;
      addString( "]") ;
      if ( true )
      {
         addString( ",") ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV21CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV7EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV8LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9',hsh:true},{av:'AV9AgeOrden',fld:'vAGEORDEN',pic:'ZZZ9',hsh:true},{av:'A114AgeLegActivo',fld:'AGELEGACTIVO',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("AFTER TRN","{handler:'e12062',iparms:[]");
      setEventMetadata("AFTER TRN",",oparms:[]}");
      setEventMetadata("VALID_CONCODIGO","{handler:'valid_Concodigo',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A26ConCodigo',fld:'CONCODIGO',pic:''},{av:'A42ConCodYDesc',fld:'CONCODYDESC',pic:''},{av:'A41ConDescrip',fld:'CONDESCRIP',pic:''},{av:'A143ConCanti',fld:'CONCANTI',pic:''},{av:'A158ConValUni',fld:'CONVALUNI',pic:''},{av:'A152ConImporte',fld:'CONIMPORTE',pic:''}]");
      setEventMetadata("VALID_CONCODIGO",",oparms:[{av:'A42ConCodYDesc',fld:'CONCODYDESC',pic:''},{av:'A41ConDescrip',fld:'CONDESCRIP',pic:''},{av:'A143ConCanti',fld:'CONCANTI',pic:''},{av:'A158ConValUni',fld:'CONVALUNI',pic:''},{av:'A152ConImporte',fld:'CONIMPORTE',pic:''}]}");
      ...
      setEventMetadata("VALID_AGEFECHAS","{handler:'valid_Agefechas',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'A112AgeFecHas',fld:'AGEFECHAS',pic:''},{av:'A111AgeFecDes',fld:'AGEFECDES',pic:''},{av:'AV21CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV7EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV8LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9',hsh:true},{av:'A26ConCodigo',fld:'CONCODIGO',pic:''},{av:'A25AgeOrden',fld:'AGEORDEN',pic:'ZZZ9'},{av:'AV26existe',fld:'vEXISTE',pic:''}]");
      setEventMetadata("VALID_AGEFECHAS",",oparms:[{av:'AV26existe',fld:'vEXISTE',pic:''}]}");
      ...
      setEventMetadata("VALID_LEGNUMERO","{handler:'valid_Legnumero',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A250LegIdNomApe',fld:'LEGIDNOMAPE',pic:''},{av:'A591LegNomApe',fld:'LEGNOMAPE',pic:''},{av:'A230LegApellido',fld:'LEGAPELLIDO',pic:''},{av:'A251LegNombre',fld:'LEGNOMBRE',pic:''},{av:'A244LegFecEgreso',fld:'LEGFECEGRESO',pic:''},{av:'A93LegId',fld:'LEGID',pic:''}]");
      setEventMetadata("VALID_LEGNUMERO",",oparms:[{av:'A250LegIdNomApe',fld:'LEGIDNOMAPE',pic:''},{av:'A591LegNomApe',fld:'LEGNOMAPE',pic:''},{av:'A230LegApellido',fld:'LEGAPELLIDO',pic:''},{av:'A251LegNombre',fld:'LEGNOMBRE',pic:''},{av:'A244LegFecEgreso',fld:'LEGFECEGRESO',pic:''},{av:'A93LegId',fld:'LEGID',pic:''}]}");
   }
   ...
   public void initialize( )
   {
      ...
      Z42ConCodYDesc = "" ;
      Z41ConDescrip = "" ;
      T00064_A2EmpNom = new String[] {""} ;
      T00065_A250LegIdNomApe = new String[] {""} ;
      T00065_A591LegNomApe = new String[] {""} ;
      T00065_A230LegApellido = new String[] {""} ;
      T00065_A251LegNombre = new String[] {""} ;
      T00065_A244LegFecEgreso = new java.util.Date[] {GXutil.nullDate()} ;
      T00065_n244LegFecEgreso = new boolean[] {false} ;
      T00065_A93LegId = new String[] {""} ;
      T00065_n93LegId = new boolean[] {false} ;
      T00066_A42ConCodYDesc = new String[] {""} ;
      T00066_n42ConCodYDesc = new boolean[] {false} ;
      T00066_A41ConDescrip = new String[] {""} ;
      T00066_A143ConCanti = new boolean[] {false} ;
      T00066_A158ConValUni = new boolean[] {false} ;
      T00066_A152ConImporte = new boolean[] {false} ;
      T00067_A42ConCodYDesc = new String[] {""} ;
      T00067_n42ConCodYDesc = new boolean[] {false} ;
      T00067_A250LegIdNomApe = new String[] {""} ;
      T00067_A591LegNomApe = new String[] {""} ;
      T00067_A25AgeOrden = new short[1] ;
      T00067_A1254AgeLiqNro = new int[1] ;
      T00067_n1254AgeLiqNro = new boolean[] {false} ;
      T00067_A2EmpNom = new String[] {""} ;
      T00067_A230LegApellido = new String[] {""} ;
      T00067_A251LegNombre = new String[] {""} ;
      T00067_A244LegFecEgreso = new java.util.Date[] {GXutil.nullDate()} ;
      T00067_n244LegFecEgreso = new boolean[] {false} ;
      T00067_A41ConDescrip = new String[] {""} ;
      T00067_A110AgeCanti = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00067_n110AgeCanti = new boolean[] {false} ;
      T00067_A115AgeVUnit = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00067_n115AgeVUnit = new boolean[] {false} ;
      T00067_A113AgeImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00067_n113AgeImporte = new boolean[] {false} ;
      T00067_A111AgeFecDes = new java.util.Date[] {GXutil.nullDate()} ;
      T00067_n111AgeFecDes = new boolean[] {false} ;
      T00067_A112AgeFecHas = new java.util.Date[] {GXutil.nullDate()} ;
      T00067_n112AgeFecHas = new boolean[] {false} ;
      T00067_A93LegId = new String[] {""} ;
      T00067_n93LegId = new boolean[] {false} ;
      T00067_A143ConCanti = new boolean[] {false} ;
      T00067_A158ConValUni = new boolean[] {false} ;
      T00067_A152ConImporte = new boolean[] {false} ;
      T00067_A3CliCod = new int[1] ;
      T00067_A1EmpCod = new short[1] ;
      T00067_A6LegNumero = new int[1] ;
      T00067_A26ConCodigo = new String[] {""} ;
      T00068_A42ConCodYDesc = new String[] {""} ;
      T00068_n42ConCodYDesc = new boolean[] {false} ;
      T00068_A41ConDescrip = new String[] {""} ;
      T00068_A143ConCanti = new boolean[] {false} ;
      T00068_A158ConValUni = new boolean[] {false} ;
      T00068_A152ConImporte = new boolean[] {false} ;
      T00069_A2EmpNom = new String[] {""} ;
      T000610_A250LegIdNomApe = new String[] {""} ;
      T000610_A591LegNomApe = new String[] {""} ;
      T000610_A230LegApellido = new String[] {""} ;
      T000610_A251LegNombre = new String[] {""} ;
      T000610_A244LegFecEgreso = new java.util.Date[] {GXutil.nullDate()} ;
      T000610_n244LegFecEgreso = new boolean[] {false} ;
      T000610_A93LegId = new String[] {""} ;
      T000610_n93LegId = new boolean[] {false} ;
      T000611_A3CliCod = new int[1] ;
      T000611_A1EmpCod = new short[1] ;
      T000611_A6LegNumero = new int[1] ;
      T000611_A25AgeOrden = new short[1] ;
      T00063_A25AgeOrden = new short[1] ;
      T00063_A1254AgeLiqNro = new int[1] ;
      T00063_n1254AgeLiqNro = new boolean[] {false} ;
      T00063_A110AgeCanti = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00063_n110AgeCanti = new boolean[] {false} ;
      T00063_A115AgeVUnit = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00063_n115AgeVUnit = new boolean[] {false} ;
      T00063_A113AgeImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00063_n113AgeImporte = new boolean[] {false} ;
      T00063_A111AgeFecDes = new java.util.Date[] {GXutil.nullDate()} ;
      T00063_n111AgeFecDes = new boolean[] {false} ;
      T00063_A112AgeFecHas = new java.util.Date[] {GXutil.nullDate()} ;
      T00063_n112AgeFecHas = new boolean[] {false} ;
      T00063_A3CliCod = new int[1] ;
      T00063_A1EmpCod = new short[1] ;
      T00063_A6LegNumero = new int[1] ;
      T00063_A26ConCodigo = new String[] {""} ;
      T000612_A25AgeOrden = new short[1] ;
      T000612_A3CliCod = new int[1] ;
      T000612_A1EmpCod = new short[1] ;
      T000612_A6LegNumero = new int[1] ;
      T000613_A25AgeOrden = new short[1] ;
      T000613_A3CliCod = new int[1] ;
      T000613_A1EmpCod = new short[1] ;
      T000613_A6LegNumero = new int[1] ;
      T00062_A25AgeOrden = new short[1] ;
      T00062_A1254AgeLiqNro = new int[1] ;
      T00062_n1254AgeLiqNro = new boolean[] {false} ;
      T00062_A110AgeCanti = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00062_n110AgeCanti = new boolean[] {false} ;
      T00062_A115AgeVUnit = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00062_n115AgeVUnit = new boolean[] {false} ;
      T00062_A113AgeImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      T00062_n113AgeImporte = new boolean[] {false} ;
      T00062_A111AgeFecDes = new java.util.Date[] {GXutil.nullDate()} ;
      T00062_n111AgeFecDes = new boolean[] {false} ;
      T00062_A112AgeFecHas = new java.util.Date[] {GXutil.nullDate()} ;
      T00062_n112AgeFecHas = new boolean[] {false} ;
      T00062_A3CliCod = new int[1] ;
      T00062_A1EmpCod = new short[1] ;
      T00062_A6LegNumero = new int[1] ;
      T00062_A26ConCodigo = new String[] {""} ;
      T000617_A2EmpNom = new String[] {""} ;
      T000618_A250LegIdNomApe = new String[] {""} ;
      T000618_A591LegNomApe = new String[] {""} ;
      T000618_A230LegApellido = new String[] {""} ;
      T000618_A251LegNombre = new String[] {""} ;
      T000618_A244LegFecEgreso = new java.util.Date[] {GXutil.nullDate()} ;
      T000618_n244LegFecEgreso = new boolean[] {false} ;
      T000618_A93LegId = new String[] {""} ;
      T000618_n93LegId = new boolean[] {false} ;
      T000619_A42ConCodYDesc = new String[] {""} ;
      T000619_n42ConCodYDesc = new boolean[] {false} ;
      T000619_A41ConDescrip = new String[] {""} ;
      T000619_A143ConCanti = new boolean[] {false} ;
      T000619_A158ConValUni = new boolean[] {false} ;
      T000619_A152ConImporte = new boolean[] {false} ;
      T000620_A3CliCod = new int[1] ;
      T000620_A1EmpCod = new short[1] ;
      T000620_A6LegNumero = new int[1] ;
      T000620_A25AgeOrden = new short[1] ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.agendanovedades__default(),
         new Object[] {
             new Object[] {
            T00062_A25AgeOrden, T00062_A1254AgeLiqNro, T00062_n1254AgeLiqNro, T00062_A110AgeCanti, T00062_n110AgeCanti, T00062_A115AgeVUnit, T00062_n115AgeVUnit, T00062_A113AgeImporte, T00062_n113AgeImporte, T00062_A111AgeFecDes,
            T00062_n111AgeFecDes, T00062_A112AgeFecHas, T00062_n112AgeFecHas, T00062_A3CliCod, T00062_A1EmpCod, T00062_A6LegNumero, T00062_A26ConCodigo
            }
            , new Object[] {
            T00063_A25AgeOrden, T00063_A1254AgeLiqNro, T00063_n1254AgeLiqNro, T00063_A110AgeCanti, T00063_n110AgeCanti, T00063_A115AgeVUnit, T00063_n115AgeVUnit, T00063_A113AgeImporte, T00063_n113AgeImporte, T00063_A111AgeFecDes,
            T00063_n111AgeFecDes, T00063_A112AgeFecHas, T00063_n112AgeFecHas, T00063_A3CliCod, T00063_A1EmpCod, T00063_A6LegNumero, T00063_A26ConCodigo
            }
            , new Object[] {
            T00064_A2EmpNom
            }
            , new Object[] {
            T00065_A250LegIdNomApe, T00065_A591LegNomApe, T00065_A230LegApellido, T00065_A251LegNombre, T00065_A244LegFecEgreso, T00065_n244LegFecEgreso, T00065_A93LegId, T00065_n93LegId
            }
            , new Object[] {
            T00066_A42ConCodYDesc, T00066_n42ConCodYDesc, T00066_A41ConDescrip, T00066_A143ConCanti, T00066_A158ConValUni, T00066_A152ConImporte
            }
            , new Object[] {
            T00067_A42ConCodYDesc, T00067_n42ConCodYDesc, T00067_A250LegIdNomApe, T00067_A591LegNomApe, T00067_A25AgeOrden, T00067_A1254AgeLiqNro, T00067_n1254AgeLiqNro, T00067_A2EmpNom, T00067_A230LegApellido, T00067_A251LegNombre,
            T00067_A244LegFecEgreso, T00067_n244LegFecEgreso, T00067_A41ConDescrip, T00067_A110AgeCanti, T00067_n110AgeCanti, T00067_A115AgeVUnit, T00067_n115AgeVUnit, T00067_A113AgeImporte, T00067_n113AgeImporte, T00067_A111AgeFecDes,
            T00067_n111AgeFecDes, T00067_A112AgeFecHas, T00067_n112AgeFecHas, T00067_A93LegId, T00067_n93LegId, T00067_A143ConCanti, T00067_A158ConValUni, T00067_A152ConImporte, T00067_A3CliCod, T00067_A1EmpCod,
            T00067_A6LegNumero, T00067_A26ConCodigo
            }
            , new Object[] {
            T00068_A42ConCodYDesc, T00068_n42ConCodYDesc, T00068_A41ConDescrip, T00068_A143ConCanti, T00068_A158ConValUni, T00068_A152ConImporte
            }
            , new Object[] {
            T00069_A2EmpNom
            }
            , new Object[] {
            T000610_A250LegIdNomApe, T000610_A591LegNomApe, T000610_A230LegApellido, T000610_A251LegNombre, T000610_A244LegFecEgreso, T000610_n244LegFecEgreso, T000610_A93LegId, T000610_n93LegId
            }
            , new Object[] {
            T000611_A3CliCod, T000611_A1EmpCod, T000611_A6LegNumero, T000611_A25AgeOrden
            }
            , new Object[] {
            T000612_A25AgeOrden, T000612_A3CliCod, T000612_A1EmpCod, T000612_A6LegNumero
            }
            , new Object[] {
            T000613_A25AgeOrden, T000613_A3CliCod, T000613_A1EmpCod, T000613_A6LegNumero
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            T000618_A250LegIdNomApe, T000618_A591LegNomApe, T000618_A230LegApellido, T000618_A251LegNombre, T000618_A244LegFecEgreso, T000618_n244LegFecEgreso, T000618_A93LegId, T000618_n93LegId
            }
            , new Object[] {
            T000619_A42ConCodYDesc, T000619_n42ConCodYDesc, T000619_A41ConDescrip, T000619_A143ConCanti, T000619_A158ConValUni, T000619_A152ConImporte
            }
            , new Object[] {
            T000620_A3CliCod, T000620_A1EmpCod, T000620_A6LegNumero, T000620_A25AgeOrden
            }
         }
      );
      AV29Pgmname = "AgendaNovedades" ;
   ...
   private String[] T00064_A2EmpNom ;
   private String[] T00065_A250LegIdNomApe ;
   private String[] T00065_A591LegNomApe ;
   private String[] T00065_A230LegApellido ;
   private String[] T00065_A251LegNombre ;
   private java.util.Date[] T00065_A244LegFecEgreso ;
   private boolean[] T00065_n244LegFecEgreso ;
   private String[] T00065_A93LegId ;
   private boolean[] T00065_n93LegId ;
   private String[] T00066_A42ConCodYDesc ;
   private boolean[] T00066_n42ConCodYDesc ;
   private String[] T00066_A41ConDescrip ;
   private boolean[] T00066_A143ConCanti ;
   private boolean[] T00066_A158ConValUni ;
   private boolean[] T00066_A152ConImporte ;
   private String[] T00067_A42ConCodYDesc ;
   private boolean[] T00067_n42ConCodYDesc ;
   private String[] T00067_A250LegIdNomApe ;
   private String[] T00067_A591LegNomApe ;
   private short[] T00067_A25AgeOrden ;
   private int[] T00067_A1254AgeLiqNro ;
   private boolean[] T00067_n1254AgeLiqNro ;
   private String[] T00067_A2EmpNom ;
   private String[] T00067_A230LegApellido ;
   private String[] T00067_A251LegNombre ;
   private java.util.Date[] T00067_A244LegFecEgreso ;
   private boolean[] T00067_n244LegFecEgreso ;
   private String[] T00067_A41ConDescrip ;
   private java.math.BigDecimal[] T00067_A110AgeCanti ;
   private boolean[] T00067_n110AgeCanti ;
   private java.math.BigDecimal[] T00067_A115AgeVUnit ;
   private boolean[] T00067_n115AgeVUnit ;
   private java.math.BigDecimal[] T00067_A113AgeImporte ;
   private boolean[] T00067_n113AgeImporte ;
   private java.util.Date[] T00067_A111AgeFecDes ;
   private boolean[] T00067_n111AgeFecDes ;
   private java.util.Date[] T00067_A112AgeFecHas ;
   private boolean[] T00067_n112AgeFecHas ;
   private String[] T00067_A93LegId ;
   private boolean[] T00067_n93LegId ;
   private boolean[] T00067_A143ConCanti ;
   private boolean[] T00067_A158ConValUni ;
   private boolean[] T00067_A152ConImporte ;
   private int[] T00067_A3CliCod ;
   private short[] T00067_A1EmpCod ;
   private int[] T00067_A6LegNumero ;
   private String[] T00067_A26ConCodigo ;
   private String[] T00068_A42ConCodYDesc ;
   private boolean[] T00068_n42ConCodYDesc ;
   private String[] T00068_A41ConDescrip ;
   private boolean[] T00068_A143ConCanti ;
   private boolean[] T00068_A158ConValUni ;
   private boolean[] T00068_A152ConImporte ;
   private String[] T00069_A2EmpNom ;
   private String[] T000610_A250LegIdNomApe ;
   private String[] T000610_A591LegNomApe ;
   private String[] T000610_A230LegApellido ;
   private String[] T000610_A251LegNombre ;
   private java.util.Date[] T000610_A244LegFecEgreso ;
   private boolean[] T000610_n244LegFecEgreso ;
   private String[] T000610_A93LegId ;
   private boolean[] T000610_n93LegId ;
   private int[] T000611_A3CliCod ;
   private short[] T000611_A1EmpCod ;
   private int[] T000611_A6LegNumero ;
   private short[] T000611_A25AgeOrden ;
   private short[] T00063_A25AgeOrden ;
   private int[] T00063_A1254AgeLiqNro ;
   private boolean[] T00063_n1254AgeLiqNro ;
   private java.math.BigDecimal[] T00063_A110AgeCanti ;
   private boolean[] T00063_n110AgeCanti ;
   private java.math.BigDecimal[] T00063_A115AgeVUnit ;
   private boolean[] T00063_n115AgeVUnit ;
   private java.math.BigDecimal[] T00063_A113AgeImporte ;
   private boolean[] T00063_n113AgeImporte ;
   private java.util.Date[] T00063_A111AgeFecDes ;
   private boolean[] T00063_n111AgeFecDes ;
   private java.util.Date[] T00063_A112AgeFecHas ;
   private boolean[] T00063_n112AgeFecHas ;
   private int[] T00063_A3CliCod ;
   private short[] T00063_A1EmpCod ;
   private int[] T00063_A6LegNumero ;
   private String[] T00063_A26ConCodigo ;
   private short[] T000612_A25AgeOrden ;
   private int[] T000612_A3CliCod ;
   private short[] T000612_A1EmpCod ;
   private int[] T000612_A6LegNumero ;
   private short[] T000613_A25AgeOrden ;
   private int[] T000613_A3CliCod ;
   private short[] T000613_A1EmpCod ;
   private int[] T000613_A6LegNumero ;
   private short[] T00062_A25AgeOrden ;
   private int[] T00062_A1254AgeLiqNro ;
   private boolean[] T00062_n1254AgeLiqNro ;
   private java.math.BigDecimal[] T00062_A110AgeCanti ;
   private boolean[] T00062_n110AgeCanti ;
   private java.math.BigDecimal[] T00062_A115AgeVUnit ;
   private boolean[] T00062_n115AgeVUnit ;
   private java.math.BigDecimal[] T00062_A113AgeImporte ;
   private boolean[] T00062_n113AgeImporte ;
   private java.util.Date[] T00062_A111AgeFecDes ;
   private boolean[] T00062_n111AgeFecDes ;
   private java.util.Date[] T00062_A112AgeFecHas ;
   private boolean[] T00062_n112AgeFecHas ;
   private int[] T00062_A3CliCod ;
   private short[] T00062_A1EmpCod ;
   private int[] T00062_A6LegNumero ;
   private String[] T00062_A26ConCodigo ;
   private String[] T000617_A2EmpNom ;
   private String[] T000618_A250LegIdNomApe ;
   private String[] T000618_A591LegNomApe ;
   private String[] T000618_A230LegApellido ;
   private String[] T000618_A251LegNombre ;
   private java.util.Date[] T000618_A244LegFecEgreso ;
   private boolean[] T000618_n244LegFecEgreso ;
   private String[] T000618_A93LegId ;
   private boolean[] T000618_n93LegId ;
   private String[] T000619_A42ConCodYDesc ;
   private boolean[] T000619_n42ConCodYDesc ;
   private String[] T000619_A41ConDescrip ;
   private boolean[] T000619_A143ConCanti ;
   private boolean[] T000619_A158ConValUni ;
   private boolean[] T000619_A152ConImporte ;
   private int[] T000620_A3CliCod ;
   private short[] T000620_A1EmpCod ;
   private int[] T000620_A6LegNumero ;
   private short[] T000620_A25AgeOrden ;
...
final  class agendanovedades__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("T00062", "SELECT AgeOrden, AgeLiqNro, AgeCanti, AgeVUnit, AgeImporte, AgeFecDes, AgeFecHas, CliCod, EmpCod, LegNumero, ConCodigo FROM AgendaNovedades WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? AND AgeOrden = ?  FOR UPDATE OF AgendaNovedades NOWAIT",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00063", "SELECT AgeOrden, AgeLiqNro, AgeCanti, AgeVUnit, AgeImporte, AgeFecDes, AgeFecHas, CliCod, EmpCod, LegNumero, ConCodigo FROM AgendaNovedades WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? AND AgeOrden = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00064", "SELECT EmpNom FROM Empresa WHERE CliCod = ? AND EmpCod = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00065", "SELECT LegIdNomApe, LegNomApe, LegApellido, LegNombre, LegFecEgreso, LegId FROM Legajo WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00066", "SELECT ConCodYDesc, ConDescrip, ConCanti, ConValUni, ConImporte FROM Concepto WHERE CliCod = ? AND ConCodigo = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00067", "SELECT T4.ConCodYDesc, T3.LegIdNomApe, T3.LegNomApe, TM1.AgeOrden, TM1.AgeLiqNro, T2.EmpNom, T3.LegApellido, T3.LegNombre, T3.LegFecEgreso, T4.ConDescrip, TM1.AgeCanti, TM1.AgeVUnit, TM1.AgeImporte, TM1.AgeFecDes, TM1.AgeFecHas, T3.LegId, T4.ConCanti, T4.ConValUni, T4.ConImporte, TM1.CliCod, TM1.EmpCod, TM1.LegNumero, TM1.ConCodigo FROM (((AgendaNovedades TM1 INNER JOIN Empresa T2 ON T2.CliCod = TM1.CliCod AND T2.EmpCod = TM1.EmpCod) INNER JOIN Legajo T3 ON T3.CliCod = TM1.CliCod AND T3.EmpCod = TM1.EmpCod AND T3.LegNumero = TM1.LegNumero) INNER JOIN Concepto T4 ON T4.CliCod = TM1.CliCod AND T4.ConCodigo = TM1.ConCodigo) WHERE TM1.AgeOrden = ? and TM1.CliCod = ? and TM1.EmpCod = ? and TM1.LegNumero = ? ORDER BY TM1.CliCod, TM1.EmpCod, TM1.LegNumero, TM1.AgeOrden ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00068", "SELECT ConCodYDesc, ConDescrip, ConCanti, ConValUni, ConImporte FROM Concepto WHERE CliCod = ? AND ConCodigo = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T00069", "SELECT EmpNom FROM Empresa WHERE CliCod = ? AND EmpCod = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000610", "SELECT LegIdNomApe, LegNomApe, LegApellido, LegNombre, LegFecEgreso, LegId FROM Legajo WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000611", "SELECT CliCod, EmpCod, LegNumero, AgeOrden FROM AgendaNovedades WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? AND AgeOrden = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000612", "SELECT AgeOrden, CliCod, EmpCod, LegNumero FROM AgendaNovedades WHERE ( AgeOrden > ? or AgeOrden = ? and CliCod > ? or CliCod = ? and AgeOrden = ? and EmpCod > ? or EmpCod = ? and CliCod = ? and AgeOrden = ? and LegNumero > ?) ORDER BY CliCod, EmpCod, LegNumero, AgeOrden  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("T000613", "SELECT AgeOrden, CliCod, EmpCod, LegNumero FROM AgendaNovedades WHERE ( AgeOrden < ? or AgeOrden = ? and CliCod < ? or CliCod = ? and AgeOrden = ? and EmpCod < ? or EmpCod = ? and CliCod = ? and AgeOrden = ? and LegNumero < ?) ORDER BY CliCod DESC, EmpCod DESC, LegNumero DESC, AgeOrden DESC  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new UpdateCursor("T000614", "SAVEPOINT gxupdate;INSERT INTO AgendaNovedades(AgeOrden, AgeLiqNro, AgeCanti, AgeVUnit, AgeImporte, AgeFecDes, AgeFecHas, CliCod, EmpCod, LegNumero, ConCodigo, AgePerDescrip) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '');RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T000615", "SAVEPOINT gxupdate;UPDATE AgendaNovedades SET AgeLiqNro=?, AgeCanti=?, AgeVUnit=?, AgeImporte=?, AgeFecDes=?, AgeFecHas=?, ConCodigo=?  WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? AND AgeOrden = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T000616", "SAVEPOINT gxupdate;DELETE FROM AgendaNovedades  WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? AND AgeOrden = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new ForEachCursor("T000617", "SELECT EmpNom FROM Empresa WHERE CliCod = ? AND EmpCod = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000618", "SELECT LegIdNomApe, LegNomApe, LegApellido, LegNombre, LegFecEgreso, LegId FROM Legajo WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000619", "SELECT ConCodYDesc, ConDescrip, ConCanti, ConValUni, ConImporte FROM Concepto WHERE CliCod = ? AND ConCodigo = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T000620", "SELECT CliCod, EmpCod, LegNumero, AgeOrden FROM AgendaNovedades ORDER BY CliCod, EmpCod, LegNumero, AgeOrden ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            ...
            case 5 :
               ...
               ((boolean[]) buf[26])[0] = rslt.getBoolean(18);
               ((boolean[]) buf[27])[0] = rslt.getBoolean(19);
