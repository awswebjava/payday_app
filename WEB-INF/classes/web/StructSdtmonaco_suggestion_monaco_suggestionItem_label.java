...
public final  class StructSdtmonaco_suggestion_monaco_suggestionItem_label implements Cloneable, java.io.Serializable
{
   public StructSdtmonaco_suggestion_monaco_suggestionItem_label( )
   {
      this( -1, new ModelContext( StructSdtmonaco_suggestion_monaco_suggestionItem_label.class ));
   }

   public StructSdtmonaco_suggestion_monaco_suggestionItem_label( int remoteHandle ,
