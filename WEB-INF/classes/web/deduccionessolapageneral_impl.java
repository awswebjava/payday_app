...
public final  class deduccionessolapageneral_impl extends GXWebComponent
{
   public deduccionessolapageneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public deduccionessolapageneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( deduccionessolapageneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "deducciones Solapa General", "")) ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LEGDEDCONCODIGO", GXutil.rtrim( A84LegDedConCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LEGDEDCONDESCRIP", A559LegDedConDescrip);
   }

   public void renderHtmlCloseForm7V2( )
   {
   ...
   {
      return "deduccionesSolapaGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "deducciones Solapa General", "") ;
   }
   ...
   public void wb7V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.deduccionessolapageneral");
         }
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtLegDedConCodYDesc_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         web.GxWebStd.gx_label_element( httpContext, edtLegDedConCodYDesc_Internalname, httpContext.getMessage( "Deducción", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtLegDedConCodYDesc_Internalname, A570LegDedConCodYDesc, "", "", (short)(0), 1, edtLegDedConCodYDesc_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "DescripcionEnorme", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_deduccionesSolapaGeneral.htm");
         ...
         web.GxWebStd.gx_bitmap( httpContext, edtLegDedFchHas_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtLegDedFchHas_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_deduccionesSolapaGeneral.htm");
         httpContext.writeTextNL( "</div>") ;
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtLegDedDescrip_Internalname, A568LegDedDescrip, "", "", (short)(0), 1, edtLegDedDescrip_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "DescripcionEnorme", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_deduccionesSolapaGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e117v1_client"+"'", TempTags, "", 2, "HLP_deduccionesSolapaGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e127v1_client"+"'", TempTags, "", 2, "HLP_deduccionesSolapaGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_deduccionesSolapaGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_deduccionesSolapaGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegNumero_Internalname, GXutil.ltrim( localUtil.ntoc( A6LegNumero, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6LegNumero), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegNumero_Jsonclick, 0, "Attribute", "", "", "", "", edtLegNumero_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoMedio", "right", false, "", "HLP_deduccionesSolapaGeneral.htm");
         /* Single line edit */
   ...
   public void start7V2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "deducciones Solapa General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV20Pgmname = "deduccionesSolapaGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void send_integrity_lvl_hashes7V2( )
   {
   }
   ...
   public void e137V2( )
   {
      ...
      deduccionessolapageneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV14CliCod = GXt_int1 ;
   ...
   protected void e147V2( )
   {
      ...
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWdeduccionesSolapa_Update", GXv_boolean5) ;
      deduccionessolapageneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      ...
      GXt_boolean4 = AV13TempBoolean ;
      GXv_boolean5[0] = GXt_boolean4 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWdeduccionesSolapa_Delete", GXv_boolean5) ;
      deduccionessolapageneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      AV13TempBoolean = GXt_boolean4 ;
      if ( ! ( AV13TempBoolean ) )
      {
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "deduccionesSolapa" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "deduccionessolapageneral", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181704364", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("deduccionessolapageneral.js", "?2025181704364", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      edtLegDedConCodYDesc_Enabled = 0 ;
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e117V1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A83LegDedSec',fld:'LEGDEDSEC',pic:'ZZZZZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e127V1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A83LegDedSec',fld:'LEGDEDSEC',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV20Pgmname = "" ;
      scmdbuf = "" ;
      H007V2_A3CliCod = new int[1] ;
      H007V2_A1EmpCod = new short[1] ;
      H007V2_A6LegNumero = new int[1] ;
      H007V2_A83LegDedSec = new int[1] ;
      H007V2_A560LegDedImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007V2_A568LegDedDescrip = new String[] {""} ;
      H007V2_A557LegDedFchHas = new java.util.Date[] {GXutil.nullDate()} ;
      H007V2_A556LegDedFchDes = new java.util.Date[] {GXutil.nullDate()} ;
      H007V2_A559LegDedConDescrip = new String[] {""} ;
      H007V2_A84LegDedConCodigo = new String[] {""} ;
      ...
      sCtrlA6LegNumero = "" ;
      sCtrlA83LegDedSec = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.deduccionessolapageneral__default(),
         new Object[] {
             new Object[] {
            H007V2_A3CliCod, H007V2_A1EmpCod, H007V2_A6LegNumero, H007V2_A83LegDedSec, H007V2_A560LegDedImporte, H007V2_A568LegDedDescrip, H007V2_A557LegDedFchHas, H007V2_A556LegDedFchDes, H007V2_A559LegDedConDescrip, H007V2_A84LegDedConCodigo
            }
         }
      );
      AV20Pgmname = "deduccionesSolapaGeneral" ;
   ...
   private int edtLegDedConCodYDesc_Enabled ;
   ...
   private int[] H007V2_A3CliCod ;
   private short[] H007V2_A1EmpCod ;
   private int[] H007V2_A6LegNumero ;
   private int[] H007V2_A83LegDedSec ;
   private java.math.BigDecimal[] H007V2_A560LegDedImporte ;
   private String[] H007V2_A568LegDedDescrip ;
   private java.util.Date[] H007V2_A557LegDedFchHas ;
   private java.util.Date[] H007V2_A556LegDedFchDes ;
   private String[] H007V2_A559LegDedConDescrip ;
   private String[] H007V2_A84LegDedConCodigo ;
...
final  class deduccionessolapageneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H007V2", "SELECT T1.CliCod, T1.EmpCod, T1.LegNumero, T1.LegDedSec, T1.LegDedImporte, T1.LegDedDescrip, T1.LegDedFchHas, T1.LegDedFchDes, T2.ConDescrip AS LegDedConDescrip, T1.LegDedConCodigo AS LegDedConCodigo FROM (legajo_deducciones T1 INNER JOIN Concepto T2 ON T2.CliCod = T1.CliCod AND T2.ConCodigo = T1.LegDedConCodigo) WHERE T1.CliCod = ? and T1.EmpCod = ? and T1.LegNumero = ? and T1.LegDedSec = ? ORDER BY T1.CliCod, T1.EmpCod, T1.LegNumero, T1.LegDedSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
