...
@javax.xml.bind.annotation.XmlType(name = "conceptotipoliquidacionloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class conceptotipoliquidacionloaddvcombo_RESTInterfaceIN
{
   ...
   String AV20TLiqCod;
   @JsonProperty("TLiqCod")
   public String getTLiqCod( )
   {
      if ( GXutil.strcmp(AV20TLiqCod, null) == 0 )
      {
         return "" ;
      }
      else
