...
@javax.ws.rs.Path("/PuestoWWGetFilterData")
public final  class puestowwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.puestowwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV28DDOName;
      ...
      if ( ! processHeaders("puestowwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.puestowwgetfilterdata worker = new web.puestowwgetfilterdata(remoteHandle, context);
         worker.execute(AV28DDOName,AV29SearchTxt,AV30SearchTxtTo,AV31OptionsJson,AV32OptionsDescJson,AV33OptionIndexesJson );
         web.puestowwgetfilterdata_RESTInterfaceOUT data = new web.puestowwgetfilterdata_RESTInterfaceOUT();
