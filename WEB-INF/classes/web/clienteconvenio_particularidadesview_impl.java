...
public final  class clienteconvenio_particularidadesview_impl extends GXDataArea
{
   public clienteconvenio_particularidadesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clienteconvenio_particularidadesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clienteconvenio_particularidadesview_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.clienteconvenio_particularidadesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.formatDateParm(AV13CliConveVig)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CliConveVig","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.clienteconvenio_particularidadesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.formatDateParm(AV13CliConveVig)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CliConveVig","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ClienteConvenio_ParticularidadesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Cliente Convenio_Particularidades View", "") ;
   }
   ...
   public void wbEB0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_EB2( true) ;
      }
      else
      {
         wb_table1_9_EB2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_EB2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startEB2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Cliente Convenio_Particularidades View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e11EB2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00EB2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CliConveVig, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CliConveVig});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1575CliConveVig = H00EB2_A1575CliConveVig[0] ;
         A1565CliConvenio = H00EB2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00EB2_A1564CliPaiConve[0] ;
         A3CliCod = H00EB2_A3CliCod[0] ;
         A905ConveDefault = H00EB2_A905ConveDefault[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.booltostr( A905ConveDefault) );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ClienteConvenio_ParticularidadesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.clienteconvenio_particularidadesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ClienteConvenio_ParticularidadesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13CliConveVig});
   ...
   public void wb_table1_9_EB2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ClienteConvenio_ParticularidadesView.htm");
         /* Div Control */
         ...
         wb_table1_9_EB2e( true) ;
      }
      else
      {
         wb_table1_9_EB2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713272158", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("clienteconvenio_particularidadesview.js", "?20251713272158", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Cliente Convenio_Particularidades View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13CliConveVig',fld:'vCLICONVEVIG',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00EB2_A1575CliConveVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00EB2_A1565CliConvenio = new String[] {""} ;
      H00EB2_A1564CliPaiConve = new short[1] ;
      H00EB2_A3CliCod = new int[1] ;
      H00EB2_A905ConveDefault = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.clienteconvenio_particularidadesview__default(),
         new Object[] {
             new Object[] {
            H00EB2_A1575CliConveVig, H00EB2_A1565CliConvenio, H00EB2_A1564CliPaiConve, H00EB2_A3CliCod, H00EB2_A905ConveDefault
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private java.util.Date[] H00EB2_A1575CliConveVig ;
   private String[] H00EB2_A1565CliConvenio ;
   private short[] H00EB2_A1564CliPaiConve ;
   private int[] H00EB2_A3CliCod ;
   private boolean[] H00EB2_A905ConveDefault ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class clienteconvenio_particularidadesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00EB2", "SELECT CliConveVig, CliConvenio, CliPaiConve, CliCod, ConveDefault FROM ClienteConvenio_Particularidades WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CliConveVig = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CliConveVig = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, CliConveVig ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
