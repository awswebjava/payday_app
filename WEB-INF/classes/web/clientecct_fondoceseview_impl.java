...
public final  class clientecct_fondoceseview_impl extends GXDataArea
{
   public clientecct_fondoceseview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clientecct_fondoceseview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clientecct_fondoceseview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV14CliConveFondoSec = (short)(GXutil.lval( httpContext.GetPar( "CliConveFondoSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14CliConveFondoSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV14CliConveFondoSec), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEFONDOSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14CliConveFondoSec), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.clientecct_fondoceseview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.formatDateParm(AV13CliConveVig)),GXutil.URLEncode(GXutil.ltrimstr(AV14CliConveFondoSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CliConveVig","CliConveFondoSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEVIG", getSecureSignedToken( "", AV13CliConveVig));
      web.GxWebStd.gx_hidden_field( httpContext, "vCLICONVEFONDOSEC", GXutil.ltrim( localUtil.ntoc( AV14CliConveFondoSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEFONDOSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14CliConveFondoSec), "ZZZ9")));
   ...
   {
      return formatLink("web.clientecct_fondoceseview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.formatDateParm(AV13CliConveVig)),GXutil.URLEncode(GXutil.ltrimstr(AV14CliConveFondoSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CliConveVig","CliConveFondoSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Clientecct_fondoceseView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Clientecct_fondocese View", "") ;
   }
   ...
   public void wbMH0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_MH2( true) ;
      }
      else
      {
         wb_table1_9_MH2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_MH2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startMH2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Clientecct_fondocese View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupMH0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14CliConveFondoSec = (short)(localUtil.ctol( httpContext.cgiGet( "vCLICONVEFONDOSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11MH2( )
   {
      ...
      AV21GXLvl11 = (byte)(0) ;
      /* Using cursor H00MH2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CliConveVig, Short.valueOf(AV14CliConveFondoSec), Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CliConveVig, Short.valueOf(AV14CliConveFondoSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A2147CliConveFondoSec = H00MH2_A2147CliConveFondoSec[0] ;
         A1575CliConveVig = H00MH2_A1575CliConveVig[0] ;
         A1565CliConvenio = H00MH2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00MH2_A1564CliPaiConve[0] ;
         A3CliCod = H00MH2_A3CliCod[0] ;
         A2148CliConveFondoMeses = H00MH2_A2148CliConveFondoMeses[0] ;
         AV21GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A2148CliConveFondoMeses, 4, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV15LoadAllTabs || ( GXutil.strcmp(AV16SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV16SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Clientecct_fondoceseGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.clientecct_fondocesegeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Clientecct_fondoceseGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13CliConveVig,Short.valueOf(AV14CliConveFondoSec)});
   ...
   public void wb_table1_9_MH2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Clientecct_fondoceseView.htm");
         /* Div Control */
         ...
         wb_table1_9_MH2e( true) ;
      }
      else
      {
         wb_table1_9_MH2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13CliConveVig", localUtil.format(AV13CliConveVig, "99/99/99"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEVIG", getSecureSignedToken( "", AV13CliConveVig));
      AV14CliConveFondoSec = ((Number) GXutil.testNumericType( getParm(obj,4), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14CliConveFondoSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV14CliConveFondoSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEFONDOSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14CliConveFondoSec), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025171326252", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("clientecct_fondoceseview.js", "?2025171326253", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Clientecct_fondocese View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00MH2_A2147CliConveFondoSec = new short[1] ;
      H00MH2_A1575CliConveVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00MH2_A1565CliConvenio = new String[] {""} ;
      H00MH2_A1564CliPaiConve = new short[1] ;
      H00MH2_A3CliCod = new int[1] ;
      H00MH2_A2148CliConveFondoMeses = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.clientecct_fondoceseview__default(),
         new Object[] {
             new Object[] {
            H00MH2_A2147CliConveFondoSec, H00MH2_A1575CliConveVig, H00MH2_A1565CliConvenio, H00MH2_A1564CliPaiConve, H00MH2_A3CliCod, H00MH2_A2148CliConveFondoMeses
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV14CliConveFondoSec ;
   ...
   private short[] H00MH2_A2147CliConveFondoSec ;
   private java.util.Date[] H00MH2_A1575CliConveVig ;
   private String[] H00MH2_A1565CliConvenio ;
   private short[] H00MH2_A1564CliPaiConve ;
   private int[] H00MH2_A3CliCod ;
   private short[] H00MH2_A2148CliConveFondoMeses ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class clientecct_fondoceseview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00MH2", "SELECT CliConveFondoSec, CliConveVig, CliConvenio, CliPaiConve, CliCod, CliConveFondoMeses FROM Clientecct_fondocese WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CliConveVig = ? and CliConveFondoSec = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CliConveVig = ? and CliConveFondoSec = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, CliConveVig, CliConveFondoSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
