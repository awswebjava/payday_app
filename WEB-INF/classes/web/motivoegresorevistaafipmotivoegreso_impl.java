...
public final  class motivoegresorevistaafipmotivoegreso_impl extends GXWebComponent
{
   public motivoegresorevistaafipmotivoegreso_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public motivoegresorevistaafipmotivoegreso_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( motivoegresorevistaafipmotivoegreso_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Motivo Egreso Revista Afip Motivo Egreso", "")) ;
   ...
   public void renderHtmlCloseFormHZ2( )
   {
   ...
   {
      return "MotivoEgresoRevistaAfipMotivoEgreso" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Motivo Egreso Revista Afip Motivo Egreso", "") ;
   }
   ...
   public void wbHZ0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.motivoegresorevistaafipmotivoegreso");
         }
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtMegDescrip_Internalname, A300MegDescrip, "", "", (short)(0), 1, edtMegDescrip_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "DescripcionEnorme", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_MotivoEgresoRevistaAfipMotivoEgreso.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, dynMegRelSec, dynMegRelSec.getInternalname(), GXutil.trim( GXutil.str( A1990MegRelSec, 6, 0)), 1, dynMegRelSec.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, dynMegRelSec.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_MotivoEgresoRevistaAfipMotivoEgreso.htm");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11hz1_client"+"'", TempTags, "", 2, "HLP_MotivoEgresoRevistaAfipMotivoEgreso.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_MotivoEgresoRevistaAfipMotivoEgreso.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startHZ2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Motivo Egreso Revista Afip Motivo Egreso", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxdlamegrelsecHZ2( int AV13CliCod )
   {
      if ( ! httpContext.isAjaxRequest( ) )
      {
         httpContext.GX_webresponse.addHeader("Cache-Control", "no-store");
      ...
      addString( "[[") ;
      gxdlamegrelsec_dataHZ2( AV13CliCod) ;
      gxdynajaxindex = 1 ;
   ...
   public void gxamegrelsec_htmlHZ2( int AV13CliCod )
   {
      int gxdynajaxvalue;
      gxdlamegrelsec_dataHZ2( AV13CliCod) ;
      gxdynajaxindex = 1 ;
   ...
   protected void gxdlamegrelsec_dataHZ2( int AV13CliCod )
   {
      ...
      {
         gxdynajaxctrlcodr.add(GXutil.ltrim( localUtil.ntoc( H00HZ2_A1885CliRelSec[0], (byte)(6), (byte)(0), ".", "")));
         gxdynajaxctrldescr.add(H00HZ2_A1880CliReDTChar[0]);
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "MotivoEgresoRevistaAfipMotivoEgreso" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfHZ2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1990MegRelSec = H00HZ3_A1990MegRelSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1990MegRelSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1990MegRelSec), 6, 0));
            A300MegDescrip = H00HZ3_A300MegDescrip[0] ;
   ...
   public void send_integrity_lvl_hashesHZ2( )
   {
   }
   ...
   public void e13HZ2( )
   {
      ...
      motivoegresorevistaafipmotivoegreso_impl.this.GXt_int1 = GXv_int2[0] ;
      AV13CliCod = GXt_int1 ;
   ...
   protected void e14HZ2( )
   {
      ...
      motivoegresorevistaafipmotivoegreso_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "motivoegresorevistaafipmotivoegreso", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020294288", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("motivoegresorevistaafipmotivoegreso.js", "?2024122020294290", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e11HZ1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A11MegCodigo',fld:'MEGCODIGO',pic:''}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12HZ1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A11MegCodigo',fld:'MEGCODIGO',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      gxwrpcisep = "" ;
      scmdbuf = "" ;
      H00HZ2_A3CliCod = new int[1] ;
      H00HZ2_A1885CliRelSec = new int[1] ;
      H00HZ2_A1880CliReDTChar = new String[] {""} ;
      AV17Pgmname = "" ;
      H00HZ3_A3CliCod = new int[1] ;
      H00HZ3_A11MegCodigo = new String[] {""} ;
      H00HZ3_A1990MegRelSec = new int[1] ;
      H00HZ3_A300MegDescrip = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.motivoegresorevistaafipmotivoegreso__default(),
         new Object[] {
             new Object[] {
            H00HZ2_A3CliCod, H00HZ2_A1885CliRelSec, H00HZ2_A1880CliReDTChar
            }
            , new Object[] {
            H00HZ3_A3CliCod, H00HZ3_A11MegCodigo, H00HZ3_A1990MegRelSec, H00HZ3_A300MegDescrip
            }
         }
      );
      AV17Pgmname = "MotivoEgresoRevistaAfipMotivoEgreso" ;
   ...
   private int[] H00HZ2_A3CliCod ;
   private int[] H00HZ2_A1885CliRelSec ;
   private String[] H00HZ2_A1880CliReDTChar ;
   private int[] H00HZ3_A3CliCod ;
   private String[] H00HZ3_A11MegCodigo ;
   private int[] H00HZ3_A1990MegRelSec ;
   private String[] H00HZ3_A300MegDescrip ;
...
final  class motivoegresorevistaafipmotivoegreso__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00HZ2", "SELECT CliCod, CliRelSec, CliReDTChar FROM Cliente_Release WHERE CliCod = ? ORDER BY CliReDTChar ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00HZ3", "SELECT CliCod, MegCodigo, MegRelSec, MegDescrip FROM MotivoEgreso WHERE CliCod = ? and MegCodigo = ( ?) ORDER BY CliCod, MegCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
