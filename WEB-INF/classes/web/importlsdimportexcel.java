...
public final  class importlsdimportexcel extends GXProcedure
{
   public importlsdimportexcel( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( importlsdimportexcel.class ), "" );
   }
   ...
   {
      importlsdimportexcel.this.aP3 = new boolean[] {false};
   ...
   private void execute_int( String aP0 ,
                             ...
                             boolean[] aP3 )
   {
      importlsdimportexcel.this.AV22FilePath = aP0;
      importlsdimportexcel.this.AV29ExtraParmsJson = aP1;
      importlsdimportexcel.this.aP2 = aP2;
      importlsdimportexcel.this.aP3 = aP3;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      importlsdimportexcel.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S131( )
   {
      ...
      returnInSub = false ;
      Application.commitDataStores(context, remoteHandle, pr_default, "importlsdimportexcel");
   }
   ...
   public void S191( )
   {
      ...
      {
         A3CliCod = P00O72_A3CliCod[0] ;
         A1EmpCod = P00O72_A1EmpCod[0] ;
         A88ImpLiqSec = P00O72_A88ImpLiqSec[0] ;
         A89ImpLiqConExtCod = P00O72_A89ImpLiqConExtCod[0] ;
   ...
   public void S161( )
   {
      ...
      AV28TitleNames.add(httpContext.getMessage( "Nro Liq", ""), 0);
      ...
      AV28TitleNames.add(httpContext.getMessage( "Imp Liq Det Cant", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Imp Liq Det Imp", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Signo", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Imp Liq Det Hijos", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "CBU", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Imp Liq Det Conyu", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Tipo", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Imp Liq Det CCT", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Imp Liq Det SCVO", ""), 0);
      ...
      importlsdimportexcel.this.AV13DiscardedColumns = GXv_char4[0] ;
      AV27TitleIndexes = GXv_objcol_int5[0] ;
      importlsdimportexcel.this.AV11ColumnsCount = GXv_int6[0] ;
      importlsdimportexcel.this.AV12ColumnsFound = GXv_int7[0] ;
   ...
   {
      this.aP2[0] = importlsdimportexcel.this.AV26Messages;
      this.aP3[0] = importlsdimportexcel.this.AV20IsOk;
      CloseOpenCursors();
   ...
   public void initialize( )
   {
      ...
      AV39ImpLiqConExtCods = new GXSimpleCollection<String>(String.class, "internal", "");
      scmdbuf = "" ;
      P00O72_A3CliCod = new int[1] ;
      P00O72_A1EmpCod = new short[1] ;
      P00O72_A88ImpLiqSec = new short[1] ;
      P00O72_A89ImpLiqConExtCod = new String[] {""} ;
      A89ImpLiqConExtCod = "" ;
      AV28TitleNames = new GXSimpleCollection<String>(String.class, "internal", "");
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.importlsdimportexcel__default(),
         new Object[] {
             new Object[] {
            P00O72_A3CliCod, P00O72_A1EmpCod, P00O72_A88ImpLiqSec, P00O72_A89ImpLiqConExtCod
            }
         }
      );
      AV49Pgmname = "ImportLSDImportExcel" ;
      /* GeneXus formulas. */
      AV49Pgmname = "ImportLSDImportExcel" ;
      Gx_err = (short)(0) ;
   }
   ...
   private int[] P00O72_A3CliCod ;
   private short[] P00O72_A1EmpCod ;
   private short[] P00O72_A88ImpLiqSec ;
   private String[] P00O72_A89ImpLiqConExtCod ;
...
final  class importlsdimportexcel__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("P00O72", "SELECT CliCod, EmpCod, ImpLiqSec, ImpLiqConExtCod FROM importacion_conceptos ORDER BY CliCod, EmpCod, ImpLiqSec, ImpLiqConExtCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
