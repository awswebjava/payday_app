...
public final  class paisextraordinariaspais_impl extends GXWebComponent
{
   public paisextraordinariaspais_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public paisextraordinariaspais_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( paisextraordinariaspais_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Pais Extraordinarias Pais", "")) ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"PAIHSEXSEC", GXutil.ltrim( localUtil.ntoc( A1332PaiHsExSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   }

   public void renderHtmlCloseFormJB2( )
   {
   ...
   {
      return "PaisExtraordinariasPais" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Pais Extraordinarias Pais", "") ;
   }
   ...
   public void wbJB0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.paisextraordinariaspais");
         }
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtPaiNom_Internalname, A312PaiNom, GXutil.rtrim( localUtil.format( A312PaiNom, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaiNom_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaiNom_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "DescripcionMedia", "left", true, "", "HLP_PaisExtraordinariasPais.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtPaiReligDefault_Internalname, GXutil.rtrim( A1252PaiReligDefault), GXutil.rtrim( localUtil.format( A1252PaiReligDefault, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaiReligDefault_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaiReligDefault_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_PaisExtraordinariasPais.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbPaiPerVacDes, cmbPaiPerVacDes.getInternalname(), GXutil.trim( GXutil.str( A1521PaiPerVacDes, 2, 0)), 1, cmbPaiPerVacDes.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbPaiPerVacDes.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_PaisExtraordinariasPais.htm");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbPaiPerVacHas, cmbPaiPerVacHas.getInternalname(), GXutil.trim( GXutil.str( A1522PaiPerVacHas, 2, 0)), 1, cmbPaiPerVacHas.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbPaiPerVacHas.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_PaisExtraordinariasPais.htm");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtPaiVizzoti_Internalname, GXutil.ltrim( localUtil.ntoc( A1737PaiVizzoti, (byte)(6), (byte)(4), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtPaiVizzoti_Enabled!=0) ? localUtil.format( A1737PaiVizzoti, "9.9999") : localUtil.format( A1737PaiVizzoti, "9.9999"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaiVizzoti_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaiVizzoti_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "porUnaje", "right", false, "", "HLP_PaisExtraordinariasPais.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11jb1_client"+"'", TempTags, "", 2, "HLP_PaisExtraordinariasPais.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12jb1_client"+"'", TempTags, "", 2, "HLP_PaisExtraordinariasPais.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startJB2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Pais Extraordinarias Pais", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "PaisExtraordinariasPais" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfJB2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1737PaiVizzoti = H00JB2_A1737PaiVizzoti[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1737PaiVizzoti", GXutil.ltrimstr( A1737PaiVizzoti, 6, 4));
            A1736PaiExcVizzoti = H00JB2_A1736PaiExcVizzoti[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1736PaiExcVizzoti", A1736PaiExcVizzoti);
            A1814PaiFracVacAnt = H00JB2_A1814PaiFracVacAnt[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1814PaiFracVacAnt", GXutil.ltrimstr( A1814PaiFracVacAnt, 6, 4));
            A1522PaiPerVacHas = H00JB2_A1522PaiPerVacHas[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1522PaiPerVacHas", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1522PaiPerVacHas), 2, 0));
            A1521PaiPerVacDes = H00JB2_A1521PaiPerVacDes[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1521PaiPerVacDes", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1521PaiPerVacDes), 2, 0));
            A1402PaiFondoCese = H00JB2_A1402PaiFondoCese[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1402PaiFondoCese", A1402PaiFondoCese);
            A1252PaiReligDefault = H00JB2_A1252PaiReligDefault[0] ;
            n1252PaiReligDefault = H00JB2_n1252PaiReligDefault[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1252PaiReligDefault", A1252PaiReligDefault);
            A310PaiDomMostrar = H00JB2_A310PaiDomMostrar[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A310PaiDomMostrar", A310PaiDomMostrar);
            A311PaiNacMostrar = H00JB2_A311PaiNacMostrar[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A311PaiNacMostrar", A311PaiNacMostrar);
            A312PaiNom = H00JB2_A312PaiNom[0] ;
   ...
   public void send_integrity_lvl_hashesJB2( )
   {
   }
   ...
   public void e13JB2( )
   {
      ...
      paisextraordinariaspais_impl.this.GXt_int1 = GXv_int2[0] ;
      AV13CliCod = GXt_int1 ;
   ...
   protected void e14JB2( )
   {
      ...
      paisextraordinariaspais_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "paisextraordinariaspais", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202513953440", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("paisextraordinariaspais.js", "?202513953440", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e11JB1',iparms:[{av:'A46PaiCod',fld:'PAICOD',pic:'ZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12JB1',iparms:[{av:'A46PaiCod',fld:'PAICOD',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00JB2_A46PaiCod = new short[1] ;
      H00JB2_A1737PaiVizzoti = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00JB2_A1736PaiExcVizzoti = new boolean[] {false} ;
      H00JB2_A1814PaiFracVacAnt = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00JB2_A1522PaiPerVacHas = new byte[1] ;
      H00JB2_A1521PaiPerVacDes = new byte[1] ;
      H00JB2_A1402PaiFondoCese = new boolean[] {false} ;
      H00JB2_A1252PaiReligDefault = new String[] {""} ;
      H00JB2_n1252PaiReligDefault = new boolean[] {false} ;
      H00JB2_A310PaiDomMostrar = new boolean[] {false} ;
      H00JB2_A311PaiNacMostrar = new boolean[] {false} ;
      H00JB2_A312PaiNom = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.paisextraordinariaspais__default(),
         new Object[] {
             new Object[] {
            H00JB2_A46PaiCod, H00JB2_A1737PaiVizzoti, H00JB2_A1736PaiExcVizzoti, H00JB2_A1814PaiFracVacAnt, H00JB2_A1522PaiPerVacHas, H00JB2_A1521PaiPerVacDes, H00JB2_A1402PaiFondoCese, H00JB2_A1252PaiReligDefault, H00JB2_n1252PaiReligDefault, H00JB2_A310PaiDomMostrar,
            H00JB2_A311PaiNacMostrar, H00JB2_A312PaiNom
            }
         }
      );
      AV17Pgmname = "PaisExtraordinariasPais" ;
   ...
   private short[] H00JB2_A46PaiCod ;
   private java.math.BigDecimal[] H00JB2_A1737PaiVizzoti ;
   private boolean[] H00JB2_A1736PaiExcVizzoti ;
   private java.math.BigDecimal[] H00JB2_A1814PaiFracVacAnt ;
   private byte[] H00JB2_A1522PaiPerVacHas ;
   private byte[] H00JB2_A1521PaiPerVacDes ;
   private boolean[] H00JB2_A1402PaiFondoCese ;
   private String[] H00JB2_A1252PaiReligDefault ;
   private boolean[] H00JB2_n1252PaiReligDefault ;
   private boolean[] H00JB2_A310PaiDomMostrar ;
   private boolean[] H00JB2_A311PaiNacMostrar ;
   private String[] H00JB2_A312PaiNom ;
...
final  class paisextraordinariaspais__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00JB2", "SELECT PaiCod, PaiVizzoti, PaiExcVizzoti, PaiFracVacAnt, PaiPerVacHas, PaiPerVacDes, PaiFondoCese, PaiReligDefault, PaiDomMostrar, PaiNacMostrar, PaiNom FROM Pais WHERE PaiCod = ? ORDER BY PaiCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
