...
public final  class empresaview_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.empresaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","EmpCod","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.empresaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","EmpCod","TabCode"})  ;
   }
   ...
   public void wb4X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_4X2( true) ;
      }
      else
      {
         wb_table1_9_4X2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_4X2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void e114X2( )
   {
      ...
      AV17GXLvl11 = (byte)(0) ;
      /* Using cursor H004X2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV12CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV12CliCod), Short.valueOf(AV9EmpCod)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1EmpCod = H004X2_A1EmpCod[0] ;
         A3CliCod = H004X2_A3CliCod[0] ;
         A2EmpNom = H004X2_A2EmpNom[0] ;
         AV17GXLvl11 = (byte)(1) ;
         Form.setCaption( A2EmpNom );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.empresageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EmpresaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV12CliCod),Short.valueOf(AV9EmpCod)});
   ...
   public void wb_table1_9_4X2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaView.htm");
         /* Div Control */
         ...
         wb_table1_9_4X2e( true) ;
      }
      else
      {
         wb_table1_9_4X2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025139343869", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresaview.js", "?2025139343869", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H004X2_A1EmpCod = new short[1] ;
      H004X2_A3CliCod = new int[1] ;
      H004X2_A2EmpNom = new String[] {""} ;
      A2EmpNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.empresaview__default(),
         new Object[] {
             new Object[] {
            H004X2_A1EmpCod, H004X2_A3CliCod, H004X2_A2EmpNom
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] H004X2_A1EmpCod ;
   private int[] H004X2_A3CliCod ;
   private String[] H004X2_A2EmpNom ;
...
final  class empresaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004X2", "SELECT EmpCod, CliCod, EmpNom FROM Empresa WHERE (CliCod = ? and EmpCod = ?) AND (CliCod = ? and EmpCod = ?) ORDER BY CliCod, EmpCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
