...
@javax.xml.bind.annotation.XmlType(name = "paisvacacionesloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class paisvacacionesloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("PaiVacDesAnt")
   public byte getPaiVacDesAnt( )
   {
      return AV19PaiVacDesAnt ;
   }

   @JsonProperty("PaiVacDesAnt")
   public void setPaiVacDesAnt(  byte Value )
   {
      AV19PaiVacDesAnt= Value;
   }
