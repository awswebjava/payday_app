...
public final  class obrasocialview_impl extends GXDataArea
{
   public obrasocialview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public obrasocialview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( obrasocialview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV9OsoCod = httpContext.GetPar( "OsoCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9OsoCod", AV9OsoCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vOSOCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9OsoCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.obrasocialview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9OsoCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","OsoCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vOSOCOD", GXutil.rtrim( AV9OsoCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vOSOCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9OsoCod, ""))));
   ...
   {
      return formatLink("web.obrasocialview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9OsoCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","OsoCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ObraSocialView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Obra Social View", "") ;
   }
   ...
   public void wb170( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_172( true) ;
      }
      else
      {
         wb_table1_9_172( false) ;
      }
      return  ;
   }

   public void wb_table1_9_172e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start172( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Obra Social View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup170( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV12CliCod = (int)(localUtil.ctol( httpContext.cgiGet( "vCLICOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         AV9OsoCod = httpContext.cgiGet( "vOSOCOD") ;
   ...
   public void e11172( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00172 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV12CliCod), AV9OsoCod, Integer.valueOf(AV12CliCod), AV9OsoCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A5OsoCod = H00172_A5OsoCod[0] ;
         A3CliCod = H00172_A3CliCod[0] ;
         A307OsoDescrip = H00172_A307OsoDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A307OsoDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ObraSocialGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.obrasocialgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ObraSocialGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV12CliCod),AV9OsoCod});
   ...
   public void wb_table1_9_172( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ObraSocialView.htm");
         /* Div Control */
         ...
         wb_table1_9_172e( true) ;
      }
      else
      {
         wb_table1_9_172e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      AV9OsoCod = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9OsoCod", AV9OsoCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vOSOCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9OsoCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202032582", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("obrasocialview.js", "?202412202032582", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Obra Social View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV9OsoCod',fld:'vOSOCOD',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00172_A5OsoCod = new String[] {""} ;
      H00172_A3CliCod = new int[1] ;
      H00172_A307OsoDescrip = new String[] {""} ;
      A5OsoCod = "" ;
      A307OsoDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.obrasocialview__default(),
         new Object[] {
             new Object[] {
            H00172_A5OsoCod, H00172_A3CliCod, H00172_A307OsoDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV9OsoCod ;
   private String wcpOAV7TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV9OsoCod ;
   ...
   private String[] H00172_A5OsoCod ;
   private int[] H00172_A3CliCod ;
   private String[] H00172_A307OsoDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class obrasocialview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00172", "SELECT OsoCod, CliCod, OsoDescrip FROM ObraSocial WHERE (CliCod = ? and OsoCod = ( ?)) AND (CliCod = ? and OsoCod = ( ?)) ORDER BY CliCod, OsoCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
