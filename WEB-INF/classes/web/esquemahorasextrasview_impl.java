...
public final  class esquemahorasextrasview_impl extends GXDataArea
{
   public esquemahorasextrasview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public esquemahorasextrasview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( esquemahorasextrasview_impl.class ));
   }
   ...
   {
      return formatLink("web.esquemahorasextrasview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","PaiTipoTraId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EsquemaHorasExtrasView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Esquema Horas Extras View", "") ;
   }
   ...
   public void wbQ90( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_Q92( true) ;
      }
      else
      {
         wb_table1_9_Q92( false) ;
      }
      return  ;
   }

   public void wb_table1_9_Q92e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startQ92( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Esquema Horas Extras View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesQ92( )
   {
   }
   ...
   public void e11Q92( )
   {
      ...
      {
         A1294PaiTipoTraId = H00Q92_A1294PaiTipoTraId[0] ;
         A1565CliConvenio = H00Q92_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00Q92_A1564CliPaiConve[0] ;
         A3CliCod = H00Q92_A3CliCod[0] ;
         A1323ConveHsDia = H00Q92_A1323ConveHsDia[0] ;
         AV22GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EsquemaHorasExtrasGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.esquemahorasextrasgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EsquemaHorasExtrasGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
   ...
   public void wb_table1_9_Q92( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EsquemaHorasExtrasView.htm");
         /* Div Control */
         ...
         wb_table1_9_Q92e( true) ;
      }
      else
      {
         wb_table1_9_Q92e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025189434838", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("esquemahorasextrasview.js", "?2025189434839", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Esquema Horas Extras View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00Q92_A1294PaiTipoTraId = new String[] {""} ;
      H00Q92_A1565CliConvenio = new String[] {""} ;
      H00Q92_A1564CliPaiConve = new short[1] ;
      H00Q92_A3CliCod = new int[1] ;
      H00Q92_A1323ConveHsDia = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      A1294PaiTipoTraId = "" ;
      A1565CliConvenio = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.esquemahorasextrasview__default(),
         new Object[] {
             new Object[] {
            H00Q92_A1294PaiTipoTraId, H00Q92_A1565CliConvenio, H00Q92_A1564CliPaiConve, H00Q92_A3CliCod, H00Q92_A1323ConveHsDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00Q92_A1294PaiTipoTraId ;
   private String[] H00Q92_A1565CliConvenio ;
   private short[] H00Q92_A1564CliPaiConve ;
   private int[] H00Q92_A3CliCod ;
   private java.math.BigDecimal[] H00Q92_A1323ConveHsDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class esquemahorasextrasview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00Q92", "SELECT PaiTipoTraId, CliConvenio, CliPaiConve, CliCod, ConveHsDia FROM convenio_tiposdetrabajo WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and PaiTipoTraId = ( ?)) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and PaiTipoTraId = ( ?)) ORDER BY CliCod, CliPaiConve, CliConvenio, PaiTipoTraId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
