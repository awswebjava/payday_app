...
@javax.xml.bind.annotation.XmlType(name = "tipodeconceptoloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class tipodeconceptoloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("TipoConCod")
   public String getTipoConCod( )
   {
      if ( GXutil.strcmp(AV18TipoConCod, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV18TipoConCod ;
      }
   }
