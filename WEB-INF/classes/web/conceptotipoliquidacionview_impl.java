...
public final  class conceptotipoliquidacionview_impl extends GXDataArea
{
   public conceptotipoliquidacionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public conceptotipoliquidacionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( conceptotipoliquidacionview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12TLiqCod = httpContext.GetPar( "TLiqCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12TLiqCod", AV12TLiqCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTLIQCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12TLiqCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.conceptotipoliquidacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11ConCodigo)),GXutil.URLEncode(GXutil.rtrim(AV12TLiqCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ConCodigo","TLiqCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ConCodigo, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vTLIQCOD", GXutil.rtrim( AV12TLiqCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTLIQCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12TLiqCod, ""))));
   ...
   {
      return formatLink("web.conceptotipoliquidacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11ConCodigo)),GXutil.URLEncode(GXutil.rtrim(AV12TLiqCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ConCodigo","TLiqCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ConceptoTipoLiquidacionView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Concepto Tipo Liquidacion View", "") ;
   }
   ...
   public void wbIR0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_IR2( true) ;
      }
      else
      {
         wb_table1_9_IR2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_IR2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startIR2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Concepto Tipo Liquidacion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesIR2( )
   {
   }
   ...
   public void strupIR0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12TLiqCod = httpContext.cgiGet( "vTLIQCOD") ;
   ...
   public void e11IR2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00IR2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11ConCodigo, AV12TLiqCod, Integer.valueOf(AV10CliCod), AV11ConCodigo, AV12TLiqCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A32TLiqCod = H00IR2_A32TLiqCod[0] ;
         A26ConCodigo = H00IR2_A26ConCodigo[0] ;
         A3CliCod = H00IR2_A3CliCod[0] ;
         A1406ConTLOrdejec = H00IR2_A1406ConTLOrdejec[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1406ConTLOrdejec, 12, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ConceptoTipoLiquidacionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.conceptotipoliquidaciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ConceptoTipoLiquidacionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11ConCodigo,AV12TLiqCod});
   ...
   public void wb_table1_9_IR2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ConceptoTipoLiquidacionView.htm");
         /* Div Control */
         ...
         wb_table1_9_IR2e( true) ;
      }
      else
      {
         wb_table1_9_IR2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11ConCodigo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11ConCodigo", AV11ConCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ConCodigo, ""))));
      AV12TLiqCod = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12TLiqCod", AV12TLiqCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTLIQCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12TLiqCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412201949448", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("conceptotipoliquidacionview.js", "?202412201949448", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Concepto Tipo Liquidacion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11ConCodigo',fld:'vCONCODIGO',pic:'',hsh:true},{av:'AV12TLiqCod',fld:'vTLIQCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00IR2_A32TLiqCod = new String[] {""} ;
      H00IR2_A26ConCodigo = new String[] {""} ;
      H00IR2_A3CliCod = new int[1] ;
      H00IR2_A1406ConTLOrdejec = new long[1] ;
      A32TLiqCod = "" ;
      A26ConCodigo = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.conceptotipoliquidacionview__default(),
         new Object[] {
             new Object[] {
            H00IR2_A32TLiqCod, H00IR2_A26ConCodigo, H00IR2_A3CliCod, H00IR2_A1406ConTLOrdejec
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV12TLiqCod ;
   ...
   private String[] H00IR2_A32TLiqCod ;
   private String[] H00IR2_A26ConCodigo ;
   private int[] H00IR2_A3CliCod ;
   private long[] H00IR2_A1406ConTLOrdejec ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class conceptotipoliquidacionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00IR2", "SELECT TLiqCod, ConCodigo, CliCod, ConTLOrdejec FROM ConceptoTipoLiquidacion WHERE (CliCod = ? and ConCodigo = ( ?) and TLiqCod = ( ?)) AND (CliCod = ? and ConCodigo = ( ?) and TLiqCod = ( ?)) ORDER BY CliCod, ConCodigo, TLiqCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
