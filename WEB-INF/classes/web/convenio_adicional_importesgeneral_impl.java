...
public final  class convenio_adicional_importesgeneral_impl extends GXWebComponent
{
   public convenio_adicional_importesgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_adicional_importesgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_adicional_importesgeneral_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "A999ConveAdiVig", localUtil.format(A999ConveAdiVig, "99/99/99"));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(A3CliCod),Short.valueOf(A1564CliPaiConve),A1565CliConvenio,A996ConveAdicod,A999ConveAdiVig});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"CONVEADIIMPRELSEC") == 0 )
            {
               ...
               gxdlaconveadiimprelsecEX2( AV13CliCod) ;
               return  ;
            }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Convenio_Adicional_Importes General", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_adicional_importesgeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1564CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(A1565CliConvenio)),GXutil.URLEncode(GXutil.rtrim(A996ConveAdicod)),GXutil.URLEncode(GXutil.formatDateParm(A999ConveAdiVig))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiVig"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA999ConveAdiVig", localUtil.dtoc( wcpOA999ConveAdiVig, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CONVEADICOD", GXutil.rtrim( A996ConveAdicod));
   ...
   {
      return "Convenio_Adicional_ImportesGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Convenio_Adicional_Importes General", "") ;
   }
   ...
   public void wbEX0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.convenio_adicional_importesgeneral");
         }
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtConveAdiDescri_Internalname, A997ConveAdiDescri, edtConveAdiDescri_Link, "", (short)(0), 1, edtConveAdiDescri_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_Convenio_Adicional_ImportesGeneral.htm");
         ...
         /* Attribute/Variable Label */
         web.GxWebStd.gx_label_element( httpContext, edtConveAdiVig_Internalname, httpContext.getMessage( "Fecha de vigencia", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveAdiVig_Internalname, localUtil.format(A999ConveAdiVig, "99/99/99"), localUtil.format( A999ConveAdiVig, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveAdiVig_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtConveAdiVig_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_Convenio_Adicional_ImportesGeneral.htm");
         web.GxWebStd.gx_bitmap( httpContext, edtConveAdiVig_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtConveAdiVig_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Convenio_Adicional_ImportesGeneral.htm");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, dynConveAdiImpRelSec, dynConveAdiImpRelSec.getInternalname(), GXutil.trim( GXutil.str( A1899ConveAdiImpRelSec, 6, 0)), 1, dynConveAdiImpRelSec.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, dynConveAdiImpRelSec.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_Convenio_Adicional_ImportesGeneral.htm");
         dynConveAdiImpRelSec.setValue( GXutil.trim( GXutil.str( A1899ConveAdiImpRelSec, 6, 0)) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, dynConveAdiImpRelSec.getInternalname(), "Values", dynConveAdiImpRelSec.ToJavascriptSource(), true);
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11ex1_client"+"'", TempTags, "", 2, "HLP_Convenio_Adicional_ImportesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12ex1_client"+"'", TempTags, "", 2, "HLP_Convenio_Adicional_ImportesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startEX2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Convenio_Adicional_Importes General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxdlaconveadiimprelsecEX2( int AV13CliCod )
   {
      if ( ! httpContext.isAjaxRequest( ) )
      {
         httpContext.GX_webresponse.addHeader("Cache-Control", "no-store");
      ...
      addString( "[[") ;
      gxdlaconveadiimprelsec_dataEX2( AV13CliCod) ;
      gxdynajaxindex = 1 ;
   ...
   public void gxaconveadiimprelsec_htmlEX2( int AV13CliCod )
   {
      int gxdynajaxvalue;
      gxdlaconveadiimprelsec_dataEX2( AV13CliCod) ;
      gxdynajaxindex = 1 ;
   ...
   protected void gxdlaconveadiimprelsec_dataEX2( int AV13CliCod )
   {
      ...
      {
         gxdynajaxctrlcodr.add(GXutil.ltrim( localUtil.ntoc( H00EX2_A1885CliRelSec[0], (byte)(6), (byte)(0), ".", "")));
         gxdynajaxctrldescr.add(H00EX2_A1880CliReDTChar[0]);
   ...
   public void fix_multi_value_controls( )
   {
      if ( dynConveAdiImpRelSec.getItemCount() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1899ConveAdiImpRelSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1899ConveAdiImpRelSec), 6, 0));
      }
      if ( httpContext.isAjaxRequest( ) )
      {
         dynConveAdiImpRelSec.setValue( GXutil.trim( GXutil.str( A1899ConveAdiImpRelSec, 6, 0)) );
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "Convenio_Adicional_ImportesGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfEX2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1899ConveAdiImpRelSec = H00EX3_A1899ConveAdiImpRelSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1899ConveAdiImpRelSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1899ConveAdiImpRelSec), 6, 0));
            A1000ConveAdiImporte = H00EX3_A1000ConveAdiImporte[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1000ConveAdiImporte", GXutil.ltrimstr( A1000ConveAdiImporte, 14, 2));
            /* Execute user event: Load */
            e14EX2 ();
   ...
   public void before_start_formulas( )
   {
      ...
      A997ConveAdiDescri = H00EX4_A997ConveAdiDescri[0] ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A997ConveAdiDescri", A997ConveAdiDescri);
      pr_default.close(2);
      pr_default.close(2);
      fix_multi_value_controls( ) ;
   }
   ...
   public void strupEX0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOA999ConveAdiVig = localUtil.ctod( httpContext.cgiGet( sPrefix+"wcpOA999ConveAdiVig"), 0) ;
         A996ConveAdicod = httpContext.cgiGet( sPrefix+"CONVEADICOD") ;
   ...
   public void e13EX2( )
   {
      ...
      convenio_adicional_importesgeneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV13CliCod = GXt_int1 ;
   ...
   protected void e14EX2( )
   {
      ...
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWconvenio_adicional", GXv_boolean5) ;
      convenio_adicional_importesgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      AV12TempBoolean = GXt_boolean4 ;
      if ( AV12TempBoolean )
      {
         edtConveAdiDescri_Link = formatLink("web.convenio_adicionalview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1564CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(A1565CliConvenio)),GXutil.URLEncode(GXutil.rtrim(A996ConveAdicod)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","TabCode"})  ;
         httpContext.ajax_rsp_assign_prop(sPrefix, false, edtConveAdiDescri_Internalname, "Link", edtConveAdiDescri_Link, true);
      }
      edtCliCod_Visible = 0 ;
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Convenio_Adicional_Importes" );
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A996ConveAdicod", A996ConveAdicod);
      A999ConveAdiVig = (java.util.Date)getParm(obj,4,TypeConstants.DATE) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A999ConveAdiVig", localUtil.format(A999ConveAdiVig, "99/99/99"));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA999ConveAdiVig = (String)getParm(obj,4,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "convenio_adicional_importesgeneral", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A996ConveAdicod", A996ConveAdicod);
         A999ConveAdiVig = (java.util.Date)getParm(obj,6,TypeConstants.DATE) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A999ConveAdiVig", localUtil.format(A999ConveAdiVig, "99/99/99"));
      }
      wcpOA3CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA3CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOA1564CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA1564CliPaiConve"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      ...
      wcpOA996ConveAdicod = httpContext.cgiGet( sPrefix+"wcpOA996ConveAdicod") ;
      wcpOA999ConveAdiVig = localUtil.ctod( httpContext.cgiGet( sPrefix+"wcpOA999ConveAdiVig"), 0) ;
      if ( ! GetJustCreated( ) && ( ( A3CliCod != wcpOA3CliCod ) || ( A1564CliPaiConve != wcpOA1564CliPaiConve ) || ( GXutil.strcmp(A1565CliConvenio, wcpOA1565CliConvenio) != 0 ) || ( GXutil.strcmp(A996ConveAdicod, wcpOA996ConveAdicod) != 0 ) || !( GXutil.dateCompare(GXutil.resetTime(A999ConveAdiVig), GXutil.resetTime(wcpOA999ConveAdiVig)) ) ) )
      {
         setjustcreated();
      }
      ...
      wcpOA999ConveAdiVig = A999ConveAdiVig ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlA999ConveAdiVig = httpContext.cgiGet( sPrefix+"A999ConveAdiVig_CTRL") ;
      if ( GXutil.len( sCtrlA999ConveAdiVig) > 0 )
      {
         A999ConveAdiVig = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( sCtrlA999ConveAdiVig), 0)) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A999ConveAdiVig", localUtil.format(A999ConveAdiVig, "99/99/99"));
      }
      else
      {
         A999ConveAdiVig = localUtil.ctod( httpContext.cgiGet( sPrefix+"A999ConveAdiVig_PARM"), 0) ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A999ConveAdiVig_PARM", localUtil.dtoc( A999ConveAdiVig, 0, "/"));
      if ( GXutil.len( GXutil.rtrim( sCtrlA999ConveAdiVig)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A999ConveAdiVig_CTRL", GXutil.rtrim( sCtrlA999ConveAdiVig));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713334427", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("convenio_adicional_importesgeneral.js", "?20251713334427", false, true);
      /* End function include_jscripts */
   }

   public void init_default_properties( )
   {
      edtConveAdiDescri_Internalname = sPrefix+"CONVEADIDESCRI" ;
      edtConveAdiVig_Internalname = sPrefix+"CONVEADIVIG" ;
      edtConveAdiImporte_Internalname = sPrefix+"CONVEADIIMPORTE" ;
      dynConveAdiImpRelSec.setInternalname( sPrefix+"CONVEADIIMPRELSEC" );
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1564CliPaiConve',fld:'CLIPAICONVE',pic:'ZZZ9'},{av:'A1565CliConvenio',fld:'CLICONVENIO',pic:''},{av:'A996ConveAdicod',fld:'CONVEADICOD',pic:''},{av:'A999ConveAdiVig',fld:'CONVEADIVIG',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e11EX1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1564CliPaiConve',fld:'CLIPAICONVE',pic:'ZZZ9'},{av:'A1565CliConvenio',fld:'CLICONVENIO',pic:''},{av:'A996ConveAdicod',fld:'CONVEADICOD',pic:''},{av:'A999ConveAdiVig',fld:'CONVEADIVIG',pic:''}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12EX1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1564CliPaiConve',fld:'CLIPAICONVE',pic:'ZZZ9'},{av:'A1565CliConvenio',fld:'CLICONVENIO',pic:''},{av:'A996ConveAdicod',fld:'CONVEADICOD',pic:''},{av:'A999ConveAdiVig',fld:'CONVEADIVIG',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      wcpOA996ConveAdicod = "" ;
      wcpOA999ConveAdiVig = GXutil.nullDate() ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      A1565CliConvenio = "" ;
      ...
      gxwrpcisep = "" ;
      scmdbuf = "" ;
      H00EX2_A3CliCod = new int[1] ;
      H00EX2_A1885CliRelSec = new int[1] ;
      H00EX2_A1880CliReDTChar = new String[] {""} ;
      AV17Pgmname = "" ;
      H00EX3_A3CliCod = new int[1] ;
      H00EX3_A1564CliPaiConve = new short[1] ;
      H00EX3_A1565CliConvenio = new String[] {""} ;
      H00EX3_A996ConveAdicod = new String[] {""} ;
      H00EX3_A999ConveAdiVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00EX3_A1899ConveAdiImpRelSec = new int[1] ;
      H00EX3_A1000ConveAdiImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00EX3_A997ConveAdiDescri = new String[] {""} ;
      H00EX4_A997ConveAdiDescri = new String[] {""} ;
      ...
      sCtrlA999ConveAdiVig = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_adicional_importesgeneral__default(),
         new Object[] {
             new Object[] {
            H00EX2_A3CliCod, H00EX2_A1885CliRelSec, H00EX2_A1880CliReDTChar
            }
            , new Object[] {
            H00EX3_A3CliCod, H00EX3_A1564CliPaiConve, H00EX3_A1565CliConvenio, H00EX3_A996ConveAdicod, H00EX3_A999ConveAdiVig, H00EX3_A1899ConveAdiImpRelSec, H00EX3_A1000ConveAdiImporte, H00EX3_A997ConveAdiDescri
            }
            , new Object[] {
            H00EX4_A997ConveAdiDescri
            }
         }
      );
      AV17Pgmname = "Convenio_Adicional_ImportesGeneral" ;
   ...
   private String edtConveAdiDescri_Link ;
   ...
   private String sCtrlA999ConveAdiVig ;
   private java.util.Date wcpOA999ConveAdiVig ;
   ...
   private int[] H00EX2_A3CliCod ;
   private int[] H00EX2_A1885CliRelSec ;
   private String[] H00EX2_A1880CliReDTChar ;
   private int[] H00EX3_A3CliCod ;
   private short[] H00EX3_A1564CliPaiConve ;
   private String[] H00EX3_A1565CliConvenio ;
   private String[] H00EX3_A996ConveAdicod ;
   private java.util.Date[] H00EX3_A999ConveAdiVig ;
   private int[] H00EX3_A1899ConveAdiImpRelSec ;
   private java.math.BigDecimal[] H00EX3_A1000ConveAdiImporte ;
   private String[] H00EX3_A997ConveAdiDescri ;
   private String[] H00EX4_A997ConveAdiDescri ;
...
final  class convenio_adicional_importesgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00EX2", "SELECT CliCod, CliRelSec, CliReDTChar FROM Cliente_Release WHERE CliCod = ? ORDER BY CliReDTChar ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00EX3", "SELECT T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiVig, T1.ConveAdiImpRelSec, T1.ConveAdiImporte, T2.ConveAdiDescri FROM (convenio_adicionalimportes T1 INNER JOIN convenio_adicional T2 ON T2.CliCod = T1.CliCod AND T2.CliPaiConve = T1.CliPaiConve AND T2.CliConvenio = T1.CliConvenio AND T2.ConveAdicod = T1.ConveAdicod) WHERE T1.CliCod = ? and T1.CliPaiConve = ? and T1.CliConvenio = ( ?) and T1.ConveAdicod = ( ?) and T1.ConveAdiVig = ? ORDER BY T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiVig ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00EX4", "SELECT ConveAdiDescri FROM convenio_adicional WHERE CliCod = ? AND CliPaiConve = ? AND CliConvenio = ? AND ConveAdicod = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
