...
public final  class bancoview_impl extends GXDataArea
{
   public bancoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public bancoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( bancoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11BanCod = httpContext.GetPar( "BanCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11BanCod", AV11BanCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vBANCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11BanCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.bancoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11BanCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","BanCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vBANCOD", GXutil.rtrim( AV11BanCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vBANCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11BanCod, ""))));
   ...
   {
      return formatLink("web.bancoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11BanCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","BanCod","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Banco View", "") ;
   }
   ...
   public void wb0Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_0Q2( true) ;
      }
      else
      {
         wb_table1_9_0Q2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_0Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0Q2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Banco View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup0Q0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11BanCod = httpContext.cgiGet( "vBANCOD") ;
   ...
   public void e110Q2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H000Q2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11BanCod, Integer.valueOf(AV10CliCod), AV11BanCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A7BanCod = H000Q2_A7BanCod[0] ;
         A3CliCod = H000Q2_A3CliCod[0] ;
         A117BanDescrip = H000Q2_A117BanDescrip[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A117BanDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "BancoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.bancogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "BancoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11BanCod});
   ...
   public void wb_table1_9_0Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_BancoView.htm");
         /* Div Control */
         ...
         wb_table1_9_0Q2e( true) ;
      }
      else
      {
         wb_table1_9_0Q2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11BanCod = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11BanCod", AV11BanCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vBANCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11BanCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019414631", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("bancoview.js", "?2024122019414631", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Banco View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11BanCod',fld:'vBANCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000Q2_A7BanCod = new String[] {""} ;
      H000Q2_A3CliCod = new int[1] ;
      H000Q2_A117BanDescrip = new String[] {""} ;
      A7BanCod = "" ;
      A117BanDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.bancoview__default(),
         new Object[] {
             new Object[] {
            H000Q2_A7BanCod, H000Q2_A3CliCod, H000Q2_A117BanDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11BanCod ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11BanCod ;
   ...
   private String[] H000Q2_A7BanCod ;
   private int[] H000Q2_A3CliCod ;
   private String[] H000Q2_A117BanDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class bancoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000Q2", "SELECT BanCod, CliCod, BanDescrip FROM Banco WHERE (CliCod = ? and BanCod = ( ?)) AND (CliCod = ? and BanCod = ( ?)) ORDER BY CliCod, BanCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
