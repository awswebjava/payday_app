...
@javax.xml.bind.annotation.XmlType(name = "convenioloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class convenioloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("ConveCodigo")
   public String getConveCodigo( )
   {
      if ( GXutil.strcmp(AV19ConveCodigo, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV19ConveCodigo ;
      }
   }
