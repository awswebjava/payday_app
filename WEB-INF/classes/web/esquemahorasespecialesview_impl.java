...
public final  class esquemahorasespecialesview_impl extends GXDataArea
{
   public esquemahorasespecialesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public esquemahorasespecialesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( esquemahorasespecialesview_impl.class ));
   }
   ...
   {
      return formatLink("web.esquemahorasespecialesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.ltrimstr(AV13ConveHsExSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveHsExSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EsquemaHorasEspecialesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Esquema Horas Especiales View", "") ;
   }
   ...
   public void wbQE0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_QE2( true) ;
      }
      else
      {
         wb_table1_9_QE2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_QE2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startQE2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Esquema Horas Especiales View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesQE2( )
   {
   }
   ...
   public void e11QE2( )
   {
      ...
      {
         A1327ConveHsExSec = H00QE2_A1327ConveHsExSec[0] ;
         A1565CliConvenio = H00QE2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00QE2_A1564CliPaiConve[0] ;
         A3CliCod = H00QE2_A3CliCod[0] ;
         A1328ConveHsPDiaDia = H00QE2_A1328ConveHsPDiaDia[0] ;
         AV22GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EsquemaHorasEspecialesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.esquemahorasespecialesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EsquemaHorasEspecialesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
   ...
   public void wb_table1_9_QE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EsquemaHorasEspecialesView.htm");
         /* Div Control */
         ...
         wb_table1_9_QE2e( true) ;
      }
      else
      {
         wb_table1_9_QE2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251817522434", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("esquemahorasespecialesview.js", "?20251817522434", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Esquema Horas Especiales View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00QE2_A1327ConveHsExSec = new short[1] ;
      H00QE2_A1565CliConvenio = new String[] {""} ;
      H00QE2_A1564CliPaiConve = new short[1] ;
      H00QE2_A3CliCod = new int[1] ;
      H00QE2_A1328ConveHsPDiaDia = new byte[1] ;
      A1565CliConvenio = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.esquemahorasespecialesview__default(),
         new Object[] {
             new Object[] {
            H00QE2_A1327ConveHsExSec, H00QE2_A1565CliConvenio, H00QE2_A1564CliPaiConve, H00QE2_A3CliCod, H00QE2_A1328ConveHsPDiaDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] H00QE2_A1327ConveHsExSec ;
   private String[] H00QE2_A1565CliConvenio ;
   private short[] H00QE2_A1564CliPaiConve ;
   private int[] H00QE2_A3CliCod ;
   private byte[] H00QE2_A1328ConveHsPDiaDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class esquemahorasespecialesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00QE2", "SELECT ConveHsExSec, CliConvenio, CliPaiConve, CliCod, ConveHsPDiaDia FROM Convenio_horasextras_porDia WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveHsExSec = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveHsExSec = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, ConveHsExSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
