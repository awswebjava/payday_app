...
public final  class condiciones_conceptoview_impl extends GXDataArea
{
   public condiciones_conceptoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public condiciones_conceptoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( condiciones_conceptoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10ConCondicion = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10ConCondicion", AV10ConCondicion);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCONDICION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10ConCondicion, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.condiciones_conceptoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10ConCondicion)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ConCondicion","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vCONCONDICION", GXutil.rtrim( AV10ConCondicion));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCONDICION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10ConCondicion, ""))));
   ...
   {
      return formatLink("web.condiciones_conceptoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10ConCondicion)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ConCondicion","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Condiciones_conceptoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Condiciones_concepto View", "") ;
   }
   ...
   public void wbIV0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_IV2( true) ;
      }
      else
      {
         wb_table1_9_IV2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_IV2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startIV2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Condiciones_concepto View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupIV0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10ConCondicion = httpContext.cgiGet( "vCONCONDICION") ;
   ...
   public void e11IV2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00IV2 */
      pr_default.execute(0, new Object[] {AV10ConCondicion});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A953ConCondicion = H00IV2_A953ConCondicion[0] ;
         A1758CondicionDescrip = H00IV2_A1758CondicionDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1758CondicionDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Condiciones_conceptoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.condiciones_conceptogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Condiciones_conceptoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10ConCondicion});
   ...
   public void wb_table1_9_IV2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Condiciones_conceptoView.htm");
         /* Div Control */
         ...
         wb_table1_9_IV2e( true) ;
      }
      else
      {
         wb_table1_9_IV2e( false) ;
      }
   }
   ...
   {
      AV10ConCondicion = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10ConCondicion", AV10ConCondicion);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCONDICION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10ConCondicion, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025171332947", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("condiciones_conceptoview.js", "?2025171332947", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Condiciones_concepto View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10ConCondicion',fld:'vCONCONDICION',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00IV2_A953ConCondicion = new String[] {""} ;
      H00IV2_A1758CondicionDescrip = new String[] {""} ;
      A953ConCondicion = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.condiciones_conceptoview__default(),
         new Object[] {
             new Object[] {
            H00IV2_A953ConCondicion, H00IV2_A1758CondicionDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10ConCondicion ;
   ...
   private String[] H00IV2_A953ConCondicion ;
   private String[] H00IV2_A1758CondicionDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class condiciones_conceptoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00IV2", "SELECT ConCondicion, CondicionDescrip FROM Condiciones_concepto WHERE ConCondicion = ( ?) ORDER BY ConCondicion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
