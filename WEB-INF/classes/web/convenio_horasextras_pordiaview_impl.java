...
public final  class convenio_horasextras_pordiaview_impl extends GXDataArea
{
   public convenio_horasextras_pordiaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_horasextras_pordiaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_horasextras_pordiaview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13ConveHsExSec = (short)(GXutil.lval( httpContext.GetPar( "ConveHsExSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13ConveHsExSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13ConveHsExSec), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEHSEXSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13ConveHsExSec), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_horasextras_pordiaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.ltrimstr(AV13ConveHsExSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveHsExSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONVEHSEXSEC", GXutil.ltrim( localUtil.ntoc( AV13ConveHsExSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEHSEXSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13ConveHsExSec), "ZZZ9")));
   ...
   {
      return formatLink("web.convenio_horasextras_pordiaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.ltrimstr(AV13ConveHsExSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveHsExSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Convenio_horasextras_porDiaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Convenio_horasextras_por Dia View", "") ;
   }
   ...
   public void wbFF0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_FF2( true) ;
      }
      else
      {
         wb_table1_9_FF2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_FF2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startFF2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Convenio_horasextras_por Dia View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesFF2( )
   {
   }
   ...
   public void strupFF0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13ConveHsExSec = (short)(localUtil.ctol( httpContext.cgiGet( "vCONVEHSEXSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11FF2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00FF2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, Short.valueOf(AV13ConveHsExSec), Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, Short.valueOf(AV13ConveHsExSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1327ConveHsExSec = H00FF2_A1327ConveHsExSec[0] ;
         A1565CliConvenio = H00FF2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00FF2_A1564CliPaiConve[0] ;
         A3CliCod = H00FF2_A3CliCod[0] ;
         A1328ConveHsPDiaDia = H00FF2_A1328ConveHsPDiaDia[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1328ConveHsPDiaDia, 1, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Convenio_horasextras_porDiaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.convenio_horasextras_pordiageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Convenio_horasextras_porDiaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,Short.valueOf(AV13ConveHsExSec)});
   ...
   public void wb_table1_9_FF2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Convenio_horasextras_porDiaView.htm");
         /* Div Control */
         ...
         wb_table1_9_FF2e( true) ;
      }
      else
      {
         wb_table1_9_FF2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliConvenio", AV12CliConvenio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      AV13ConveHsExSec = ((Number) GXutil.testNumericType( getParm(obj,3), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13ConveHsExSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13ConveHsExSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEHSEXSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13ConveHsExSec), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251817483282", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("convenio_horasextras_pordiaview.js", "?20251817483282", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Convenio_horasextras_por Dia View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13ConveHsExSec',fld:'vCONVEHSEXSEC',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00FF2_A1327ConveHsExSec = new short[1] ;
      H00FF2_A1565CliConvenio = new String[] {""} ;
      H00FF2_A1564CliPaiConve = new short[1] ;
      H00FF2_A3CliCod = new int[1] ;
      H00FF2_A1328ConveHsPDiaDia = new byte[1] ;
      A1565CliConvenio = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_horasextras_pordiaview__default(),
         new Object[] {
             new Object[] {
            H00FF2_A1327ConveHsExSec, H00FF2_A1565CliConvenio, H00FF2_A1564CliPaiConve, H00FF2_A3CliCod, H00FF2_A1328ConveHsPDiaDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV13ConveHsExSec ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV11CliPaiConve ;
   private short AV13ConveHsExSec ;
   private short wbEnd ;
   ...
   private short[] H00FF2_A1327ConveHsExSec ;
   private String[] H00FF2_A1565CliConvenio ;
   private short[] H00FF2_A1564CliPaiConve ;
   private int[] H00FF2_A3CliCod ;
   private byte[] H00FF2_A1328ConveHsPDiaDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class convenio_horasextras_pordiaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00FF2", "SELECT ConveHsExSec, CliConvenio, CliPaiConve, CliCod, ConveHsPDiaDia FROM Convenio_horasextras_porDia WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveHsExSec = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveHsExSec = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, ConveHsExSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
