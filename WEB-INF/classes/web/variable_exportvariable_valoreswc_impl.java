...
public final  class variable_exportvariable_valoreswc_impl extends GXWebComponent
{
   ...
   public void S162( )
   {
      ...
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState10, "TFOPECLIVRELREF", httpContext.getMessage( "Liberación", ""), !(GXutil.strcmp("", AV39TFOpeCliVRelRef)==0), (short)(0), AV39TFOpeCliVRelRef, "", !(AV40TFOpeCliVRelRef_Sels.size()==0), AV40TFOpeCliVRelRef_Sels.toJSonString(false), "") ;
