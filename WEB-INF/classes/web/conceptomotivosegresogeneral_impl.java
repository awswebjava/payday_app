...
public final  class conceptomotivosegresogeneral_impl extends GXWebComponent
{
   public conceptomotivosegresogeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public conceptomotivosegresogeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( conceptomotivosegresogeneral_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "A2077ConMegSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A2077ConMegSec), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(A3CliCod),A26ConCodigo,A11MegCodigo,Short.valueOf(A2077ConMegSec)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Concepto Motivos Egreso General", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.conceptomotivosegresogeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(A26ConCodigo)),GXutil.URLEncode(GXutil.rtrim(A11MegCodigo)),GXutil.URLEncode(GXutil.ltrimstr(A2077ConMegSec,4,0))}, new String[] {"CliCod","ConCodigo","MegCodigo","ConMegSec"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA2077ConMegSec", GXutil.ltrim( localUtil.ntoc( wcpOA2077ConMegSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CONMEGSEC", GXutil.ltrim( localUtil.ntoc( A2077ConMegSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   }

   public void renderHtmlCloseFormIP2( )
   {
   ...
   {
      return "ConceptoMotivosEgresoGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Concepto Motivos Egreso General", "") ;
   }
   ...
   public void wbIP0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.conceptomotivosegresogeneral");
         }
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliNom_Internalname, A344CliNom, GXutil.rtrim( localUtil.format( A344CliNom, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliNom_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCliNom_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "DescripcionLarga", "left", true, "", "HLP_ConceptoMotivosEgresoGeneral.htm");
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtMegDescrip_Internalname, A300MegDescrip, "", "", (short)(0), 1, edtMegDescrip_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "DescripcionEnorme", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_ConceptoMotivosEgresoGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbMegPreaTipo, cmbMegPreaTipo.getInternalname(), GXutil.rtrim( A1532MegPreaTipo), 1, cmbMegPreaTipo.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbMegPreaTipo.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_ConceptoMotivosEgresoGeneral.htm");
         cmbMegPreaTipo.setValue( GXutil.rtrim( A1532MegPreaTipo) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbMegPreaTipo.getInternalname(), "Values", cmbMegPreaTipo.ToJavascriptSource(), true);
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbConMegDura, cmbConMegDura.getInternalname(), GXutil.rtrim( A1534ConMegDura), 1, cmbConMegDura.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbConMegDura.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_ConceptoMotivosEgresoGeneral.htm");
         cmbConMegDura.setValue( GXutil.rtrim( A1534ConMegDura) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbConMegDura.getInternalname(), "Values", cmbConMegDura.ToJavascriptSource(), true);
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConMegPropor_Internalname, GXutil.ltrim( localUtil.ntoc( A1529ConMegPropor, (byte)(6), (byte)(4), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtConMegPropor_Enabled!=0) ? localUtil.format( A1529ConMegPropor, "9.9999") : localUtil.format( A1529ConMegPropor, "9.9999"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConMegPropor_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtConMegPropor_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "porUnaje", "right", false, "", "HLP_ConceptoMotivosEgresoGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtConCodYDesc_Internalname, A42ConCodYDesc, "", "", (short)(0), 1, edtConCodYDesc_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "DescripcionEnorme", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_ConceptoMotivosEgresoGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11ip1_client"+"'", TempTags, "", 2, "HLP_ConceptoMotivosEgresoGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12ip1_client"+"'", TempTags, "", 2, "HLP_ConceptoMotivosEgresoGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startIP2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Concepto Motivos Egreso General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void fix_multi_value_controls( )
   {
      if ( cmbMegPreaTipo.getItemCount() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1532MegPreaTipo", A1532MegPreaTipo);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
         cmbMegPreaTipo.setValue( GXutil.rtrim( A1532MegPreaTipo) );
      ...
      if ( cmbConMegDura.getItemCount() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1534ConMegDura", A1534ConMegDura);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
         cmbConMegDura.setValue( GXutil.rtrim( A1534ConMegDura) );
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ConceptoMotivosEgresoGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfIP2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1529ConMegPropor = H00IP2_A1529ConMegPropor[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1529ConMegPropor", GXutil.ltrimstr( A1529ConMegPropor, 6, 4));
            A1534ConMegDura = H00IP2_A1534ConMegDura[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1534ConMegDura", A1534ConMegDura);
            A1530ConMegMeses = H00IP2_A1530ConMegMeses[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1530ConMegMeses", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1530ConMegMeses), 2, 0));
            A1532MegPreaTipo = H00IP2_A1532MegPreaTipo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1532MegPreaTipo", A1532MegPreaTipo);
            /* Execute user event: Load */
            e14IP2 ();
   ...
   public void send_integrity_lvl_hashesIP2( )
   {
   }
   ...
   public void before_start_formulas( )
   {
      ...
      A344CliNom = H00IP3_A344CliNom[0] ;
      ...
      A42ConCodYDesc = H00IP4_A42ConCodYDesc[0] ;
      n42ConCodYDesc = H00IP4_n42ConCodYDesc[0] ;
      ...
      A300MegDescrip = H00IP5_A300MegDescrip[0] ;
   ...
   public void strupIP0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOA2077ConMegSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA2077ConMegSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         A2077ConMegSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"CONMEGSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e13IP2( )
   {
      ...
      conceptomotivosegresogeneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV13CliCod = GXt_int1 ;
   ...
   protected void e14IP2( )
   {
      ...
      conceptomotivosegresogeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "ConceptoMotivosEgreso" );
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A26ConCodigo", A26ConCodigo);
      A11MegCodigo = (String)getParm(obj,2,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A11MegCodigo", A11MegCodigo);
      A2077ConMegSec = ((Number) GXutil.testNumericType( getParm(obj,3,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A2077ConMegSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A2077ConMegSec), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA11MegCodigo = (String)getParm(obj,2,TypeConstants.STRING) ;
      sCtrlA2077ConMegSec = (String)getParm(obj,3,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "conceptomotivosegresogeneral", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A26ConCodigo", A26ConCodigo);
         A11MegCodigo = (String)getParm(obj,4,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A11MegCodigo", A11MegCodigo);
         A2077ConMegSec = ((Number) GXutil.testNumericType( getParm(obj,5,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A2077ConMegSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A2077ConMegSec), 4, 0));
      }
      wcpOA3CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA3CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOA26ConCodigo = httpContext.cgiGet( sPrefix+"wcpOA26ConCodigo") ;
      wcpOA11MegCodigo = httpContext.cgiGet( sPrefix+"wcpOA11MegCodigo") ;
      wcpOA2077ConMegSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA2077ConMegSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( A3CliCod != wcpOA3CliCod ) || ( GXutil.strcmp(A26ConCodigo, wcpOA26ConCodigo) != 0 ) || ( GXutil.strcmp(A11MegCodigo, wcpOA11MegCodigo) != 0 ) || ( A2077ConMegSec != wcpOA2077ConMegSec ) ) )
      {
         setjustcreated();
      }
      ...
      wcpOA2077ConMegSec = A2077ConMegSec ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlA2077ConMegSec = httpContext.cgiGet( sPrefix+"A2077ConMegSec_CTRL") ;
      if ( GXutil.len( sCtrlA2077ConMegSec) > 0 )
      {
         A2077ConMegSec = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlA2077ConMegSec), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A2077ConMegSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A2077ConMegSec), 4, 0));
      }
      else
      {
         A2077ConMegSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"A2077ConMegSec_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A2077ConMegSec_PARM", GXutil.ltrim( localUtil.ntoc( A2077ConMegSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlA2077ConMegSec)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A2077ConMegSec_CTRL", GXutil.rtrim( sCtrlA2077ConMegSec));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181658547", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("conceptomotivosegresogeneral.js", "?2025181658547", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      cmbMegPreaTipo.setInternalname( sPrefix+"MEGPREATIPO" );
      edtConMegMeses_Internalname = sPrefix+"CONMEGMESES" ;
      cmbConMegDura.setInternalname( sPrefix+"CONMEGDURA" );
      edtConMegPropor_Internalname = sPrefix+"CONMEGPROPOR" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A26ConCodigo',fld:'CONCODIGO',pic:''},{av:'A11MegCodigo',fld:'MEGCODIGO',pic:''},{av:'A2077ConMegSec',fld:'CONMEGSEC',pic:'ZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e11IP1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A26ConCodigo',fld:'CONCODIGO',pic:''},{av:'A11MegCodigo',fld:'MEGCODIGO',pic:''},{av:'A2077ConMegSec',fld:'CONMEGSEC',pic:'ZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12IP1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A26ConCodigo',fld:'CONCODIGO',pic:''},{av:'A11MegCodigo',fld:'MEGCODIGO',pic:''},{av:'A2077ConMegSec',fld:'CONMEGSEC',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00IP2_A3CliCod = new int[1] ;
      H00IP2_A26ConCodigo = new String[] {""} ;
      H00IP2_A11MegCodigo = new String[] {""} ;
      H00IP2_A2077ConMegSec = new short[1] ;
      H00IP2_A42ConCodYDesc = new String[] {""} ;
      H00IP2_n42ConCodYDesc = new boolean[] {false} ;
      H00IP2_A1529ConMegPropor = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00IP2_A1534ConMegDura = new String[] {""} ;
      H00IP2_A1530ConMegMeses = new byte[1] ;
      H00IP2_A1532MegPreaTipo = new String[] {""} ;
      H00IP2_A300MegDescrip = new String[] {""} ;
      H00IP2_A344CliNom = new String[] {""} ;
      H00IP3_A344CliNom = new String[] {""} ;
      H00IP4_A42ConCodYDesc = new String[] {""} ;
      H00IP4_n42ConCodYDesc = new boolean[] {false} ;
      H00IP5_A300MegDescrip = new String[] {""} ;
      ...
      sCtrlA11MegCodigo = "" ;
      sCtrlA2077ConMegSec = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.conceptomotivosegresogeneral__default(),
         new Object[] {
             new Object[] {
            H00IP2_A3CliCod, H00IP2_A26ConCodigo, H00IP2_A11MegCodigo, H00IP2_A2077ConMegSec, H00IP2_A42ConCodYDesc, H00IP2_n42ConCodYDesc, H00IP2_A1529ConMegPropor, H00IP2_A1534ConMegDura, H00IP2_A1530ConMegMeses, H00IP2_A1532MegPreaTipo,
            H00IP2_A300MegDescrip, H00IP2_A344CliNom
            }
            , new Object[] {
            H00IP3_A344CliNom
            }
            , new Object[] {
            H00IP4_A42ConCodYDesc, H00IP4_n42ConCodYDesc
            }
            , new Object[] {
            H00IP5_A300MegDescrip
            }
         }
      );
      AV17Pgmname = "ConceptoMotivosEgresoGeneral" ;
   ...
   private short wcpOA2077ConMegSec ;
   ...
   private String sCtrlA2077ConMegSec ;
   ...
   private int[] H00IP2_A3CliCod ;
   private String[] H00IP2_A26ConCodigo ;
   private String[] H00IP2_A11MegCodigo ;
   private short[] H00IP2_A2077ConMegSec ;
   private String[] H00IP2_A42ConCodYDesc ;
   private boolean[] H00IP2_n42ConCodYDesc ;
   private java.math.BigDecimal[] H00IP2_A1529ConMegPropor ;
   private String[] H00IP2_A1534ConMegDura ;
   private byte[] H00IP2_A1530ConMegMeses ;
   private String[] H00IP2_A1532MegPreaTipo ;
   private String[] H00IP2_A300MegDescrip ;
   private String[] H00IP2_A344CliNom ;
   private String[] H00IP3_A344CliNom ;
   private String[] H00IP4_A42ConCodYDesc ;
   private boolean[] H00IP4_n42ConCodYDesc ;
   private String[] H00IP5_A300MegDescrip ;
...
final  class conceptomotivosegresogeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00IP2", "SELECT T1.CliCod, T1.ConCodigo, T1.MegCodigo, T1.ConMegSec, T3.ConCodYDesc, T1.ConMegPropor, T1.ConMegDura, T1.ConMegMeses, T1.MegPreaTipo, T4.MegDescrip, T2.CliNom FROM (((ConceptoMotivosEgreso T1 INNER JOIN Cliente T2 ON T2.CliCod = T1.CliCod) INNER JOIN Concepto T3 ON T3.CliCod = T1.CliCod AND T3.ConCodigo = T1.ConCodigo) INNER JOIN MotivoEgreso T4 ON T4.CliCod = T1.CliCod AND T4.MegCodigo = T1.MegCodigo) WHERE T1.CliCod = ? and T1.ConCodigo = ( ?) and T1.MegCodigo = ( ?) and T1.ConMegSec = ? ORDER BY T1.CliCod, T1.ConCodigo, T1.MegCodigo, T1.ConMegSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00IP3", "SELECT CliNom FROM Cliente WHERE CliCod = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00IP4", "SELECT ConCodYDesc FROM Concepto WHERE CliCod = ? AND ConCodigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00IP5", "SELECT MegDescrip FROM MotivoEgreso WHERE CliCod = ? AND MegCodigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
