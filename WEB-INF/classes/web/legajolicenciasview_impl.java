...
public final  class legajolicenciasview_impl extends GXDataArea
{
   public legajolicenciasview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public legajolicenciasview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( legajolicenciasview_impl.class ));
   }
   ...
   {
      return formatLink("web.legajolicenciasview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.formatDateParm(AV13LegLicenIni)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegLicenIni","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "LegajoLicenciasView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Legajo Licencias View", "") ;
   }
   ...
   public void wb1L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1L2( true) ;
      }
      else
      {
         wb_table1_9_1L2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1L2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1L2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Legajo Licencias View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e111L2( )
   {
      ...
      {
         A76LegLicenIni = H001L2_A76LegLicenIni[0] ;
         A6LegNumero = H001L2_A6LegNumero[0] ;
         A1EmpCod = H001L2_A1EmpCod[0] ;
         A3CliCod = H001L2_A3CliCod[0] ;
         A481LegLicenFin = H001L2_A481LegLicenFin[0] ;
         AV19GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "LegajoLicenciasGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.legajolicenciasgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "LegajoLicenciasGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
   ...
   public void wb_table1_9_1L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_LegajoLicenciasView.htm");
         /* Div Control */
         ...
         wb_table1_9_1L2e( true) ;
      }
      else
      {
         wb_table1_9_1L2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020172453", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("legajolicenciasview.js", "?2024122020172453", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Legajo Licencias View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001L2_A76LegLicenIni = new java.util.Date[] {GXutil.nullDate()} ;
      H001L2_A6LegNumero = new int[1] ;
      H001L2_A1EmpCod = new short[1] ;
      H001L2_A3CliCod = new int[1] ;
      H001L2_A481LegLicenFin = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.legajolicenciasview__default(),
         new Object[] {
             new Object[] {
            H001L2_A76LegLicenIni, H001L2_A6LegNumero, H001L2_A1EmpCod, H001L2_A3CliCod, H001L2_A481LegLicenFin
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private java.util.Date[] H001L2_A76LegLicenIni ;
   private int[] H001L2_A6LegNumero ;
   private short[] H001L2_A1EmpCod ;
   private int[] H001L2_A3CliCod ;
   private java.util.Date[] H001L2_A481LegLicenFin ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class legajolicenciasview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001L2", "SELECT LegLicenIni, LegNumero, EmpCod, CliCod, LegLicenFin FROM LegajoLicencias WHERE (CliCod = ? and EmpCod = ? and LegNumero = ? and LegLicenIni = ?) AND (CliCod = ? and EmpCod = ? and LegNumero = ? and LegLicenIni = ?) ORDER BY CliCod, EmpCod, LegNumero, LegLicenIni ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
