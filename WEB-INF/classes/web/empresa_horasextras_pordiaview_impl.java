...
public final  class empresa_horasextras_pordiaview_impl extends GXDataArea
{
   public empresa_horasextras_pordiaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresa_horasextras_pordiaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresa_horasextras_pordiaview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12EmpHsExSec = (short)(GXutil.lval( httpContext.GetPar( "EmpHsExSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12EmpHsExSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12EmpHsExSec), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPHSEXSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12EmpHsExSec), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.empresa_horasextras_pordiaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12EmpHsExSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpHsExSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vEMPHSEXSEC", GXutil.ltrim( localUtil.ntoc( AV12EmpHsExSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPHSEXSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12EmpHsExSec), "ZZZ9")));
   ...
   {
      return formatLink("web.empresa_horasextras_pordiaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12EmpHsExSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpHsExSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Empresa_horasextras_porDiaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Empresa_horasextras_por Dia View", "") ;
   }
   ...
   public void wbKU0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_KU2( true) ;
      }
      else
      {
         wb_table1_9_KU2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_KU2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startKU2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Empresa_horasextras_por Dia View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesKU2( )
   {
   }
   ...
   public void strupKU0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12EmpHsExSec = (short)(localUtil.ctol( httpContext.cgiGet( "vEMPHSEXSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11KU2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00KU2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Short.valueOf(AV12EmpHsExSec), Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Short.valueOf(AV12EmpHsExSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1340EmpHsExSec = H00KU2_A1340EmpHsExSec[0] ;
         A1EmpCod = H00KU2_A1EmpCod[0] ;
         A3CliCod = H00KU2_A3CliCod[0] ;
         A1341EmpHsPDiaDia = H00KU2_A1341EmpHsPDiaDia[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1341EmpHsPDiaDia, 1, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Empresa_horasextras_porDiaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.empresa_horasextras_pordiageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Empresa_horasextras_porDiaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),Short.valueOf(AV12EmpHsExSec)});
   ...
   public void wb_table1_9_KU2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Empresa_horasextras_porDiaView.htm");
         /* Div Control */
         ...
         wb_table1_9_KU2e( true) ;
      }
      else
      {
         wb_table1_9_KU2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12EmpHsExSec = ((Number) GXutil.testNumericType( getParm(obj,2), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12EmpHsExSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12EmpHsExSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPHSEXSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12EmpHsExSec), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181752838", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresa_horasextras_pordiaview.js", "?2025181752838", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Empresa_horasextras_por Dia View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12EmpHsExSec',fld:'vEMPHSEXSEC',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00KU2_A1340EmpHsExSec = new short[1] ;
      H00KU2_A1EmpCod = new short[1] ;
      H00KU2_A3CliCod = new int[1] ;
      H00KU2_A1341EmpHsPDiaDia = new byte[1] ;
      ucTabs = new com.genexus.webpanels.GXUserControl();
      sStyleString = "" ;
      lblGeneral_title_Jsonclick = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new web.empresa_horasextras_pordiaview__default(),
         new Object[] {
             new Object[] {
            H00KU2_A1340EmpHsExSec, H00KU2_A1EmpCod, H00KU2_A3CliCod, H00KU2_A1341EmpHsPDiaDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV12EmpHsExSec ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV11EmpCod ;
   private short AV12EmpHsExSec ;
   private short wbEnd ;
   ...
   private short[] H00KU2_A1340EmpHsExSec ;
   private short[] H00KU2_A1EmpCod ;
   private int[] H00KU2_A3CliCod ;
   private byte[] H00KU2_A1341EmpHsPDiaDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class empresa_horasextras_pordiaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00KU2", "SELECT EmpHsExSec, EmpCod, CliCod, EmpHsPDiaDia FROM Empresahorasextras_pordia WHERE (CliCod = ? and EmpCod = ? and EmpHsExSec = ?) AND (CliCod = ? and EmpCod = ? and EmpHsExSec = ?) ORDER BY CliCod, EmpCod, EmpHsExSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
