...
public final  class tipo_feriadoview_impl extends GXDataArea
{
   public tipo_feriadoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipo_feriadoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipo_feriadoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11FerTipo = httpContext.GetPar( "FerTipo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11FerTipo", AV11FerTipo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFERTIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11FerTipo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.tipo_feriadoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11FerTipo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","FerTipo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vFERTIPO", GXutil.rtrim( AV11FerTipo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFERTIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11FerTipo, ""))));
   ...
   {
      return formatLink("web.tipo_feriadoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11FerTipo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","FerTipo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "tipo_feriadoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "tipo_feriado View", "") ;
   }
   ...
   public void wbGX0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_GX2( true) ;
      }
      else
      {
         wb_table1_9_GX2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_GX2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startGX2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "tipo_feriado View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupGX0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11FerTipo = httpContext.cgiGet( "vFERTIPO") ;
   ...
   public void e11GX2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00GX2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PaiCod), AV11FerTipo, Short.valueOf(AV10PaiCod), AV11FerTipo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1221FerTipo = H00GX2_A1221FerTipo[0] ;
         A46PaiCod = H00GX2_A46PaiCod[0] ;
         A1785FerTipoDescrip = H00GX2_A1785FerTipoDescrip[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.trim( A1785FerTipoDescrip) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "tipo_feriadoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.tipo_feriadogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "tipo_feriadoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod),AV11FerTipo});
   ...
   public void wb_table1_9_GX2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_tipo_feriadoView.htm");
         /* Div Control */
         ...
         wb_table1_9_GX2e( true) ;
      }
      else
      {
         wb_table1_9_GX2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PaiCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      AV11FerTipo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11FerTipo", AV11FerTipo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFERTIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11FerTipo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020431860", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipo_feriadoview.js", "?2024122020431860", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "tipo_feriado View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11FerTipo',fld:'vFERTIPO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00GX2_A1221FerTipo = new String[] {""} ;
      H00GX2_A46PaiCod = new short[1] ;
      H00GX2_A1785FerTipoDescrip = new String[] {""} ;
      A1221FerTipo = "" ;
      A1785FerTipoDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.tipo_feriadoview__default(),
         new Object[] {
             new Object[] {
            H00GX2_A1221FerTipo, H00GX2_A46PaiCod, H00GX2_A1785FerTipoDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11FerTipo ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11FerTipo ;
   ...
   private String[] H00GX2_A1221FerTipo ;
   private short[] H00GX2_A46PaiCod ;
   private String[] H00GX2_A1785FerTipoDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipo_feriadoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00GX2", "SELECT FerTipo, PaiCod, FerTipoDescrip FROM tipo_feriado WHERE (PaiCod = ? and FerTipo = ( ?)) AND (PaiCod = ? and FerTipo = ( ?)) ORDER BY PaiCod, FerTipo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
