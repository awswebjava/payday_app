...
public final  class faltas_y_tardesview_impl extends GXDataArea
{
   public faltas_y_tardesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public faltas_y_tardesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( faltas_y_tardesview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13LegLicenIni = localUtil.parseDateParm( httpContext.GetPar( "LegLicenIni")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13LegLicenIni", localUtil.format(AV13LegLicenIni, "99/99/99"));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGLICENINI", getSecureSignedToken( "", AV13LegLicenIni));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.faltas_y_tardesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.formatDateParm(AV13LegLicenIni)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegLicenIni","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGNUMERO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LegNumero), "ZZZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vLEGLICENINI", localUtil.dtoc( AV13LegLicenIni, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGLICENINI", getSecureSignedToken( "", AV13LegLicenIni));
   ...
   {
      return formatLink("web.faltas_y_tardesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.formatDateParm(AV13LegLicenIni)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegLicenIni","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "faltas_y_tardesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "faltas_y_tardes View", "") ;
   }
   ...
   public void wbCV0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_CV2( true) ;
      }
      else
      {
         wb_table1_9_CV2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_CV2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startCV2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "faltas_y_tardes View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesCV2( )
   {
   }
   ...
   public void strupCV0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13LegLicenIni = localUtil.ctod( httpContext.cgiGet( "vLEGLICENINI"), 0) ;
   ...
   public void e11CV2( )
   {
      ...
      AV21GXLvl11 = (byte)(0) ;
      /* Using cursor H00CV2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Integer.valueOf(AV12LegNumero), AV13LegLicenIni, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Integer.valueOf(AV12LegNumero), AV13LegLicenIni});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A76LegLicenIni = H00CV2_A76LegLicenIni[0] ;
         A6LegNumero = H00CV2_A6LegNumero[0] ;
         A1EmpCod = H00CV2_A1EmpCod[0] ;
         A3CliCod = H00CV2_A3CliCod[0] ;
         A481LegLicenFin = H00CV2_A481LegLicenFin[0] ;
         AV21GXLvl11 = (byte)(1) ;
         Form.setCaption( localUtil.dtoc( A481LegLicenFin, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/") );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "faltas_y_tardesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.faltas_y_tardesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "faltas_y_tardesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),Integer.valueOf(AV12LegNumero),AV13LegLicenIni});
   ...
   public void wb_table1_9_CV2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_faltas_y_tardesView.htm");
         /* Div Control */
         ...
         wb_table1_9_CV2e( true) ;
      }
      else
      {
         wb_table1_9_CV2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LegNumero), 8, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGNUMERO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LegNumero), "ZZZZZZZ9")));
      AV13LegLicenIni = (java.util.Date)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13LegLicenIni", localUtil.format(AV13LegLicenIni, "99/99/99"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGLICENINI", getSecureSignedToken( "", AV13LegLicenIni));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20241220205528", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("faltas_y_tardesview.js", "?20241220205528", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "faltas_y_tardes View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9',hsh:true},{av:'AV13LegLicenIni',fld:'vLEGLICENINI',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   {
      wcpOAV13LegLicenIni = GXutil.nullDate() ;
      wcpOAV8TabCode = "" ;
      Tabs_Activepagecontrolname = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV13LegLicenIni = GXutil.nullDate() ;
      AV8TabCode = "" ;
      ...
      scmdbuf = "" ;
      H00CV2_A76LegLicenIni = new java.util.Date[] {GXutil.nullDate()} ;
      H00CV2_A6LegNumero = new int[1] ;
      H00CV2_A1EmpCod = new short[1] ;
      H00CV2_A3CliCod = new int[1] ;
      H00CV2_A481LegLicenFin = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.faltas_y_tardesview__default(),
         new Object[] {
             new Object[] {
            H00CV2_A76LegLicenIni, H00CV2_A6LegNumero, H00CV2_A1EmpCod, H00CV2_A3CliCod, H00CV2_A481LegLicenFin
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private java.util.Date wcpOAV13LegLicenIni ;
   ...
   private java.util.Date[] H00CV2_A76LegLicenIni ;
   private int[] H00CV2_A6LegNumero ;
   private short[] H00CV2_A1EmpCod ;
   private int[] H00CV2_A3CliCod ;
   private java.util.Date[] H00CV2_A481LegLicenFin ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class faltas_y_tardesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00CV2", "SELECT LegLicenIni, LegNumero, EmpCod, CliCod, LegLicenFin FROM LegajoLicencias WHERE (CliCod = ? and EmpCod = ? and LegNumero = ? and LegLicenIni = ?) AND (CliCod = ? and EmpCod = ? and LegNumero = ? and LegLicenIni = ?) ORDER BY CliCod, EmpCod, LegNumero, LegLicenIni ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
