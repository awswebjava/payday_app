...
@javax.ws.rs.Path("/SVGWWGetFilterData")
public final  class svgwwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.svgwwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV29DDOName;
      ...
      if ( ! processHeaders("svgwwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.svgwwgetfilterdata worker = new web.svgwwgetfilterdata(remoteHandle, context);
         worker.execute(AV29DDOName,AV30SearchTxt,AV31SearchTxtTo,AV32OptionsJson,AV33OptionsDescJson,AV34OptionIndexesJson );
         web.svgwwgetfilterdata_RESTInterfaceOUT data = new web.svgwwgetfilterdata_RESTInterfaceOUT();
