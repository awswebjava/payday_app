...
public final  class provinciaww_impl extends GXDataArea
{
   public provinciaww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public provinciaww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( provinciaww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV39PaiCod = (short)(GXutil.lval( httpContext.GetPar( "PaiCod"))) ;
      ...
      AV22TFProvCod = (short)(GXutil.lval( httpContext.GetPar( "TFProvCod"))) ;
      AV23TFProvCod_To = (short)(GXutil.lval( httpContext.GetPar( "TFProvCod_To"))) ;
      AV25TFProvNom = httpContext.GetPar( "TFProvNom") ;
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV26TFProvNom_Sels);
      AV55paisEs = GXutil.strtobool( httpContext.GetPar( "paisEs")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV39PaiCod, AV58ManageFiltersExecutionStep, AV19ColumnsSelector, AV71Pgmname, AV46MenuOpcCod, AV12GridState, AV22TFProvCod, AV23TFProvCod_To, AV25TFProvNom, AV26TFProvNom_Sels, AV55paisEs, AV14OrderedBy, AV15OrderedDsc, AV37CliCod, AV33IsAuthorized_Update, AV35IsAuthorized_Delete, AV48WelcomeMessage_NoMostrarMas) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.provinciaww", new String[] {GXutil.URLEncode(GXutil.rtrim(AV46MenuOpcCod))}, new String[] {"MenuOpcCod"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMENUOPCCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV46MenuOpcCod, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAISES", getSecureSignedToken( "", AV55paisEs));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vTFPROVCOD", GXutil.ltrim( localUtil.ntoc( AV22TFProvCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "vTFPROVCOD_TO", GXutil.ltrim( localUtil.ntoc( AV23TFProvCod_To, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "vTFPROVNOM", AV25TFProvNom);
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vTFPROVNOM_SELS", AV26TFProvNom_Sels);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vTFPROVNOM_SELS", AV26TFProvNom_Sels);
      }
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "vPAISES", AV55paisEs);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAISES", getSecureSignedToken( "", AV55paisEs));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV35IsAuthorized_Delete));
      web.GxWebStd.gx_hidden_field( httpContext, "vTFPROVNOM_SELSJSON", AV24TFProvNom_SelsJson);
      web.GxWebStd.gx_hidden_field( httpContext, "vPAICOD", GXutil.ltrim( localUtil.ntoc( AV39PaiCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   {
      return formatLink("web.provinciaww", new String[] {GXutil.URLEncode(GXutil.rtrim(AV46MenuOpcCod))}, new String[] {"MenuOpcCod"})  ;
   }
   ...
   public void wbEE0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_9_EE2( true) ;
      }
      else
      {
         wb_table1_9_EE2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 short AV22TFProvCod ,
                                 short AV23TFProvCod_To ,
                                 String AV25TFProvNom ,
                                 GXSimpleCollection<String> AV26TFProvNom_Sels ,
                                 boolean AV55paisEs ,
                                 short AV14OrderedBy ,
   ...
   public void rfEE2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A322ProvNom ,
                                              AV75Provinciawwds_4_tfprovnom_sels ,
                                              Short.valueOf(AV72Provinciawwds_1_tfprovcod) ,
                                              Short.valueOf(AV73Provinciawwds_2_tfprovcod_to) ,
                                              Integer.valueOf(AV75Provinciawwds_4_tfprovnom_sels.size()) ,
                                              AV74Provinciawwds_3_tfprovnom ,
         ...
         lV74Provinciawwds_3_tfprovnom = GXutil.concat( GXutil.rtrim( AV74Provinciawwds_3_tfprovnom), "%", "") ;
         /* Using cursor H00EE2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV72Provinciawwds_1_tfprovcod), Short.valueOf(AV73Provinciawwds_2_tfprovcod_to), lV74Provinciawwds_3_tfprovnom, Short.valueOf(AV39PaiCod), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_110_idx = 1 ;
         sGXsfl_110_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_110_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_1102( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A322ProvNom = H00EE2_A322ProvNom[0] ;
            A47ProvCod = H00EE2_A47ProvCod[0] ;
            A312PaiNom = H00EE2_A312PaiNom[0] ;
            A46PaiCod = H00EE2_A46PaiCod[0] ;
            A312PaiNom = H00EE2_A312PaiNom[0] ;
            e21EE2 ();
   ...
   public void send_integrity_lvl_hashesEE2( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_PROVCOD"+"_"+sGXsfl_110_idx, getSecureSignedToken( sGXsfl_110_idx, localUtil.format( DecimalUtil.doubleToDec(A47ProvCod), "ZZZ9")));
   }
   ...
   {
      AV72Provinciawwds_1_tfprovcod = AV22TFProvCod ;
      AV73Provinciawwds_2_tfprovcod_to = AV23TFProvCod_To ;
      AV74Provinciawwds_3_tfprovnom = AV25TFProvNom ;
      AV75Provinciawwds_4_tfprovnom_sels = AV26TFProvNom_Sels ;
      ...
      lV74Provinciawwds_3_tfprovnom = GXutil.concat( GXutil.rtrim( AV74Provinciawwds_3_tfprovnom), "%", "") ;
      /* Using cursor H00EE3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV72Provinciawwds_1_tfprovcod), Short.valueOf(AV73Provinciawwds_2_tfprovcod_to), lV74Provinciawwds_3_tfprovnom, Short.valueOf(AV39PaiCod)});
      GRID_nRecordCount = H00EE3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e19EE2( )
   {
      ...
      Form.setCaption( httpContext.getMessage( " Provincia", "") );
      ...
      provinciaww_impl.this.AV49MenuBienveImgURL = GXv_char3[0] ;
      provinciaww_impl.this.AV51MenuBienveTitulo = GXv_char4[0] ;
      provinciaww_impl.this.AV52MenuBienveTexto = GXv_char5[0] ;
      provinciaww_impl.this.AV53MenuBienveVisible = GXv_boolean6[0] ;
      ...
      provinciaww_impl.this.GXt_char8 = GXv_char5[0] ;
      GXv_char4[0] = GXt_char7 ;
      new web.getsvg(remoteHandle, context).execute( GXt_char8, GXv_char4) ;
      provinciaww_impl.this.GXt_char7 = GXv_char4[0] ;
      ...
      provinciaww_impl.this.GXt_int9 = GXv_int10[0] ;
      AV37CliCod = GXt_int9 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV37CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV37CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV37CliCod), "ZZZZZ9")));
      GXv_int11[0] = AV39PaiCod ;
      new web.clientegetpais(remoteHandle, context).execute( AV37CliCod, GXv_int11) ;
      provinciaww_impl.this.AV39PaiCod = GXv_int11[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV39PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV39PaiCod), 4, 0));
      GXt_boolean12 = AV55paisEs ;
      GXv_boolean6[0] = GXt_boolean12 ;
      new web.esconceptosdefault(remoteHandle, context).execute( GXv_boolean6) ;
      provinciaww_impl.this.GXt_boolean12 = GXv_boolean6[0] ;
      AV55paisEs = GXt_boolean12 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV55paisEs", AV55paisEs);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAISES", getSecureSignedToken( "", AV55paisEs));
   }
   ...
   public void e20EE2( )
   {
      ...
      S162 ();
      if (returnInSub) return;
      if ( GXutil.strcmp(AV21Session.getValue("ProvinciaWWColumnsSelector"), "") != 0 )
      {
         AV17ColumnsSelectorXML = AV21Session.getValue("ProvinciaWWColumnsSelector") ;
      ...
      edtProvCod_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+1)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      httpContext.ajax_rsp_assign_prop("", false, edtProvCod_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtProvCod_Visible), 5, 0), !bGXsfl_110_Refreshing);
      edtProvNom_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+2)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      httpContext.ajax_rsp_assign_prop("", false, edtProvNom_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtProvNom_Visible), 5, 0), !bGXsfl_110_Refreshing);
      ...
      provinciaww_impl.this.AV65filterCount = GXv_int11[0] ;
      provinciaww_impl.this.AV66filtrosTexto = GXv_char5[0] ;
   ...
   public void e15EE2( )
   {
      ...
      {
         if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "ProvCod") == 0 )
         {
            AV22TFProvCod = (short)(GXutil.lval( Ddo_grid_Filteredtext_get)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV22TFProvCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV22TFProvCod), 4, 0));
            AV23TFProvCod_To = (short)(GXutil.lval( Ddo_grid_Filteredtextto_get)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV23TFProvCod_To", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV23TFProvCod_To), 4, 0));
         }
         else if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "ProvNom") == 0 )
         {
            AV25TFProvNom = Ddo_grid_Filteredtext_get ;
            httpContext.ajax_rsp_assign_attri("", false, "AV25TFProvNom", AV25TFProvNom);
            AV24TFProvNom_SelsJson = Ddo_grid_Selectedvalue_get ;
            httpContext.ajax_rsp_assign_attri("", false, "AV24TFProvNom_SelsJson", AV24TFProvNom_SelsJson);
            AV26TFProvNom_Sels.fromJSonString(AV24TFProvNom_SelsJson, null);
         }
         subgrid_firstpage( ) ;
      }
      /*  Sending Event outputs  */
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV26TFProvNom_Sels", AV26TFProvNom_Sels);
   }
   ...
   private void e21EE2( )
   {
      ...
      if ( AV33IsAuthorized_Update )
      {
         if ( AV55paisEs )
         {
            edtavUpdate_Link = formatLink("web.provincia", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A46PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A47ProvCod,4,0))}, new String[] {"Mode","PaiCod","ProvCod"})  ;
      ...
      if ( AV35IsAuthorized_Delete )
      {
         if ( AV55paisEs )
         {
            edtavDelete_Link = formatLink("web.provincia", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A46PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A47ProvCod,4,0))}, new String[] {"Mode","PaiCod","ProvCod"})  ;
      ...
      httpContext.ajax_rsp_assign_attri("", false, edtavDisplay_Internalname, AV45Display);
      edtavDisplay_Link = formatLink("web.provinciaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A46PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A47ProvCod,4,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"PaiCod","ProvCod","TabCode"})  ;
   ...
   public void e11EE2( )
   {
      ...
      new web.wwpbaseobjects.savecolumnsselectorstate(remoteHandle, context).execute( "ProvinciaWWColumnsSelector", ((GXutil.strcmp("", AV17ColumnsSelectorXML)==0) ? "" : AV19ColumnsSelector.toxml(false, true, "WWPColumnsSelector", "PayDay"))) ;
   ...
   public void e12EE2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("web.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ProvinciaWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV71Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV58ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV58ManageFiltersExecutionStep", GXutil.str( AV58ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      ...
      {
         httpContext.popup(formatLink("web.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ProvinciaWWFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV58ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV58ManageFiltersExecutionStep", GXutil.str( AV58ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      else
      {
         ...
         GXv_char5[0] = GXt_char8 ;
         new web.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ProvinciaWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         provinciaww_impl.this.GXt_char8 = GXv_char5[0] ;
   ...
   public void e16EE2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("web.provincia", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0)),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","PaiCod","ProvCod"}) );
   ...
   public void e17EE2( )
   {
      ...
      new web.provinciawwexport(remoteHandle, context).execute( GXv_char5, GXv_char4) ;
      provinciaww_impl.this.AV40ExcelFilename = GXv_char5[0] ;
      provinciaww_impl.this.AV41ErrorMessage = GXv_char4[0] ;
   ...
   public void S172( )
   {
      ...
      new web.wwpbaseobjects.wwp_columnsselector_add(remoteHandle, context).execute( GXv_SdtWWPColumnsSelector14, "ProvCod", "", "Cod. Prov.", true, "") ;
      AV19ColumnsSelector = GXv_SdtWWPColumnsSelector14[0] ;
      GXv_SdtWWPColumnsSelector14[0] = AV19ColumnsSelector;
      new web.wwpbaseobjects.wwp_columnsselector_add(remoteHandle, context).execute( GXv_SdtWWPColumnsSelector14, "ProvNom", "", "Nom. Prov.", true, "") ;
      AV19ColumnsSelector = GXv_SdtWWPColumnsSelector14[0] ;
      GXv_SdtWWPColumnsSelector14[0] = AV19ColumnsSelector;
      ...
      GXv_char5[0] = GXt_char8 ;
      new web.wwpbaseobjects.loadcolumnsselectorstate(remoteHandle, context).execute( "ProvinciaWWColumnsSelector", GXv_char5) ;
      provinciaww_impl.this.GXt_char8 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      returnInSub = false ;
      GXt_boolean12 = AV33IsAuthorized_Update ;
      GXv_boolean6[0] = GXt_boolean12 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWProvincia_Update", GXv_boolean6) ;
      provinciaww_impl.this.GXt_boolean12 = GXv_boolean6[0] ;
      AV33IsAuthorized_Update = GXt_boolean12 ;
      ...
      GXt_boolean12 = AV35IsAuthorized_Delete ;
      GXv_boolean6[0] = GXt_boolean12 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWProvincia_Delete", GXv_boolean6) ;
      provinciaww_impl.this.GXt_boolean12 = GXv_boolean6[0] ;
      AV35IsAuthorized_Delete = GXt_boolean12 ;
      ...
      GXt_boolean12 = AV36TempBoolean ;
      GXv_boolean6[0] = GXt_boolean12 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWProvincia_Insert", GXv_boolean6) ;
      provinciaww_impl.this.GXt_boolean12 = GXv_boolean6[0] ;
      AV36TempBoolean = GXt_boolean12 ;
      if ( ! ( AV36TempBoolean && ( ( AV55paisEs ) ) ) )
      {
   ...
   public void S112( )
   {
      ...
      new web.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ProvinciaWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item17) ;
   ...
   public void S182( )
   {
      ...
      returnInSub = false ;
      AV22TFProvCod = (short)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV22TFProvCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV22TFProvCod), 4, 0));
      AV23TFProvCod_To = (short)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV23TFProvCod_To", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV23TFProvCod_To), 4, 0));
      AV25TFProvNom = "" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV25TFProvNom", AV25TFProvNom);
      AV26TFProvNom_Sels = new GXSimpleCollection<String>(String.class, "internal", "") ;
   ...
   public void S192( )
   {
      ...
      while ( AV76GXV1 <= AV12GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         ...
         if ( GXutil.strcmp(AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFPROVCOD") == 0 )
         {
            AV22TFProvCod = (short)(GXutil.lval( AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value())) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV22TFProvCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV22TFProvCod), 4, 0));
            AV23TFProvCod_To = (short)(GXutil.lval( AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Valueto())) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV23TFProvCod_To", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV23TFProvCod_To), 4, 0));
         }
         else if ( GXutil.strcmp(AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFPROVNOM") == 0 )
         {
            AV25TFProvNom = AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV25TFProvNom", AV25TFProvNom);
         }
         else if ( GXutil.strcmp(AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFPROVNOM_SEL") == 0 )
         {
            AV24TFProvNom_SelsJson = AV13GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV24TFProvNom_SelsJson", AV24TFProvNom_SelsJson);
            AV26TFProvNom_Sels.fromJSonString(AV24TFProvNom_SelsJson, null);
         }
      ...
      GXt_char8 = "" ;
      GXv_char5[0] = GXt_char8 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (AV26TFProvNom_Sels.size()==0), AV24TFProvNom_SelsJson, GXv_char5) ;
      provinciaww_impl.this.GXt_char8 = GXv_char5[0] ;
      Ddo_grid_Selectedvalue_set = "|"+GXt_char8 ;
      ucDdo_grid.sendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
      GXt_char8 = "" ;
      GXv_char5[0] = GXt_char8 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (GXutil.strcmp("", AV25TFProvNom)==0), AV25TFProvNom, GXv_char5) ;
      provinciaww_impl.this.GXt_char8 = GXv_char5[0] ;
      Ddo_grid_Filteredtext_set = ((0==AV22TFProvCod) ? "" : GXutil.str( AV22TFProvCod, 4, 0))+"|"+GXt_char8 ;
      ucDdo_grid.sendProperty(context, "", false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
      Ddo_grid_Filteredtextto_set = ((0==AV23TFProvCod_To) ? "" : GXutil.str( AV23TFProvCod_To, 4, 0))+"|" ;
      ucDdo_grid.sendProperty(context, "", false, Ddo_grid_Internalname, "FilteredTextTo_set", Ddo_grid_Filteredtextto_set);
   }
   ...
   public void S162( )
   {
      ...
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState18, "TFPROVCOD", httpContext.getMessage( "Cod. Prov.", ""), !((0==AV22TFProvCod)&&(0==AV23TFProvCod_To)), (short)(0), GXutil.trim( GXutil.str( AV22TFProvCod, 4, 0)), GXutil.trim( GXutil.str( AV23TFProvCod_To, 4, 0))) ;
      AV12GridState = GXv_SdtWWPGridState18[0] ;
      GXv_SdtWWPGridState18[0] = AV12GridState;
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState18, "TFPROVNOM", httpContext.getMessage( "Nom. Prov.", ""), !(GXutil.strcmp("", AV25TFProvNom)==0), (short)(0), AV25TFProvNom, "", !(AV26TFProvNom_Sels.size()==0), AV26TFProvNom_Sels.toJSonString(false), "") ;
      AV12GridState = GXv_SdtWWPGridState18[0] ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Provincia" );
   ...
   public void e18EE2( )
   {
      ...
      if ( AV48WelcomeMessage_NoMostrarMas )
      {
         ...
         provinciaww_impl.this.AV50textoNoMostrara = GXv_char5[0] ;
   ...
   public void wb_table1_9_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table2_12_EE2( true) ;
      }
      else
      {
         wb_table2_12_EE2( false) ;
      }
      return  ;
   }

   public void wb_table2_12_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_9_EE2e( true) ;
      }
      else
      {
         wb_table1_9_EE2e( false) ;
      }
   }

   public void wb_table2_12_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblWelcomemessage_closehelp_Internalname, lblWelcomemessage_closehelp_Caption, "", "", lblWelcomemessage_closehelp_Jsonclick, "'"+""+"'"+",false,"+"'"+"e22ee1_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, (short)(1), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         web.GxWebStd.gx_bitmap( httpContext, imgavWelcomemessage_foto_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, AV54WelcomeMessage_Foto_IsBlob, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         wb_table3_30_EE2( true) ;
      }
      else
      {
         wb_table3_30_EE2( false) ;
      }
      return  ;
   }

   public void wb_table3_30_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
         wb_table4_35_EE2( true) ;
      }
      else
      {
         wb_table4_35_EE2( false) ;
      }
      return  ;
   }

   public void wb_table4_35_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;align-self:center;", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblWelcomemessage_combotext_Internalname, lblWelcomemessage_combotext_Caption, "", "", lblWelcomemessage_combotext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WelcomeTextNomm", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;align-self:center;", "div");
         wb_table5_54_EE2( true) ;
      }
      else
      {
         wb_table5_54_EE2( false) ;
      }
      return  ;
   }

   public void wb_table5_54_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table6_63_EE2( true) ;
      }
      else
      {
         wb_table6_63_EE2( false) ;
      }
      return  ;
   }

   public void wb_table6_63_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 110 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_12_EE2e( true) ;
      }
      else
      {
         wb_table2_12_EE2e( false) ;
      }
   }

   public void wb_table6_63_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblButtonexport1_textblock_texto_Internalname, httpContext.getMessage( "Exportar", ""), "", "", lblButtonexport1_textblock_texto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ButtonImportExport", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblButtonfilter1_textblock_svg_Internalname, httpContext.getMessage( "<svg width=\"18\" height=\"10\" viewBox=\"0 0 18 10\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M1 1H17M3.85714 5H14.1429M7.28571 9H10.7143\" stroke=\"var(--colors_gray09)\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/></svg>", ""), "", "", lblButtonfilter1_textblock_svg_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(1), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblButtonfilter1_textblock_texto_Internalname, httpContext.getMessage( "Filtros", ""), "", "", lblButtonfilter1_textblock_texto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ButtonImportExport", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "TableBadgeCell", "left", "top", "", "", "div");
         wb_table7_99_EE2( true) ;
      }
      else
      {
         wb_table7_99_EE2( false) ;
      }
      return  ;
   }

   public void wb_table7_99_EE2e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_63_EE2e( true) ;
      }
      else
      {
         wb_table6_63_EE2e( false) ;
      }
   }

   public void wb_table7_99_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td data-align=\"Center\"  style=\""+GXutil.CssPrettify( "text-align:-khtml-Center;text-align:-moz-Center;text-align:-webkit-Center")+"\">") ;
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblButtonfilter1_textblockbadgecount_Internalname, lblButtonfilter1_textblockbadgecount_Caption, "", "", lblButtonfilter1_textblockbadgecount_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBadge", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_99_EE2e( true) ;
      }
      else
      {
         wb_table7_99_EE2e( false) ;
      }
   }

   public void wb_table5_54_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblTotaltext_Internalname, httpContext.getMessage( "Total:", ""), "", "", lblTotaltext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "bold", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblCouttext_Internalname, lblCouttext_Caption, "", "", lblCouttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TotalTextPill", 0, "", lblCouttext_Visible, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_54_EE2e( true) ;
      }
      else
      {
         wb_table5_54_EE2e( false) ;
      }
   }

   public void wb_table4_35_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblWelcomemessage_descripcion_Internalname, lblWelcomemessage_descripcion_Caption, "", "", lblWelcomemessage_descripcion_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WelcomeDescription", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_35_EE2e( true) ;
      }
      else
      {
         wb_table4_35_EE2e( false) ;
      }
   }

   public void wb_table3_30_EE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblWelcomemessage_titulo_Internalname, lblWelcomemessage_titulo_Caption, "", "", lblWelcomemessage_titulo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WelcomeTitle", 0, "", 1, 1, 0, (short)(0), "HLP_ProvinciaWW.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_30_EE2e( true) ;
      }
      else
      {
         wb_table3_30_EE2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020373683", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("provinciaww.js", "?2024122020373683", false, true);
      httpContext.AddJavascriptSource("UserControls/A3LClonEventRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
   ...
   public void subsflControlProps_1102( )
   {
      ...
      edtPaiNom_Internalname = "PAINOM_"+sGXsfl_110_idx ;
      edtProvCod_Internalname = "PROVCOD_"+sGXsfl_110_idx ;
      edtProvNom_Internalname = "PROVNOM_"+sGXsfl_110_idx ;
   ...
   public void subsflControlProps_fel_1102( )
   {
      ...
      edtPaiNom_Internalname = "PAINOM_"+sGXsfl_110_fel_idx ;
      edtProvCod_Internalname = "PROVCOD_"+sGXsfl_110_fel_idx ;
      edtProvNom_Internalname = "PROVNOM_"+sGXsfl_110_fel_idx ;
   ...
   public void startgridcontrol110( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( "") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtProvCod_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Cod. Prov.", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtProvNom_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Nom. Prov.", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Visible", GXutil.ltrim( localUtil.ntoc( edtProvCod_Visible, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Format = "4.0|" ;
      Ddo_grid_Datalistproc = "ProvinciaWWGetFilterData" ;
      ...
      Ddo_grid_Columnids = "2:ProvCod|3:ProvNom" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV39PaiCod',fld:'vPAICOD',pic:'ZZZ9'},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV71Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtProvCod_Visible',ctrl:'PROVCOD',prop:'Visible'},{av:'edtProvNom_Visible',ctrl:'PROVNOM',prop:'Visible'},{av:'edtavVersvg_Visible',ctrl:'vVERSVG',prop:'Visible'},{av:'edtavModificarsvg_Visible',ctrl:'vMODIFICARSVG',prop:'Visible'},{av:'edtavEliminarsvg_Visible',ctrl:'vELIMINARSVG',prop:'Visible'},{av:'AV29GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV30GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV31GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'lblCouttext_Caption',ctrl:'COUTTEXT',prop:'Caption'},{av:'lblCouttext_Visible',ctrl:'COUTTEXT',prop:'Visible'},{av:'lblButtonfilter1_textblockbadgecount_Caption',ctrl:'BUTTONFILTER1_TEXTBLOCKBADGECOUNT',prop:'Caption'},{av:'tblButtonfilter1_tablebadge_Tooltiptext',ctrl:'BUTTONFILTER1_TABLEBADGE',prop:'Tooltiptext'},{av:'tblButtonfilter1_tablebadge_Visible',ctrl:'BUTTONFILTER1_TABLEBADGE',prop:'Visible'},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV56ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e13EE2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV39PaiCod',fld:'vPAICOD',pic:'ZZZ9'},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e14EE2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV39PaiCod',fld:'vPAICOD',pic:'ZZZ9'},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e15EE2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV39PaiCod',fld:'vPAICOD',pic:'ZZZ9'},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'},{av:'Ddo_grid_Filteredtextto_get',ctrl:'DDO_GRID',prop:'FilteredTextTo_get'}]");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV24TFProvNom_SelsJson',fld:'vTFPROVNOM_SELSJSON',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e21EE2',iparms:[{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'A46PaiCod',fld:'PAICOD',pic:'ZZZ9',hsh:true},{av:'A47ProvCod',fld:'PROVCOD',pic:'ZZZ9',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'e11EE2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV39PaiCod',fld:'vPAICOD',pic:'ZZZ9'},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
      setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'edtProvCod_Visible',ctrl:'PROVCOD',prop:'Visible'},{av:'edtProvNom_Visible',ctrl:'PROVNOM',prop:'Visible'},{av:'edtavVersvg_Visible',ctrl:'vVERSVG',prop:'Visible'},{av:'edtavModificarsvg_Visible',ctrl:'vMODIFICARSVG',prop:'Visible'},{av:'edtavEliminarsvg_Visible',ctrl:'vELIMINARSVG',prop:'Visible'},{av:'AV29GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV30GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV31GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'lblCouttext_Caption',ctrl:'COUTTEXT',prop:'Caption'},{av:'lblCouttext_Visible',ctrl:'COUTTEXT',prop:'Visible'},{av:'lblButtonfilter1_textblockbadgecount_Caption',ctrl:'BUTTONFILTER1_TEXTBLOCKBADGECOUNT',prop:'Caption'},{av:'tblButtonfilter1_tablebadge_Tooltiptext',ctrl:'BUTTONFILTER1_TABLEBADGE',prop:'Tooltiptext'},{av:'tblButtonfilter1_tablebadge_Visible',ctrl:'BUTTONFILTER1_TABLEBADGE',prop:'Visible'},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV56ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e12EE2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV39PaiCod',fld:'vPAICOD',pic:'ZZZ9'},{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'AV55paisEs',fld:'vPAISES',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV24TFProvNom_SelsJson',fld:'vTFPROVNOM_SELSJSON',pic:''}]");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV58ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22TFProvCod',fld:'vTFPROVCOD',pic:'ZZZ9'},{av:'AV23TFProvCod_To',fld:'vTFPROVCOD_TO',pic:'ZZZ9'},{av:'AV25TFProvNom',fld:'vTFPROVNOM',pic:''},{av:'AV26TFProvNom_Sels',fld:'vTFPROVNOM_SELS',pic:''},{av:'Ddo_grid_Selectedvalue_set',ctrl:'DDO_GRID',prop:'SelectedValue_set'},{av:'Ddo_grid_Filteredtext_set',ctrl:'DDO_GRID',prop:'FilteredText_set'},{av:'Ddo_grid_Filteredtextto_set',ctrl:'DDO_GRID',prop:'FilteredTextTo_set'},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV24TFProvNom_SelsJson',fld:'vTFPROVNOM_SELSJSON',pic:''},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtProvCod_Visible',ctrl:'PROVCOD',prop:'Visible'},{av:'edtProvNom_Visible',ctrl:'PROVNOM',prop:'Visible'},{av:'edtavVersvg_Visible',ctrl:'vVERSVG',prop:'Visible'},{av:'edtavModificarsvg_Visible',ctrl:'vMODIFICARSVG',prop:'Visible'},{av:'edtavEliminarsvg_Visible',ctrl:'vELIMINARSVG',prop:'Visible'},{av:'AV29GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV30GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV31GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'lblCouttext_Caption',ctrl:'COUTTEXT',prop:'Caption'},{av:'lblCouttext_Visible',ctrl:'COUTTEXT',prop:'Visible'},{av:'lblButtonfilter1_textblockbadgecount_Caption',ctrl:'BUTTONFILTER1_TEXTBLOCKBADGECOUNT',prop:'Caption'},{av:'tblButtonfilter1_tablebadge_Tooltiptext',ctrl:'BUTTONFILTER1_TABLEBADGE',prop:'Tooltiptext'},{av:'tblButtonfilter1_tablebadge_Visible',ctrl:'BUTTONFILTER1_TABLEBADGE',prop:'Visible'},{av:'AV33IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV35IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV56ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
      setEventMetadata("'DOINSERT'","{handler:'e16EE2',iparms:[{av:'A46PaiCod',fld:'PAICOD',pic:'ZZZ9',hsh:true},{av:'A47ProvCod',fld:'PROVCOD',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("'DOEXPORT'","{handler:'e17EE2',iparms:[]");
      setEventMetadata("'DOEXPORT'",",oparms:[]}");
      setEventMetadata("VWELCOMEMESSAGE_NOMOSTRARMAS.CLICK","{handler:'e18EE2',iparms:[{av:'AV48WelcomeMessage_NoMostrarMas',fld:'vWELCOMEMESSAGE_NOMOSTRARMAS',pic:''},{av:'AV46MenuOpcCod',fld:'vMENUOPCCOD',pic:'',hsh:true},{av:'AV37CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true}]");
      setEventMetadata("VWELCOMEMESSAGE_NOMOSTRARMAS.CLICK",",oparms:[{av:'lblWelcomemessage_combotext_Caption',ctrl:'WELCOMEMESSAGE_COMBOTEXT',prop:'Caption'}]}");
      setEventMetadata("WELCOMEMESSAGE_CLOSEHELP.CLICK","{handler:'e22EE1',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      AV43ModificarSVG = "" ;
      AV44EliminarSVG = "" ;
      AV75Provinciawwds_4_tfprovnom_sels = new GXSimpleCollection<String>(String.class, "internal", "");
      scmdbuf = "" ;
      lV74Provinciawwds_3_tfprovnom = "" ;
      AV74Provinciawwds_3_tfprovnom = "" ;
      H00EE2_A322ProvNom = new String[] {""} ;
      H00EE2_A47ProvCod = new short[1] ;
      H00EE2_A312PaiNom = new String[] {""} ;
      H00EE2_A46PaiCod = new short[1] ;
      H00EE3_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.provinciaww__default(),
         new Object[] {
             new Object[] {
            H00EE2_A322ProvNom, H00EE2_A47ProvCod, H00EE2_A312PaiNom, H00EE2_A46PaiCod
            }
            , new Object[] {
            H00EE3_AGRID_nRecordCount
            }
         }
      );
      AV71Pgmname = "ProvinciaWW" ;
   ...
   private short AV22TFProvCod ;
   private short AV23TFProvCod_To ;
   ...
   private short AV72Provinciawwds_1_tfprovcod ;
   private short AV73Provinciawwds_2_tfprovcod_to ;
   ...
   private int AV75Provinciawwds_4_tfprovnom_sels_size ;
   ...
   private String AV24TFProvNom_SelsJson ;
   ...
   private String AV25TFProvNom ;
   private String AV31GridAppliedFilters ;
   private String A312PaiNom ;
   private String A322ProvNom ;
   private String lV74Provinciawwds_3_tfprovnom ;
   private String AV74Provinciawwds_3_tfprovnom ;
   ...
   private GXSimpleCollection<String> AV75Provinciawwds_4_tfprovnom_sels ;
   private ICheckbox chkavWelcomemessage_nomostrarmas ;
   private IDataStoreProvider pr_default ;
   private String[] H00EE2_A322ProvNom ;
   private short[] H00EE2_A47ProvCod ;
   private String[] H00EE2_A312PaiNom ;
   private short[] H00EE2_A46PaiCod ;
   private long[] H00EE3_AGRID_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
   private GXSimpleCollection<String> AV26TFProvNom_Sels ;
...
final  class provinciaww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00EE2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String A322ProvNom ,
                                          GXSimpleCollection<String> AV75Provinciawwds_4_tfprovnom_sels ,
                                          short AV72Provinciawwds_1_tfprovcod ,
                                          short AV73Provinciawwds_2_tfprovcod_to ,
                                          int AV75Provinciawwds_4_tfprovnom_sels_size ,
                                          String AV74Provinciawwds_3_tfprovnom ,
                                          short AV39PaiCod ,
                                          short A47ProvCod ,
                                          short A46PaiCod ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.ProvNom, T1.ProvCod, T2.PaiNom, T1.PaiCod" ;
      sFromString = " FROM (Provincia T1 INNER JOIN Pais T2 ON T2.PaiCod = T1.PaiCod)" ;
      sOrderString = "" ;
      if ( ! (0==AV72Provinciawwds_1_tfprovcod) )
      {
      ...
      if ( ! (0==AV73Provinciawwds_2_tfprovcod_to) )
      {
         addWhere(sWhereString, "(T1.ProvCod <= ?)");
      }
      else
      ...
      if ( ( AV75Provinciawwds_4_tfprovnom_sels_size == 0 ) && ( ! (GXutil.strcmp("", AV74Provinciawwds_3_tfprovnom)==0) ) )
      {
         addWhere(sWhereString, "(LOWER(T1.ProvNom) like LOWER(?))");
      }
      else
      {
         GXv_int19[2] = (byte)(1) ;
      }
      if ( AV75Provinciawwds_4_tfprovnom_sels_size > 0 )
      {
         addWhere(sWhereString, "("+GXutil.toValueList("postgresql", AV75Provinciawwds_4_tfprovnom_sels, "T1.ProvNom IN (", ")")+")");
      }
      if ( ! (0==AV39PaiCod) )
      {
      ...
      {
         sOrderString += " ORDER BY T1.ProvCod, T1.PaiCod" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.ProvCod DESC, T1.PaiCod" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.ProvNom, T1.PaiCod, T1.ProvCod" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.ProvNom DESC, T1.PaiCod, T1.ProvCod" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.PaiCod, T1.ProvCod" ;
      }
   ...
   protected Object[] conditional_H00EE3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String A322ProvNom ,
                                          GXSimpleCollection<String> AV75Provinciawwds_4_tfprovnom_sels ,
                                          ...
                                          boolean AV15OrderedDsc )
   {
      java.lang.StringBuffer sWhereString = new java.lang.StringBuffer();
      String scmdbuf;
      byte[] GXv_int22 = new byte[4];
      Object[] GXv_Object23 = new Object[2];
      scmdbuf = "SELECT COUNT(*) FROM (Provincia T1 INNER JOIN Pais T2 ON T2.PaiCod = T1.PaiCod)" ;
      if ( ! (0==AV72Provinciawwds_1_tfprovcod) )
      {
         addWhere(sWhereString, "(T1.ProvCod >= ?)");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00EE2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() );
            case 1 :
                  return conditional_H00EE3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00EE2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00EE3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
