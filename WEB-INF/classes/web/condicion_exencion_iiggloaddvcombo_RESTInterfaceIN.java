...
@javax.xml.bind.annotation.XmlType(name = "condicion_exencion_iiggloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class condicion_exencion_iiggloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("CondExenIIGG")
   public String getCondExenIIGG( )
   {
      if ( GXutil.strcmp(AV19CondExenIIGG, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV19CondExenIIGG ;
      }
   }

   @JsonProperty("CondExenIIGG")
   public void setCondExenIIGG(  String Value )
   {
      if ( Value == null )
      {
         AV19CondExenIIGG = "" ;
