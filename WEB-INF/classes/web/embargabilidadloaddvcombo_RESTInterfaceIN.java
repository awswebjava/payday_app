...
@javax.xml.bind.annotation.XmlType(name = "embargabilidadloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class embargabilidadloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("EmbargaSec")
   public short getEmbargaSec( )
   {
      return AV18EmbargaSec ;
   }

   @JsonProperty("EmbargaSec")
   public void setEmbargaSec(  short Value )
   {
      AV18EmbargaSec= Value;
   }
