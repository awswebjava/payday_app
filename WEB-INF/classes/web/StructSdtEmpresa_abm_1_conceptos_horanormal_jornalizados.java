...
public final  class StructSdtEmpresa_abm_1_conceptos_horanormal_jornalizados implements Cloneable, java.io.Serializable
{
   public StructSdtEmpresa_abm_1_conceptos_horanormal_jornalizados( )
   {
      this( -1, new ModelContext( StructSdtEmpresa_abm_1_conceptos_horanormal_jornalizados.class ));
   }

   public StructSdtEmpresa_abm_1_conceptos_horanormal_jornalizados( int remoteHandle ,
   ...
   protected short gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Modified ;
   protected short gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Initialized ;
   protected String gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Empjorconcodigo ;
   protected String gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Mode ;
   protected String gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Empjorconcodigo_Z ;
   protected boolean gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Empjorhabitual ;
   protected boolean gxTv_SdtEmpresa_abm_1_conceptos_horanormal_jornalizados_Empjorhabitual_Z ;
}
