...
public final  class seccionview_impl extends GXDataArea
{
   public seccionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seccionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seccionview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV9SecCodigo = httpContext.GetPar( "SecCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9SecCodigo", AV9SecCodigo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SecCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.seccionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9SecCodigo)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","SecCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vSECCODIGO", GXutil.rtrim( AV9SecCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SecCodigo, ""))));
   ...
   {
      return formatLink("web.seccionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9SecCodigo)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","SecCodigo","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Seccion View", "") ;
   }
   ...
   public void wb1A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1A2( true) ;
      }
      else
      {
         wb_table1_9_1A2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1A2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1A2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Seccion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup1A0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV9SecCodigo = httpContext.cgiGet( "vSECCODIGO") ;
   ...
   public void e111A2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H001A2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV12CliCod), AV9SecCodigo, Integer.valueOf(AV12CliCod), AV9SecCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A13SecCodigo = H001A2_A13SecCodigo[0] ;
         A3CliCod = H001A2_A3CliCod[0] ;
         A329SecDescrip = H001A2_A329SecDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A329SecDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SeccionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.secciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SeccionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV12CliCod),AV9SecCodigo});
   ...
   public void wb_table1_9_1A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_SeccionView.htm");
         /* Div Control */
         ...
         wb_table1_9_1A2e( true) ;
      }
      else
      {
         wb_table1_9_1A2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      AV9SecCodigo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9SecCodigo", AV9SecCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SecCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202039981", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("seccionview.js", "?202412202039981", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Seccion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV9SecCodigo',fld:'vSECCODIGO',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001A2_A13SecCodigo = new String[] {""} ;
      H001A2_A3CliCod = new int[1] ;
      H001A2_A329SecDescrip = new String[] {""} ;
      A13SecCodigo = "" ;
      A329SecDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.seccionview__default(),
         new Object[] {
             new Object[] {
            H001A2_A13SecCodigo, H001A2_A3CliCod, H001A2_A329SecDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV9SecCodigo ;
   ...
   private String[] H001A2_A13SecCodigo ;
   private int[] H001A2_A3CliCod ;
   private String[] H001A2_A329SecDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class seccionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001A2", "SELECT SecCodigo, CliCod, SecDescrip FROM Seccion WHERE (CliCod = ? and SecCodigo = ( ?)) AND (CliCod = ? and SecCodigo = ( ?)) ORDER BY CliCod, SecCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
