...
public final  class motivoegresoview_impl extends GXDataArea
{
   public motivoegresoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public motivoegresoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( motivoegresoview_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.motivoegresoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11MegCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","MegCodigo","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.motivoegresoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11MegCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","MegCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "MotivoEgresoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Motivo Egreso View", "") ;
   }
   ...
   public void wb160( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_162( true) ;
      }
      else
      {
         wb_table1_9_162( false) ;
      }
      return  ;
   }

   public void wb_table1_9_162e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start162( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Motivo Egreso View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup160( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11MegCodigo = httpContext.cgiGet( "vMEGCODIGO") ;
   ...
   public void e11162( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00162 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11MegCodigo, Integer.valueOf(AV10CliCod), AV11MegCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A11MegCodigo = H00162_A11MegCodigo[0] ;
         A3CliCod = H00162_A3CliCod[0] ;
         A300MegDescrip = H00162_A300MegDescrip[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A300MegDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "MotivoEgresoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.motivoegresogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "MotivoEgresoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11MegCodigo});
   ...
   public void wb_table1_9_162( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_MotivoEgresoView.htm");
         /* Div Control */
         ...
         wb_table1_9_162e( true) ;
      }
      else
      {
         wb_table1_9_162e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020295142", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("motivoegresoview.js", "?2024122020295143", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Motivo Egreso View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11MegCodigo',fld:'vMEGCODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00162_A11MegCodigo = new String[] {""} ;
      H00162_A3CliCod = new int[1] ;
      H00162_A300MegDescrip = new String[] {""} ;
      A11MegCodigo = "" ;
      A300MegDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.motivoegresoview__default(),
         new Object[] {
             new Object[] {
            H00162_A11MegCodigo, H00162_A3CliCod, H00162_A300MegDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00162_A11MegCodigo ;
   private int[] H00162_A3CliCod ;
   private String[] H00162_A300MegDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class motivoegresoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00162", "SELECT MegCodigo, CliCod, MegDescrip FROM MotivoEgreso WHERE (CliCod = ? and MegCodigo = ( ?)) AND (CliCod = ? and MegCodigo = ( ?)) ORDER BY CliCod, MegCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
