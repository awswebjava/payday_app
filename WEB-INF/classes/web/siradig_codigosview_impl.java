...
public final  class siradig_codigosview_impl extends GXDataArea
{
   public siradig_codigosview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public siradig_codigosview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( siradig_codigosview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11SiraTipo = httpContext.GetPar( "SiraTipo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11SiraTipo", AV11SiraTipo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSIRATIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11SiraTipo, ""))));
               AV12SiraCodigo = httpContext.GetPar( "SiraCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12SiraCodigo", AV12SiraCodigo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSIRACODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12SiraCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.siradig_codigosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11SiraTipo)),GXutil.URLEncode(GXutil.rtrim(AV12SiraCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","SiraTipo","SiraCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vSIRATIPO", GXutil.rtrim( AV11SiraTipo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSIRATIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11SiraTipo, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vSIRACODIGO", GXutil.rtrim( AV12SiraCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSIRACODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12SiraCodigo, ""))));
   ...
   {
      return formatLink("web.siradig_codigosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11SiraTipo)),GXutil.URLEncode(GXutil.rtrim(AV12SiraCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","SiraTipo","SiraCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "siradig_codigosView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "siradig_codigos View", "") ;
   }
   ...
   public void wbBW0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_BW2( true) ;
      }
      else
      {
         wb_table1_9_BW2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_BW2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startBW2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "siradig_codigos View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupBW0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11SiraTipo = httpContext.cgiGet( "vSIRATIPO") ;
         AV12SiraCodigo = httpContext.cgiGet( "vSIRACODIGO") ;
   ...
   public void e11BW2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00BW2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11SiraTipo, AV12SiraCodigo, Integer.valueOf(AV10CliCod), AV11SiraTipo, AV12SiraCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1102SiraCodigo = H00BW2_A1102SiraCodigo[0] ;
         A1101SiraTipo = H00BW2_A1101SiraTipo[0] ;
         A3CliCod = H00BW2_A3CliCod[0] ;
         A1103SiraPropor = H00BW2_A1103SiraPropor[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1103SiraPropor, 6, 4) );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "siradig_codigosGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.siradig_codigosgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "siradig_codigosGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11SiraTipo,AV12SiraCodigo});
   ...
   public void wb_table1_9_BW2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_siradig_codigosView.htm");
         /* Div Control */
         ...
         wb_table1_9_BW2e( true) ;
      }
      else
      {
         wb_table1_9_BW2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11SiraTipo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11SiraTipo", AV11SiraTipo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSIRATIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11SiraTipo, ""))));
      AV12SiraCodigo = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12SiraCodigo", AV12SiraCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSIRACODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12SiraCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181775662", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("siradig_codigosview.js", "?2025181775662", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "siradig_codigos View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11SiraTipo',fld:'vSIRATIPO',pic:'',hsh:true},{av:'AV12SiraCodigo',fld:'vSIRACODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00BW2_A1102SiraCodigo = new String[] {""} ;
      H00BW2_A1101SiraTipo = new String[] {""} ;
      H00BW2_A3CliCod = new int[1] ;
      H00BW2_A1103SiraPropor = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      A1102SiraCodigo = "" ;
      A1101SiraTipo = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.siradig_codigosview__default(),
         new Object[] {
             new Object[] {
            H00BW2_A1102SiraCodigo, H00BW2_A1101SiraTipo, H00BW2_A3CliCod, H00BW2_A1103SiraPropor
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV11SiraTipo ;
   private String wcpOAV12SiraCodigo ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11SiraTipo ;
   private String AV12SiraCodigo ;
   ...
   private String[] H00BW2_A1102SiraCodigo ;
   private String[] H00BW2_A1101SiraTipo ;
   private int[] H00BW2_A3CliCod ;
   private java.math.BigDecimal[] H00BW2_A1103SiraPropor ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class siradig_codigosview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00BW2", "SELECT SiraCodigo, SiraTipo, CliCod, SiraPropor FROM siradig_codigos WHERE (CliCod = ? and SiraTipo = ( ?) and SiraCodigo = ( ?)) AND (CliCod = ? and SiraTipo = ( ?) and SiraCodigo = ( ?)) ORDER BY CliCod, SiraTipo, SiraCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
