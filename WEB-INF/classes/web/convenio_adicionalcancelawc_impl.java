...
public final  class convenio_adicionalcancelawc_impl extends GXWebComponent
{
   public convenio_adicionalcancelawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_adicionalcancelawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_adicionalcancelawc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV11ConveAdicod = httpContext.GetPar( "ConveAdicod") ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11ConveAdicod", AV11ConveAdicod);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8CliCod),Short.valueOf(AV9CliPaiConve),AV10CliConvenio,AV11ConveAdicod});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9CliPaiConve, AV10CliConvenio, AV11ConveAdicod, AV29Pgmname, AV17OrderedBy, AV18OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "convenio_adicional Cancela WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_adicionalcancelawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV10CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV11ConveAdicod))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV11ConveAdicod", GXutil.rtrim( wcpOAV11ConveAdicod));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCONVEADICOD", GXutil.rtrim( AV11ConveAdicod));
   ...
   public void renderHtmlCloseFormLK2( )
   {
   ...
   {
      return "convenio_adicionalCancelaWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "convenio_adicional Cancela WC", "") ;
   }
   ...
   public void wbLK0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.convenio_adicionalcancelawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_convenio_adicionalCancelaWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliPaiConve_Internalname, GXutil.ltrim( localUtil.ntoc( A1564CliPaiConve, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1564CliPaiConve), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliPaiConve_Jsonclick, 0, "Attribute", "", "", "", "", edtCliPaiConve_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_convenio_adicionalCancelaWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliConvenio_Internalname, GXutil.rtrim( A1565CliConvenio), GXutil.rtrim( localUtil.format( A1565CliConvenio, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliConvenio_Jsonclick, 0, "Attribute", "", "", "", "", edtCliConvenio_Visible, 0, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_convenio_adicionalCancelaWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveAdicod_Internalname, GXutil.rtrim( A996ConveAdicod), GXutil.rtrim( localUtil.format( A996ConveAdicod, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveAdicod_Jsonclick, 0, "Attribute", "", "", "", "", edtConveAdicod_Visible, 0, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_convenio_adicionalCancelaWC.htm");
         /* User Defined Control */
   ...
   public void startLK2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "convenio_adicional Cancela WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV29Pgmname = "convenio_adicionalCancelaWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfLK2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00LK2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9CliPaiConve), AV10CliConvenio, AV11ConveAdicod, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A3CliCod = H00LK2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1564CliPaiConve = H00LK2_A1564CliPaiConve[0] ;
            ...
            A1565CliConvenio = H00LK2_A1565CliConvenio[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1565CliConvenio", A1565CliConvenio);
            A996ConveAdicod = H00LK2_A996ConveAdicod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A996ConveAdicod", A996ConveAdicod);
            A1898ConveAdiSitCanRelSec = H00LK2_A1898ConveAdiSitCanRelSec[0] ;
            A1825ConveAdiSitCancDes = H00LK2_A1825ConveAdiSitCancDes[0] ;
            A1824ConveAdiSitCancela = H00LK2_A1824ConveAdiSitCancela[0] ;
            A1825ConveAdiSitCancDes = H00LK2_A1825ConveAdiSitCancDes[0] ;
            e16LK2 ();
   ...
   public void send_integrity_lvl_hashesLK2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV29Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV29Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00LK3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9CliPaiConve), AV10CliConvenio, AV11ConveAdicod});
   ...
   public void strupLK0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV11ConveAdicod = httpContext.cgiGet( sPrefix+"wcpOAV11ConveAdicod") ;
   ...
   public void e14LK2( )
   {
      ...
      convenio_adicionalcancelawc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e15LK2( )
   {
      ...
      convenio_adicionalcancelawc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV13TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "convenio_adicional" );
      ...
      AV13TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV14TrnContextAtt, 0);
      AV14TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV14TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ConveAdicod" );
      AV14TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( AV11ConveAdicod );
      AV13TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV14TrnContextAtt, 0);
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10CliConvenio", AV10CliConvenio);
      AV11ConveAdicod = (String)getParm(obj,3,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11ConveAdicod", AV11ConveAdicod);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV11ConveAdicod = (String)getParm(obj,3,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "convenio_adicionalcancelawc", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10CliConvenio", AV10CliConvenio);
         AV11ConveAdicod = (String)getParm(obj,5,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11ConveAdicod", AV11ConveAdicod);
      }
      wcpOAV8CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV9CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9CliPaiConve"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV10CliConvenio = httpContext.cgiGet( sPrefix+"wcpOAV10CliConvenio") ;
      wcpOAV11ConveAdicod = httpContext.cgiGet( sPrefix+"wcpOAV11ConveAdicod") ;
      if ( ! GetJustCreated( ) && ( ( AV8CliCod != wcpOAV8CliCod ) || ( AV9CliPaiConve != wcpOAV9CliPaiConve ) || ( GXutil.strcmp(AV10CliConvenio, wcpOAV10CliConvenio) != 0 ) || ( GXutil.strcmp(AV11ConveAdicod, wcpOAV11ConveAdicod) != 0 ) ) )
      {
         setjustcreated();
      }
      ...
      wcpOAV11ConveAdicod = AV11ConveAdicod ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlAV11ConveAdicod = httpContext.cgiGet( sPrefix+"AV11ConveAdicod_CTRL") ;
      if ( GXutil.len( sCtrlAV11ConveAdicod) > 0 )
      {
         AV11ConveAdicod = httpContext.cgiGet( sCtrlAV11ConveAdicod) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11ConveAdicod", AV11ConveAdicod);
      }
      else
      {
         AV11ConveAdicod = httpContext.cgiGet( sPrefix+"AV11ConveAdicod_PARM") ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11ConveAdicod_PARM", GXutil.rtrim( AV11ConveAdicod));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV11ConveAdicod)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11ConveAdicod_CTRL", GXutil.rtrim( sCtrlAV11ConveAdicod));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713331053", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("convenio_adicionalcancelawc.js", "?20251713331054", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtConveAdiSitCancela_Internalname = sPrefix+"CONVEADISITCANCELA_"+sGXsfl_15_idx ;
      edtConveAdiSitCancDes_Internalname = sPrefix+"CONVEADISITCANCDES_"+sGXsfl_15_idx ;
      edtConveAdiSitCanRelSec_Internalname = sPrefix+"CONVEADISITCANRELSEC_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtConveAdiSitCancela_Internalname = sPrefix+"CONVEADISITCANCELA_"+sGXsfl_15_fel_idx ;
      edtConveAdiSitCancDes_Internalname = sPrefix+"CONVEADISITCANCDES_"+sGXsfl_15_fel_idx ;
      edtConveAdiSitCanRelSec_Internalname = sPrefix+"CONVEADISITCANRELSEC_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtConveAdiSitCancela_Internalname,GXutil.rtrim( A1824ConveAdiSitCancela),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtConveAdiSitCancela_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtConveAdiSitCancDes_Internalname,A1825ConveAdiSitCancDes,GXutil.rtrim( localUtil.format( A1825ConveAdiSitCancDes, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtConveAdiSitCancDes_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"DescripcionLarga","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtConveAdiSitCanRelSec_Internalname,GXutil.ltrim( localUtil.ntoc( A1898ConveAdiSitCanRelSec, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1898ConveAdiSitCanRelSec), "ZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtConveAdiSitCanRelSec_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(6),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         send_integrity_lvl_hashesLK2( ) ;
   ...
   public void startgridcontrol15( )
   {
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1824ConveAdiSitCancela));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A1825ConveAdiSitCancDes);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1898ConveAdiSitCanRelSec, (byte)(6), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtConveAdiSitCancela_Internalname = sPrefix+"CONVEADISITCANCELA" ;
      edtConveAdiSitCancDes_Internalname = sPrefix+"CONVEADISITCANCDES" ;
      edtConveAdiSitCanRelSec_Internalname = sPrefix+"CONVEADISITCANRELSEC" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:ConveAdiSitCancela|1:ConveAdiSitCancDes|2:ConveAdiSitCanRelSec" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9'},{av:'AV10CliConvenio',fld:'vCLICONVENIO',pic:''},{av:'AV11ConveAdicod',fld:'vCONVEADICOD',pic:''},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16LK2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[]}");
      setEventMetadata("VALID_CONVEADISITCANCELA","{handler:'valid_Conveadisitcancela',iparms:[]");
      setEventMetadata("VALID_CONVEADISITCANCELA",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Conveadisitcanrelsec',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00LK2_A3CliCod = new int[1] ;
      H00LK2_A1564CliPaiConve = new short[1] ;
      H00LK2_A1565CliConvenio = new String[] {""} ;
      H00LK2_A996ConveAdicod = new String[] {""} ;
      H00LK2_A1898ConveAdiSitCanRelSec = new int[1] ;
      H00LK2_A1825ConveAdiSitCancDes = new String[] {""} ;
      H00LK2_A1824ConveAdiSitCancela = new String[] {""} ;
      ...
      sCtrlAV11ConveAdicod = "" ;
      subGrid_Linesclass = "" ;
      ROClassString = "" ;
      GridColumn = new com.genexus.webpanels.GXWebColumn();
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_adicionalcancelawc__default(),
         new Object[] {
             new Object[] {
            H00LK2_A3CliCod, H00LK2_A1564CliPaiConve, H00LK2_A1565CliConvenio, H00LK2_A996ConveAdicod, H00LK2_A1898ConveAdiSitCanRelSec, H00LK2_A1825ConveAdiSitCancDes, H00LK2_A1824ConveAdiSitCancela
            }
            , new Object[] {
   ...
   private String wcpOAV11ConveAdicod ;
   ...
   private String sCtrlAV11ConveAdicod ;
   ...
   private int[] H00LK2_A3CliCod ;
   private short[] H00LK2_A1564CliPaiConve ;
   private String[] H00LK2_A1565CliConvenio ;
   private String[] H00LK2_A996ConveAdicod ;
   private int[] H00LK2_A1898ConveAdiSitCanRelSec ;
   private String[] H00LK2_A1825ConveAdiSitCancDes ;
   private String[] H00LK2_A1824ConveAdiSitCancela ;
...
final  class convenio_adicionalcancelawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00LK2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          String A996ConveAdicod )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiSitCanRelSec, T2.SitDescrip AS ConveAdiSitCancDes, T1.ConveAdiSitCancela AS ConveAdiSitCancela" ;
      sFromString = " FROM (convenio_adicionalCancela T1 INNER JOIN Estado T2 ON T2.SitCodigo = T1.ConveAdiSitCancela)" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.CliCod = ? and T1.CliPaiConve = ? and T1.CliConvenio = ( ?) and T1.ConveAdicod = ( ?))");
      if ( ( AV17OrderedBy == 1 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiSitCancela" ;
      }
      else if ( ( AV17OrderedBy == 1 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.CliPaiConve DESC, T1.CliConvenio DESC, T1.ConveAdicod DESC, T1.ConveAdiSitCancela DESC" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T2.SitDescrip, T1.ConveAdiSitCancela" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.CliPaiConve DESC, T1.CliConvenio DESC, T1.ConveAdicod DESC, T2.SitDescrip DESC, T1.ConveAdiSitCancela" ;
      }
      else if ( ( AV17OrderedBy == 3 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiSitCanRelSec, T1.ConveAdiSitCancela" ;
      }
      else if ( ( AV17OrderedBy == 3 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.CliPaiConve DESC, T1.CliConvenio DESC, T1.ConveAdicod DESC, T1.ConveAdiSitCanRelSec DESC, T1.ConveAdiSitCancela" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiSitCancela" ;
   ...
   protected Object[] conditional_H00LK3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV17OrderedBy ,
                                          boolean AV18OrderedDsc ,
                                          ...
                                          String A996ConveAdicod )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (convenio_adicionalCancela T1 INNER JOIN Estado T2 ON T2.SitCodigo = T1.ConveAdiSitCancela)" ;
      addWhere(sWhereString, "(T1.CliCod = ? and T1.CliPaiConve = ? and T1.CliConvenio = ( ?) and T1.ConveAdicod = ( ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00LK2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , (String)dynConstraints[8] , (String)dynConstraints[9] );
            case 1 :
                  return conditional_H00LK3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , (String)dynConstraints[8] , (String)dynConstraints[9] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00LK2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00LK3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
