...
public final  class paramview_impl extends GXDataArea
{
   public paramview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public paramview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( paramview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11ParmCod = httpContext.GetPar( "ParmCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11ParmCod", AV11ParmCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPARMCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ParmCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.paramview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11ParmCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ParmCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vPARMCOD", GXutil.rtrim( AV11ParmCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPARMCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ParmCod, ""))));
   ...
   {
      return formatLink("web.paramview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11ParmCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ParmCod","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Param View", "") ;
   }
   ...
   public void wb8Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_8Y2( true) ;
      }
      else
      {
         wb_table1_9_8Y2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_8Y2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start8Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Param View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes8Y2( )
   {
   }
   ...
   public void strup8Y0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11ParmCod = httpContext.cgiGet( "vPARMCOD") ;
   ...
   public void e118Y2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H008Y2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11ParmCod, Integer.valueOf(AV10CliCod), AV11ParmCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A61ParmCod = H008Y2_A61ParmCod[0] ;
         A3CliCod = H008Y2_A3CliCod[0] ;
         A315ParmDescri = H008Y2_A315ParmDescri[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A315ParmDescri );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ParamGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.paramgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ParamGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11ParmCod});
   ...
   public void wb_table1_9_8Y2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ParamView.htm");
         /* Div Control */
         ...
         wb_table1_9_8Y2e( true) ;
      }
      else
      {
         wb_table1_9_8Y2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11ParmCod = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11ParmCod", AV11ParmCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPARMCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ParmCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020361891", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paramview.js", "?2024122020361891", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Param View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11ParmCod',fld:'vPARMCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H008Y2_A61ParmCod = new String[] {""} ;
      H008Y2_A3CliCod = new int[1] ;
      H008Y2_A315ParmDescri = new String[] {""} ;
      A61ParmCod = "" ;
      A315ParmDescri = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.paramview__default(),
         new Object[] {
             new Object[] {
            H008Y2_A61ParmCod, H008Y2_A3CliCod, H008Y2_A315ParmDescri
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11ParmCod ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11ParmCod ;
   ...
   private String[] H008Y2_A61ParmCod ;
   private int[] H008Y2_A3CliCod ;
   private String[] H008Y2_A315ParmDescri ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class paramview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H008Y2", "SELECT ParmCod, CliCod, ParmDescri FROM Param WHERE (CliCod = ? and ParmCod = ( ?)) AND (CliCod = ? and ParmCod = ( ?)) ORDER BY CliCod, ParmCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
