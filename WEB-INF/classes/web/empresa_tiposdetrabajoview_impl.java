...
public final  class empresa_tiposdetrabajoview_impl extends GXDataArea
{
   public empresa_tiposdetrabajoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresa_tiposdetrabajoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresa_tiposdetrabajoview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12PaiTipoTraId = httpContext.GetPar( "PaiTipoTraId") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12PaiTipoTraId", AV12PaiTipoTraId);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12PaiTipoTraId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.empresa_tiposdetrabajoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","PaiTipoTraId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vPAITIPOTRAID", GXutil.rtrim( AV12PaiTipoTraId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12PaiTipoTraId, ""))));
   ...
   {
      return formatLink("web.empresa_tiposdetrabajoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","PaiTipoTraId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "empresa_tiposdetrabajoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "empresa_tiposdetrabajo View", "") ;
   }
   ...
   public void wbKL0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_KL2( true) ;
      }
      else
      {
         wb_table1_9_KL2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_KL2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startKL2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "empresa_tiposdetrabajo View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesKL2( )
   {
   }
   ...
   public void strupKL0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12PaiTipoTraId = httpContext.cgiGet( "vPAITIPOTRAID") ;
   ...
   public void e11KL2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00KL2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12PaiTipoTraId, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12PaiTipoTraId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1294PaiTipoTraId = H00KL2_A1294PaiTipoTraId[0] ;
         A1EmpCod = H00KL2_A1EmpCod[0] ;
         A3CliCod = H00KL2_A3CliCod[0] ;
         A1344EmpHsDia = H00KL2_A1344EmpHsDia[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1344EmpHsDia, 3, 1) );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "empresa_tiposdetrabajoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.empresa_tiposdetrabajogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "empresa_tiposdetrabajoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),AV12PaiTipoTraId});
   ...
   public void wb_table1_9_KL2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_empresa_tiposdetrabajoView.htm");
         /* Div Control */
         ...
         wb_table1_9_KL2e( true) ;
      }
      else
      {
         wb_table1_9_KL2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12PaiTipoTraId = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12PaiTipoTraId", AV12PaiTipoTraId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12PaiTipoTraId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181742190", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresa_tiposdetrabajoview.js", "?2025181742190", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "empresa_tiposdetrabajo View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12PaiTipoTraId',fld:'vPAITIPOTRAID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00KL2_A1294PaiTipoTraId = new String[] {""} ;
      H00KL2_A1EmpCod = new short[1] ;
      H00KL2_A3CliCod = new int[1] ;
      H00KL2_A1344EmpHsDia = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      A1294PaiTipoTraId = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.empresa_tiposdetrabajoview__default(),
         new Object[] {
             new Object[] {
            H00KL2_A1294PaiTipoTraId, H00KL2_A1EmpCod, H00KL2_A3CliCod, H00KL2_A1344EmpHsDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV12PaiTipoTraId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12PaiTipoTraId ;
   ...
   private String[] H00KL2_A1294PaiTipoTraId ;
   private short[] H00KL2_A1EmpCod ;
   private int[] H00KL2_A3CliCod ;
   private java.math.BigDecimal[] H00KL2_A1344EmpHsDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class empresa_tiposdetrabajoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00KL2", "SELECT PaiTipoTraId, EmpCod, CliCod, EmpHsDia FROM Empresatipo_trabajo WHERE (CliCod = ? and EmpCod = ? and PaiTipoTraId = ( ?)) AND (CliCod = ? and EmpCod = ? and PaiTipoTraId = ( ?)) ORDER BY CliCod, EmpCod, PaiTipoTraId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
