...
public final  class localidadview_impl extends GXDataArea
{
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12LocCod = (short)(GXutil.lval( httpContext.GetPar( "LocCod"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12LocCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LocCod), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLOCCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LocCod), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.localidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11ProvCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LocCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","ProvCod","LocCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPROVCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11ProvCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vLOCCOD", GXutil.ltrim( localUtil.ntoc( AV12LocCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLOCCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LocCod), "ZZZ9")));
   ...
   {
      return formatLink("web.localidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11ProvCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LocCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","ProvCod","LocCod","TabCode"})  ;
   }
   ...
   public void wb140( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_142( true) ;
      }
      else
      {
         wb_table1_9_142( false) ;
      }
      return  ;
   }

   public void wb_table1_9_142e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void strup140( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11ProvCod = (short)(localUtil.ctol( httpContext.cgiGet( "vPROVCOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         AV12LocCod = (short)(localUtil.ctol( httpContext.cgiGet( "vLOCCOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11142( )
   {
      ...
      AV22GXLvl11 = (byte)(0) ;
      /* Using cursor H00142 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PaiCod), Short.valueOf(AV11ProvCod), Short.valueOf(AV12LocCod), Short.valueOf(AV10PaiCod), Short.valueOf(AV11ProvCod), Short.valueOf(AV12LocCod)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A48LocCod = H00142_A48LocCod[0] ;
         A47ProvCod = H00142_A47ProvCod[0] ;
         A46PaiCod = H00142_A46PaiCod[0] ;
         A286LocNom = H00142_A286LocNom[0] ;
         AV22GXLvl11 = (byte)(1) ;
         Form.setCaption( A286LocNom );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.localidadgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "LocalidadGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod),Short.valueOf(AV11ProvCod),Short.valueOf(AV12LocCod)});
   ...
   public void wb_table1_9_142( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_LocalidadView.htm");
         /* Div Control */
         ...
         wb_table1_9_142e( true) ;
      }
      else
      {
         wb_table1_9_142e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11ProvCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11ProvCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPROVCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11ProvCod), "ZZZ9")));
      AV12LocCod = ((Number) GXutil.testNumericType( getParm(obj,2), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12LocCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LocCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLOCCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LocCod), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020253768", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("localidadview.js", "?2024122020253768", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11ProvCod',fld:'vPROVCOD',pic:'ZZZ9',hsh:true},{av:'AV12LocCod',fld:'vLOCCOD',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00142_A48LocCod = new short[1] ;
      H00142_A47ProvCod = new short[1] ;
      H00142_A46PaiCod = new short[1] ;
      H00142_A286LocNom = new String[] {""} ;
      A286LocNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.localidadview__default(),
         new Object[] {
             new Object[] {
            H00142_A48LocCod, H00142_A47ProvCod, H00142_A46PaiCod, H00142_A286LocNom
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] H00142_A48LocCod ;
   private short[] H00142_A47ProvCod ;
   private short[] H00142_A46PaiCod ;
   private String[] H00142_A286LocNom ;
...
final  class localidadview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00142", "SELECT LocCod, ProvCod, PaiCod, LocNom FROM Localidad WHERE (PaiCod = ? and ProvCod = ? and LocCod = ?) AND (PaiCod = ? and ProvCod = ? and LocCod = ?) ORDER BY PaiCod, ProvCod, LocCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
