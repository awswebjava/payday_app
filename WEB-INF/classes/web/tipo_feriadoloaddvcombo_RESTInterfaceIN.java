...
@javax.xml.bind.annotation.XmlType(name = "tipo_feriadoloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class tipo_feriadoloaddvcombo_RESTInterfaceIN
{
   ...
   String AV19FerTipo;
   @JsonProperty("FerTipo")
   public String getFerTipo( )
   {
      if ( GXutil.strcmp(AV19FerTipo, null) == 0 )
      {
         return "" ;
      }
      else
   ...
   @JsonProperty("FerTipo")
   public void setFerTipo(  String Value )
   {
      if ( Value == null )
      {
         AV19FerTipo = "" ;
