...
public final  class esquemahorasextrasgeneral_impl extends GXWebComponent
{
   public esquemahorasextrasgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public esquemahorasextrasgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( esquemahorasextrasgeneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Esquema Horas Extras General", "")) ;
   ...
   public void renderHtmlCloseFormQB2( )
   {
   ...
   {
      return "EsquemaHorasExtrasGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Esquema Horas Extras General", "") ;
   }
   ...
   public void wbQB0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.esquemahorasextrasgeneral");
         }
         ...
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, dynPaiTipoTraId, dynPaiTipoTraId.getInternalname(), GXutil.rtrim( A1294PaiTipoTraId), 1, dynPaiTipoTraId.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, dynPaiTipoTraId.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_EsquemaHorasExtrasGeneral.htm");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveHsDia_Internalname, GXutil.ltrim( localUtil.ntoc( A1323ConveHsDia, (byte)(3), (byte)(1), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtConveHsDia_Enabled!=0) ? localUtil.format( A1323ConveHsDia, "9.9") : localUtil.format( A1323ConveHsDia, "9.9"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveHsDia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtConveHsDia_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_EsquemaHorasExtrasGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveHsSem_Internalname, GXutil.ltrim( localUtil.ntoc( A1324ConveHsSem, (byte)(4), (byte)(1), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtConveHsSem_Enabled!=0) ? localUtil.format( A1324ConveHsSem, "Z9.9") : localUtil.format( A1324ConveHsSem, "Z9.9"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveHsSem_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtConveHsSem_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_EsquemaHorasExtrasGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveHsMaxDia_Internalname, GXutil.ltrim( localUtil.ntoc( A1391ConveHsMaxDia, (byte)(3), (byte)(1), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtConveHsMaxDia_Enabled!=0) ? localUtil.format( A1391ConveHsMaxDia, "9.9") : localUtil.format( A1391ConveHsMaxDia, "9.9"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveHsMaxDia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtConveHsMaxDia_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_EsquemaHorasExtrasGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveHsMaxSem_Internalname, GXutil.ltrim( localUtil.ntoc( A1392ConveHsMaxSem, (byte)(4), (byte)(1), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtConveHsMaxSem_Enabled!=0) ? localUtil.format( A1392ConveHsMaxSem, "Z9.9") : localUtil.format( A1392ConveHsMaxSem, "Z9.9"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveHsMaxSem_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtConveHsMaxSem_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_EsquemaHorasExtrasGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11qb1_client"+"'", TempTags, "", 2, "HLP_EsquemaHorasExtrasGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12qb1_client"+"'", TempTags, "", 2, "HLP_EsquemaHorasExtrasGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startQB2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Esquema Horas Extras General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxdlapaitipotraidQB1( )
   {
      if ( ! httpContext.isAjaxRequest( ) )
      {
         httpContext.GX_webresponse.addHeader("Cache-Control", "no-store");
   ...
   public void gxapaitipotraid_htmlQB1( )
   {
   ...
   protected void gxdlapaitipotraid_dataQB1( )
   {
      ...
      {
         gxdynajaxctrlcodr.add(GXutil.rtrim( H00QB2_A1292TipoTraId[0]));
         gxdynajaxctrldescr.add(H00QB2_A1293TipoTraNom[0]);
   ...
   public void clear_multi_value_controls( )
   {
      if ( httpContext.isAjaxRequest( ) )
      {
         ...
         {
            dynPaiTipoTraId.addItem(H00QB3_A1292TipoTraId[0], H00QB3_A1293TipoTraNom[0], (short)(0));
   ...
   {
      /* GeneXus formulas. */
      AV21Pgmname = "EsquemaHorasExtrasGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void send_integrity_lvl_hashesQB2( )
   {
   }
   ...
   public void e13QB2( )
   {
      ...
      esquemahorasextrasgeneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV15CliCod = GXt_int1 ;
   ...
   protected void e14QB2( )
   {
      ...
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWEsquemaHorasExtras_Update", GXv_boolean5) ;
      esquemahorasextrasgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      ...
      GXt_boolean4 = AV14TempBoolean ;
      GXv_boolean5[0] = GXt_boolean4 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWEsquemaHorasExtras_Delete", GXv_boolean5) ;
      esquemahorasextrasgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      AV14TempBoolean = GXt_boolean4 ;
      if ( ! ( AV14TempBoolean ) )
      {
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "EsquemaHorasExtras" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "esquemahorasextrasgeneral", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181923178", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("esquemahorasextrasgeneral.js", "?2025181923178", false, true);
   ...
   public void init_web_controls( )
   {
      ...
      {
         dynPaiTipoTraId.addItem(H00QB5_A1292TipoTraId[0], H00QB5_A1293TipoTraNom[0], (short)(0));
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e11QB1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1564CliPaiConve',fld:'CLIPAICONVE',pic:'ZZZ9'},{av:'A1565CliConvenio',fld:'CLICONVENIO',pic:''},{av:'dynPaiTipoTraId'},{av:'A1294PaiTipoTraId',fld:'PAITIPOTRAID',pic:''}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12QB1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1564CliPaiConve',fld:'CLIPAICONVE',pic:'ZZZ9'},{av:'A1565CliConvenio',fld:'CLICONVENIO',pic:''},{av:'dynPaiTipoTraId'},{av:'A1294PaiTipoTraId',fld:'PAITIPOTRAID',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      gxwrpcisep = "" ;
      scmdbuf = "" ;
      H00QB2_A1292TipoTraId = new String[] {""} ;
      H00QB2_A1293TipoTraNom = new String[] {""} ;
      H00QB3_A1292TipoTraId = new String[] {""} ;
      H00QB3_A1293TipoTraNom = new String[] {""} ;
      AV21Pgmname = "" ;
      H00QB4_A3CliCod = new int[1] ;
      H00QB4_A1564CliPaiConve = new short[1] ;
      H00QB4_A1565CliConvenio = new String[] {""} ;
      H00QB4_A1294PaiTipoTraId = new String[] {""} ;
      H00QB4_A1394ConveHsMaxAnu = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00QB4_A1393ConveHsMaxMes = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00QB4_A1392ConveHsMaxSem = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00QB4_A1391ConveHsMaxDia = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00QB4_A1324ConveHsSem = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00QB4_A1323ConveHsDia = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      H00QB5_A1292TipoTraId = new String[] {""} ;
      H00QB5_A1293TipoTraNom = new String[] {""} ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.esquemahorasextrasgeneral__default(),
         new Object[] {
             new Object[] {
            H00QB2_A1292TipoTraId, H00QB2_A1293TipoTraNom
            }
            , new Object[] {
            H00QB3_A1292TipoTraId, H00QB3_A1293TipoTraNom
            }
            , new Object[] {
            H00QB4_A3CliCod, H00QB4_A1564CliPaiConve, H00QB4_A1565CliConvenio, H00QB4_A1294PaiTipoTraId, H00QB4_A1394ConveHsMaxAnu, H00QB4_A1393ConveHsMaxMes, H00QB4_A1392ConveHsMaxSem, H00QB4_A1391ConveHsMaxDia, H00QB4_A1324ConveHsSem, H00QB4_A1323ConveHsDia
            }
            , new Object[] {
            H00QB5_A1292TipoTraId, H00QB5_A1293TipoTraNom
            }
         }
      );
      AV21Pgmname = "EsquemaHorasExtrasGeneral" ;
   ...
   private String[] H00QB2_A1292TipoTraId ;
   private String[] H00QB2_A1293TipoTraNom ;
   private String[] H00QB3_A1292TipoTraId ;
   private String[] H00QB3_A1293TipoTraNom ;
   private int[] H00QB4_A3CliCod ;
   private short[] H00QB4_A1564CliPaiConve ;
   private String[] H00QB4_A1565CliConvenio ;
   private String[] H00QB4_A1294PaiTipoTraId ;
   private java.math.BigDecimal[] H00QB4_A1394ConveHsMaxAnu ;
   private java.math.BigDecimal[] H00QB4_A1393ConveHsMaxMes ;
   private java.math.BigDecimal[] H00QB4_A1392ConveHsMaxSem ;
   private java.math.BigDecimal[] H00QB4_A1391ConveHsMaxDia ;
   private java.math.BigDecimal[] H00QB4_A1324ConveHsSem ;
   private java.math.BigDecimal[] H00QB4_A1323ConveHsDia ;
   private String[] H00QB5_A1292TipoTraId ;
   private String[] H00QB5_A1293TipoTraNom ;
...
final  class esquemahorasextrasgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00QB2", "SELECT TipoTraId, TipoTraNom FROM TipoTrabajo ORDER BY TipoTraNom ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00QB3", "SELECT TipoTraId, TipoTraNom FROM TipoTrabajo ORDER BY TipoTraNom ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00QB4", "SELECT CliCod, CliPaiConve, CliConvenio, PaiTipoTraId, ConveHsMaxAnu, ConveHsMaxMes, ConveHsMaxSem, ConveHsMaxDia, ConveHsSem, ConveHsDia FROM convenio_tiposdetrabajo WHERE CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and PaiTipoTraId = ( ?) ORDER BY CliCod, CliPaiConve, CliConvenio, PaiTipoTraId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00QB5", "SELECT TipoTraId, TipoTraNom FROM TipoTrabajo ORDER BY TipoTraNom ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
      };
   }
