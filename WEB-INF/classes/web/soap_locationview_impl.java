...
public final  class soap_locationview_impl extends GXDataArea
{
   public soap_locationview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public soap_locationview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( soap_locationview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11SoapLocId = httpContext.GetPar( "SoapLocId") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11SoapLocId", AV11SoapLocId);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSOAPLOCID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11SoapLocId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.soap_locationview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11SoapLocId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","SoapLocId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vSOAPLOCID", GXutil.rtrim( AV11SoapLocId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSOAPLOCID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11SoapLocId, ""))));
   ...
   {
      return formatLink("web.soap_locationview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11SoapLocId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","SoapLocId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "soap_locationView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "soap_location View", "") ;
   }
   ...
   public void wbOS0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_OS2( true) ;
      }
      else
      {
         wb_table1_9_OS2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_OS2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startOS2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "soap_location View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesOS2( )
   {
   }
   ...
   public void strupOS0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11SoapLocId = httpContext.cgiGet( "vSOAPLOCID") ;
   ...
   public void e11OS2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00OS2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11SoapLocId, Integer.valueOf(AV10CliCod), AV11SoapLocId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A2162SoapLocId = H00OS2_A2162SoapLocId[0] ;
         A3CliCod = H00OS2_A3CliCod[0] ;
         A2163SoapLocHab = H00OS2_A2163SoapLocHab[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.booltostr( A2163SoapLocHab) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "soap_locationGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.soap_locationgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "soap_locationGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11SoapLocId});
   ...
   public void wb_table1_9_OS2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_soap_locationView.htm");
         /* Div Control */
         ...
         wb_table1_9_OS2e( true) ;
      }
      else
      {
         wb_table1_9_OS2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11SoapLocId = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11SoapLocId", AV11SoapLocId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSOAPLOCID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11SoapLocId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020402320", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("soap_locationview.js", "?2024122020402320", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "soap_location View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11SoapLocId',fld:'vSOAPLOCID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00OS2_A2162SoapLocId = new String[] {""} ;
      H00OS2_A3CliCod = new int[1] ;
      H00OS2_A2163SoapLocHab = new boolean[] {false} ;
      A2162SoapLocId = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.soap_locationview__default(),
         new Object[] {
             new Object[] {
            H00OS2_A2162SoapLocId, H00OS2_A3CliCod, H00OS2_A2163SoapLocHab
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11SoapLocId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11SoapLocId ;
   ...
   private String[] H00OS2_A2162SoapLocId ;
   private int[] H00OS2_A3CliCod ;
   private boolean[] H00OS2_A2163SoapLocHab ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class soap_locationview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00OS2", "SELECT SoapLocId, CliCod, SoapLocHab FROM soap_location WHERE (CliCod = ? and SoapLocId = ( ?)) AND (CliCod = ? and SoapLocId = ( ?)) ORDER BY CliCod, SoapLocId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
