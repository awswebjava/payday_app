...
public final  class legajo_permanenciaview_impl extends GXDataArea
{
   public legajo_permanenciaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public legajo_permanenciaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( legajo_permanenciaview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13LegHisFecIng = localUtil.parseDateParm( httpContext.GetPar( "LegHisFecIng")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13LegHisFecIng", localUtil.format(AV13LegHisFecIng, "99/99/9999"));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGHISFECING", getSecureSignedToken( "", AV13LegHisFecIng));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.legajo_permanenciaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.formatDateParm(AV13LegHisFecIng)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegHisFecIng","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGNUMERO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LegNumero), "ZZZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vLEGHISFECING", localUtil.dtoc( AV13LegHisFecIng, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGHISFECING", getSecureSignedToken( "", AV13LegHisFecIng));
   ...
   {
      return formatLink("web.legajo_permanenciaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.formatDateParm(AV13LegHisFecIng)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegHisFecIng","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "legajo_permanenciaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "legajo_permanencia View", "") ;
   }
   ...
   public void wbOZ0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_OZ2( true) ;
      }
      else
      {
         wb_table1_9_OZ2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_OZ2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startOZ2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "legajo_permanencia View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesOZ2( )
   {
   }
   ...
   public void strupOZ0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13LegHisFecIng = localUtil.ctod( httpContext.cgiGet( "vLEGHISFECING"), 0) ;
   ...
   public void e11OZ2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00OZ2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Integer.valueOf(AV12LegNumero), AV13LegHisFecIng, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Integer.valueOf(AV12LegNumero), AV13LegHisFecIng});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A2253LegHisFecIng = H00OZ2_A2253LegHisFecIng[0] ;
         A6LegNumero = H00OZ2_A6LegNumero[0] ;
         A1EmpCod = H00OZ2_A1EmpCod[0] ;
         A3CliCod = H00OZ2_A3CliCod[0] ;
         A2254LegHisFecEgr = H00OZ2_A2254LegHisFecEgr[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( localUtil.dtoc( A2254LegHisFecEgr, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/") );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "legajo_permanenciaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.legajo_permanenciageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "legajo_permanenciaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),Integer.valueOf(AV12LegNumero),AV13LegHisFecIng});
   ...
   public void wb_table1_9_OZ2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_legajo_permanenciaView.htm");
         /* Div Control */
         ...
         wb_table1_9_OZ2e( true) ;
      }
      else
      {
         wb_table1_9_OZ2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LegNumero), 8, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGNUMERO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LegNumero), "ZZZZZZZ9")));
      AV13LegHisFecIng = (java.util.Date)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13LegHisFecIng", localUtil.format(AV13LegHisFecIng, "99/99/9999"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGHISFECING", getSecureSignedToken( "", AV13LegHisFecIng));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020202025", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("legajo_permanenciaview.js", "?2024122020202025", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "legajo_permanencia View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9',hsh:true},{av:'AV13LegHisFecIng',fld:'vLEGHISFECING',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   {
      wcpOAV13LegHisFecIng = GXutil.nullDate() ;
      wcpOAV8TabCode = "" ;
      Tabs_Activepagecontrolname = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV13LegHisFecIng = GXutil.nullDate() ;
      AV8TabCode = "" ;
      ...
      scmdbuf = "" ;
      H00OZ2_A2253LegHisFecIng = new java.util.Date[] {GXutil.nullDate()} ;
      H00OZ2_A6LegNumero = new int[1] ;
      H00OZ2_A1EmpCod = new short[1] ;
      H00OZ2_A3CliCod = new int[1] ;
      H00OZ2_A2254LegHisFecEgr = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.legajo_permanenciaview__default(),
         new Object[] {
             new Object[] {
            H00OZ2_A2253LegHisFecIng, H00OZ2_A6LegNumero, H00OZ2_A1EmpCod, H00OZ2_A3CliCod, H00OZ2_A2254LegHisFecEgr
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private java.util.Date wcpOAV13LegHisFecIng ;
   private java.util.Date AV13LegHisFecIng ;
   ...
   private java.util.Date[] H00OZ2_A2253LegHisFecIng ;
   private int[] H00OZ2_A6LegNumero ;
   private short[] H00OZ2_A1EmpCod ;
   private int[] H00OZ2_A3CliCod ;
   private java.util.Date[] H00OZ2_A2254LegHisFecEgr ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class legajo_permanenciaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00OZ2", "SELECT LegHisFecIng, LegNumero, EmpCod, CliCod, LegHisFecEgr FROM legajo_permanencia WHERE (CliCod = ? and EmpCod = ? and LegNumero = ? and LegHisFecIng = ?) AND (CliCod = ? and EmpCod = ? and LegNumero = ? and LegHisFecIng = ?) ORDER BY CliCod, EmpCod, LegNumero, LegHisFecIng ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
