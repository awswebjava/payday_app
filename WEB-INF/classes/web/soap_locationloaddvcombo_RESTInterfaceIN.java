...
@javax.xml.bind.annotation.XmlType(name = "soap_locationloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class soap_locationloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("SoapLocId")
   public String getSoapLocId( )
   {
      if ( GXutil.strcmp(AV19SoapLocId, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV19SoapLocId ;
      }
   }

   @JsonProperty("SoapLocId")
   public void setSoapLocId(  String Value )
   {
      if ( Value == null )
      {
         AV19SoapLocId = "" ;
