...
@javax.xml.bind.annotation.XmlType(name = "variablevaloresloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class variablevaloresloaddvcombo_RESTInterfaceIN
{
   ...
   String AV19OpeCliId;
   @JsonProperty("OpeCliId")
   public String getOpeCliId( )
   {
      if ( GXutil.strcmp(AV19OpeCliId, null) == 0 )
      {
         return "" ;
      }
      else
   ...
   String AV20OpeCliVig;
   @JsonProperty("OpeCliVig")
   public String getOpeCliVig( )
   {
      return AV20OpeCliVig ;
   }

   @JsonProperty("OpeCliVig")
   public void setOpeCliVig(  String Value )
   {
      AV20OpeCliVig= Value;
   }
