...
public final  class licenciaswc_impl extends GXWebComponent
{
   public licenciaswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public licenciaswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( licenciaswc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV25TFLegLicenIni = localUtil.parseDateParm( httpContext.GetPar( "TFLegLicenIni")) ;
      AV26TFLegLicenIni_To = localUtil.parseDateParm( httpContext.GetPar( "TFLegLicenIni_To")) ;
      AV30TFLegLicenFin = localUtil.parseDateParm( httpContext.GetPar( "TFLegLicenFin")) ;
      AV31TFLegLicenFin_To = localUtil.parseDateParm( httpContext.GetPar( "TFLegLicenFin_To")) ;
      AV36TFLegLicDescrip = httpContext.GetPar( "TFLegLicDescrip") ;
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV37TFLegLicDescrip_Sels);
      sPrefix = httpContext.GetPar( "sPrefix") ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9EmpCod, AV11LegNumero, AV22ColumnsSelector, AV46Pgmname, AV17OrderedBy, AV18OrderedDsc, AV25TFLegLicenIni, AV26TFLegLicenIni_To, AV30TFLegLicenFin, AV31TFLegLicenFin_To, AV36TFLegLicDescrip, AV37TFLegLicDescrip_Sels, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "licencias WC", "")) ;
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV46Pgmname, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV41GridCurrentPage, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV42GridPageCount, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vGRIDAPPLIEDFILTERS", AV43GridAppliedFilters);
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDDO_LEGLICENINIAUXDATE", localUtil.dtoc( AV27DDO_LegLicenIniAuxDate, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDDO_LEGLICENINIAUXDATETO", localUtil.dtoc( AV28DDO_LegLicenIniAuxDateTo, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDDO_LEGLICENFINAUXDATE", localUtil.dtoc( AV32DDO_LegLicenFinAuxDate, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDDO_LEGLICENFINAUXDATETO", localUtil.dtoc( AV33DDO_LegLicenFinAuxDateTo, 0, "/"));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV46Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV46Pgmname, ""))));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTFLEGLICENINI", localUtil.dtoc( AV25TFLegLicenIni, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTFLEGLICENINI_TO", localUtil.dtoc( AV26TFLegLicenIni_To, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTFLEGLICENFIN", localUtil.dtoc( AV30TFLegLicenFin, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTFLEGLICENFIN_TO", localUtil.dtoc( AV31TFLegLicenFin_To, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTFLEGLICDESCRIP", AV36TFLegLicDescrip);
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vTFLEGLICDESCRIP_SELS", AV37TFLegLicDescrip_Sels);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vTFLEGLICDESCRIP_SELS", AV37TFLegLicDescrip_Sels);
      }
   ...
   public void renderHtmlCloseFormJX2( )
   {
   ...
   {
      return httpContext.getMessage( "licencias WC", "") ;
   }
   ...
   public void wbJX0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.licenciaswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Vacaciones, licencias, faltas y llegadas tardes", ""), "", "", lblTextblocktitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP ML10", 0, "", 1, 1, 0, (short)(0), "HLP_licenciasWC.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
         /* Div Control */
         ...
         wb_table1_21_JX2( true) ;
      }
      else
      {
         wb_table1_21_JX2( false) ;
      }
      return  ;
   }

   public void wb_table1_21_JX2e( boolean wbgen )
   {
      if ( wbgen )
      {
      ...
      if ( wbEnd == 30 )
      {
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavDdo_legliceniniauxdatetext_Internalname, AV29DDO_LegLicenIniAuxDateText, GXutil.rtrim( localUtil.format( AV29DDO_LegLicenIniAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,48);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_legliceniniauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_licenciasWC.htm");
         /* User Defined Control */
         ucTfleglicenini_rangepicker.setProperty("Start Date", AV27DDO_LegLicenIniAuxDate);
         ucTfleglicenini_rangepicker.setProperty("End Date", AV28DDO_LegLicenIniAuxDateTo);
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavDdo_leglicenfinauxdatetext_Internalname, AV34DDO_LegLicenFinAuxDateText, GXutil.rtrim( localUtil.format( AV34DDO_LegLicenFinAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_leglicenfinauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_licenciasWC.htm");
         /* User Defined Control */
         ucTfleglicenfin_rangepicker.setProperty("Start Date", AV32DDO_LegLicenFinAuxDate);
         ucTfleglicenfin_rangepicker.setProperty("End Date", AV33DDO_LegLicenFinAuxDateTo);
   ...
   public void startJX2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "licencias WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 java.util.Date AV25TFLegLicenIni ,
                                 java.util.Date AV26TFLegLicenIni_To ,
                                 java.util.Date AV30TFLegLicenFin ,
                                 java.util.Date AV31TFLegLicenFin_To ,
                                 String AV36TFLegLicDescrip ,
                                 GXSimpleCollection<String> AV37TFLegLicDescrip_Sels ,
                                 String sPrefix )
   {
      initialize_formulas( ) ;
      web.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void rfJX2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A914LegLicDescrip ,
                                              AV37TFLegLicDescrip_Sels ,
                                              AV25TFLegLicenIni ,
                                              AV26TFLegLicenIni_To ,
                                              AV30TFLegLicenFin ,
                                              AV31TFLegLicenFin_To ,
                                              Integer.valueOf(AV37TFLegLicDescrip_Sels.size()) ,
                                              AV36TFLegLicDescrip ,
                                              A76LegLicenIni ,
                                              A481LegLicenFin ,
         ...
         lV36TFLegLicDescrip = GXutil.concat( GXutil.rtrim( AV36TFLegLicDescrip), "%", "") ;
         /* Using cursor H00JX2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV11LegNumero), AV25TFLegLicenIni, AV26TFLegLicenIni_To, AV30TFLegLicenFin, AV31TFLegLicenFin_To, lV36TFLegLicDescrip, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_30_idx = 1 ;
         sGXsfl_30_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_30_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_302( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A6LegNumero = H00JX2_A6LegNumero[0] ;
            A1EmpCod = H00JX2_A1EmpCod[0] ;
            A3CliCod = H00JX2_A3CliCod[0] ;
            A517LegLicSitDescrip = H00JX2_A517LegLicSitDescrip[0] ;
            A914LegLicDescrip = H00JX2_A914LegLicDescrip[0] ;
            A76LegLicenIni = H00JX2_A76LegLicenIni[0] ;
            A481LegLicenFin = H00JX2_A481LegLicenFin[0] ;
   ...
   public void send_integrity_lvl_hashesJX2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV46Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV46Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV36TFLegLicDescrip = GXutil.concat( GXutil.rtrim( AV36TFLegLicDescrip), "%", "") ;
      /* Using cursor H00JX3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV11LegNumero), AV25TFLegLicenIni, AV26TFLegLicenIni_To, AV30TFLegLicenFin, AV31TFLegLicenFin_To, lV36TFLegLicDescrip});
      GRID_nRecordCount = H00JX3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strupJX0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         AV43GridAppliedFilters = httpContext.cgiGet( sPrefix+"vGRIDAPPLIEDFILTERS") ;
         AV27DDO_LegLicenIniAuxDate = localUtil.ctod( httpContext.cgiGet( sPrefix+"vDDO_LEGLICENINIAUXDATE"), 0) ;
         AV28DDO_LegLicenIniAuxDateTo = localUtil.ctod( httpContext.cgiGet( sPrefix+"vDDO_LEGLICENINIAUXDATETO"), 0) ;
         AV32DDO_LegLicenFinAuxDate = localUtil.ctod( httpContext.cgiGet( sPrefix+"vDDO_LEGLICENFINAUXDATE"), 0) ;
         AV33DDO_LegLicenFinAuxDateTo = localUtil.ctod( httpContext.cgiGet( sPrefix+"vDDO_LEGLICENFINAUXDATETO"), 0) ;
         ...
         AV29DDO_LegLicenIniAuxDateText = httpContext.cgiGet( edtavDdo_legliceniniauxdatetext_Internalname) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV29DDO_LegLicenIniAuxDateText", AV29DDO_LegLicenIniAuxDateText);
         AV34DDO_LegLicenFinAuxDateText = httpContext.cgiGet( edtavDdo_leglicenfinauxdatetext_Internalname) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV34DDO_LegLicenFinAuxDateText", AV34DDO_LegLicenFinAuxDateText);
   ...
   public void e15JX2( )
   {
      ...
      licenciaswc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      ...
      GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 = AV38DDO_TitleSettingsIcons;
      GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4[0] = GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3;
      new web.wwpbaseobjects.getwwptitlesettingsicons(remoteHandle, context).execute( GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4) ;
      GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 = GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4[0] ;
      AV38DDO_TitleSettingsIcons = GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3;
   ...
   public void e16JX2( )
   {
      ...
      S142 ();
      if (returnInSub) return;
      if ( GXutil.strcmp(AV24Session.getValue("licenciasWCColumnsSelector"), "") != 0 )
      {
         AV20ColumnsSelectorXML = AV24Session.getValue("licenciasWCColumnsSelector") ;
      ...
      edtLegLicenIni_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV22ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+1)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      edtLegLicenFin_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV22ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+2)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      edtLegLicCntDias_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV22ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+3)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      edtLegLicDescrip_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV22ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+4)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      GXt_char6 = AV43GridAppliedFilters ;
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV46Pgmname, GXv_char7) ;
      licenciaswc_impl.this.GXt_char6 = GXv_char7[0] ;
      AV43GridAppliedFilters = GXt_char6 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV43GridAppliedFilters", AV43GridAppliedFilters);
   ...
   public void e14JX2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
      {
         ...
         {
            AV25TFLegLicenIni = localUtil.ctod( Ddo_grid_Filteredtext_get, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV25TFLegLicenIni", localUtil.format(AV25TFLegLicenIni, "99/99/99"));
            AV26TFLegLicenIni_To = localUtil.ctod( Ddo_grid_Filteredtextto_get, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV26TFLegLicenIni_To", localUtil.format(AV26TFLegLicenIni_To, "99/99/99"));
         }
         else if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "LegLicenFin") == 0 )
         {
            AV30TFLegLicenFin = localUtil.ctod( Ddo_grid_Filteredtext_get, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV30TFLegLicenFin", localUtil.format(AV30TFLegLicenFin, "99/99/99"));
            AV31TFLegLicenFin_To = localUtil.ctod( Ddo_grid_Filteredtextto_get, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV31TFLegLicenFin_To", localUtil.format(AV31TFLegLicenFin_To, "99/99/99"));
         }
         else if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "LegLicDescrip") == 0 )
         {
            AV36TFLegLicDescrip = Ddo_grid_Filteredtext_get ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV36TFLegLicDescrip", AV36TFLegLicDescrip);
            AV35TFLegLicDescrip_SelsJson = Ddo_grid_Selectedvalue_get ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV35TFLegLicDescrip_SelsJson", AV35TFLegLicDescrip_SelsJson);
            AV37TFLegLicDescrip_Sels.fromJSonString(AV35TFLegLicDescrip_SelsJson, null);
         }
         subgrid_firstpage( ) ;
      }
      /*  Sending Event outputs  */
      httpContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV37TFLegLicDescrip_Sels", AV37TFLegLicDescrip_Sels);
   }
   ...
   public void e11JX2( )
   {
      ...
      new web.wwpbaseobjects.savecolumnsselectorstate(remoteHandle, context).execute( "licenciasWCColumnsSelector", ((GXutil.strcmp("", AV20ColumnsSelectorXML)==0) ? "" : AV22ColumnsSelector.toxml(false, true, "WWPColumnsSelector", "PayDay"))) ;
   ...
   public void S152( )
   {
      ...
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.loadcolumnsselectorstate(remoteHandle, context).execute( "licenciasWCColumnsSelector", GXv_char7) ;
      licenciaswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV24Session.getValue(AV46Pgmname+"GridState"), "") == 0 )
      {
         AV15GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV46Pgmname+"GridState"), null, null);
      }
      else
      {
         AV15GridState.fromxml(AV24Session.getValue(AV46Pgmname+"GridState"), null, null);
      }
      ...
      if (returnInSub) return;
      AV47GXV1 = 1 ;
      while ( AV47GXV1 <= AV15GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV16GridStateFilterValue = (web.wwpbaseobjects.SdtWWPGridState_FilterValue)((web.wwpbaseobjects.SdtWWPGridState_FilterValue)AV15GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV47GXV1));
         if ( GXutil.strcmp(AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFLEGLICENINI") == 0 )
         {
            AV25TFLegLicenIni = localUtil.ctod( AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value(), localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV25TFLegLicenIni", localUtil.format(AV25TFLegLicenIni, "99/99/99"));
            AV26TFLegLicenIni_To = localUtil.ctod( AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Valueto(), localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV26TFLegLicenIni_To", localUtil.format(AV26TFLegLicenIni_To, "99/99/99"));
         }
         else if ( GXutil.strcmp(AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFLEGLICENFIN") == 0 )
         {
            AV30TFLegLicenFin = localUtil.ctod( AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value(), localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV30TFLegLicenFin", localUtil.format(AV30TFLegLicenFin, "99/99/99"));
            AV31TFLegLicenFin_To = localUtil.ctod( AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Valueto(), localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV31TFLegLicenFin_To", localUtil.format(AV31TFLegLicenFin_To, "99/99/99"));
         }
         else if ( GXutil.strcmp(AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFLEGLICDESCRIP") == 0 )
         {
            AV36TFLegLicDescrip = AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV36TFLegLicDescrip", AV36TFLegLicDescrip);
         }
         else if ( GXutil.strcmp(AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFLEGLICDESCRIP_SEL") == 0 )
         {
            AV35TFLegLicDescrip_SelsJson = AV16GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV35TFLegLicDescrip_SelsJson", AV35TFLegLicDescrip_SelsJson);
            AV37TFLegLicDescrip_Sels.fromJSonString(AV35TFLegLicDescrip_SelsJson, null);
         }
      ...
      GXt_char6 = "" ;
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (AV37TFLegLicDescrip_Sels.size()==0), AV35TFLegLicDescrip_SelsJson, GXv_char7) ;
      licenciaswc_impl.this.GXt_char6 = GXv_char7[0] ;
      Ddo_grid_Selectedvalue_set = "|||"+GXt_char6 ;
      ucDdo_grid.sendProperty(context, sPrefix, false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
      GXt_char6 = "" ;
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (GXutil.strcmp("", AV36TFLegLicDescrip)==0), AV36TFLegLicDescrip, GXv_char7) ;
      licenciaswc_impl.this.GXt_char6 = GXv_char7[0] ;
      Ddo_grid_Filteredtext_set = (GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV25TFLegLicenIni)) ? "" : localUtil.dtoc( AV25TFLegLicenIni, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/"))+"|"+(GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV30TFLegLicenFin)) ? "" : localUtil.dtoc( AV30TFLegLicenFin, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/"))+"||"+GXt_char6 ;
      ucDdo_grid.sendProperty(context, sPrefix, false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
      Ddo_grid_Filteredtextto_set = (GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV26TFLegLicenIni_To)) ? "" : localUtil.dtoc( AV26TFLegLicenIni_To, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/"))+"|"+(GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV31TFLegLicenFin_To)) ? "" : localUtil.dtoc( AV31TFLegLicenFin_To, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/"))+"||" ;
   ...
   public void S142( )
   {
      ...
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState10, "TFLEGLICENINI", httpContext.getMessage( "Inicio", ""), !(GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV25TFLegLicenIni))&&GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV26TFLegLicenIni_To))), (short)(0), GXutil.trim( localUtil.dtoc( AV25TFLegLicenIni, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/")), GXutil.trim( localUtil.dtoc( AV26TFLegLicenIni_To, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/"))) ;
      AV15GridState = GXv_SdtWWPGridState10[0] ;
      GXv_SdtWWPGridState10[0] = AV15GridState;
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState10, "TFLEGLICENFIN", httpContext.getMessage( "Fin", ""), !(GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV30TFLegLicenFin))&&GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV31TFLegLicenFin_To))), (short)(0), GXutil.trim( localUtil.dtoc( AV30TFLegLicenFin, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/")), GXutil.trim( localUtil.dtoc( AV31TFLegLicenFin_To, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/"))) ;
      AV15GridState = GXv_SdtWWPGridState10[0] ;
      GXv_SdtWWPGridState10[0] = AV15GridState;
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState10, "TFLEGLICDESCRIP", httpContext.getMessage( "Situación", ""), !(GXutil.strcmp("", AV36TFLegLicDescrip)==0), (short)(0), AV36TFLegLicDescrip, "", !(AV37TFLegLicDescrip_Sels.size()==0), AV37TFLegLicDescrip_Sels.toJSonString(false), "") ;
      AV15GridState = GXv_SdtWWPGridState10[0] ;
      if ( ! (0==AV8CliCod) )
      {
      ...
      new web.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV46Pgmname+"GridState", AV15GridState.toxml(false, true, "WWPGridState", "PayDay")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV13TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV46Pgmname );
      ...
      AV13TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "LegajoLicencias" );
   ...
   public void wb_table1_21_JX2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_21_JX2e( true) ;
      }
      else
      {
         wb_table1_21_JX2e( false) ;
      }
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "licenciaswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025139463064", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("licenciaswc.js", "?2025139463064", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Datalistproc = "licenciasWCGetFilterData" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'sPrefix'},{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV25TFLegLicenIni',fld:'vTFLEGLICENINI',pic:''},{av:'AV26TFLegLicenIni_To',fld:'vTFLEGLICENINI_TO',pic:''},{av:'AV30TFLegLicenFin',fld:'vTFLEGLICENFIN',pic:''},{av:'AV31TFLegLicenFin_To',fld:'vTFLEGLICENFIN_TO',pic:''},{av:'AV36TFLegLicDescrip',fld:'vTFLEGLICDESCRIP',pic:''},{av:'AV37TFLegLicDescrip_Sels',fld:'vTFLEGLICDESCRIP_SELS',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtLegLicenIni_Visible',ctrl:'LEGLICENINI',prop:'Visible'},{av:'edtLegLicenFin_Visible',ctrl:'LEGLICENFIN',prop:'Visible'},{av:'edtLegLicCntDias_Visible',ctrl:'LEGLICCNTDIAS',prop:'Visible'},{av:'edtLegLicDescrip_Visible',ctrl:'LEGLICDESCRIP',prop:'Visible'},{av:'AV41GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV42GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV43GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e12JX2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV25TFLegLicenIni',fld:'vTFLEGLICENINI',pic:''},{av:'AV26TFLegLicenIni_To',fld:'vTFLEGLICENINI_TO',pic:''},{av:'AV30TFLegLicenFin',fld:'vTFLEGLICENFIN',pic:''},{av:'AV31TFLegLicenFin_To',fld:'vTFLEGLICENFIN_TO',pic:''},{av:'AV36TFLegLicDescrip',fld:'vTFLEGLICDESCRIP',pic:''},{av:'AV37TFLegLicDescrip_Sels',fld:'vTFLEGLICDESCRIP_SELS',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e13JX2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV25TFLegLicenIni',fld:'vTFLEGLICENINI',pic:''},{av:'AV26TFLegLicenIni_To',fld:'vTFLEGLICENINI_TO',pic:''},{av:'AV30TFLegLicenFin',fld:'vTFLEGLICENFIN',pic:''},{av:'AV31TFLegLicenFin_To',fld:'vTFLEGLICENFIN_TO',pic:''},{av:'AV36TFLegLicDescrip',fld:'vTFLEGLICDESCRIP',pic:''},{av:'AV37TFLegLicDescrip_Sels',fld:'vTFLEGLICDESCRIP_SELS',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e14JX2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV25TFLegLicenIni',fld:'vTFLEGLICENINI',pic:''},{av:'AV26TFLegLicenIni_To',fld:'vTFLEGLICENINI_TO',pic:''},{av:'AV30TFLegLicenFin',fld:'vTFLEGLICENFIN',pic:''},{av:'AV31TFLegLicenFin_To',fld:'vTFLEGLICENFIN_TO',pic:''},{av:'AV36TFLegLicDescrip',fld:'vTFLEGLICDESCRIP',pic:''},{av:'AV37TFLegLicDescrip_Sels',fld:'vTFLEGLICDESCRIP_SELS',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'},{av:'Ddo_grid_Filteredtextto_get',ctrl:'DDO_GRID',prop:'FilteredTextTo_get'}]");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV25TFLegLicenIni',fld:'vTFLEGLICENINI',pic:''},{av:'AV26TFLegLicenIni_To',fld:'vTFLEGLICENINI_TO',pic:''},{av:'AV30TFLegLicenFin',fld:'vTFLEGLICENFIN',pic:''},{av:'AV31TFLegLicenFin_To',fld:'vTFLEGLICENFIN_TO',pic:''},{av:'AV36TFLegLicDescrip',fld:'vTFLEGLICDESCRIP',pic:''},{av:'AV35TFLegLicDescrip_SelsJson',fld:'vTFLEGLICDESCRIP_SELSJSON',pic:''},{av:'AV37TFLegLicDescrip_Sels',fld:'vTFLEGLICDESCRIP_SELS',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e17JX2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[]}");
      setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'e11JX2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV25TFLegLicenIni',fld:'vTFLEGLICENINI',pic:''},{av:'AV26TFLegLicenIni_To',fld:'vTFLEGLICENINI_TO',pic:''},{av:'AV30TFLegLicenFin',fld:'vTFLEGLICENFIN',pic:''},{av:'AV31TFLegLicenFin_To',fld:'vTFLEGLICENFIN_TO',pic:''},{av:'AV36TFLegLicDescrip',fld:'vTFLEGLICDESCRIP',pic:''},{av:'AV37TFLegLicDescrip_Sels',fld:'vTFLEGLICDESCRIP_SELS',pic:''},{av:'sPrefix'},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
      setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV22ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'edtLegLicenIni_Visible',ctrl:'LEGLICENINI',prop:'Visible'},{av:'edtLegLicenFin_Visible',ctrl:'LEGLICENFIN',prop:'Visible'},{av:'edtLegLicCntDias_Visible',ctrl:'LEGLICCNTDIAS',prop:'Visible'},{av:'edtLegLicDescrip_Visible',ctrl:'LEGLICDESCRIP',prop:'Visible'},{av:'AV41GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV42GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV43GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
   ...
   public void initialize( )
   {
      ...
      AV46Pgmname = "" ;
      AV25TFLegLicenIni = GXutil.nullDate() ;
      AV26TFLegLicenIni_To = GXutil.nullDate() ;
      AV30TFLegLicenFin = GXutil.nullDate() ;
      AV31TFLegLicenFin_To = GXutil.nullDate() ;
      AV36TFLegLicDescrip = "" ;
      AV37TFLegLicDescrip_Sels = new GXSimpleCollection<String>(String.class, "internal", "");
      Form = new com.genexus.webpanels.GXWebForm();
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      GXKey = "" ;
      AV38DDO_TitleSettingsIcons = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      AV43GridAppliedFilters = "" ;
      AV27DDO_LegLicenIniAuxDate = GXutil.nullDate() ;
      AV28DDO_LegLicenIniAuxDateTo = GXutil.nullDate() ;
      AV32DDO_LegLicenFinAuxDate = GXutil.nullDate() ;
      AV33DDO_LegLicenFinAuxDateTo = GXutil.nullDate() ;
      ...
      AV34DDO_LegLicenFinAuxDateText = "" ;
      ...
      scmdbuf = "" ;
      lV36TFLegLicDescrip = "" ;
      H00JX2_A6LegNumero = new int[1] ;
      H00JX2_A1EmpCod = new short[1] ;
      H00JX2_A3CliCod = new int[1] ;
      H00JX2_A517LegLicSitDescrip = new String[] {""} ;
      H00JX2_A914LegLicDescrip = new String[] {""} ;
      H00JX2_A76LegLicenIni = new java.util.Date[] {GXutil.nullDate()} ;
      H00JX2_A481LegLicenFin = new java.util.Date[] {GXutil.nullDate()} ;
      H00JX3_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.licenciaswc__default(),
         new Object[] {
             new Object[] {
            H00JX2_A6LegNumero, H00JX2_A1EmpCod, H00JX2_A3CliCod, H00JX2_A517LegLicSitDescrip, H00JX2_A914LegLicDescrip, H00JX2_A76LegLicenIni, H00JX2_A481LegLicenFin
            }
            , new Object[] {
            H00JX3_AGRID_nRecordCount
            }
         }
      );
      AV46Pgmname = "licenciasWC" ;
   ...
   private int AV37TFLegLicDescrip_Sels_size ;
   ...
   private java.util.Date AV25TFLegLicenIni ;
   private java.util.Date AV26TFLegLicenIni_To ;
   private java.util.Date AV30TFLegLicenFin ;
   private java.util.Date AV31TFLegLicenFin_To ;
   private java.util.Date AV27DDO_LegLicenIniAuxDate ;
   private java.util.Date AV28DDO_LegLicenIniAuxDateTo ;
   private java.util.Date AV32DDO_LegLicenFinAuxDate ;
   private java.util.Date AV33DDO_LegLicenFinAuxDateTo ;
   ...
   private String AV35TFLegLicDescrip_SelsJson ;
   private String AV21UserCustomValue ;
   private String AV36TFLegLicDescrip ;
   private String AV43GridAppliedFilters ;
   private String AV29DDO_LegLicenIniAuxDateText ;
   private String AV34DDO_LegLicenFinAuxDateText ;
   private String A914LegLicDescrip ;
   private String A517LegLicSitDescrip ;
   private String lV36TFLegLicDescrip ;
   ...
   private int[] H00JX2_A6LegNumero ;
   private short[] H00JX2_A1EmpCod ;
   private int[] H00JX2_A3CliCod ;
   private String[] H00JX2_A517LegLicSitDescrip ;
   private String[] H00JX2_A914LegLicDescrip ;
   private java.util.Date[] H00JX2_A76LegLicenIni ;
   private java.util.Date[] H00JX2_A481LegLicenFin ;
   private long[] H00JX3_AGRID_nRecordCount ;
   private GXSimpleCollection<String> AV37TFLegLicDescrip_Sels ;
   ...
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV38DDO_TitleSettingsIcons ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4[] ;
}

final  class licenciaswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00JX2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          java.util.Date AV30TFLegLicenFin ,
                                          java.util.Date AV31TFLegLicenFin_To ,
                                          int AV37TFLegLicDescrip_Sels_size ,
                                          String AV36TFLegLicDescrip ,
                                          ...
                                          int A6LegNumero )
   {
      ...
      if ( ! GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV25TFLegLicenIni)) )
      {
      ...
      if ( ! GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV26TFLegLicenIni_To)) )
      {
         addWhere(sWhereString, "(LegLicenIni <= ?)");
      }
      else
      ...
      if ( ! GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV30TFLegLicenFin)) )
      {
      ...
      if ( ! GXutil.dateCompare(GXutil.resetTime(GXutil.nullDate()), GXutil.resetTime(AV31TFLegLicenFin_To)) )
      {
         addWhere(sWhereString, "(LegLicenFin <= ?)");
      }
      else
      ...
      if ( ( AV37TFLegLicDescrip_Sels_size == 0 ) && ( ! (GXutil.strcmp("", AV36TFLegLicDescrip)==0) ) )
      {
      ...
      if ( AV37TFLegLicDescrip_Sels_size > 0 )
      {
         addWhere(sWhereString, "("+GXutil.toValueList("postgresql", AV37TFLegLicDescrip_Sels, "LegLicDescrip IN (", ")")+")");
      }
      if ( AV17OrderedBy == 1 )
      {
   ...
   protected Object[] conditional_H00JX3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String A914LegLicDescrip ,
                                          GXSimpleCollection<String> AV37TFLegLicDescrip_Sels ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00JX2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , (java.util.Date)dynConstraints[2] , (java.util.Date)dynConstraints[3] , (java.util.Date)dynConstraints[4] , (java.util.Date)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , (String)dynConstraints[7] , (java.util.Date)dynConstraints[8] , (java.util.Date)dynConstraints[9] , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).intValue() , ((Number) dynConstraints[13]).shortValue() , ((Number) dynConstraints[14]).intValue() , ((Number) dynConstraints[15]).intValue() , ((Number) dynConstraints[16]).shortValue() , ((Number) dynConstraints[17]).intValue() );
            case 1 :
                  return conditional_H00JX3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , (java.util.Date)dynConstraints[2] , (java.util.Date)dynConstraints[3] , (java.util.Date)dynConstraints[4] , (java.util.Date)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , (String)dynConstraints[7] , (java.util.Date)dynConstraints[8] , (java.util.Date)dynConstraints[9] , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).intValue() , ((Number) dynConstraints[13]).shortValue() , ((Number) dynConstraints[14]).intValue() , ((Number) dynConstraints[15]).intValue() , ((Number) dynConstraints[16]).shortValue() , ((Number) dynConstraints[17]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00JX2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00JX3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
