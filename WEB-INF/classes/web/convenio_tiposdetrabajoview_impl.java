...
public final  class convenio_tiposdetrabajoview_impl extends GXDataArea
{
   public convenio_tiposdetrabajoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_tiposdetrabajoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_tiposdetrabajoview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13PaiTipoTraId = httpContext.GetPar( "PaiTipoTraId") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13PaiTipoTraId", AV13PaiTipoTraId);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13PaiTipoTraId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_tiposdetrabajoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","PaiTipoTraId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vPAITIPOTRAID", GXutil.rtrim( AV13PaiTipoTraId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13PaiTipoTraId, ""))));
   ...
   {
      return formatLink("web.convenio_tiposdetrabajoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","PaiTipoTraId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "convenio_tiposdetrabajoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "convenio_tiposdetrabajo View", "") ;
   }
   ...
   public void wbFB0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_FB2( true) ;
      }
      else
      {
         wb_table1_9_FB2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_FB2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startFB2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "convenio_tiposdetrabajo View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesFB2( )
   {
   }
   ...
   public void strupFB0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13PaiTipoTraId = httpContext.cgiGet( "vPAITIPOTRAID") ;
   ...
   public void e11FB2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00FB2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13PaiTipoTraId, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13PaiTipoTraId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1294PaiTipoTraId = H00FB2_A1294PaiTipoTraId[0] ;
         A1565CliConvenio = H00FB2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00FB2_A1564CliPaiConve[0] ;
         A3CliCod = H00FB2_A3CliCod[0] ;
         A1323ConveHsDia = H00FB2_A1323ConveHsDia[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1323ConveHsDia, 3, 1) );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "convenio_tiposdetrabajoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.convenio_tiposdetrabajogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "convenio_tiposdetrabajoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13PaiTipoTraId});
   ...
   public void wb_table1_9_FB2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_convenio_tiposdetrabajoView.htm");
         /* Div Control */
         ...
         wb_table1_9_FB2e( true) ;
      }
      else
      {
         wb_table1_9_FB2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliConvenio", AV12CliConvenio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      AV13PaiTipoTraId = (String)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13PaiTipoTraId", AV13PaiTipoTraId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13PaiTipoTraId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713343052", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("convenio_tiposdetrabajoview.js", "?20251713343052", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "convenio_tiposdetrabajo View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13PaiTipoTraId',fld:'vPAITIPOTRAID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00FB2_A1294PaiTipoTraId = new String[] {""} ;
      H00FB2_A1565CliConvenio = new String[] {""} ;
      H00FB2_A1564CliPaiConve = new short[1] ;
      H00FB2_A3CliCod = new int[1] ;
      H00FB2_A1323ConveHsDia = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      A1294PaiTipoTraId = "" ;
      A1565CliConvenio = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_tiposdetrabajoview__default(),
         new Object[] {
             new Object[] {
            H00FB2_A1294PaiTipoTraId, H00FB2_A1565CliConvenio, H00FB2_A1564CliPaiConve, H00FB2_A3CliCod, H00FB2_A1323ConveHsDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV13PaiTipoTraId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12CliConvenio ;
   private String AV13PaiTipoTraId ;
   ...
   private String[] H00FB2_A1294PaiTipoTraId ;
   private String[] H00FB2_A1565CliConvenio ;
   private short[] H00FB2_A1564CliPaiConve ;
   private int[] H00FB2_A3CliCod ;
   private java.math.BigDecimal[] H00FB2_A1323ConveHsDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class convenio_tiposdetrabajoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00FB2", "SELECT PaiTipoTraId, CliConvenio, CliPaiConve, CliCod, ConveHsDia FROM convenio_tiposdetrabajo WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and PaiTipoTraId = ( ?)) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and PaiTipoTraId = ( ?)) ORDER BY CliCod, CliPaiConve, CliConvenio, PaiTipoTraId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
