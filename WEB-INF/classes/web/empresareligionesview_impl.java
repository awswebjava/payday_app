...
public final  class empresareligionesview_impl extends GXDataArea
{
   public empresareligionesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresareligionesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresareligionesview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12EmpReligion = httpContext.GetPar( "EmpReligion") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12EmpReligion", AV12EmpReligion);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPRELIGION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpReligion, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.empresareligionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12EmpReligion)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpReligion","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vEMPRELIGION", GXutil.rtrim( AV12EmpReligion));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPRELIGION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpReligion, ""))));
   ...
   {
      return formatLink("web.empresareligionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12EmpReligion)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpReligion","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EmpresaReligionesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Empresa Religiones View", "") ;
   }
   ...
   public void wbD30( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_D32( true) ;
      }
      else
      {
         wb_table1_9_D32( false) ;
      }
      return  ;
   }

   public void wb_table1_9_D32e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startD32( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Empresa Religiones View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupD30( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12EmpReligion = httpContext.cgiGet( "vEMPRELIGION") ;
   ...
   public void e11D32( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00D32 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12EmpReligion, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12EmpReligion});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1237EmpReligion = H00D32_A1237EmpReligion[0] ;
         A1EmpCod = H00D32_A1EmpCod[0] ;
         A3CliCod = H00D32_A3CliCod[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( httpContext.getMessage( "Empresa Religiones", "") );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EmpresaReligionesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.empresareligionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EmpresaReligionesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),AV12EmpReligion});
   ...
   public void wb_table1_9_D32( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaReligionesView.htm");
         /* Div Control */
         ...
         wb_table1_9_D32e( true) ;
      }
      else
      {
         wb_table1_9_D32e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12EmpReligion = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12EmpReligion", AV12EmpReligion);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPRELIGION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpReligion, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019591478", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresareligionesview.js", "?2024122019591478", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Empresa Religiones View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12EmpReligion',fld:'vEMPRELIGION',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00D32_A1237EmpReligion = new String[] {""} ;
      H00D32_A1EmpCod = new short[1] ;
      H00D32_A3CliCod = new int[1] ;
      A1237EmpReligion = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.empresareligionesview__default(),
         new Object[] {
             new Object[] {
            H00D32_A1237EmpReligion, H00D32_A1EmpCod, H00D32_A3CliCod
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV12EmpReligion ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12EmpReligion ;
   ...
   private String[] H00D32_A1237EmpReligion ;
   private short[] H00D32_A1EmpCod ;
   private int[] H00D32_A3CliCod ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class empresareligionesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00D32", "SELECT EmpReligion, EmpCod, CliCod FROM Empresanolaborables_religion WHERE (CliCod = ? and EmpCod = ? and EmpReligion = ( ?)) AND (CliCod = ? and EmpCod = ? and EmpReligion = ( ?)) ORDER BY CliCod, EmpCod, EmpReligion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
