...
public final  class paisview_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.paisview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.paisview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","TabCode"})  ;
   }
   ...
   public void wbCS0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_CS2( true) ;
      }
      else
      {
         wb_table1_9_CS2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_CS2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void send_integrity_lvl_hashesCS2( )
   {
   }
   ...
   public void e11CS2( )
   {
      ...
      {
         A46PaiCod = H00CS2_A46PaiCod[0] ;
         A312PaiNom = H00CS2_A312PaiNom[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A312PaiNom );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.paisgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PaisGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod)});
   ...
   public void wb_table1_9_CS2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PaisView.htm");
         /* Div Control */
         ...
         wb_table1_9_CS2e( true) ;
      }
      else
      {
         wb_table1_9_CS2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202035377", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paisview.js", "?202412202035377", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00CS2_A46PaiCod = new short[1] ;
      H00CS2_A312PaiNom = new String[] {""} ;
      A312PaiNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.paisview__default(),
         new Object[] {
             new Object[] {
            H00CS2_A46PaiCod, H00CS2_A312PaiNom
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] H00CS2_A46PaiCod ;
   private String[] H00CS2_A312PaiNom ;
...
final  class paisview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00CS2", "SELECT PaiCod, PaiNom FROM Pais WHERE PaiCod = ? ORDER BY PaiCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
