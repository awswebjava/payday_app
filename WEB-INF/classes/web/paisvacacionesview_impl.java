...
public final  class paisvacacionesview_impl extends GXDataArea
{
   public paisvacacionesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public paisvacacionesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( paisvacacionesview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11PaiVacDesAnt = (byte)(GXutil.lval( httpContext.GetPar( "PaiVacDesAnt"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11PaiVacDesAnt", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11PaiVacDesAnt), 2, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAIVACDESANT", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11PaiVacDesAnt), "Z9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.paisvacacionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11PaiVacDesAnt,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","PaiVacDesAnt","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vPAIVACDESANT", GXutil.ltrim( localUtil.ntoc( AV11PaiVacDesAnt, (byte)(2), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAIVACDESANT", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11PaiVacDesAnt), "Z9")));
   ...
   {
      return formatLink("web.paisvacacionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11PaiVacDesAnt,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","PaiVacDesAnt","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "PaisVacacionesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Pais Vacaciones View", "") ;
   }
   ...
   public void wbJ60( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_J62( true) ;
      }
      else
      {
         wb_table1_9_J62( false) ;
      }
      return  ;
   }

   public void wb_table1_9_J62e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startJ62( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Pais Vacaciones View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupJ60( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11PaiVacDesAnt = (byte)(localUtil.ctol( httpContext.cgiGet( "vPAIVACDESANT"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11J62( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00J62 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PaiCod), Byte.valueOf(AV11PaiVacDesAnt), Short.valueOf(AV10PaiCod), Byte.valueOf(AV11PaiVacDesAnt)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1766PaiVacDesAnt = H00J62_A1766PaiVacDesAnt[0] ;
         A46PaiCod = H00J62_A46PaiCod[0] ;
         A1767PaiVacHasAnt = H00J62_A1767PaiVacHasAnt[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1767PaiVacHasAnt, 2, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "PaisVacacionesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.paisvacacionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PaisVacacionesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod),Byte.valueOf(AV11PaiVacDesAnt)});
   ...
   public void wb_table1_9_J62( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PaisVacacionesView.htm");
         /* Div Control */
         ...
         wb_table1_9_J62e( true) ;
      }
      else
      {
         wb_table1_9_J62e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PaiCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      AV11PaiVacDesAnt = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.BYTE)).byteValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11PaiVacDesAnt", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11PaiVacDesAnt), 2, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAIVACDESANT", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11PaiVacDesAnt), "Z9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020345629", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paisvacacionesview.js", "?2024122020345629", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Pais Vacaciones View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11PaiVacDesAnt',fld:'vPAIVACDESANT',pic:'Z9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00J62_A1766PaiVacDesAnt = new byte[1] ;
      H00J62_A46PaiCod = new short[1] ;
      H00J62_A1767PaiVacHasAnt = new byte[1] ;
      ucTabs = new com.genexus.webpanels.GXUserControl();
      sStyleString = "" ;
      lblGeneral_title_Jsonclick = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new web.paisvacacionesview__default(),
         new Object[] {
             new Object[] {
            H00J62_A1766PaiVacDesAnt, H00J62_A46PaiCod, H00J62_A1767PaiVacHasAnt
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private byte wcpOAV11PaiVacDesAnt ;
   private byte nGotPars ;
   private byte GxWebError ;
   private byte AV11PaiVacDesAnt ;
   ...
   private byte[] H00J62_A1766PaiVacDesAnt ;
   private short[] H00J62_A46PaiCod ;
   private byte[] H00J62_A1767PaiVacHasAnt ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class paisvacacionesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00J62", "SELECT PaiVacDesAnt, PaiCod, PaiVacHasAnt FROM PaisVacaciones WHERE (PaiCod = ? and PaiVacDesAnt = ?) AND (PaiCod = ? and PaiVacDesAnt = ?) ORDER BY PaiCod, PaiVacDesAnt ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
