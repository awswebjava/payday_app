...
public final  class escalasalarialview_impl extends GXDataArea
{
   public escalasalarialview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public escalasalarialview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( escalasalarialview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13CatCodigo = httpContext.GetPar( "CatCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13CatCodigo", AV13CatCodigo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13CatCodigo, ""))));
               AV14CatVigencia = localUtil.parseDateParm( httpContext.GetPar( "CatVigencia")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14CatVigencia", localUtil.format(AV14CatVigencia, "99/99/9999"));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATVIGENCIA", getSecureSignedToken( "", AV14CatVigencia));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.escalasalarialview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13CatCodigo)),GXutil.URLEncode(GXutil.formatDateParm(AV14CatVigencia)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CatCodigo","CatVigencia","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCATCODIGO", GXutil.rtrim( AV13CatCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13CatCodigo, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCATVIGENCIA", localUtil.dtoc( AV14CatVigencia, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATVIGENCIA", getSecureSignedToken( "", AV14CatVigencia));
   ...
   {
      return formatLink("web.escalasalarialview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13CatCodigo)),GXutil.URLEncode(GXutil.formatDateParm(AV14CatVigencia)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CatCodigo","CatVigencia","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EscalaSalarialView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Escala Salarial View", "") ;
   }
   ...
   public void wbEQ0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_EQ2( true) ;
      }
      else
      {
         wb_table1_9_EQ2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_EQ2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startEQ2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Escala Salarial View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesEQ2( )
   {
   }
   ...
   public void strupEQ0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13CatCodigo = httpContext.cgiGet( "vCATCODIGO") ;
         AV14CatVigencia = localUtil.ctod( httpContext.cgiGet( "vCATVIGENCIA"), 0) ;
   ...
   public void e11EQ2( )
   {
      ...
      AV21GXLvl11 = (byte)(0) ;
      /* Using cursor H00EQ2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CatCodigo, AV14CatVigencia, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CatCodigo, AV14CatVigencia});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A907CatVigencia = H00EQ2_A907CatVigencia[0] ;
         A8CatCodigo = H00EQ2_A8CatCodigo[0] ;
         A1565CliConvenio = H00EQ2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00EQ2_A1564CliPaiConve[0] ;
         A3CliCod = H00EQ2_A3CliCod[0] ;
         A122CatBasico = H00EQ2_A122CatBasico[0] ;
         n122CatBasico = H00EQ2_n122CatBasico[0] ;
         AV21GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A122CatBasico, 14, 2) );
   ...
   public void S112( )
   {
      ...
      if ( AV15LoadAllTabs || ( GXutil.strcmp(AV16SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV16SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EscalaSalarialGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.escalasalarialgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EscalaSalarialGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13CatCodigo,AV14CatVigencia});
   ...
   public void wb_table1_9_EQ2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EscalaSalarialView.htm");
         /* Div Control */
         ...
         wb_table1_9_EQ2e( true) ;
      }
      else
      {
         wb_table1_9_EQ2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliConvenio", AV12CliConvenio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      AV13CatCodigo = (String)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13CatCodigo", AV13CatCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13CatCodigo, ""))));
      AV14CatVigencia = (java.util.Date)getParm(obj,4) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14CatVigencia", localUtil.format(AV14CatVigencia, "99/99/9999"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATVIGENCIA", getSecureSignedToken( "", AV14CatVigencia));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713381773", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("escalasalarialview.js", "?20251713381773", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Escala Salarial View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13CatCodigo',fld:'vCATCODIGO',pic:'',hsh:true},{av:'AV14CatVigencia',fld:'vCATVIGENCIA',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      wcpOAV12CliConvenio = "" ;
      wcpOAV13CatCodigo = "" ;
      wcpOAV14CatVigencia = GXutil.nullDate() ;
      wcpOAV8TabCode = "" ;
      ...
      scmdbuf = "" ;
      H00EQ2_A907CatVigencia = new java.util.Date[] {GXutil.nullDate()} ;
      H00EQ2_A8CatCodigo = new String[] {""} ;
      H00EQ2_A1565CliConvenio = new String[] {""} ;
      H00EQ2_A1564CliPaiConve = new short[1] ;
      H00EQ2_A3CliCod = new int[1] ;
      H00EQ2_A122CatBasico = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00EQ2_n122CatBasico = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.escalasalarialview__default(),
         new Object[] {
             new Object[] {
            H00EQ2_A907CatVigencia, H00EQ2_A8CatCodigo, H00EQ2_A1565CliConvenio, H00EQ2_A1564CliPaiConve, H00EQ2_A3CliCod, H00EQ2_A122CatBasico, H00EQ2_n122CatBasico
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV13CatCodigo ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12CliConvenio ;
   private String AV13CatCodigo ;
   ...
   private java.util.Date wcpOAV14CatVigencia ;
   ...
   private java.util.Date[] H00EQ2_A907CatVigencia ;
   private String[] H00EQ2_A8CatCodigo ;
   private String[] H00EQ2_A1565CliConvenio ;
   private short[] H00EQ2_A1564CliPaiConve ;
   private int[] H00EQ2_A3CliCod ;
   private java.math.BigDecimal[] H00EQ2_A122CatBasico ;
   private boolean[] H00EQ2_n122CatBasico ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class escalasalarialview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00EQ2", "SELECT CatVigencia, CatCodigo, CliConvenio, CliPaiConve, CliCod, CatBasico FROM Categoriavalores1 WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CatCodigo = ( ?) and CatVigencia = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CatCodigo = ( ?) and CatVigencia = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, CatCodigo, CatVigencia ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
