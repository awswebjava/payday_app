...
public final  class religionview_impl extends GXDataArea
{
   public religionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public religionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( religionview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "ReligId") ;
         ...
         {
            AV10ReligId = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10ReligId", AV10ReligId);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRELIGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10ReligId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.religionview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10ReligId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ReligId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vRELIGID", GXutil.rtrim( AV10ReligId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRELIGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10ReligId, ""))));
   ...
   {
      return formatLink("web.religionview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10ReligId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ReligId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Religion View", "") ;
   }
   ...
   public void wbFH0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_FH2( true) ;
      }
      else
      {
         wb_table1_9_FH2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_FH2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startFH2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Religion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesFH2( )
   {
   }
   ...
   public void strupFH0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10ReligId = httpContext.cgiGet( "vRELIGID") ;
   ...
   public void e11FH2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00FH2 */
      pr_default.execute(0, new Object[] {AV10ReligId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1229ReligId = H00FH2_A1229ReligId[0] ;
         A1283ReligNombre = H00FH2_A1283ReligNombre[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A1283ReligNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ReligionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.religiongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ReligionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10ReligId});
   ...
   public void wb_table1_9_FH2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ReligionView.htm");
         /* Div Control */
         ...
         wb_table1_9_FH2e( true) ;
      }
      else
      {
         wb_table1_9_FH2e( false) ;
      }
   }
   ...
   {
      AV10ReligId = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10ReligId", AV10ReligId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRELIGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10ReligId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020382322", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("religionview.js", "?2024122020382322", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Religion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10ReligId',fld:'vRELIGID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00FH2_A1229ReligId = new String[] {""} ;
      H00FH2_A1283ReligNombre = new String[] {""} ;
      A1229ReligId = "" ;
      A1283ReligNombre = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.religionview__default(),
         new Object[] {
             new Object[] {
            H00FH2_A1229ReligId, H00FH2_A1283ReligNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10ReligId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV10ReligId ;
   ...
   private String[] H00FH2_A1229ReligId ;
   private String[] H00FH2_A1283ReligNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class religionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00FH2", "SELECT ReligId, ReligNombre FROM Religion WHERE ReligId = ( ?) ORDER BY ReligId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
