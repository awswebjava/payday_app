...
public final  class condicion_exencion_iiggview_impl extends GXDataArea
{
   public condicion_exencion_iiggview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public condicion_exencion_iiggview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( condicion_exencion_iiggview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11CondExenIIGG = httpContext.GetPar( "CondExenIIGG") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11CondExenIIGG", AV11CondExenIIGG);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONDEXENIIGG", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11CondExenIIGG, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.condicion_exencion_iiggview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11CondExenIIGG)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CondExenIIGG","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONDEXENIIGG", GXutil.rtrim( AV11CondExenIIGG));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONDEXENIIGG", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11CondExenIIGG, ""))));
   ...
   {
      return formatLink("web.condicion_exencion_iiggview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11CondExenIIGG)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CondExenIIGG","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "condicion_exencion_iiggView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "condicion_exencion_iigg View", "") ;
   }
   ...
   public void wbBP0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_BP2( true) ;
      }
      else
      {
         wb_table1_9_BP2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_BP2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startBP2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "condicion_exencion_iigg View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupBP0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11CondExenIIGG = httpContext.cgiGet( "vCONDEXENIIGG") ;
   ...
   public void e11BP2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00BP2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11CondExenIIGG, Integer.valueOf(AV10CliCod), AV11CondExenIIGG});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1105CondExenIIGG = H00BP2_A1105CondExenIIGG[0] ;
         A3CliCod = H00BP2_A3CliCod[0] ;
         A1106CondExenIIGGAcu = H00BP2_A1106CondExenIIGGAcu[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.booltostr( A1106CondExenIIGGAcu) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "condicion_exencion_iiggGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.condicion_exencion_iigggeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "condicion_exencion_iiggGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11CondExenIIGG});
   ...
   public void wb_table1_9_BP2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_condicion_exencion_iiggView.htm");
         /* Div Control */
         ...
         wb_table1_9_BP2e( true) ;
      }
      else
      {
         wb_table1_9_BP2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11CondExenIIGG = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11CondExenIIGG", AV11CondExenIIGG);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONDEXENIIGG", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11CondExenIIGG, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202518170021", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("condicion_exencion_iiggview.js", "?202518170021", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "condicion_exencion_iigg View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CondExenIIGG',fld:'vCONDEXENIIGG',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00BP2_A1105CondExenIIGG = new String[] {""} ;
      H00BP2_A3CliCod = new int[1] ;
      H00BP2_A1106CondExenIIGGAcu = new boolean[] {false} ;
      A1105CondExenIIGG = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.condicion_exencion_iiggview__default(),
         new Object[] {
             new Object[] {
            H00BP2_A1105CondExenIIGG, H00BP2_A3CliCod, H00BP2_A1106CondExenIIGGAcu
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11CondExenIIGG ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11CondExenIIGG ;
   ...
   private String[] H00BP2_A1105CondExenIIGG ;
   private int[] H00BP2_A3CliCod ;
   private boolean[] H00BP2_A1106CondExenIIGGAcu ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class condicion_exencion_iiggview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00BP2", "SELECT CondExenIIGG, CliCod, CondExenIIGGAcu FROM condicion_exencion_iigg WHERE (CliCod = ? and CondExenIIGG = ( ?)) AND (CliCod = ? and CondExenIIGG = ( ?)) ORDER BY CliCod, CondExenIIGG ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
