...
public final  class legajo_deduccionesgeneral_impl extends GXWebComponent
{
   public legajo_deduccionesgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public legajo_deduccionesgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( legajo_deduccionesgeneral_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "A83LegDedSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A83LegDedSec), 8, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(A3CliCod),Short.valueOf(A1EmpCod),Integer.valueOf(A6LegNumero),Integer.valueOf(A83LegDedSec)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "legajo_deducciones General", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.legajo_deduccionesgeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A6LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(A83LegDedSec,8,0))}, new String[] {"CliCod","EmpCod","LegNumero","LegDedSec"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA83LegDedSec", GXutil.ltrim( localUtil.ntoc( wcpOA83LegDedSec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseForm7T2( )
   {
   ...
   {
      return "legajo_deduccionesGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "legajo_deducciones General", "") ;
   }
   ...
   public void wb7T0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.legajo_deduccionesgeneral");
         }
         ...
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbLegDedTipo, cmbLegDedTipo.getInternalname(), GXutil.rtrim( A1553LegDedTipo), 1, cmbLegDedTipo.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbLegDedTipo.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_legajo_deduccionesGeneral.htm");
         cmbLegDedTipo.setValue( GXutil.rtrim( A1553LegDedTipo) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbLegDedTipo.getInternalname(), "Values", cmbLegDedTipo.ToJavascriptSource(), true);
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegIdNomApe_Internalname, A250LegIdNomApe, GXutil.rtrim( localUtil.format( A250LegIdNomApe, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegIdNomApe_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLegIdNomApe_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_legajo_deduccionesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbLegDedConCodigo, cmbLegDedConCodigo.getInternalname(), GXutil.rtrim( A84LegDedConCodigo), 1, cmbLegDedConCodigo.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbLegDedConCodigo.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_legajo_deduccionesGeneral.htm");
         cmbLegDedConCodigo.setValue( GXutil.rtrim( A84LegDedConCodigo) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbLegDedConCodigo.getInternalname(), "Values", cmbLegDedConCodigo.ToJavascriptSource(), true);
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Attribute/Variable Label */
         web.GxWebStd.gx_label_element( httpContext, edtLegDedFchDes_Internalname, httpContext.getMessage( "Desde", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegDedFchDes_Internalname, localUtil.format(A556LegDedFchDes, "99/99/99"), localUtil.format( A556LegDedFchDes, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegDedFchDes_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLegDedFchDes_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_legajo_deduccionesGeneral.htm");
         web.GxWebStd.gx_bitmap( httpContext, edtLegDedFchDes_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtLegDedFchDes_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_legajo_deduccionesGeneral.htm");
         ...
         /* Attribute/Variable Label */
         web.GxWebStd.gx_label_element( httpContext, edtLegDedFchHas_Internalname, httpContext.getMessage( "Hasta", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtLegDedDescrip_Internalname, A568LegDedDescrip, "", "", (short)(0), 1, edtLegDedDescrip_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "DescripcionEnorme", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_legajo_deduccionesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLegDedFile_Internalname, "Filetype", edtLegDedFile_Filetype, true);
         if ( ! (GXutil.strcmp("", A1555LegDedFile)==0) )
         {
            ...
            if ( gxblobfileaux.getErrCode() == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1555LegDedFile", A1555LegDedFile);
               httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLegDedFile_Internalname, "URL", httpContext.getResourceRelative(A1555LegDedFile), true);
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e117t1_client"+"'", TempTags, "", 2, "HLP_legajo_deduccionesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e127t1_client"+"'", TempTags, "", 2, "HLP_legajo_deduccionesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_legajo_deduccionesGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_legajo_deduccionesGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegDedSec_Internalname, GXutil.ltrim( localUtil.ntoc( A83LegDedSec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A83LegDedSec), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegDedSec_Jsonclick, 0, "Attribute", "", "", "", "", edtLegDedSec_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoMedio", "right", false, "", "HLP_legajo_deduccionesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start7T2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "legajo_deducciones General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void fix_multi_value_controls( )
   {
      if ( cmbLegDedTipo.getItemCount() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1553LegDedTipo", A1553LegDedTipo);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
         cmbLegDedTipo.setValue( GXutil.rtrim( A1553LegDedTipo) );
      ...
      if ( cmbLegDedConCodigo.getItemCount() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A84LegDedConCodigo", A84LegDedConCodigo);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
         cmbLegDedConCodigo.setValue( GXutil.rtrim( A84LegDedConCodigo) );
   ...
   {
      /* GeneXus formulas. */
      AV20Pgmname = "legajo_deduccionesGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf7T2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1555LegDedFile = H007T2_A1555LegDedFile[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1555LegDedFile", A1555LegDedFile);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLegDedFile_Internalname, "URL", httpContext.getResourceRelative(A1555LegDedFile), true);
            A560LegDedImporte = H007T2_A560LegDedImporte[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A560LegDedImporte", GXutil.ltrimstr( A560LegDedImporte, 14, 2));
            A568LegDedDescrip = H007T2_A568LegDedDescrip[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A568LegDedDescrip", A568LegDedDescrip);
            A557LegDedFchHas = H007T2_A557LegDedFchHas[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A557LegDedFchHas", localUtil.format(A557LegDedFchHas, "99/99/99"));
            A556LegDedFchDes = H007T2_A556LegDedFchDes[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A556LegDedFchDes", localUtil.format(A556LegDedFchDes, "99/99/99"));
            A84LegDedConCodigo = H007T2_A84LegDedConCodigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A84LegDedConCodigo", A84LegDedConCodigo);
            A1553LegDedTipo = H007T2_A1553LegDedTipo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1553LegDedTipo", A1553LegDedTipo);
            /* Execute user event: Load */
            e147T2 ();
   ...
   public void send_integrity_lvl_hashes7T2( )
   {
   }
   ...
   public void before_start_formulas( )
   {
      ...
      A250LegIdNomApe = H007T3_A250LegIdNomApe[0] ;
   ...
   public void strup7T0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOA83LegDedSec = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA83LegDedSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         A6LegNumero = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"LEGNUMERO"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e137T2( )
   {
      ...
      legajo_deduccionesgeneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV14CliCod = GXt_int1 ;
   ...
   protected void e147T2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLegDedSec_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtLegDedSec_Visible), 5, 0), true);
      ...
      legajo_deduccionesgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "legajo_deducciones" );
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
      A83LegDedSec = ((Number) GXutil.testNumericType( getParm(obj,3,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A83LegDedSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A83LegDedSec), 8, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA83LegDedSec = (String)getParm(obj,3,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "legajo_deduccionesgeneral", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
         A83LegDedSec = ((Number) GXutil.testNumericType( getParm(obj,5,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A83LegDedSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A83LegDedSec), 8, 0));
      }
      wcpOA3CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA3CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOA1EmpCod = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA1EmpCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOA6LegNumero = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA6LegNumero"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOA83LegDedSec = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA83LegDedSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( A3CliCod != wcpOA3CliCod ) || ( A1EmpCod != wcpOA1EmpCod ) || ( A6LegNumero != wcpOA6LegNumero ) || ( A83LegDedSec != wcpOA83LegDedSec ) ) )
      {
         setjustcreated();
      }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlA83LegDedSec = httpContext.cgiGet( sPrefix+"A83LegDedSec_CTRL") ;
      if ( GXutil.len( sCtrlA83LegDedSec) > 0 )
      {
         A83LegDedSec = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlA83LegDedSec), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A83LegDedSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A83LegDedSec), 8, 0));
      }
      else
      {
         A83LegDedSec = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"A83LegDedSec_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A83LegDedSec_PARM", GXutil.ltrim( localUtil.ntoc( A83LegDedSec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlA83LegDedSec)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A83LegDedSec_CTRL", GXutil.rtrim( sCtrlA83LegDedSec));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713493664", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("legajo_deduccionesgeneral.js", "?20251713493664", false, true);
      /* End function include_jscripts */
   }

   public void init_default_properties( )
   {
      cmbLegDedTipo.setInternalname( sPrefix+"LEGDEDTIPO" );
      edtLegIdNomApe_Internalname = sPrefix+"LEGIDNOMAPE" ;
      cmbLegDedConCodigo.setInternalname( sPrefix+"LEGDEDCONCODIGO" );
      ...
      edtLegDedFile_Internalname = sPrefix+"LEGDEDFILE" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A83LegDedSec',fld:'LEGDEDSEC',pic:'ZZZZZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e117T1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A83LegDedSec',fld:'LEGDEDSEC',pic:'ZZZZZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e127T1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A83LegDedSec',fld:'LEGDEDSEC',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV20Pgmname = "" ;
      scmdbuf = "" ;
      H007T2_A3CliCod = new int[1] ;
      H007T2_A1EmpCod = new short[1] ;
      H007T2_A6LegNumero = new int[1] ;
      H007T2_A83LegDedSec = new int[1] ;
      H007T2_A1555LegDedFile = new String[] {""} ;
      H007T2_A560LegDedImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007T2_A568LegDedDescrip = new String[] {""} ;
      H007T2_A557LegDedFchHas = new java.util.Date[] {GXutil.nullDate()} ;
      H007T2_A556LegDedFchDes = new java.util.Date[] {GXutil.nullDate()} ;
      H007T2_A84LegDedConCodigo = new String[] {""} ;
      H007T2_A250LegIdNomApe = new String[] {""} ;
      H007T2_A1553LegDedTipo = new String[] {""} ;
      H007T3_A250LegIdNomApe = new String[] {""} ;
      ...
      sCtrlA6LegNumero = "" ;
      sCtrlA83LegDedSec = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.legajo_deduccionesgeneral__default(),
         new Object[] {
             new Object[] {
            H007T2_A3CliCod, H007T2_A1EmpCod, H007T2_A6LegNumero, H007T2_A83LegDedSec, H007T2_A1555LegDedFile, H007T2_A560LegDedImporte, H007T2_A568LegDedDescrip, H007T2_A557LegDedFchHas, H007T2_A556LegDedFchDes, H007T2_A84LegDedConCodigo,
            H007T2_A250LegIdNomApe, H007T2_A1553LegDedTipo
            }
            , new Object[] {
            H007T3_A250LegIdNomApe
            }
         }
      );
      AV20Pgmname = "legajo_deduccionesGeneral" ;
   ...
   private String sCtrlA83LegDedSec ;
   ...
   private int[] H007T2_A3CliCod ;
   private short[] H007T2_A1EmpCod ;
   private int[] H007T2_A6LegNumero ;
   private int[] H007T2_A83LegDedSec ;
   private String[] H007T2_A1555LegDedFile ;
   private java.math.BigDecimal[] H007T2_A560LegDedImporte ;
   private String[] H007T2_A568LegDedDescrip ;
   private java.util.Date[] H007T2_A557LegDedFchHas ;
   private java.util.Date[] H007T2_A556LegDedFchDes ;
   private String[] H007T2_A84LegDedConCodigo ;
   private String[] H007T2_A250LegIdNomApe ;
   private String[] H007T2_A1553LegDedTipo ;
   private String[] H007T3_A250LegIdNomApe ;
...
final  class legajo_deduccionesgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H007T2", "SELECT T1.CliCod, T1.EmpCod, T1.LegNumero, T1.LegDedSec, T1.LegDedFile, T1.LegDedImporte, T1.LegDedDescrip, T1.LegDedFchHas, T1.LegDedFchDes, T1.LegDedConCodigo, T2.LegIdNomApe, T1.LegDedTipo FROM (legajo_deducciones T1 INNER JOIN Legajo T2 ON T2.CliCod = T1.CliCod AND T2.EmpCod = T1.EmpCod AND T2.LegNumero = T1.LegNumero) WHERE T1.CliCod = ? and T1.EmpCod = ? and T1.LegNumero = ? and T1.LegDedSec = ? ORDER BY T1.CliCod, T1.EmpCod, T1.LegNumero, T1.LegDedSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H007T3", "SELECT LegIdNomApe FROM Legajo WHERE CliCod = ? AND EmpCod = ? AND LegNumero = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
