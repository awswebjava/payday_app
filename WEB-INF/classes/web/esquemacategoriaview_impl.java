...
public final  class esquemacategoriaview_impl extends GXDataArea
{
   public esquemacategoriaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public esquemacategoriaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( esquemacategoriaview_impl.class ));
   }
   ...
   {
      return formatLink("web.esquemacategoriaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13CatCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CatCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EsquemaCategoriaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Esquema Categoria View", "") ;
   }
   ...
   public void wbPS0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_PS2( true) ;
      }
      else
      {
         wb_table1_9_PS2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_PS2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startPS2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Esquema Categoria View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesPS2( )
   {
   }
   ...
   public void e11PS2( )
   {
      ...
      AV22GXLvl11 = (byte)(0) ;
      /* Using cursor H00PS2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CatCodigo, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CatCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A8CatCodigo = H00PS2_A8CatCodigo[0] ;
         A1565CliConvenio = H00PS2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00PS2_A1564CliPaiConve[0] ;
         A3CliCod = H00PS2_A3CliCod[0] ;
         A123CatDescrip = H00PS2_A123CatDescrip[0] ;
         AV22GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EsquemaCategoriaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.esquemacategoriageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EsquemaCategoriaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13CatCodigo});
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "valores") == 0 ) )
      {
         /* Object Property */
         if ( true )
         {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Valoreswc_Component), GXutil.lower( "EsquemaCategoriavaloresWC")) != 0 )
         {
            WebComp_Valoreswc = WebUtils.getWebComponent(getClass(), "web.esquemacategoriavaloreswc_impl", remoteHandle, context);
            WebComp_Valoreswc_Component = "EsquemaCategoriavaloresWC" ;
         }
         if ( GXutil.len( WebComp_Valoreswc_Component) != 0 )
         {
            WebComp_Valoreswc.setjustcreated();
            WebComp_Valoreswc.componentprepare(new Object[] {"W0031","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13CatCodigo});
   ...
   public void wb_table1_9_PS2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EsquemaCategoriaView.htm");
         /* Div Control */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblValores_title_Internalname, httpContext.getMessage( "valores", ""), "", "", lblValores_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EsquemaCategoriaView.htm");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         wb_table1_9_PS2e( true) ;
      }
      else
      {
         wb_table1_9_PS2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251717585757", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("esquemacategoriaview.js", "?20251717585757", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Esquema Categoria View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13CatCodigo',fld:'vCATCODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00PS2_A8CatCodigo = new String[] {""} ;
      H00PS2_A1565CliConvenio = new String[] {""} ;
      H00PS2_A1564CliPaiConve = new short[1] ;
      H00PS2_A3CliCod = new int[1] ;
      H00PS2_A123CatDescrip = new String[] {""} ;
      A8CatCodigo = "" ;
      A1565CliConvenio = "" ;
      A123CatDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.esquemacategoriaview__default(),
         new Object[] {
             new Object[] {
            H00PS2_A8CatCodigo, H00PS2_A1565CliConvenio, H00PS2_A1564CliPaiConve, H00PS2_A3CliCod, H00PS2_A123CatDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00PS2_A8CatCodigo ;
   private String[] H00PS2_A1565CliConvenio ;
   private short[] H00PS2_A1564CliPaiConve ;
   private int[] H00PS2_A3CliCod ;
   private String[] H00PS2_A123CatDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class esquemacategoriaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00PS2", "SELECT CatCodigo, CliConvenio, CliPaiConve, CliCod, CatDescrip FROM Categoria1 WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CatCodigo = ( ?)) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CatCodigo = ( ?)) ORDER BY CliCod, CliPaiConve, CliConvenio, CatCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
