...
public final  class debugview_impl extends GXDataArea
{
   public debugview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public debugview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( debugview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11DebugPgm = httpContext.GetPar( "DebugPgm") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11DebugPgm", AV11DebugPgm);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEBUGPGM", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11DebugPgm, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.debugview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11DebugPgm)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","DebugPgm","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vDEBUGPGM", AV11DebugPgm);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEBUGPGM", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11DebugPgm, ""))));
   ...
   {
      return formatLink("web.debugview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11DebugPgm)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","DebugPgm","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Debug View", "") ;
   }
   ...
   public void wbP30( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_P32( true) ;
      }
      else
      {
         wb_table1_9_P32( false) ;
      }
      return  ;
   }

   public void wb_table1_9_P32e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startP32( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Debug View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesP32( )
   {
   }
   ...
   public void strupP30( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11DebugPgm = httpContext.cgiGet( "vDEBUGPGM") ;
   ...
   public void e11P32( )
   {
      ...
      AV18GXLvl8 = (byte)(0) ;
      /* Using cursor H00P32 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11DebugPgm, Integer.valueOf(AV10CliCod), AV11DebugPgm});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1754DebugPgm = H00P32_A1754DebugPgm[0] ;
         A3CliCod = H00P32_A3CliCod[0] ;
         A1755DebugActivo = H00P32_A1755DebugActivo[0] ;
         AV18GXLvl8 = (byte)(1) ;
         Form.setCaption( GXutil.booltostr( A1755DebugActivo) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "DebugGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.debuggeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "DebugGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11DebugPgm});
   ...
   public void wb_table1_9_P32( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DebugView.htm");
         /* Div Control */
         ...
         wb_table1_9_P32e( true) ;
      }
      else
      {
         wb_table1_9_P32e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11DebugPgm = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11DebugPgm", AV11DebugPgm);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDEBUGPGM", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11DebugPgm, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019552935", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("debugview.js", "?2024122019552935", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Debug View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11DebugPgm',fld:'vDEBUGPGM',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00P32_A1754DebugPgm = new String[] {""} ;
      H00P32_A3CliCod = new int[1] ;
      H00P32_A1755DebugActivo = new boolean[] {false} ;
      A1754DebugPgm = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.debugview__default(),
         new Object[] {
             new Object[] {
            H00P32_A1754DebugPgm, H00P32_A3CliCod, H00P32_A1755DebugActivo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV11DebugPgm ;
   private String AV11DebugPgm ;
   ...
   private String[] H00P32_A1754DebugPgm ;
   private int[] H00P32_A3CliCod ;
   private boolean[] H00P32_A1755DebugActivo ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class debugview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00P32", "SELECT DebugPgm, CliCod, DebugActivo FROM Debug WHERE (CliCod = ? and DebugPgm = ( ?)) AND (CliCod = ? and DebugPgm = ( ?)) ORDER BY CliCod, DebugPgm ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
