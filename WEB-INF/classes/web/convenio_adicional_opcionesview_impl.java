...
public final  class convenio_adicional_opcionesview_impl extends GXDataArea
{
   public convenio_adicional_opcionesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_adicional_opcionesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_adicional_opcionesview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13ConveAdicod = httpContext.GetPar( "ConveAdicod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13ConveAdicod", AV13ConveAdicod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
               AV14ConveAdiOpcCod = (short)(GXutil.lval( httpContext.GetPar( "ConveAdiOpcCod"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14ConveAdiOpcCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV14ConveAdiOpcCod), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADIOPCCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14ConveAdiOpcCod), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_adicional_opcionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13ConveAdicod)),GXutil.URLEncode(GXutil.ltrimstr(AV14ConveAdiOpcCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiOpcCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONVEADICOD", GXutil.rtrim( AV13ConveAdicod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONVEADIOPCCOD", GXutil.ltrim( localUtil.ntoc( AV14ConveAdiOpcCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADIOPCCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14ConveAdiOpcCod), "ZZZ9")));
   ...
   {
      return formatLink("web.convenio_adicional_opcionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13ConveAdicod)),GXutil.URLEncode(GXutil.ltrimstr(AV14ConveAdiOpcCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiOpcCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "convenio_adicional_opcionesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "convenio_adicional_opciones View", "") ;
   }
   ...
   public void wbET0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_ET2( true) ;
      }
      else
      {
         wb_table1_9_ET2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_ET2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startET2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "convenio_adicional_opciones View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesET2( )
   {
   }
   ...
   public void strupET0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13ConveAdicod = httpContext.cgiGet( "vCONVEADICOD") ;
         AV14ConveAdiOpcCod = (short)(localUtil.ctol( httpContext.cgiGet( "vCONVEADIOPCCOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11ET2( )
   {
      ...
      AV21GXLvl11 = (byte)(0) ;
      /* Using cursor H00ET2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13ConveAdicod, Short.valueOf(AV14ConveAdiOpcCod), Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13ConveAdicod, Short.valueOf(AV14ConveAdiOpcCod)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1011ConveAdiOpcCod = H00ET2_A1011ConveAdiOpcCod[0] ;
         A996ConveAdicod = H00ET2_A996ConveAdicod[0] ;
         A1565CliConvenio = H00ET2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00ET2_A1564CliPaiConve[0] ;
         A3CliCod = H00ET2_A3CliCod[0] ;
         A1021ConveAdiOpcFor = H00ET2_A1021ConveAdiOpcFor[0] ;
         AV21GXLvl11 = (byte)(1) ;
         Form.setCaption( A1021ConveAdiOpcFor );
   ...
   public void S112( )
   {
      ...
      if ( AV15LoadAllTabs || ( GXutil.strcmp(AV16SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV16SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "convenio_adicional_opcionesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.convenio_adicional_opcionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "convenio_adicional_opcionesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13ConveAdicod,Short.valueOf(AV14ConveAdiOpcCod)});
   ...
   public void wb_table1_9_ET2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_convenio_adicional_opcionesView.htm");
         /* Div Control */
         ...
         wb_table1_9_ET2e( true) ;
      }
      else
      {
         wb_table1_9_ET2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliConvenio", AV12CliConvenio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      AV13ConveAdicod = (String)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13ConveAdicod", AV13ConveAdicod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
      AV14ConveAdiOpcCod = ((Number) GXutil.testNumericType( getParm(obj,4), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14ConveAdiOpcCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV14ConveAdiOpcCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADIOPCCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14ConveAdiOpcCod), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713335726", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("convenio_adicional_opcionesview.js", "?20251713335726", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "convenio_adicional_opciones View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13ConveAdicod',fld:'vCONVEADICOD',pic:'',hsh:true},{av:'AV14ConveAdiOpcCod',fld:'vCONVEADIOPCCOD',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00ET2_A1011ConveAdiOpcCod = new short[1] ;
      H00ET2_A996ConveAdicod = new String[] {""} ;
      H00ET2_A1565CliConvenio = new String[] {""} ;
      H00ET2_A1564CliPaiConve = new short[1] ;
      H00ET2_A3CliCod = new int[1] ;
      H00ET2_A1021ConveAdiOpcFor = new String[] {""} ;
      A996ConveAdicod = "" ;
      A1565CliConvenio = "" ;
      A1021ConveAdiOpcFor = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_adicional_opcionesview__default(),
         new Object[] {
             new Object[] {
            H00ET2_A1011ConveAdiOpcCod, H00ET2_A996ConveAdicod, H00ET2_A1565CliConvenio, H00ET2_A1564CliPaiConve, H00ET2_A3CliCod, H00ET2_A1021ConveAdiOpcFor
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV14ConveAdiOpcCod ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV11CliPaiConve ;
   private short AV14ConveAdiOpcCod ;
   private short wbEnd ;
   ...
   private String wcpOAV13ConveAdicod ;
   ...
   private short[] H00ET2_A1011ConveAdiOpcCod ;
   private String[] H00ET2_A996ConveAdicod ;
   private String[] H00ET2_A1565CliConvenio ;
   private short[] H00ET2_A1564CliPaiConve ;
   private int[] H00ET2_A3CliCod ;
   private String[] H00ET2_A1021ConveAdiOpcFor ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class convenio_adicional_opcionesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00ET2", "SELECT ConveAdiOpcCod, ConveAdicod, CliConvenio, CliPaiConve, CliCod, ConveAdiOpcFor FROM convenio_adicionalalicuotas WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveAdicod = ( ?) and ConveAdiOpcCod = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveAdicod = ( ?) and ConveAdiOpcCod = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, ConveAdicod, ConveAdiOpcCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
