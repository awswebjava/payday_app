...
public final  class liquidacionajustedetallewc_impl extends GXWebComponent
{
   public liquidacionajustedetallewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public liquidacionajustedetallewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( liquidacionajustedetallewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10LiqNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LiqNro), 8, 0));
               ...
               AV12LiqAjuNro = (short)(GXutil.lval( httpContext.GetPar( "LiqAjuNro"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV12LiqAjuNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LiqAjuNro), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8CliCod),Short.valueOf(AV9EmpCod),Integer.valueOf(AV10LiqNro),Integer.valueOf(AV11LegNumero),Short.valueOf(AV12LiqAjuNro)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9EmpCod, AV10LiqNro, AV11LegNumero, AV12LiqAjuNro, AV30Pgmname, AV18OrderedBy, AV19OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Liquidacion Ajustedetalle WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.liquidacionajustedetallewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV10LiqNro,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LiqAjuNro,4,0))}, new String[] {"CliCod","EmpCod","LiqNro","LegNumero","LiqAjuNro"}) +"\">") ;
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV30Pgmname, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV10LiqNro", GXutil.ltrim( localUtil.ntoc( wcpOAV10LiqNro, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV12LiqAjuNro", GXutil.ltrim( localUtil.ntoc( wcpOAV12LiqAjuNro, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV30Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV30Pgmname, ""))));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vLIQNRO", GXutil.ltrim( localUtil.ntoc( AV10LiqNro, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vLIQAJUNRO", GXutil.ltrim( localUtil.ntoc( AV12LiqAjuNro, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseFormDU2( )
   {
   ...
   {
      return "LiquidacionAjustedetalleWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Liquidacion Ajustedetalle WC", "") ;
   }
   ...
   public void wbDU0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.liquidacionajustedetallewc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_LiquidacionAjustedetalleWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_LiquidacionAjustedetalleWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLiqNro_Internalname, GXutil.ltrim( localUtil.ntoc( A31LiqNro, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A31LiqNro), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLiqNro_Jsonclick, 0, "Attribute", "", "", "", "", edtLiqNro_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoMedio", "right", false, "", "HLP_LiquidacionAjustedetalleWC.htm");
         /* Single line edit */
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLiqAjuNro_Internalname, GXutil.ltrim( localUtil.ntoc( A1541LiqAjuNro, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1541LiqAjuNro), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLiqAjuNro_Jsonclick, 0, "Attribute", "", "", "", "", edtLiqAjuNro_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_LiquidacionAjustedetalleWC.htm");
         /* User Defined Control */
   ...
   public void startDU2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Liquidacion Ajustedetalle WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV30Pgmname = "LiquidacionAjustedetalleWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfDU2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT,
                                              TypeConstants.INT, TypeConstants.SHORT
                                              }
         });
         /* Using cursor H00DU2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV10LiqNro), Integer.valueOf(AV11LegNumero), Short.valueOf(AV12LiqAjuNro), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A3CliCod = H00DU2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H00DU2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A31LiqNro = H00DU2_A31LiqNro[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A31LiqNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(A31LiqNro), 8, 0));
            A6LegNumero = H00DU2_A6LegNumero[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
            A1541LiqAjuNro = H00DU2_A1541LiqAjuNro[0] ;
            ...
            A1545LiqAjuCant = H00DU2_A1545LiqAjuCant[0] ;
            A1544LiqAjuImporte = H00DU2_A1544LiqAjuImporte[0] ;
            A1540LiqAjuConcepto = H00DU2_A1540LiqAjuConcepto[0] ;
            A1543LiqAjuSec = H00DU2_A1543LiqAjuSec[0] ;
            e16DU2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00DU3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV10LiqNro), Integer.valueOf(AV11LegNumero), Short.valueOf(AV12LiqAjuNro)});
   ...
   public void strupDU0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV10LiqNro = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV10LiqNro"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         ...
         wcpOAV12LiqAjuNro = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV12LiqAjuNro"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e14DU2( )
   {
      ...
      liquidacionajustedetallewc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      ...
      edtLiqAjuNro_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLiqAjuNro_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtLiqAjuNro_Visible), 5, 0), true);
   ...
   public void e15DU2( )
   {
      ...
      new web.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV30Pgmname, GXv_char7) ;
      liquidacionajustedetallewc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV20Session.getValue(AV30Pgmname+"GridState"), "") == 0 )
      {
         AV16GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV30Pgmname+"GridState"), null, null);
      }
      else
      {
         AV16GridState.fromxml(AV20Session.getValue(AV30Pgmname+"GridState"), null, null);
      }
   ...
   public void S142( )
   {
      ...
      new web.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV30Pgmname+"GridState", AV16GridState.toxml(false, true, "WWPGridState", "PayDay")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV14TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV30Pgmname );
      ...
      AV14TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "LiquidacionAjuste" );
      ...
      AV14TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV15TrnContextAtt, 0);
      AV15TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV15TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "LiqNro" );
      AV15TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV10LiqNro, 8, 0) );
      AV14TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV15TrnContextAtt, 0);
      AV15TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV15TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "LegNumero" );
      AV15TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV11LegNumero, 8, 0) );
      AV14TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV15TrnContextAtt, 0);
      AV15TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV15TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "LiqAjuNro" );
      AV15TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV12LiqAjuNro, 4, 0) );
      AV14TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV15TrnContextAtt, 0);
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9EmpCod), 4, 0));
      AV10LiqNro = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10LiqNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LiqNro), 8, 0));
      AV11LegNumero = ((Number) GXutil.testNumericType( getParm(obj,3,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11LegNumero), 8, 0));
      AV12LiqAjuNro = ((Number) GXutil.testNumericType( getParm(obj,4,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV12LiqAjuNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LiqAjuNro), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV10LiqNro = (String)getParm(obj,2,TypeConstants.STRING) ;
      sCtrlAV11LegNumero = (String)getParm(obj,3,TypeConstants.STRING) ;
      sCtrlAV12LiqAjuNro = (String)getParm(obj,4,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "liquidacionajustedetallewc", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9EmpCod), 4, 0));
         AV10LiqNro = ((Number) GXutil.testNumericType( getParm(obj,4,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10LiqNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LiqNro), 8, 0));
         AV11LegNumero = ((Number) GXutil.testNumericType( getParm(obj,5,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11LegNumero), 8, 0));
         AV12LiqAjuNro = ((Number) GXutil.testNumericType( getParm(obj,6,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV12LiqAjuNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LiqAjuNro), 4, 0));
      }
      wcpOAV8CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV9EmpCod = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9EmpCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      ...
      wcpOAV11LegNumero = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV11LegNumero"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV12LiqAjuNro = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV12LiqAjuNro"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( AV8CliCod != wcpOAV8CliCod ) || ( AV9EmpCod != wcpOAV9EmpCod ) || ( AV10LiqNro != wcpOAV10LiqNro ) || ( AV11LegNumero != wcpOAV11LegNumero ) || ( AV12LiqAjuNro != wcpOAV12LiqAjuNro ) ) )
      {
         setjustcreated();
      }
      wcpOAV8CliCod = AV8CliCod ;
      wcpOAV9EmpCod = AV9EmpCod ;
      wcpOAV10LiqNro = AV10LiqNro ;
      wcpOAV11LegNumero = AV11LegNumero ;
      wcpOAV12LiqAjuNro = AV12LiqAjuNro ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlAV10LiqNro = httpContext.cgiGet( sPrefix+"AV10LiqNro_CTRL") ;
      if ( GXutil.len( sCtrlAV10LiqNro) > 0 )
      {
         AV10LiqNro = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV10LiqNro), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10LiqNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LiqNro), 8, 0));
      }
      else
      {
         AV10LiqNro = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV10LiqNro_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
      ...
      sCtrlAV12LiqAjuNro = httpContext.cgiGet( sPrefix+"AV12LiqAjuNro_CTRL") ;
      if ( GXutil.len( sCtrlAV12LiqAjuNro) > 0 )
      {
         AV12LiqAjuNro = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV12LiqAjuNro), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV12LiqAjuNro", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LiqAjuNro), 4, 0));
      }
      else
      {
         AV12LiqAjuNro = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV12LiqAjuNro_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV10LiqNro_PARM", GXutil.ltrim( localUtil.ntoc( AV10LiqNro, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV10LiqNro)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV10LiqNro_CTRL", GXutil.rtrim( sCtrlAV10LiqNro));
      }
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV12LiqAjuNro_PARM", GXutil.ltrim( localUtil.ntoc( AV12LiqAjuNro, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV12LiqAjuNro)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV12LiqAjuNro_CTRL", GXutil.rtrim( sCtrlAV12LiqAjuNro));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181754497", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("liquidacionajustedetallewc.js", "?2025181754498", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtLiqAjuSec_Internalname = sPrefix+"LIQAJUSEC_"+sGXsfl_15_idx ;
      edtLiqAjuConcepto_Internalname = sPrefix+"LIQAJUCONCEPTO_"+sGXsfl_15_idx ;
      edtLiqAjuImporte_Internalname = sPrefix+"LIQAJUIMPORTE_"+sGXsfl_15_idx ;
      edtLiqAjuCant_Internalname = sPrefix+"LIQAJUCANT_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtLiqAjuSec_Internalname = sPrefix+"LIQAJUSEC_"+sGXsfl_15_fel_idx ;
      edtLiqAjuConcepto_Internalname = sPrefix+"LIQAJUCONCEPTO_"+sGXsfl_15_fel_idx ;
      edtLiqAjuImporte_Internalname = sPrefix+"LIQAJUIMPORTE_"+sGXsfl_15_fel_idx ;
      edtLiqAjuCant_Internalname = sPrefix+"LIQAJUCANT_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLiqAjuSec_Internalname,GXutil.ltrim( localUtil.ntoc( A1543LiqAjuSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1543LiqAjuSec), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLiqAjuSec_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLiqAjuConcepto_Internalname,GXutil.rtrim( A1540LiqAjuConcepto),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLiqAjuConcepto_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"CodConcepto","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLiqAjuImporte_Internalname,GXutil.ltrim( localUtil.ntoc( A1544LiqAjuImporte, (byte)(17), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A1544LiqAjuImporte, "ZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLiqAjuImporte_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(17),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Importes","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLiqAjuCant_Internalname,GXutil.ltrim( localUtil.ntoc( A1545LiqAjuCant, (byte)(9), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A1545LiqAjuCant, "ZZZZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLiqAjuCant_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(9),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol15( )
   {
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1543LiqAjuSec, (byte)(4), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1540LiqAjuConcepto));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1544LiqAjuImporte, (byte)(17), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1545LiqAjuCant, (byte)(9), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtLiqAjuSec_Internalname = sPrefix+"LIQAJUSEC" ;
      edtLiqAjuConcepto_Internalname = sPrefix+"LIQAJUCONCEPTO" ;
      edtLiqAjuImporte_Internalname = sPrefix+"LIQAJUIMPORTE" ;
      edtLiqAjuCant_Internalname = sPrefix+"LIQAJUCANT" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:LiqAjuSec|1:LiqAjuConcepto|2:LiqAjuImporte|3:LiqAjuCant" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LiqNro',fld:'vLIQNRO',pic:'ZZZZZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV12LiqAjuNro',fld:'vLIQAJUNRO',pic:'ZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV18OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV19OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11DU2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LiqNro',fld:'vLIQNRO',pic:'ZZZZZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV12LiqAjuNro',fld:'vLIQAJUNRO',pic:'ZZZ9'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV18OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV19OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12DU2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LiqNro',fld:'vLIQNRO',pic:'ZZZZZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV12LiqAjuNro',fld:'vLIQAJUNRO',pic:'ZZZ9'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV18OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV19OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13DU2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LiqNro',fld:'vLIQNRO',pic:'ZZZZZZZ9'},{av:'AV11LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV12LiqAjuNro',fld:'vLIQAJUNRO',pic:'ZZZ9'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV18OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV19OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16DU2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00DU2_A3CliCod = new int[1] ;
      H00DU2_A1EmpCod = new short[1] ;
      H00DU2_A31LiqNro = new int[1] ;
      H00DU2_A6LegNumero = new int[1] ;
      H00DU2_A1541LiqAjuNro = new short[1] ;
      H00DU2_A1545LiqAjuCant = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00DU2_A1544LiqAjuImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00DU2_A1540LiqAjuConcepto = new String[] {""} ;
      H00DU2_A1543LiqAjuSec = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.liquidacionajustedetallewc__default(),
         new Object[] {
             new Object[] {
            H00DU2_A3CliCod, H00DU2_A1EmpCod, H00DU2_A31LiqNro, H00DU2_A6LegNumero, H00DU2_A1541LiqAjuNro, H00DU2_A1545LiqAjuCant, H00DU2_A1544LiqAjuImporte, H00DU2_A1540LiqAjuConcepto, H00DU2_A1543LiqAjuSec
            }
            , new Object[] {
   ...
   private short wcpOAV12LiqAjuNro ;
   private short AV9EmpCod ;
   private short AV12LiqAjuNro ;
   ...
   private String sCtrlAV10LiqNro ;
   private String sCtrlAV11LegNumero ;
   private String sCtrlAV12LiqAjuNro ;
   ...
   private int[] H00DU2_A3CliCod ;
   private short[] H00DU2_A1EmpCod ;
   private int[] H00DU2_A31LiqNro ;
   private int[] H00DU2_A6LegNumero ;
   private short[] H00DU2_A1541LiqAjuNro ;
   private java.math.BigDecimal[] H00DU2_A1545LiqAjuCant ;
   private java.math.BigDecimal[] H00DU2_A1544LiqAjuImporte ;
   private String[] H00DU2_A1540LiqAjuConcepto ;
   private short[] H00DU2_A1543LiqAjuSec ;
...
final  class liquidacionajustedetallewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A1541LiqAjuNro )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, EmpCod, LiqNro, LegNumero, LiqAjuNro, LiqAjuCant, LiqAjuImporte, LiqAjuConcepto, LiqAjuSec" ;
      sFromString = " FROM LiquidacionAjustedetalle" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LiqNro = ? and LegNumero = ? and LiqAjuNro = ?)");
      if ( ( AV18OrderedBy == 1 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LiqNro, LegNumero, LiqAjuNro, LiqAjuSec" ;
      }
      else if ( ( AV18OrderedBy == 1 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LiqNro DESC, LegNumero DESC, LiqAjuNro DESC, LiqAjuSec DESC" ;
      }
      else if ( ( AV18OrderedBy == 2 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LiqNro, LegNumero, LiqAjuNro, LiqAjuConcepto, LiqAjuSec" ;
      }
      else if ( ( AV18OrderedBy == 2 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LiqNro DESC, LegNumero DESC, LiqAjuNro DESC, LiqAjuConcepto DESC, LiqAjuSec" ;
      }
      else if ( ( AV18OrderedBy == 3 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LiqNro, LegNumero, LiqAjuNro, LiqAjuImporte, LiqAjuSec" ;
      }
      else if ( ( AV18OrderedBy == 3 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LiqNro DESC, LegNumero DESC, LiqAjuNro DESC, LiqAjuImporte DESC, LiqAjuSec" ;
      }
      else if ( ( AV18OrderedBy == 4 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LiqNro, LegNumero, LiqAjuNro, LiqAjuCant, LiqAjuSec" ;
      }
      else if ( ( AV18OrderedBy == 4 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LiqNro DESC, LegNumero DESC, LiqAjuNro DESC, LiqAjuCant DESC, LiqAjuSec" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LiqNro, LegNumero, LiqAjuNro, LiqAjuSec" ;
                                          ...
                                          short A1541LiqAjuNro )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM LiquidacionAjustedetalle" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LiqNro = ? and LegNumero = ? and LiqAjuNro = ?)");
