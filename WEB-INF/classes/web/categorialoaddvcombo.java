...
public final  class categorialoaddvcombo extends GXProcedure
{
   public categorialoaddvcombo( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( categorialoaddvcombo.class ), "" );
   }
   ...
   public String executeUdp( String aP0 ,
                             ...
                             String[] aP10 )
   {
      categorialoaddvcombo.this.aP11 = new String[] {""};
   ...
   private void execute_int( String aP0 ,
                             ...
                             String[] aP11 )
   {
      categorialoaddvcombo.this.AV15ComboName = aP0;
      categorialoaddvcombo.this.AV16TrnMode = aP1;
      categorialoaddvcombo.this.AV17IsDynamicCall = aP2;
      categorialoaddvcombo.this.AV18CliCod = aP3;
      categorialoaddvcombo.this.AV19CliPaiConve = aP4;
      categorialoaddvcombo.this.AV20CliConvenio = aP5;
      categorialoaddvcombo.this.AV21CatCodigo = aP6;
      categorialoaddvcombo.this.AV32Cond_CatPaiCod = aP7;
      categorialoaddvcombo.this.AV12SearchTxt = aP8;
      categorialoaddvcombo.this.aP9 = aP9;
      categorialoaddvcombo.this.aP10 = aP10;
      categorialoaddvcombo.this.aP11 = aP11;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWCategoria", GXv_boolean2) ;
      categorialoaddvcombo.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      if ( AV17IsDynamicCall )
      {
         if ( GXutil.strcmp(AV16TrnMode, "GET_DSC") == 0 )
         {
            ...
            while ( AV37GXV1 <= AV29ValuesCollection.size() )
            {
               ...
               {
                  A46PaiCod = P024U2_A46PaiCod[0] ;
                  A312PaiNom = P024U2_A312PaiNom[0] ;
                  AV38GXLvl34 = (byte)(1) ;
         ...
         else
         {
            ...
            {
               A312PaiNom = P024U3_A312PaiNom[0] ;
               A46PaiCod = P024U3_A46PaiCod[0] ;
      ...
      if ( AV17IsDynamicCall )
      {
         if ( GXutil.strcmp(AV16TrnMode, "GET_DSC") == 0 )
         {
            ...
            while ( AV40GXV2 <= AV29ValuesCollection.size() )
            {
               ...
               {
                  A46PaiCod = P024U4_A46PaiCod[0] ;
                  A47ProvCod = P024U4_A47ProvCod[0] ;
                  A322ProvNom = P024U4_A322ProvNom[0] ;
                  AV41GXLvl73 = (byte)(1) ;
         ...
         else
         {
            ...
            {
               A46PaiCod = P024U5_A46PaiCod[0] ;
               A322ProvNom = P024U5_A322ProvNom[0] ;
               A47ProvCod = P024U5_A47ProvCod[0] ;
               AV14Combo_DataItem = (web.wwpbaseobjects.SdtDVB_SDTComboData_Item)new web.wwpbaseobjects.SdtDVB_SDTComboData_Item(remoteHandle, context);
   ...
   {
      this.aP9[0] = categorialoaddvcombo.this.AV22SelectedValue;
      this.aP10[0] = categorialoaddvcombo.this.AV23SelectedText;
      this.aP11[0] = categorialoaddvcombo.this.AV24Combo_DataJson;
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      AV30ValueItem = "" ;
      scmdbuf = "" ;
      P024U2_A46PaiCod = new short[1] ;
      P024U2_A312PaiNom = new String[] {""} ;
      lV12SearchTxt = "" ;
      P024U3_A312PaiNom = new String[] {""} ;
      P024U3_A46PaiCod = new short[1] ;
      ...
      A322ProvNom = "" ;
      P024U4_A46PaiCod = new short[1] ;
      P024U4_A47ProvCod = new short[1] ;
      P024U4_A322ProvNom = new String[] {""} ;
      P024U5_A46PaiCod = new short[1] ;
      P024U5_A322ProvNom = new String[] {""} ;
      P024U5_A47ProvCod = new short[1] ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.categorialoaddvcombo__default(),
         new Object[] {
             new Object[] {
            P024U2_A46PaiCod, P024U2_A312PaiNom
            }
            , new Object[] {
            P024U3_A312PaiNom, P024U3_A46PaiCod
            }
            , new Object[] {
            P024U4_A46PaiCod, P024U4_A47ProvCod, P024U4_A322ProvNom
            }
            , new Object[] {
            P024U5_A46PaiCod, P024U5_A322ProvNom, P024U5_A47ProvCod
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] P024U2_A46PaiCod ;
   private String[] P024U2_A312PaiNom ;
   private String[] P024U3_A312PaiNom ;
   private short[] P024U3_A46PaiCod ;
   private short[] P024U4_A46PaiCod ;
   private short[] P024U4_A47ProvCod ;
   private String[] P024U4_A322ProvNom ;
   private short[] P024U5_A46PaiCod ;
   private String[] P024U5_A322ProvNom ;
   private short[] P024U5_A47ProvCod ;
...
final  class categorialoaddvcombo__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P024U3( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_P024U5( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV12SearchTxt ,
                                          String A322ProvNom ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 1 :
                  return conditional_P024U3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 3 :
                  return conditional_P024U5(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P024U2", "SELECT PaiCod, PaiNom FROM Pais WHERE PaiCod = ? ORDER BY PaiCod  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("P024U3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("P024U4", "SELECT PaiCod, ProvCod, ProvNom FROM Provincia WHERE PaiCod = ? and ProvCod = ? ORDER BY PaiCod, ProvCod  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("P024U5", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
