...
public final  class convenio_adicionalimporteswc_impl extends GXWebComponent
{
   public convenio_adicionalimporteswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_adicionalimporteswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_adicionalimporteswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV28CliPaiConve = (short)(GXutil.lval( httpContext.GetPar( "CliPaiConve"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV28CliPaiConve", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV28CliPaiConve), 4, 0));
               AV29CliConvenio = httpContext.GetPar( "CliConvenio") ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV29CliConvenio", AV29CliConvenio);
               AV10ConveAdicod = httpContext.GetPar( "ConveAdicod") ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10ConveAdicod", AV10ConveAdicod);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV26CliCod),Short.valueOf(AV28CliPaiConve),AV29CliConvenio,AV10ConveAdicod});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV26CliCod, AV28CliPaiConve, AV29CliConvenio, AV10ConveAdicod, AV32Pgmname, AV16OrderedBy, AV17OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "convenio_adicionalimportes WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_adicionalimporteswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV26CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV28CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV29CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV10ConveAdicod))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV26CliCod", GXutil.ltrim( localUtil.ntoc( wcpOAV26CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV28CliPaiConve", GXutil.ltrim( localUtil.ntoc( wcpOAV28CliPaiConve, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV29CliConvenio", GXutil.rtrim( wcpOAV29CliConvenio));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV10ConveAdicod", GXutil.rtrim( wcpOAV10ConveAdicod));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCLICOD", GXutil.ltrim( localUtil.ntoc( AV26CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCLIPAICONVE", GXutil.ltrim( localUtil.ntoc( AV28CliPaiConve, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCLICONVENIO", GXutil.rtrim( AV29CliConvenio));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCONVEADICOD", GXutil.rtrim( AV10ConveAdicod));
   ...
   {
      return "convenio_adicionalimportesWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "convenio_adicionalimportes WC", "") ;
   }
   ...
   public void wbE60( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.convenio_adicionalimporteswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_convenio_adicionalimportesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliPaiConve_Internalname, GXutil.ltrim( localUtil.ntoc( A1564CliPaiConve, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1564CliPaiConve), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliPaiConve_Jsonclick, 0, "Attribute", "", "", "", "", edtCliPaiConve_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_convenio_adicionalimportesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliConvenio_Internalname, GXutil.rtrim( A1565CliConvenio), GXutil.rtrim( localUtil.format( A1565CliConvenio, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliConvenio_Jsonclick, 0, "Attribute", "", "", "", "", edtCliConvenio_Visible, 0, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_convenio_adicionalimportesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtConveAdicod_Internalname, GXutil.rtrim( A996ConveAdicod), GXutil.rtrim( localUtil.format( A996ConveAdicod, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtConveAdicod_Jsonclick, 0, "Attribute", "", "", "", "", edtConveAdicod_Visible, 0, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_convenio_adicionalimportesWC.htm");
         /* User Defined Control */
   ...
   public void startE62( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "convenio_adicionalimportes WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 int AV26CliCod ,
                                 short AV28CliPaiConve ,
                                 String AV29CliConvenio ,
                                 String AV10ConveAdicod ,
                                 String AV32Pgmname ,
                                 short AV16OrderedBy ,
   ...
   {
      /* GeneXus formulas. */
      AV32Pgmname = "convenio_adicionalimportesWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfE62( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00E62 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV26CliCod), Short.valueOf(AV28CliPaiConve), AV29CliConvenio, AV10ConveAdicod, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A3CliCod = H00E62_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1564CliPaiConve = H00E62_A1564CliPaiConve[0] ;
            ...
            A1565CliConvenio = H00E62_A1565CliConvenio[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1565CliConvenio", A1565CliConvenio);
            A996ConveAdicod = H00E62_A996ConveAdicod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A996ConveAdicod", A996ConveAdicod);
            A1899ConveAdiImpRelSec = H00E62_A1899ConveAdiImpRelSec[0] ;
            A1000ConveAdiImporte = H00E62_A1000ConveAdiImporte[0] ;
            A999ConveAdiVig = H00E62_A999ConveAdiVig[0] ;
            e16E62 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00E63 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV26CliCod), Short.valueOf(AV28CliPaiConve), AV29CliConvenio, AV10ConveAdicod});
      GRID_nRecordCount = H00E63_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strupE60( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV28CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV28CliPaiConve"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         wcpOAV29CliConvenio = httpContext.cgiGet( sPrefix+"wcpOAV29CliConvenio") ;
         wcpOAV10ConveAdicod = httpContext.cgiGet( sPrefix+"wcpOAV10ConveAdicod") ;
   ...
   public void e14E62( )
   {
      ...
      convenio_adicionalimporteswc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV26CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV26CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV26CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtConveAdicod_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtConveAdicod_Visible), 5, 0), true);
   ...
   public void e15E62( )
   {
      ...
      convenio_adicionalimporteswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV18Session.getValue(AV32Pgmname+"GridState"), "") == 0 )
      {
         AV14GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV32Pgmname+"GridState"), null, null);
      }
      else
      {
         AV14GridState.fromxml(AV18Session.getValue(AV32Pgmname+"GridState"), null, null);
      }
   ...
   public void S142( )
   {
      ...
      new web.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV32Pgmname+"GridState", AV14GridState.toxml(false, true, "WWPGridState", "PayDay")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV32Pgmname );
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "convenio_adicional" );
      ...
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV26CliCod, 6, 0) );
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
      AV13TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "CliPaiConve" );
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV28CliPaiConve, 4, 0) );
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
      AV13TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "CliConvenio" );
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( AV29CliConvenio );
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
      AV13TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ConveAdicod" );
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( AV10ConveAdicod );
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
   ...
   {
      AV26CliCod = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV26CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV26CliCod), 6, 0));
      AV28CliPaiConve = ((Number) GXutil.testNumericType( getParm(obj,1,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV28CliPaiConve", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV28CliPaiConve), 4, 0));
      AV29CliConvenio = (String)getParm(obj,2,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV29CliConvenio", AV29CliConvenio);
      AV10ConveAdicod = (String)getParm(obj,3,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10ConveAdicod", AV10ConveAdicod);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV26CliCod = (String)getParm(obj,0,TypeConstants.STRING) ;
      sCtrlAV28CliPaiConve = (String)getParm(obj,1,TypeConstants.STRING) ;
      sCtrlAV29CliConvenio = (String)getParm(obj,2,TypeConstants.STRING) ;
      sCtrlAV10ConveAdicod = (String)getParm(obj,3,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "convenio_adicionalimporteswc", GetJustCreated( ));
      ...
      {
         AV26CliCod = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV26CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV26CliCod), 6, 0));
         AV28CliPaiConve = ((Number) GXutil.testNumericType( getParm(obj,3,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV28CliPaiConve", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV28CliPaiConve), 4, 0));
         AV29CliConvenio = (String)getParm(obj,4,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV29CliConvenio", AV29CliConvenio);
         AV10ConveAdicod = (String)getParm(obj,5,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10ConveAdicod", AV10ConveAdicod);
      }
      wcpOAV26CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV26CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV28CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV28CliPaiConve"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV29CliConvenio = httpContext.cgiGet( sPrefix+"wcpOAV29CliConvenio") ;
      wcpOAV10ConveAdicod = httpContext.cgiGet( sPrefix+"wcpOAV10ConveAdicod") ;
      if ( ! GetJustCreated( ) && ( ( AV26CliCod != wcpOAV26CliCod ) || ( AV28CliPaiConve != wcpOAV28CliPaiConve ) || ( GXutil.strcmp(AV29CliConvenio, wcpOAV29CliConvenio) != 0 ) || ( GXutil.strcmp(AV10ConveAdicod, wcpOAV10ConveAdicod) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV26CliCod = AV26CliCod ;
      wcpOAV28CliPaiConve = AV28CliPaiConve ;
      wcpOAV29CliConvenio = AV29CliConvenio ;
      wcpOAV10ConveAdicod = AV10ConveAdicod ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlAV28CliPaiConve = httpContext.cgiGet( sPrefix+"AV28CliPaiConve_CTRL") ;
      if ( GXutil.len( sCtrlAV28CliPaiConve) > 0 )
      {
         AV28CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV28CliPaiConve), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV28CliPaiConve", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV28CliPaiConve), 4, 0));
      }
      else
      {
         AV28CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV28CliPaiConve_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
      sCtrlAV29CliConvenio = httpContext.cgiGet( sPrefix+"AV29CliConvenio_CTRL") ;
      if ( GXutil.len( sCtrlAV29CliConvenio) > 0 )
      {
         AV29CliConvenio = httpContext.cgiGet( sCtrlAV29CliConvenio) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV29CliConvenio", AV29CliConvenio);
      }
      else
      {
         AV29CliConvenio = httpContext.cgiGet( sPrefix+"AV29CliConvenio_PARM") ;
      }
      sCtrlAV10ConveAdicod = httpContext.cgiGet( sPrefix+"AV10ConveAdicod_CTRL") ;
      if ( GXutil.len( sCtrlAV10ConveAdicod) > 0 )
      {
         AV10ConveAdicod = httpContext.cgiGet( sCtrlAV10ConveAdicod) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10ConveAdicod", AV10ConveAdicod);
      }
      else
      {
         AV10ConveAdicod = httpContext.cgiGet( sPrefix+"AV10ConveAdicod_PARM") ;
      }
   }
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV26CliCod_PARM", GXutil.ltrim( localUtil.ntoc( AV26CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV26CliCod)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV26CliCod_CTRL", GXutil.rtrim( sCtrlAV26CliCod));
      }
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV28CliPaiConve_PARM", GXutil.ltrim( localUtil.ntoc( AV28CliPaiConve, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV28CliPaiConve)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV28CliPaiConve_CTRL", GXutil.rtrim( sCtrlAV28CliPaiConve));
      }
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV29CliConvenio_PARM", GXutil.rtrim( AV29CliConvenio));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV29CliConvenio)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV29CliConvenio_CTRL", GXutil.rtrim( sCtrlAV29CliConvenio));
      }
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV10ConveAdicod_PARM", GXutil.rtrim( AV10ConveAdicod));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV10ConveAdicod)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV10ConveAdicod_CTRL", GXutil.rtrim( sCtrlAV10ConveAdicod));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713332230", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("convenio_adicionalimporteswc.js", "?20251713332230", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtConveAdiVig_Internalname = sPrefix+"CONVEADIVIG_"+sGXsfl_15_idx ;
      edtConveAdiImporte_Internalname = sPrefix+"CONVEADIIMPORTE_"+sGXsfl_15_idx ;
      edtConveAdiImpRelSec_Internalname = sPrefix+"CONVEADIIMPRELSEC_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtConveAdiVig_Internalname = sPrefix+"CONVEADIVIG_"+sGXsfl_15_fel_idx ;
      edtConveAdiImporte_Internalname = sPrefix+"CONVEADIIMPORTE_"+sGXsfl_15_fel_idx ;
      edtConveAdiImpRelSec_Internalname = sPrefix+"CONVEADIIMPRELSEC_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtConveAdiImpRelSec_Internalname,GXutil.ltrim( localUtil.ntoc( A1899ConveAdiImpRelSec, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1899ConveAdiImpRelSec), "ZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtConveAdiImpRelSec_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(6),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         send_integrity_lvl_hashesE62( ) ;
   ...
   {
      edtConveAdiVig_Internalname = sPrefix+"CONVEADIVIG" ;
      edtConveAdiImporte_Internalname = sPrefix+"CONVEADIIMPORTE" ;
      edtConveAdiImpRelSec_Internalname = sPrefix+"CONVEADIIMPRELSEC" ;
      ...
      edtConveAdicod_Internalname = sPrefix+"CONVEADICOD" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:ConveAdiVig|1:ConveAdiImporte|2:ConveAdiImpRelSec" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV26CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV28CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9'},{av:'AV29CliConvenio',fld:'vCLICONVENIO',pic:''},{av:'AV10ConveAdicod',fld:'vCONVEADICOD',pic:''},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV26CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV22GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV23GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV24GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11E62',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV28CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9'},{av:'AV29CliConvenio',fld:'vCLICONVENIO',pic:''},{av:'AV10ConveAdicod',fld:'vCONVEADICOD',pic:''},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12E62',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV28CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9'},{av:'AV29CliConvenio',fld:'vCLICONVENIO',pic:''},{av:'AV10ConveAdicod',fld:'vCONVEADICOD',pic:''},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13E62',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV28CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9'},{av:'AV29CliConvenio',fld:'vCLICONVENIO',pic:''},{av:'AV10ConveAdicod',fld:'vCONVEADICOD',pic:''},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16E62',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Conveadiimprelsec',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00E62_A3CliCod = new int[1] ;
      H00E62_A1564CliPaiConve = new short[1] ;
      H00E62_A1565CliConvenio = new String[] {""} ;
      H00E62_A996ConveAdicod = new String[] {""} ;
      H00E62_A1899ConveAdiImpRelSec = new int[1] ;
      H00E62_A1000ConveAdiImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00E62_A999ConveAdiVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00E63_AGRID_nRecordCount = new long[1] ;
      ...
      sCtrlAV26CliCod = "" ;
      sCtrlAV28CliPaiConve = "" ;
      sCtrlAV29CliConvenio = "" ;
      sCtrlAV10ConveAdicod = "" ;
      subGrid_Linesclass = "" ;
      ROClassString = "" ;
      GridColumn = new com.genexus.webpanels.GXWebColumn();
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_adicionalimporteswc__default(),
         new Object[] {
             new Object[] {
            H00E62_A3CliCod, H00E62_A1564CliPaiConve, H00E62_A1565CliConvenio, H00E62_A996ConveAdicod, H00E62_A1899ConveAdiImpRelSec, H00E62_A1000ConveAdiImporte, H00E62_A999ConveAdiVig
            }
            , new Object[] {
            H00E63_AGRID_nRecordCount
            }
         }
      );
      AV32Pgmname = "convenio_adicionalimportesWC" ;
   ...
   private short wcpOAV28CliPaiConve ;
   ...
   private String wcpOAV29CliConvenio ;
   ...
   private String sCtrlAV28CliPaiConve ;
   private String sCtrlAV29CliConvenio ;
   private String sCtrlAV10ConveAdicod ;
   ...
   private int[] H00E62_A3CliCod ;
   private short[] H00E62_A1564CliPaiConve ;
   private String[] H00E62_A1565CliConvenio ;
   private String[] H00E62_A996ConveAdicod ;
   private int[] H00E62_A1899ConveAdiImpRelSec ;
   private java.math.BigDecimal[] H00E62_A1000ConveAdiImporte ;
   private java.util.Date[] H00E62_A999ConveAdiVig ;
   private long[] H00E63_AGRID_nRecordCount ;
...
final  class convenio_adicionalimporteswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00E62( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          String A996ConveAdicod )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, CliPaiConve, CliConvenio, ConveAdicod, ConveAdiImpRelSec, ConveAdiImporte, ConveAdiVig" ;
      sFromString = " FROM convenio_adicionalimportes" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveAdicod = ( ?))");
      ...
      {
         sOrderString += " ORDER BY CliCod DESC, CliPaiConve DESC, CliConvenio DESC, ConveAdicod DESC, ConveAdiVig DESC" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, CliPaiConve, CliConvenio, ConveAdicod, ConveAdiImporte, ConveAdiVig" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, CliPaiConve DESC, CliConvenio DESC, ConveAdicod DESC, ConveAdiImporte DESC, ConveAdiVig" ;
      }
      else if ( ( AV16OrderedBy == 3 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, CliPaiConve, CliConvenio, ConveAdicod, ConveAdiImpRelSec, ConveAdiVig" ;
      }
      else if ( ( AV16OrderedBy == 3 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, CliPaiConve DESC, CliConvenio DESC, ConveAdicod DESC, ConveAdiImpRelSec DESC, ConveAdiVig" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, CliPaiConve, CliConvenio, ConveAdicod, ConveAdiVig" ;
   ...
   protected Object[] conditional_H00E63( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV16OrderedBy ,
                                          boolean AV17OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00E62(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , (String)dynConstraints[8] , (String)dynConstraints[9] );
            case 1 :
                  return conditional_H00E63(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , (String)dynConstraints[8] , (String)dynConstraints[9] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00E62", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00E63", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
