...
public final  class siniestradoview_impl extends GXDataArea
{
   public siniestradoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public siniestradoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( siniestradoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "SinieCodigo") ;
         ...
         {
            AV9SinieCodigo = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV9SinieCodigo", AV9SinieCodigo);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSINIECODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SinieCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.siniestradoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV9SinieCodigo)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"SinieCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vSINIECODIGO", GXutil.rtrim( AV9SinieCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSINIECODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SinieCodigo, ""))));
   ...
   {
      return formatLink("web.siniestradoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV9SinieCodigo)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"SinieCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "SiniestradoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Siniestrado View", "") ;
   }
   ...
   public void wb1C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1C2( true) ;
      }
      else
      {
         wb_table1_9_1C2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1C2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1C2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Siniestrado View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup1C0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV9SinieCodigo = httpContext.cgiGet( "vSINIECODIGO") ;
   ...
   public void e111C2( )
   {
      ...
      {
         A19SinieCodigo = H001C2_A19SinieCodigo[0] ;
         A333SinieDescri = H001C2_A333SinieDescri[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A333SinieDescri );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SiniestradoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.siniestradogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SiniestradoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV9SinieCodigo});
   ...
   public void wb_table1_9_1C2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_SiniestradoView.htm");
         /* Div Control */
         ...
         wb_table1_9_1C2e( true) ;
      }
      else
      {
         wb_table1_9_1C2e( false) ;
      }
   }
   ...
   {
      AV9SinieCodigo = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9SinieCodigo", AV9SinieCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSINIECODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SinieCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020394963", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("siniestradoview.js", "?2024122020394963", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Siniestrado View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV9SinieCodigo',fld:'vSINIECODIGO',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001C2_A19SinieCodigo = new String[] {""} ;
      H001C2_A333SinieDescri = new String[] {""} ;
      A19SinieCodigo = "" ;
      A333SinieDescri = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.siniestradoview__default(),
         new Object[] {
             new Object[] {
            H001C2_A19SinieCodigo, H001C2_A333SinieDescri
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV9SinieCodigo ;
   ...
   private String[] H001C2_A19SinieCodigo ;
   private String[] H001C2_A333SinieDescri ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class siniestradoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001C2", "SELECT SinieCodigo, SinieDescri FROM Siniestrado WHERE SinieCodigo = ( ?) ORDER BY SinieCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
