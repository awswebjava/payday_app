...
public final  class clienteview_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.clienteview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.clienteview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","TabCode"})  ;
   }
   ...
   public void wbGH0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_GH2( true) ;
      }
      else
      {
         wb_table1_9_GH2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_GH2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void send_integrity_lvl_hashesGH2( )
   {
   }
   ...
   public void e11GH2( )
   {
      ...
      {
         A3CliCod = H00GH2_A3CliCod[0] ;
         A344CliNom = H00GH2_A344CliNom[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( A344CliNom );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.clientegeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ClienteGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod)});
   ...
   public void wb_table1_9_GH2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ClienteView.htm");
         /* Div Control */
         ...
         wb_table1_9_GH2e( true) ;
      }
      else
      {
         wb_table1_9_GH2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019444388", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("clienteview.js", "?2024122019444388", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00GH2_A3CliCod = new int[1] ;
      H00GH2_A344CliNom = new String[] {""} ;
      A344CliNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.clienteview__default(),
         new Object[] {
             new Object[] {
            H00GH2_A3CliCod, H00GH2_A344CliNom
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int[] H00GH2_A3CliCod ;
   private String[] H00GH2_A344CliNom ;
...
final  class clienteview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00GH2", "SELECT CliCod, CliNom FROM Cliente WHERE CliCod = ? ORDER BY CliCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
