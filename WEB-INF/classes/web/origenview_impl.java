...
public final  class origenview_impl extends GXDataArea
{
   public origenview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public origenview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( origenview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10OrigId = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10OrigId", AV10OrigId);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vORIGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10OrigId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.origenview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10OrigId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"OrigId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vORIGID", GXutil.rtrim( AV10OrigId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vORIGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10OrigId, ""))));
   ...
   {
      return formatLink("web.origenview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10OrigId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"OrigId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Origen View", "") ;
   }
   ...
   public void wbFV0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_FV2( true) ;
      }
      else
      {
         wb_table1_9_FV2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_FV2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startFV2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Origen View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesFV2( )
   {
   }
   ...
   public void strupFV0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10OrigId = httpContext.cgiGet( "vORIGID") ;
   ...
   public void e11FV2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00FV2 */
      pr_default.execute(0, new Object[] {AV10OrigId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1231OrigId = H00FV2_A1231OrigId[0] ;
         A1284OrigNombre = H00FV2_A1284OrigNombre[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A1284OrigNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "OrigenGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.origengeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "OrigenGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10OrigId});
   ...
   public void wb_table1_9_FV2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_OrigenView.htm");
         /* Div Control */
         ...
         wb_table1_9_FV2e( true) ;
      }
      else
      {
         wb_table1_9_FV2e( false) ;
      }
   }
   ...
   {
      AV10OrigId = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10OrigId", AV10OrigId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vORIGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10OrigId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020322769", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("origenview.js", "?2024122020322769", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Origen View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10OrigId',fld:'vORIGID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00FV2_A1231OrigId = new String[] {""} ;
      H00FV2_A1284OrigNombre = new String[] {""} ;
      A1231OrigId = "" ;
      A1284OrigNombre = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.origenview__default(),
         new Object[] {
             new Object[] {
            H00FV2_A1231OrigId, H00FV2_A1284OrigNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10OrigId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV10OrigId ;
   ...
   private String[] H00FV2_A1231OrigId ;
   private String[] H00FV2_A1284OrigNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class origenview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00FV2", "SELECT OrigId, OrigNombre FROM Origen WHERE OrigId = ( ?) ORDER BY OrigId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
