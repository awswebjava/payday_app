...
public final  class importacion_conceptosview_impl extends GXDataArea
{
   public importacion_conceptosview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public importacion_conceptosview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( importacion_conceptosview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12ImpLiqSec = (short)(GXutil.lval( httpContext.GetPar( "ImpLiqSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12ImpLiqSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12ImpLiqSec), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPLIQSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12ImpLiqSec), "ZZZ9")));
               AV13ImpLiqConExtCod = httpContext.GetPar( "ImpLiqConExtCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13ImpLiqConExtCod", AV13ImpLiqConExtCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPLIQCONEXTCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ImpLiqConExtCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.importacion_conceptosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12ImpLiqSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV13ImpLiqConExtCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","ImpLiqSec","ImpLiqConExtCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vIMPLIQSEC", GXutil.ltrim( localUtil.ntoc( AV12ImpLiqSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPLIQSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12ImpLiqSec), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vIMPLIQCONEXTCOD", GXutil.rtrim( AV13ImpLiqConExtCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPLIQCONEXTCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ImpLiqConExtCod, ""))));
   ...
   {
      return formatLink("web.importacion_conceptosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12ImpLiqSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV13ImpLiqConExtCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","ImpLiqSec","ImpLiqConExtCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "importacion_conceptosView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "importacion_conceptos View", "") ;
   }
   ...
   public void wb8E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_8E2( true) ;
      }
      else
      {
         wb_table1_9_8E2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_8E2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start8E2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "importacion_conceptos View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes8E2( )
   {
   }
   ...
   public void strup8E0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12ImpLiqSec = (short)(localUtil.ctol( httpContext.cgiGet( "vIMPLIQSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         AV13ImpLiqConExtCod = httpContext.cgiGet( "vIMPLIQCONEXTCOD") ;
   ...
   public void e118E2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H008E2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Short.valueOf(AV12ImpLiqSec), AV13ImpLiqConExtCod, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Short.valueOf(AV12ImpLiqSec), AV13ImpLiqConExtCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A89ImpLiqConExtCod = H008E2_A89ImpLiqConExtCod[0] ;
         A88ImpLiqSec = H008E2_A88ImpLiqSec[0] ;
         A1EmpCod = H008E2_A1EmpCod[0] ;
         A3CliCod = H008E2_A3CliCod[0] ;
         A911ImpLiqTipoConCod = H008E2_A911ImpLiqTipoConCod[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( A911ImpLiqTipoConCod );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "importacion_conceptosGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.importacion_conceptosgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "importacion_conceptosGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),Short.valueOf(AV12ImpLiqSec),AV13ImpLiqConExtCod});
   ...
   public void wb_table1_9_8E2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_importacion_conceptosView.htm");
         /* Div Control */
         ...
         wb_table1_9_8E2e( true) ;
      }
      else
      {
         wb_table1_9_8E2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12ImpLiqSec = ((Number) GXutil.testNumericType( getParm(obj,2), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12ImpLiqSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12ImpLiqSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPLIQSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12ImpLiqSec), "ZZZ9")));
      AV13ImpLiqConExtCod = (String)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13ImpLiqConExtCod", AV13ImpLiqConExtCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vIMPLIQCONEXTCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ImpLiqConExtCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202091169", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("importacion_conceptosview.js", "?202412202091169", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "importacion_conceptos View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12ImpLiqSec',fld:'vIMPLIQSEC',pic:'ZZZ9',hsh:true},{av:'AV13ImpLiqConExtCod',fld:'vIMPLIQCONEXTCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H008E2_A89ImpLiqConExtCod = new String[] {""} ;
      H008E2_A88ImpLiqSec = new short[1] ;
      H008E2_A1EmpCod = new short[1] ;
      H008E2_A3CliCod = new int[1] ;
      H008E2_A911ImpLiqTipoConCod = new String[] {""} ;
      A89ImpLiqConExtCod = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.importacion_conceptosview__default(),
         new Object[] {
             new Object[] {
            H008E2_A89ImpLiqConExtCod, H008E2_A88ImpLiqSec, H008E2_A1EmpCod, H008E2_A3CliCod, H008E2_A911ImpLiqTipoConCod
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV12ImpLiqSec ;
   ...
   private int idxLst ;
   private String wcpOAV13ImpLiqConExtCod ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV13ImpLiqConExtCod ;
   ...
   private String[] H008E2_A89ImpLiqConExtCod ;
   private short[] H008E2_A88ImpLiqSec ;
   private short[] H008E2_A1EmpCod ;
   private int[] H008E2_A3CliCod ;
   private String[] H008E2_A911ImpLiqTipoConCod ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class importacion_conceptosview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H008E2", "SELECT ImpLiqConExtCod, ImpLiqSec, EmpCod, CliCod, ImpLiqTipoConCod FROM importacion_conceptos WHERE (CliCod = ? and EmpCod = ? and ImpLiqSec = ? and ImpLiqConExtCod = ( ?)) AND (CliCod = ? and EmpCod = ? and ImpLiqSec = ? and ImpLiqConExtCod = ( ?)) ORDER BY CliCod, EmpCod, ImpLiqSec, ImpLiqConExtCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
