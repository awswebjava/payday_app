...
@javax.xml.bind.annotation.XmlType(name = "siradig_codigosloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class siradig_codigosloaddvcombo_RESTInterfaceIN
{
   ...
   String AV19SiraTipo;
   @JsonProperty("SiraTipo")
   public String getSiraTipo( )
   {
      if ( GXutil.strcmp(AV19SiraTipo, null) == 0 )
      {
         return "" ;
      }
      else
   ...
   @JsonProperty("SiraTipo")
   public void setSiraTipo(  String Value )
   {
      if ( Value == null )
      {
         AV19SiraTipo = "" ;
   ...
   @JsonProperty("SiraCodigo")
   public String getSiraCodigo( )
   {
      if ( GXutil.strcmp(AV20SiraCodigo, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV20SiraCodigo ;
      }
   }

   @JsonProperty("SiraCodigo")
   public void setSiraCodigo(  String Value )
   {
      if ( Value == null )
      {
         AV20SiraCodigo = "" ;
