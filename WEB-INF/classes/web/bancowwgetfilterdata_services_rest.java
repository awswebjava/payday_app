...
@javax.ws.rs.Path("/BancoWWGetFilterData")
public final  class bancowwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.bancowwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV23DDOName;
      ...
      if ( ! processHeaders("bancowwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.bancowwgetfilterdata worker = new web.bancowwgetfilterdata(remoteHandle, context);
         worker.execute(AV23DDOName,AV21SearchTxt,AV22SearchTxtTo,AV27OptionsJson,AV30OptionsDescJson,AV32OptionIndexesJson );
         web.bancowwgetfilterdata_RESTInterfaceOUT data = new web.bancowwgetfilterdata_RESTInterfaceOUT();
