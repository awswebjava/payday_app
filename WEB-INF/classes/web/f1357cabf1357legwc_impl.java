...
public final  class f1357cabf1357legwc_impl extends GXWebComponent
{
   public f1357cabf1357legwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public f1357cabf1357legwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( f1357cabf1357legwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "F1357 Cab F1357 Leg WC", "")) ;
   ...
   public void renderHtmlCloseForm9K2( )
   {
   ...
   {
      return "F1357CabF1357LegWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "F1357 Cab F1357 Leg WC", "") ;
   }
   ...
   public void wb9K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.f1357cabf1357legwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 22 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_F1357CabF1357LegWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_F1357CabF1357LegWC.htm");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbF1357CTipoPre, cmbF1357CTipoPre.getInternalname(), GXutil.trim( GXutil.str( A784F1357CTipoPre, 1, 0)), 1, cmbF1357CTipoPre.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbF1357CTipoPre.getVisible(), 0, 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_F1357CabF1357LegWC.htm");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtF1357CPer_Internalname, GXutil.rtrim( A777F1357CPer), GXutil.rtrim( localUtil.format( A777F1357CPer, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtF1357CPer_Jsonclick, 0, "Attribute", "", "", "", "", edtF1357CPer_Visible, 0, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_F1357CabF1357LegWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtF1357CSec_Internalname, GXutil.ltrim( localUtil.ntoc( A778F1357CSec, (byte)(2), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A778F1357CSec), "Z9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtF1357CSec_Jsonclick, 0, "Attribute", "", "", "", "", edtF1357CSec_Visible, 0, 0, "text", "1", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_F1357CabF1357LegWC.htm");
         /* User Defined Control */
   ...
   public void start9K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "F1357 Cab F1357 Leg WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           cmbF1357LBeneficio.setName( cmbF1357LBeneficio.getInternalname() );
   ...
   {
      /* GeneXus formulas. */
      AV37Pgmname = "F1357CabF1357LegWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf9K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A3CliCod = H009K2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H009K2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A784F1357CTipoPre = H009K2_A784F1357CTipoPre[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A784F1357CTipoPre", GXutil.str( A784F1357CTipoPre, 1, 0));
            A777F1357CPer = H009K2_A777F1357CPer[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A777F1357CPer", A777F1357CPer);
            A778F1357CSec = H009K2_A778F1357CSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A778F1357CSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A778F1357CSec), 2, 0));
            A796F1357LMilitar = H009K2_A796F1357LMilitar[0] ;
            A795F1357LTeletrabajo = H009K2_A795F1357LTeletrabajo[0] ;
            A794F1357L27549 = H009K2_A794F1357L27549[0] ;
            A793F1357LLey27424 = H009K2_A793F1357LLey27424[0] ;
            A792F1357LLargaDist = H009K2_A792F1357LLargaDist[0] ;
            A791F1357LBeneficio = H009K2_A791F1357LBeneficio[0] ;
            A790F1357LMeses = H009K2_A790F1357LMeses[0] ;
            A789F1357LPerHas = H009K2_A789F1357LPerHas[0] ;
            A788F1357LPerDesd = H009K2_A788F1357LPerDesd[0] ;
            A787F1357LCuil = H009K2_A787F1357LCuil[0] ;
            A250LegIdNomApe = H009K2_A250LegIdNomApe[0] ;
            A786F1357LTipoReg = H009K2_A786F1357LTipoReg[0] ;
            A6LegNumero = H009K2_A6LegNumero[0] ;
            A250LegIdNomApe = H009K2_A250LegIdNomApe[0] ;
            e169K2 ();
   ...
   public void send_integrity_lvl_hashes9K2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV37Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV37Pgmname, ""))));
   }
   ...
   public void e149K2( )
   {
      ...
      f1357cabf1357legwc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e159K2( )
   {
      ...
      f1357cabf1357legwc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV13TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "F1357Leg" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "f1357cabf1357legwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713385591", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("f1357cabf1357legwc.js", "?20251713385591", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_222( )
   {
      ...
      edtF1357LTipoReg_Internalname = sPrefix+"F1357LTIPOREG_"+sGXsfl_22_idx ;
      edtLegIdNomApe_Internalname = sPrefix+"LEGIDNOMAPE_"+sGXsfl_22_idx ;
      edtF1357LCuil_Internalname = sPrefix+"F1357LCUIL_"+sGXsfl_22_idx ;
      edtF1357LPerDesd_Internalname = sPrefix+"F1357LPERDESD_"+sGXsfl_22_idx ;
      edtF1357LPerHas_Internalname = sPrefix+"F1357LPERHAS_"+sGXsfl_22_idx ;
      edtF1357LMeses_Internalname = sPrefix+"F1357LMESES_"+sGXsfl_22_idx ;
      cmbF1357LBeneficio.setInternalname( sPrefix+"F1357LBENEFICIO_"+sGXsfl_22_idx );
      edtF1357LLargaDist_Internalname = sPrefix+"F1357LLARGADIST_"+sGXsfl_22_idx ;
      edtF1357LLey27424_Internalname = sPrefix+"F1357LLEY27424_"+sGXsfl_22_idx ;
      edtF1357L27549_Internalname = sPrefix+"F1357L27549_"+sGXsfl_22_idx ;
      edtF1357LTeletrabajo_Internalname = sPrefix+"F1357LTELETRABAJO_"+sGXsfl_22_idx ;
      edtF1357LMilitar_Internalname = sPrefix+"F1357LMILITAR_"+sGXsfl_22_idx ;
   }

   public void subsflControlProps_fel_222( )
   {
      edtLegNumero_Internalname = sPrefix+"LEGNUMERO_"+sGXsfl_22_fel_idx ;
      edtF1357LTipoReg_Internalname = sPrefix+"F1357LTIPOREG_"+sGXsfl_22_fel_idx ;
      edtLegIdNomApe_Internalname = sPrefix+"LEGIDNOMAPE_"+sGXsfl_22_fel_idx ;
      edtF1357LCuil_Internalname = sPrefix+"F1357LCUIL_"+sGXsfl_22_fel_idx ;
      edtF1357LPerDesd_Internalname = sPrefix+"F1357LPERDESD_"+sGXsfl_22_fel_idx ;
      edtF1357LPerHas_Internalname = sPrefix+"F1357LPERHAS_"+sGXsfl_22_fel_idx ;
      edtF1357LMeses_Internalname = sPrefix+"F1357LMESES_"+sGXsfl_22_fel_idx ;
      cmbF1357LBeneficio.setInternalname( sPrefix+"F1357LBENEFICIO_"+sGXsfl_22_fel_idx );
      edtF1357LLargaDist_Internalname = sPrefix+"F1357LLARGADIST_"+sGXsfl_22_fel_idx ;
      edtF1357LLey27424_Internalname = sPrefix+"F1357LLEY27424_"+sGXsfl_22_fel_idx ;
      edtF1357L27549_Internalname = sPrefix+"F1357L27549_"+sGXsfl_22_fel_idx ;
      edtF1357LTeletrabajo_Internalname = sPrefix+"F1357LTELETRABAJO_"+sGXsfl_22_fel_idx ;
      edtF1357LMilitar_Internalname = sPrefix+"F1357LMILITAR_"+sGXsfl_22_fel_idx ;
   }
   ...
   public void sendrow_222( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LTipoReg_Internalname,GXutil.rtrim( A786F1357LTipoReg),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LTipoReg_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LCuil_Internalname,GXutil.rtrim( A787F1357LCuil),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LCuil_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LPerDesd_Internalname,GXutil.rtrim( A788F1357LPerDesd),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LPerDesd_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LPerHas_Internalname,GXutil.rtrim( A789F1357LPerHas),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LPerHas_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LMeses_Internalname,GXutil.rtrim( A790F1357LMeses),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LMeses_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbF1357LBeneficio.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "F1357LBENEFICIO_" + sGXsfl_22_idx ;
            cmbF1357LBeneficio.setName( GXCCtl );
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbF1357LBeneficio,cmbF1357LBeneficio.getInternalname(),GXutil.trim( GXutil.str( A791F1357LBeneficio, 1, 0)),Integer.valueOf(1),cmbF1357LBeneficio.getJsonclick(),Integer.valueOf(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","int","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(0)});
         cmbF1357LBeneficio.setValue( GXutil.trim( GXutil.str( A791F1357LBeneficio, 1, 0)) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbF1357LBeneficio.getInternalname(), "Values", cmbF1357LBeneficio.ToJavascriptSource(), !bGXsfl_22_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LLargaDist_Internalname,GXutil.rtrim( A792F1357LLargaDist),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LLargaDist_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LLey27424_Internalname,GXutil.rtrim( A793F1357LLey27424),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LLey27424_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357L27549_Internalname,GXutil.rtrim( A794F1357L27549),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357L27549_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LTeletrabajo_Internalname,GXutil.rtrim( A795F1357LTeletrabajo),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LTeletrabajo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LMilitar_Internalname,GXutil.rtrim( A796F1357LMilitar),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LMilitar_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol22( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "LTipo Reg", "")) ;
         httpContext.writeTextNL( "</th>") ;
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Meses", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Beneficio", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Larga Dist.", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ley 27424", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ley 275549", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Ley Teletrabajo", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Militar", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A786F1357LTipoReg));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A250LegIdNomApe);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A787F1357LCuil));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A788F1357LPerDesd));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A789F1357LPerHas));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A790F1357LMeses));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A791F1357LBeneficio, (byte)(1), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A792F1357LLargaDist));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A793F1357LLey27424));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A794F1357L27549));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A795F1357LTeletrabajo));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A796F1357LMilitar));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void init_default_properties( )
   {
      ...
      edtF1357LTipoReg_Internalname = sPrefix+"F1357LTIPOREG" ;
      edtLegIdNomApe_Internalname = sPrefix+"LEGIDNOMAPE" ;
      edtF1357LCuil_Internalname = sPrefix+"F1357LCUIL" ;
      edtF1357LPerDesd_Internalname = sPrefix+"F1357LPERDESD" ;
      edtF1357LPerHas_Internalname = sPrefix+"F1357LPERHAS" ;
      edtF1357LMeses_Internalname = sPrefix+"F1357LMESES" ;
      cmbF1357LBeneficio.setInternalname( sPrefix+"F1357LBENEFICIO" );
      edtF1357LLargaDist_Internalname = sPrefix+"F1357LLARGADIST" ;
      edtF1357LLey27424_Internalname = sPrefix+"F1357LLEY27424" ;
      edtF1357L27549_Internalname = sPrefix+"F1357L27549" ;
      edtF1357LTeletrabajo_Internalname = sPrefix+"F1357LTELETRABAJO" ;
      edtF1357LMilitar_Internalname = sPrefix+"F1357LMILITAR" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Datalistproc = "F1357CabF1357LegWCGetFilterData" ;
      ...
      Ddo_grid_Columnids = "2:LegIdNomApe|4:F1357LPerDesd|5:F1357LPerHas|6:F1357LMeses|7:F1357LBeneficio|8:F1357LLargaDist|9:F1357LLey27424|10:F1357L27549|11:F1357LTeletrabajo|12:F1357LMilitar" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e169K2',iparms:[]");
      ...
      setEventMetadata("NULL","{handler:'valid_F1357lmilitar',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV31TFLegIdNomApe = "" ;
      H009K2_A3CliCod = new int[1] ;
      H009K2_A1EmpCod = new short[1] ;
      H009K2_A784F1357CTipoPre = new byte[1] ;
      H009K2_A777F1357CPer = new String[] {""} ;
      H009K2_A778F1357CSec = new byte[1] ;
      H009K2_A796F1357LMilitar = new String[] {""} ;
      H009K2_A795F1357LTeletrabajo = new String[] {""} ;
      H009K2_A794F1357L27549 = new String[] {""} ;
      H009K2_A793F1357LLey27424 = new String[] {""} ;
      H009K2_A792F1357LLargaDist = new String[] {""} ;
      H009K2_A791F1357LBeneficio = new byte[1] ;
      H009K2_A790F1357LMeses = new String[] {""} ;
      H009K2_A789F1357LPerHas = new String[] {""} ;
      H009K2_A788F1357LPerDesd = new String[] {""} ;
      H009K2_A787F1357LCuil = new String[] {""} ;
      H009K2_A250LegIdNomApe = new String[] {""} ;
      H009K2_A786F1357LTipoReg = new String[] {""} ;
      H009K2_A6LegNumero = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.f1357cabf1357legwc__default(),
         new Object[] {
             new Object[] {
            H009K2_A3CliCod, H009K2_A1EmpCod, H009K2_A784F1357CTipoPre, H009K2_A777F1357CPer, H009K2_A778F1357CSec, H009K2_A796F1357LMilitar, H009K2_A795F1357LTeletrabajo, H009K2_A794F1357L27549, H009K2_A793F1357LLey27424, H009K2_A792F1357LLargaDist,
            H009K2_A791F1357LBeneficio, H009K2_A790F1357LMeses, H009K2_A789F1357LPerHas, H009K2_A788F1357LPerDesd, H009K2_A787F1357LCuil, H009K2_A250LegIdNomApe, H009K2_A786F1357LTipoReg, H009K2_A6LegNumero
            }
            , new Object[] {
   ...
   private int[] H009K2_A3CliCod ;
   private short[] H009K2_A1EmpCod ;
   private byte[] H009K2_A784F1357CTipoPre ;
   private String[] H009K2_A777F1357CPer ;
   private byte[] H009K2_A778F1357CSec ;
   private String[] H009K2_A796F1357LMilitar ;
   private String[] H009K2_A795F1357LTeletrabajo ;
   private String[] H009K2_A794F1357L27549 ;
   private String[] H009K2_A793F1357LLey27424 ;
   private String[] H009K2_A792F1357LLargaDist ;
   private byte[] H009K2_A791F1357LBeneficio ;
   private String[] H009K2_A790F1357LMeses ;
   private String[] H009K2_A789F1357LPerHas ;
   private String[] H009K2_A788F1357LPerDesd ;
   private String[] H009K2_A787F1357LCuil ;
   private String[] H009K2_A250LegIdNomApe ;
   private String[] H009K2_A786F1357LTipoReg ;
   private int[] H009K2_A6LegNumero ;
...
final  class f1357cabf1357legwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LMilitar, T1.F1357LTeletrabajo, T1.F1357L27549, T1.F1357LLey27424, T1.F1357LLargaDist," ;
      sSelectString += " T1.F1357LBeneficio, T1.F1357LMeses, T1.F1357LPerHas, T1.F1357LPerDesd, T1.F1357LCuil, T2.LegIdNomApe, T1.F1357LTipoReg, T1.LegNumero" ;
      sFromString = " FROM (F1357Leg T1 INNER JOIN Legajo T2 ON T2.CliCod = T1.CliCod AND T2.EmpCod = T1.EmpCod AND T2.LegNumero = T1.LegNumero)" ;
      sOrderString = "" ;
      ...
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LPerDesd, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 1 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LPerDesd DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LPerHas, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LPerHas DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 3 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LMeses, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 3 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LMeses DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 4 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LBeneficio, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 4 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LBeneficio DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 5 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LLargaDist, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 5 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LLargaDist DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 6 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LLey27424, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 6 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LLey27424 DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 7 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357L27549, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 7 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357L27549 DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 8 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LTeletrabajo, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 8 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LTeletrabajo DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 9 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LMilitar, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( ( AV17OrderedBy == 9 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LMilitar DESC, T1.LegNumero, T1.F1357LTipoReg" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.LegNumero, T1.F1357LTipoReg" ;
      }
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (F1357Leg T1 INNER JOIN Legajo T2 ON T2.CliCod = T1.CliCod AND T2.EmpCod = T1.EmpCod AND T2.LegNumero = T1.LegNumero)" ;
      addWhere(sWhereString, "(T1.CliCod = ? and T1.EmpCod = ? and T1.F1357CTipoPre = ? and T1.F1357CPer = ( ?) and T1.F1357CSec = ?)");
      if ( ( AV32TFLegIdNomApe_Sels_size == 0 ) && ( ! (GXutil.strcmp("", AV31TFLegIdNomApe)==0) ) )
      {
         addWhere(sWhereString, "(LOWER(T2.LegIdNomApe) like LOWER(?))");
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H009K2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H009K3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
