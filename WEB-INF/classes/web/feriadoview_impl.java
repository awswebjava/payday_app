...
public final  class feriadoview_impl extends GXDataArea
{
   public feriadoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public feriadoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( feriadoview_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.feriadoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11FerId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","FerId","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.feriadoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11FerId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","FerId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "feriado View", "") ;
   }
   ...
   public void wbG30( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_G32( true) ;
      }
      else
      {
         wb_table1_9_G32( false) ;
      }
      return  ;
   }

   public void wb_table1_9_G32e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startG32( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "feriado View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesG32( )
   {
   }
   ...
   public void e11G32( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00G32 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PaiCod), AV11FerId, Short.valueOf(AV10PaiCod), AV11FerId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1223FerId = H00G32_A1223FerId[0] ;
         A46PaiCod = H00G32_A46PaiCod[0] ;
         A1224FerDia = H00G32_A1224FerDia[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1224FerDia, 2, 0) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "feriadoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.feriadogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "feriadoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod),AV11FerId});
   ...
   public void wb_table1_9_G32( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_feriadoView.htm");
         /* Div Control */
         ...
         wb_table1_9_G32e( true) ;
      }
      else
      {
         wb_table1_9_G32e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202061616", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("feriadoview.js", "?202412202061616", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "feriado View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11FerId',fld:'vFERID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00G32_A1223FerId = new String[] {""} ;
      H00G32_A46PaiCod = new short[1] ;
      H00G32_A1224FerDia = new byte[1] ;
      A1223FerId = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.feriadoview__default(),
         new Object[] {
             new Object[] {
            H00G32_A1223FerId, H00G32_A46PaiCod, H00G32_A1224FerDia
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00G32_A1223FerId ;
   private short[] H00G32_A46PaiCod ;
   private byte[] H00G32_A1224FerDia ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class feriadoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00G32", "SELECT FerId, PaiCod, FerDia FROM feriado WHERE (PaiCod = ? and FerId = ( ?)) AND (PaiCod = ? and FerId = ( ?)) ORDER BY PaiCod, FerId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
