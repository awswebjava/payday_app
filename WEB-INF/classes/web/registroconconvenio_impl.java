...
public final  class registroconconvenio_impl extends GXDataArea
{
   public registroconconvenio_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public registroconconvenio_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( registroconconvenio_impl.class ));
   }
   ...
   {
      return formatLink("web.registroconconvenio", new String[] {GXutil.URLEncode(GXutil.rtrim(AV17TrnMode)),GXutil.URLEncode(GXutil.ltrimstr(AV21SecUserId,4,0))}, new String[] {"TrnMode","SecUserId"})  ;
   }

   public String getPgmname( )
   {
      return "RegistroConConvenio" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Registro Con Convenio", "") ;
   }
   ...
   public void wbDY0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_9_DY2( true) ;
      }
      else
      {
         wb_table1_9_DY2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_DY2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavActcodigo_Internalname, GXutil.rtrim( AV10ActCodigo), GXutil.rtrim( localUtil.format( AV10ActCodigo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,83);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavActcodigo_Jsonclick, 0, "Attribute", "", "", "", "", edtavActcodigo_Visible, 1, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_RegistroConConvenio.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 84,'',false,'',0)\"" ;
         web.GxWebStd.gx_single_line_edit( httpContext, edtavSecuser_secuserid_Internalname, GXutil.ltrim( localUtil.ntoc( AV7SecUser.getgxTv_SdtSecUser_Secuserid(), (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV7SecUser.getgxTv_SdtSecUser_Secuserid()), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecuser_secuserid_Jsonclick, 0, "Attribute", "", "", "", "", edtavSecuser_secuserid_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_RegistroConConvenio.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 85,'',false,'',0)\"" ;
         web.GxWebStd.gx_single_line_edit( httpContext, edtavSecpaicod_secuserpaicod_Internalname, GXutil.ltrim( localUtil.ntoc( AV25SecPaiCod.getgxTv_SdtSecUser_Secuserpaicod(), (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV25SecPaiCod.getgxTv_SdtSecUser_Secuserpaicod()), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,85);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecpaicod_secuserpaicod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSecpaicod_secuserpaicod_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_RegistroConConvenio.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 86,'',false,'',0)\"" ;
         web.GxWebStd.gx_single_line_edit( httpContext, edtavConvecodigo_Internalname, GXutil.rtrim( AV33ConveCodigo), GXutil.rtrim( localUtil.format( AV33ConveCodigo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,86);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConvecodigo_Jsonclick, 0, "Attribute", "", "", "", "", edtavConvecodigo_Visible, 1, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startDY2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Registro Con Convenio", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void gxdlvvactcomcodigoDY1( )
   {
      if ( ! httpContext.isAjaxRequest( ) )
      {
         httpContext.GX_webresponse.addHeader("Cache-Control", "no-store");
   ...
   public void gxvvactcomcodigo_htmlDY1( )
   {
   ...
   protected void gxdlvvactcomcodigo_dataDY1( )
   {
      ...
      {
         gxdynajaxctrlcodr.add(GXutil.rtrim( H00DY2_A903ActComCodigo[0]));
         gxdynajaxctrldescr.add(H00DY2_A904ActComDescripcion[0]);
   ...
   public void clear_multi_value_controls( )
   {
      if ( httpContext.isAjaxRequest( ) )
      {
         ...
         {
            dynavActcomcodigo.addItem(H00DY3_A903ActComCodigo[0], H00DY3_A904ActComDescripcion[0], (short)(0));
   ...
   {
      /* GeneXus formulas. */
      AV46Pgmname = "RegistroConConvenio" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void strupDY0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV33ConveCodigo = httpContext.cgiGet( edtavConvecodigo_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV33ConveCodigo", AV33ConveCodigo);
   ...
   public void e11DY2( )
   {
      ...
      registroconconvenio_impl.this.GXt_char1 = GXv_char2[0] ;
      AV29ActComCodigo = GXt_char1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV29ActComCodigo", AV29ActComCodigo);
      GXv_boolean3[0] = AV26hay ;
      new web.hayalguncliente(remoteHandle, context).execute( GXv_boolean3) ;
      registroconconvenio_impl.this.AV26hay = GXv_boolean3[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV26hay", AV26hay);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vHAY", getSecureSignedToken( "", AV26hay));
      if ( ! AV26hay )
      {
         AV7SecUser.setgxTv_SdtSecUser_Secusername( httpContext.getMessage( "conceptos@a3l.com.ar", "") );
      }
      else
      {
         ...
         registroconconvenio_impl.this.AV31CliCUIT = GXv_int4[0] ;
         registroconconvenio_impl.this.AV32Date = GXv_date5[0] ;
         if ( (0==AV31CliCUIT) )
         {
         ...
         {
            AV7SecUser.setgxTv_SdtSecUser_Secusername( httpContext.getMessage( "aguigar@gmail.com", "") );
         }
         AV12MultiEmpresa = "2" ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12MultiEmpresa", AV12MultiEmpresa);
      }
   ...
   public void e13DY2( )
   {
      ...
      registroconconvenio_impl.this.AV28hayTipoEmpl = GXv_boolean3[0] ;
      if ( AV28hayTipoEmpl )
      {
      ...
      else
      {
         ...
         if ( GXutil.strcmp(AV17TrnMode, "DSP") != 0 )
         {
            ...
            if ( ( GXutil.strcmp(AV17TrnMode, "DLT") == 0 ) || AV19CheckRequiredFieldsResult )
            {
               ...
               {
                  Application.commitDataStores(context, remoteHandle, pr_default, "registroconconvenio");
                  ...
                  {
                     GXt_char1 = AV30ActComDescripcion ;
                     GXv_char2[0] = GXt_char1 ;
                     new web.getactcomdescrip(remoteHandle, context).execute( AV29ActComCodigo, GXv_char2) ;
                     registroconconvenio_impl.this.GXt_char1 = GXv_char2[0] ;
                     AV30ActComDescripcion = GXt_char1 ;
                     AV7SecUser.setgxTv_SdtSecUser_Secuserempnom( AV7SecUser.getgxTv_SdtSecUser_Secuserempnom()+" "+GXutil.trim( AV30ActComDescripcion) );
                  }
                  new web.msgdebug_prod(remoteHandle, context).execute( AV46Pgmname, httpContext.getMessage( "&ConveCodigo ", "")+AV33ConveCodigo) ;
                  AV7SecUser = (web.wwpbaseobjects.SdtSecUser)new web.wwpbaseobjects.SdtSecUser( remoteHandle, context);
                  new web.alert(remoteHandle, context).execute( "success", httpContext.getMessage( "terminó cliente 1", "")) ;
                  AV21SecUserId = (short)(0) ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV21SecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV21SecUserId), 4, 0));
                  AV7SecUser.Load(AV21SecUserId);
                  AV7SecUser.setgxTv_SdtSecUser_Clicod_SetNull();
                  AV7SecUser.setgxTv_SdtSecUser_Secusername( httpContext.getMessage( "adrian.garcia@a3l.com.ar", "") );
                  ...
                  AV10ActCodigo = "49" ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV10ActCodigo", AV10ActCodigo);
                  AV24SecUserEmpNom = httpContext.getMessage( "adrian.garcia@a3l.com.ar", "") ;
                  AV7SecUser.setgxTv_SdtSecUser_Secuserempnom( httpContext.getMessage( "adrian.garcia@a3l.com.ar", "") );
                  AV7SecUser.setgxTv_SdtSecUser_Secuserpassword( httpContext.getMessage( "asdf", "") );
                  AV11SecUserPassword = httpContext.getMessage( "asdf", "") ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV11SecUserPassword", AV11SecUserPassword);
                  AV7SecUser.setgxTv_SdtSecUser_Secuserperlastname( httpContext.getMessage( "adrian.garcia@a3l.com.ar", "") );
                  AV7SecUser.setgxTv_SdtSecUser_Secuserpername( httpContext.getMessage( "adrian.garcia@a3l.com.ar", "") );
                  AV8SecUserEmpCuit = 20309828950L ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV8SecUserEmpCuit", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SecUserEmpCuit), 11, 0));
                  AV7SecUser.setgxTv_SdtSecUser_Secuserpaicod( (short)(12) );
                  AV7SecUser.Save();
                  if ( AV7SecUser.Success() )
                  {
                     ...
                     httpContext.wjLocDisableFrm = (byte)(1) ;
                     new web.alert(remoteHandle, context).execute( "success", httpContext.getMessage( "terminó cliente 2", "")) ;
                  }
                  else
                  {
                     new web.alert(remoteHandle, context).execute( "success", httpContext.getMessage( "error ", "")+((com.genexus.SdtMessages_Message)AV7SecUser.GetMessages().elementAt(-1+1)).getgxTv_SdtMessages_Message_Description()) ;
                  }
               }
               else
               {
                  httpContext.GX_msglist.addItem(httpContext.getMessage( "falla en el primero", ""));
                  AV16Messages = AV7SecUser.GetMessages() ;
                  /* Execute user subroutine: 'SHOW MESSAGES' */
                  S112 ();
                  if (returnInSub) return;
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      AV47GXV8 = 1 ;
      while ( AV47GXV8 <= AV16Messages.size() )
      {
         AV15Message = (com.genexus.SdtMessages_Message)((com.genexus.SdtMessages_Message)AV16Messages.elementAt(-1+AV47GXV8));
   ...
   public void S142( )
   {
      ...
      if ( true )
      {
         ...
         if ( ( GXutil.strcmp(AV7SecUser.getgxTv_SdtSecUser_Secuserempnom(), httpContext.getMessage( "NUCLEO", "")) == 0 ) && ! AV26hay )
         {
            ...
            new web.getactcomdescrip(remoteHandle, context).execute( AV29ActComCodigo, GXv_char6) ;
            registroconconvenio_impl.this.GXt_char1 = GXv_char6[0] ;
            AV30ActComDescripcion = GXt_char1 ;
            AV7SecUser.setgxTv_SdtSecUser_Secuserempnom( AV7SecUser.getgxTv_SdtSecUser_Secuserempnom()+" "+GXutil.trim( AV30ActComDescripcion) );
         }
         new web.msgdebug_prod(remoteHandle, context).execute( AV46Pgmname, httpContext.getMessage( "asdf &ConveCodigo ", "")+AV33ConveCodigo) ;
         AV48Sleep = DecimalUtil.doubleToDec(GXutil.sleep( 2)) ;
         callWebObject(formatLink("web.nuevousuario", new String[] {GXutil.URLEncode(GXutil.rtrim(AV7SecUser.getgxTv_SdtSecUser_Secusername()))}, new String[] {"SecUserName"}) );
         httpContext.wjLocDisableFrm = (byte)(1) ;
      }
      else
   ...
   protected void e15DY2( )
   {
      /* Load Routine */
      returnInSub = false ;
   }

   public void wb_table1_9_DY2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavSecuser_secusername_Internalname, AV7SecUser.getgxTv_SdtSecUser_Secusername(), GXutil.rtrim( localUtil.format( AV7SecUser.getgxTv_SdtSecUser_Secusername(), "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,32);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecuser_secusername_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavSecuser_secusername_Enabled, 1, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtavSecuser_secuserpassword_Internalname, AV7SecUser.getgxTv_SdtSecUser_Secuserpassword(), "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,37);\"", (short)(0), 1, edtavSecuser_secuserpassword_Enabled, 1, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         web.GxWebStd.gx_html_textarea( httpContext, edtavSecuserpassword_Internalname, AV11SecUserPassword, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,42);\"", (short)(0), 1, edtavSecuserpassword_Enabled, 1, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavSecuser_secuserempnom_Internalname, AV7SecUser.getgxTv_SdtSecUser_Secuserempnom(), GXutil.rtrim( localUtil.format( AV7SecUser.getgxTv_SdtSecUser_Secuserempnom(), "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecuser_secuserempnom_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavSecuser_secuserempnom_Enabled, 1, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnenter_Internalname, "", httpContext.getMessage( "GX_BtnEnter", ""), bttBtnenter_Jsonclick, 5, httpContext.getMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtncancel_Internalname, "", httpContext.getMessage( "GX_BtnCancel", ""), bttBtncancel_Jsonclick, 1, httpContext.getMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "Button" ;
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtntest_Internalname, "", httpContext.getMessage( "Test", ""), bttBtntest_Jsonclick, 5, httpContext.getMessage( "Test", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOTEST\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_RegistroConConvenio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         wb_table1_9_DY2e( true) ;
      }
      else
      {
         wb_table1_9_DY2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713582130", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("registroconconvenio.js", "?20251713582131", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Registro Con Convenio", "") );
   ...
   public void init_web_controls( )
   {
      ...
      {
         dynavActcomcodigo.addItem(H00DY4_A903ActComCodigo[0], H00DY4_A904ActComDescripcion[0], (short)(0));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'dynavActcomcodigo'},{av:'AV29ActComCodigo',fld:'vACTCOMCODIGO',pic:''},{av:'AV17TrnMode',fld:'vTRNMODE',pic:'',hsh:true},{av:'AV26hay',fld:'vHAY',pic:'',hsh:true},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[{ctrl:'BTNENTER',prop:'Visible'}]}");
      setEventMetadata("'DOTEST'","{handler:'e13DY2',iparms:[{av:'AV27terminoInicializacion',fld:'vTERMINOINICIALIZACION',pic:''},{av:'AV7SecUser',fld:'vSECUSER',pic:''},{av:'AV17TrnMode',fld:'vTRNMODE',pic:'',hsh:true},{av:'AV19CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'cmbavMultiempresa'},{av:'AV12MultiEmpresa',fld:'vMULTIEMPRESA',pic:''},{av:'AV26hay',fld:'vHAY',pic:'',hsh:true},{av:'dynavActcomcodigo'},{av:'AV29ActComCodigo',fld:'vACTCOMCODIGO',pic:''},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV33ConveCodigo',fld:'vCONVECODIGO',pic:''},{av:'AV16Messages',fld:'vMESSAGES',pic:''}]");
      setEventMetadata("'DOTEST'",",oparms:[{av:'AV27terminoInicializacion',fld:'vTERMINOINICIALIZACION',pic:''},{av:'AV7SecUser',fld:'vSECUSER',pic:''},{av:'AV21SecUserId',fld:'vSECUSERID',pic:'ZZZ9'},{av:'cmbavMultiempresa'},{av:'AV12MultiEmpresa',fld:'vMULTIEMPRESA',pic:''},{av:'AV10ActCodigo',fld:'vACTCODIGO',pic:''},{av:'AV11SecUserPassword',fld:'vSECUSERPASSWORD',pic:''},{av:'AV8SecUserEmpCuit',fld:'vSECUSEREMPCUIT',pic:'ZZ-ZZZZZZZZ-9'},{av:'AV16Messages',fld:'vMESSAGES',pic:''},{av:'AV19CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e14DY2',iparms:[{av:'AV27terminoInicializacion',fld:'vTERMINOINICIALIZACION',pic:''},{av:'AV7SecUser',fld:'vSECUSER',pic:''},{av:'AV17TrnMode',fld:'vTRNMODE',pic:'',hsh:true},{av:'AV19CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'dynavActcomcodigo'},{av:'AV29ActComCodigo',fld:'vACTCOMCODIGO',pic:''},{av:'cmbavMultiempresa'},{av:'AV12MultiEmpresa',fld:'vMULTIEMPRESA',pic:''},{av:'AV26hay',fld:'vHAY',pic:'',hsh:true},{av:'AV46Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV33ConveCodigo',fld:'vCONVECODIGO',pic:''},{av:'AV16Messages',fld:'vMESSAGES',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      AV29ActComCodigo = "" ;
      scmdbuf = "" ;
      H00DY2_A903ActComCodigo = new String[] {""} ;
      H00DY2_A904ActComDescripcion = new String[] {""} ;
      H00DY3_A903ActComCodigo = new String[] {""} ;
      H00DY3_A904ActComDescripcion = new String[] {""} ;
      AV12MultiEmpresa = "" ;
      AV11SecUserPassword = "" ;
      ...
      H00DY4_A903ActComCodigo = new String[] {""} ;
      H00DY4_A904ActComDescripcion = new String[] {""} ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.registroconconvenio__default(),
         new Object[] {
             new Object[] {
            H00DY2_A903ActComCodigo, H00DY2_A904ActComDescripcion
            }
            , new Object[] {
            H00DY3_A903ActComCodigo, H00DY3_A904ActComDescripcion
            }
            , new Object[] {
            H00DY4_A903ActComCodigo, H00DY4_A904ActComDescripcion
            }
         }
      );
      AV46Pgmname = "RegistroConConvenio" ;
   ...
   private java.math.BigDecimal AV48Sleep ;
   ...
   private String AV30ActComDescripcion ;
   private String AV24SecUserEmpNom ;
   private String AV34hash ;
   private String AV35salt ;
   ...
   private String[] H00DY2_A903ActComCodigo ;
   private String[] H00DY2_A904ActComDescripcion ;
   private String[] H00DY3_A903ActComCodigo ;
   private String[] H00DY3_A904ActComDescripcion ;
   private String[] H00DY4_A903ActComCodigo ;
   private String[] H00DY4_A904ActComDescripcion ;
...
final  class registroconconvenio__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00DY2", "SELECT ActComCodigo, ActComDescripcion FROM actividadcomercial ORDER BY ActComDescripcion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00DY3", "SELECT ActComCodigo, ActComDescripcion FROM actividadcomercial ORDER BY ActComDescripcion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00DY4", "SELECT ActComCodigo, ActComDescripcion FROM actividadcomercial ORDER BY ActComDescripcion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
      };
   }
