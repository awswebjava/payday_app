...
public final  class clienteconvenio_importesview_impl extends GXDataArea
{
   public clienteconvenio_importesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clienteconvenio_importesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clienteconvenio_importesview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13CliConveImpVig = localUtil.parseDateParm( httpContext.GetPar( "CliConveImpVig")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13CliConveImpVig", localUtil.format(AV13CliConveImpVig, "99/99/99"));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEIMPVIG", getSecureSignedToken( "", AV13CliConveImpVig));
               AV14CliConveImpTipo = httpContext.GetPar( "CliConveImpTipo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14CliConveImpTipo", AV14CliConveImpTipo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEIMPTIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14CliConveImpTipo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.clienteconvenio_importesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.formatDateParm(AV13CliConveImpVig)),GXutil.URLEncode(GXutil.rtrim(AV14CliConveImpTipo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CliConveImpVig","CliConveImpTipo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCLICONVEIMPVIG", localUtil.dtoc( AV13CliConveImpVig, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEIMPVIG", getSecureSignedToken( "", AV13CliConveImpVig));
      web.GxWebStd.gx_hidden_field( httpContext, "vCLICONVEIMPTIPO", GXutil.rtrim( AV14CliConveImpTipo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEIMPTIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14CliConveImpTipo, ""))));
   ...
   {
      return formatLink("web.clienteconvenio_importesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.formatDateParm(AV13CliConveImpVig)),GXutil.URLEncode(GXutil.rtrim(AV14CliConveImpTipo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CliConveImpVig","CliConveImpTipo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "clienteConvenio_importesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "cliente Convenio_importes View", "") ;
   }
   ...
   public void wbIX0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_IX2( true) ;
      }
      else
      {
         wb_table1_9_IX2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_IX2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startIX2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "cliente Convenio_importes View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupIX0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13CliConveImpVig = localUtil.ctod( httpContext.cgiGet( "vCLICONVEIMPVIG"), 0) ;
         AV14CliConveImpTipo = httpContext.cgiGet( "vCLICONVEIMPTIPO") ;
   ...
   public void e11IX2( )
   {
      ...
      AV21GXLvl11 = (byte)(0) ;
      /* Using cursor H00IX2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CliConveImpVig, AV14CliConveImpTipo, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13CliConveImpVig, AV14CliConveImpTipo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1588CliConveImpTipo = H00IX2_A1588CliConveImpTipo[0] ;
         A1587CliConveImpVig = H00IX2_A1587CliConveImpVig[0] ;
         A1565CliConvenio = H00IX2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00IX2_A1564CliPaiConve[0] ;
         A3CliCod = H00IX2_A3CliCod[0] ;
         A1589CliConveImporte = H00IX2_A1589CliConveImporte[0] ;
         AV21GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1589CliConveImporte, 14, 2) );
   ...
   public void S112( )
   {
      ...
      if ( AV15LoadAllTabs || ( GXutil.strcmp(AV16SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV16SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "clienteConvenio_importesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.clienteconvenio_importesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "clienteConvenio_importesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13CliConveImpVig,AV14CliConveImpTipo});
   ...
   public void wb_table1_9_IX2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_clienteConvenio_importesView.htm");
         /* Div Control */
         ...
         wb_table1_9_IX2e( true) ;
      }
      else
      {
         wb_table1_9_IX2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliConvenio", AV12CliConvenio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12CliConvenio, ""))));
      AV13CliConveImpVig = (java.util.Date)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13CliConveImpVig", localUtil.format(AV13CliConveImpVig, "99/99/99"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEIMPVIG", getSecureSignedToken( "", AV13CliConveImpVig));
      AV14CliConveImpTipo = (String)getParm(obj,4) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14CliConveImpTipo", AV14CliConveImpTipo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVEIMPTIPO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14CliConveImpTipo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025171327317", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("clienteconvenio_importesview.js", "?2025171327317", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "cliente Convenio_importes View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV12CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV13CliConveImpVig',fld:'vCLICONVEIMPVIG',pic:'',hsh:true},{av:'AV14CliConveImpTipo',fld:'vCLICONVEIMPTIPO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   {
      wcpOAV12CliConvenio = "" ;
      wcpOAV13CliConveImpVig = GXutil.nullDate() ;
      wcpOAV14CliConveImpTipo = "" ;
      wcpOAV8TabCode = "" ;
      Tabs_Activepagecontrolname = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV12CliConvenio = "" ;
      AV13CliConveImpVig = GXutil.nullDate() ;
      AV14CliConveImpTipo = "" ;
      AV8TabCode = "" ;
      ...
      scmdbuf = "" ;
      H00IX2_A1588CliConveImpTipo = new String[] {""} ;
      H00IX2_A1587CliConveImpVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00IX2_A1565CliConvenio = new String[] {""} ;
      H00IX2_A1564CliPaiConve = new short[1] ;
      H00IX2_A3CliCod = new int[1] ;
      H00IX2_A1589CliConveImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.clienteconvenio_importesview__default(),
         new Object[] {
             new Object[] {
            H00IX2_A1588CliConveImpTipo, H00IX2_A1587CliConveImpVig, H00IX2_A1565CliConvenio, H00IX2_A1564CliPaiConve, H00IX2_A3CliCod, H00IX2_A1589CliConveImporte
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV14CliConveImpTipo ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12CliConvenio ;
   private String AV14CliConveImpTipo ;
   ...
   private java.util.Date wcpOAV13CliConveImpVig ;
   private java.util.Date AV13CliConveImpVig ;
   ...
   private String[] H00IX2_A1588CliConveImpTipo ;
   private java.util.Date[] H00IX2_A1587CliConveImpVig ;
   private String[] H00IX2_A1565CliConvenio ;
   private short[] H00IX2_A1564CliPaiConve ;
   private int[] H00IX2_A3CliCod ;
   private java.math.BigDecimal[] H00IX2_A1589CliConveImporte ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class clienteconvenio_importesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00IX2", "SELECT CliConveImpTipo, CliConveImpVig, CliConvenio, CliPaiConve, CliCod, CliConveImporte FROM clienteConvenio_importes WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CliConveImpVig = ? and CliConveImpTipo = ( ?)) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CliConveImpVig = ? and CliConveImpTipo = ( ?)) ORDER BY CliCod, CliPaiConve, CliConvenio, CliConveImpVig, CliConveImpTipo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
