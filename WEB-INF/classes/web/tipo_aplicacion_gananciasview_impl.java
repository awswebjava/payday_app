...
public final  class tipo_aplicacion_gananciasview_impl extends GXDataArea
{
   public tipo_aplicacion_gananciasview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipo_aplicacion_gananciasview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipo_aplicacion_gananciasview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11AplIIGG = (short)(GXutil.lval( httpContext.GetPar( "AplIIGG"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11AplIIGG", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11AplIIGG), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAPLIIGG", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11AplIIGG), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.tipo_aplicacion_gananciasview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11AplIIGG,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","AplIIGG","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vAPLIIGG", GXutil.ltrim( localUtil.ntoc( AV11AplIIGG, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAPLIIGG", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11AplIIGG), "ZZZ9")));
   ...
   {
      return formatLink("web.tipo_aplicacion_gananciasview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11AplIIGG,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","AplIIGG","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "tipo_aplicacion_gananciasView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "tipo_aplicacion_ganancias View", "") ;
   }
   ...
   public void wbBR0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_BR2( true) ;
      }
      else
      {
         wb_table1_9_BR2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_BR2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startBR2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "tipo_aplicacion_ganancias View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupBR0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11AplIIGG = (short)(localUtil.ctol( httpContext.cgiGet( "vAPLIIGG"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11BR2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00BR2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11AplIIGG), Integer.valueOf(AV10CliCod), Short.valueOf(AV11AplIIGG)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1112AplIIGG = H00BR2_A1112AplIIGG[0] ;
         A3CliCod = H00BR2_A3CliCod[0] ;
         A1113AplIIGGNom = H00BR2_A1113AplIIGGNom[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1113AplIIGGNom );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "tipo_aplicacion_gananciasGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.tipo_aplicacion_gananciasgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "tipo_aplicacion_gananciasGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11AplIIGG)});
   ...
   public void wb_table1_9_BR2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_tipo_aplicacion_gananciasView.htm");
         /* Div Control */
         ...
         wb_table1_9_BR2e( true) ;
      }
      else
      {
         wb_table1_9_BR2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11AplIIGG = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11AplIIGG", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11AplIIGG), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAPLIIGG", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11AplIIGG), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181782261", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipo_aplicacion_gananciasview.js", "?2025181782261", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "tipo_aplicacion_ganancias View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11AplIIGG',fld:'vAPLIIGG',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00BR2_A1112AplIIGG = new short[1] ;
      H00BR2_A3CliCod = new int[1] ;
      H00BR2_A1113AplIIGGNom = new String[] {""} ;
      A1113AplIIGGNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.tipo_aplicacion_gananciasview__default(),
         new Object[] {
             new Object[] {
            H00BR2_A1112AplIIGG, H00BR2_A3CliCod, H00BR2_A1113AplIIGGNom
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] H00BR2_A1112AplIIGG ;
   private int[] H00BR2_A3CliCod ;
   private String[] H00BR2_A1113AplIIGGNom ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipo_aplicacion_gananciasview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00BR2", "SELECT AplIIGG, CliCod, AplIIGGNom FROM tipo_aplicacion_ganancias WHERE (CliCod = ? and AplIIGG = ?) AND (CliCod = ? and AplIIGG = ?) ORDER BY CliCod, AplIIGG ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
