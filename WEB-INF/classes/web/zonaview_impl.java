...
public final  class zonaview_impl extends GXDataArea
{
   public zonaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public zonaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( zonaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "ZonCod") ;
         ...
         {
            AV9ZonCod = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV9ZonCod", AV9ZonCod);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vZONCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9ZonCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.zonaview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV9ZonCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"ZonCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vZONCOD", GXutil.rtrim( AV9ZonCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vZONCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9ZonCod, ""))));
   ...
   {
      return formatLink("web.zonaview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV9ZonCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"ZonCod","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Zona View", "") ;
   }
   ...
   public void wb1F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1F2( true) ;
      }
      else
      {
         wb_table1_9_1F2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1F2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1F2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Zona View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup1F0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV9ZonCod = httpContext.cgiGet( "vZONCOD") ;
   ...
   public void e111F2( )
   {
      ...
      {
         A20ZonCod = H001F2_A20ZonCod[0] ;
         A342ZonDescrip = H001F2_A342ZonDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A342ZonDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ZonaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.zonageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ZonaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV9ZonCod});
   ...
   public void wb_table1_9_1F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ZonaView.htm");
         /* Div Control */
         ...
         wb_table1_9_1F2e( true) ;
      }
      else
      {
         wb_table1_9_1F2e( false) ;
      }
   }
   ...
   {
      AV9ZonCod = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9ZonCod", AV9ZonCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vZONCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9ZonCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020451558", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("zonaview.js", "?2024122020451558", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Zona View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV9ZonCod',fld:'vZONCOD',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001F2_A20ZonCod = new String[] {""} ;
      H001F2_A342ZonDescrip = new String[] {""} ;
      A20ZonCod = "" ;
      A342ZonDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.zonaview__default(),
         new Object[] {
             new Object[] {
            H001F2_A20ZonCod, H001F2_A342ZonDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H001F2_A20ZonCod ;
   private String[] H001F2_A342ZonDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class zonaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001F2", "SELECT ZonCod, ZonDescrip FROM Zona WHERE ZonCod = ( ?) ORDER BY ZonCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
