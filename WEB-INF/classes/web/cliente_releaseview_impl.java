...
public final  class cliente_releaseview_impl extends GXDataArea
{
   public cliente_releaseview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public cliente_releaseview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( cliente_releaseview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV16CliRelSec = (int)(GXutil.lval( httpContext.GetPar( "CliRelSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV16CliRelSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV16CliRelSec), 6, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLIRELSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV16CliRelSec), "ZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.cliente_releaseview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV16CliRelSec,6,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliRelSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vCLIRELSEC", GXutil.ltrim( localUtil.ntoc( AV16CliRelSec, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLIRELSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV16CliRelSec), "ZZZZZ9")));
   ...
   {
      return formatLink("web.cliente_releaseview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV16CliRelSec,6,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliRelSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Cliente_ReleaseView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Cliente_Release View", "") ;
   }
   ...
   public void wbKX0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_KX2( true) ;
      }
      else
      {
         wb_table1_9_KX2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_KX2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startKX2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Cliente_Release View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesKX2( )
   {
   }
   ...
   public void strupKX0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV16CliRelSec = (int)(localUtil.ctol( httpContext.cgiGet( "vCLIRELSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11KX2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00KX2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Integer.valueOf(AV16CliRelSec), Integer.valueOf(AV10CliCod), Integer.valueOf(AV16CliRelSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1885CliRelSec = H00KX2_A1885CliRelSec[0] ;
         A3CliCod = H00KX2_A3CliCod[0] ;
         A1879CliReleaseDes = H00KX2_A1879CliReleaseDes[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( A1879CliReleaseDes );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Cliente_ReleaseGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.cliente_releasegeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Cliente_ReleaseGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Integer.valueOf(AV16CliRelSec)});
   ...
   public void wb_table1_9_KX2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Cliente_ReleaseView.htm");
         /* Div Control */
         ...
         wb_table1_9_KX2e( true) ;
      }
      else
      {
         wb_table1_9_KX2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV16CliRelSec = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV16CliRelSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV16CliRelSec), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLIRELSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV16CliRelSec), "ZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019445585", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("cliente_releaseview.js", "?2024122019445585", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Cliente_Release View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV16CliRelSec',fld:'vCLIRELSEC',pic:'ZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00KX2_A1885CliRelSec = new int[1] ;
      H00KX2_A3CliCod = new int[1] ;
      H00KX2_A1879CliReleaseDes = new String[] {""} ;
      A1879CliReleaseDes = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.cliente_releaseview__default(),
         new Object[] {
             new Object[] {
            H00KX2_A1885CliRelSec, H00KX2_A3CliCod, H00KX2_A1879CliReleaseDes
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int[] H00KX2_A1885CliRelSec ;
   private int[] H00KX2_A3CliCod ;
   private String[] H00KX2_A1879CliReleaseDes ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class cliente_releaseview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00KX2", "SELECT CliRelSec, CliCod, CliReleaseDes FROM Cliente_Release WHERE (CliCod = ? and CliRelSec = ?) AND (CliCod = ? and CliRelSec = ?) ORDER BY CliCod, CliRelSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
