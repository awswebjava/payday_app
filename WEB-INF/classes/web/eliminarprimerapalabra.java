...
public final  class eliminarprimerapalabra extends GXProcedure
{
   public eliminarprimerapalabra( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( eliminarprimerapalabra.class ), "" );
   }
   ...
   {
      eliminarprimerapalabra.this.aP0 = new String[] {""};
      execute_int(aP0);
      return aP0[0];
   }
   ...
   {
      eliminarprimerapalabra.this.AV9texto = aP0[0];
      this.aP0 = aP0;
      initialize();
      /* GeneXus formulas */
      ...
      else
      {
         ...
         if ( AV8palabras.size() > 1 )
         {
            ...
            while ( AV12i <= AV8palabras.size() )
            {
               ...
               if ( ( AV12i != AV8palabras.size() ) && ( AV12i != 1 ) )
               {
                  AV9texto += " " ;
               }
               AV12i = (short)(AV12i+1) ;
   ...
   {
      this.aP0[0] = eliminarprimerapalabra.this.AV9texto;
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      AV11textoAux = "" ;
      AV16Pgmname = "" ;
      AV16Pgmname = "EliminarPrimeraPalabra" ;
      /* GeneXus formulas. */
      AV16Pgmname = "EliminarPrimeraPalabra" ;
      Gx_err = (short)(0) ;
   }
