...
public final  class adicionalview_impl extends GXDataArea
{
   public adicionalview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public adicionalview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( adicionalview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11AdicionalCod = httpContext.GetPar( "AdicionalCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11AdicionalCod", AV11AdicionalCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vADICIONALCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11AdicionalCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.adicionalview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11AdicionalCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","AdicionalCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vADICIONALCOD", GXutil.rtrim( AV11AdicionalCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vADICIONALCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11AdicionalCod, ""))));
   ...
   {
      return formatLink("web.adicionalview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11AdicionalCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","AdicionalCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "AdicionalView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Adicional View", "") ;
   }
   ...
   public void wbAS0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_AS2( true) ;
      }
      else
      {
         wb_table1_9_AS2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_AS2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startAS2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Adicional View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupAS0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11AdicionalCod = httpContext.cgiGet( "vADICIONALCOD") ;
   ...
   public void e11AS2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00AS2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PaiCod), AV11AdicionalCod, Short.valueOf(AV10PaiCod), AV11AdicionalCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A988AdicionalCod = H00AS2_A988AdicionalCod[0] ;
         A46PaiCod = H00AS2_A46PaiCod[0] ;
         A989AdicionalDescrip = H00AS2_A989AdicionalDescrip[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( A989AdicionalDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "AdicionalGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.adicionalgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "AdicionalGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod),AV11AdicionalCod});
   ...
   public void wb_table1_9_AS2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_AdicionalView.htm");
         /* Div Control */
         ...
         wb_table1_9_AS2e( true) ;
      }
      else
      {
         wb_table1_9_AS2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PaiCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      AV11AdicionalCod = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11AdicionalCod", AV11AdicionalCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vADICIONALCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11AdicionalCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412201940924", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("adicionalview.js", "?202412201940924", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Adicional View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11AdicionalCod',fld:'vADICIONALCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00AS2_A988AdicionalCod = new String[] {""} ;
      H00AS2_A46PaiCod = new short[1] ;
      H00AS2_A989AdicionalDescrip = new String[] {""} ;
      A988AdicionalCod = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.adicionalview__default(),
         new Object[] {
             new Object[] {
            H00AS2_A988AdicionalCod, H00AS2_A46PaiCod, H00AS2_A989AdicionalDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11AdicionalCod ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11AdicionalCod ;
   ...
   private String[] H00AS2_A988AdicionalCod ;
   private short[] H00AS2_A46PaiCod ;
   private String[] H00AS2_A989AdicionalDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class adicionalview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00AS2", "SELECT AdicionalCod, PaiCod, AdicionalDescrip FROM Adicional WHERE (PaiCod = ? and AdicionalCod = ( ?)) AND (PaiCod = ? and AdicionalCod = ( ?)) ORDER BY PaiCod, AdicionalCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
