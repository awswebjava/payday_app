...
public final  class clienteconveniosww_impl extends GXDataArea
{
   ...
   public void S172( )
   {
      ...
      new web.wwpbaseobjects.wwp_columnsselector_add(remoteHandle, context).execute( GXv_SdtWWPColumnsSelector15, "CliConvenio", "", "Código", true, "") ;
      AV19ColumnsSelector = GXv_SdtWWPColumnsSelector15[0] ;
      GXv_SdtWWPColumnsSelector15[0] = AV19ColumnsSelector;
      new web.wwpbaseobjects.wwp_columnsselector_add(remoteHandle, context).execute( GXv_SdtWWPColumnsSelector15, "CliConvenioDescrip", "", "Descripción", true, "") ;
      AV19ColumnsSelector = GXv_SdtWWPColumnsSelector15[0] ;
   ...
   public void S162( )
   {
      ...
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState19, "TFCLICONVENIO", httpContext.getMessage( "Código", ""), !(GXutil.strcmp("", AV50TFCliConvenio)==0), (short)(0), AV50TFCliConvenio, "", !(AV51TFCliConvenio_Sels.size()==0), AV51TFCliConvenio_Sels.toJSonString(false), "") ;
