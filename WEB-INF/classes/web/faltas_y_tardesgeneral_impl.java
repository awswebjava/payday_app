...
public final  class faltas_y_tardesgeneral_impl extends GXWebComponent
{
   public faltas_y_tardesgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public faltas_y_tardesgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( faltas_y_tardesgeneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "faltas_y_tardes General", "")) ;
   ...
   public void renderHtmlCloseFormCW2( )
   {
   ...
   {
      return "faltas_y_tardesGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "faltas_y_tardes General", "") ;
   }
   ...
   public void wbCW0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.faltas_y_tardesgeneral");
         }
         ...
         /* Attribute/Variable Label */
         web.GxWebStd.gx_label_element( httpContext, edtLegLicenIni_Internalname, httpContext.getMessage( "Desde", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         web.GxWebStd.gx_label_element( httpContext, edtLegLicenFin_Internalname, httpContext.getMessage( "Hasta", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         web.GxWebStd.gx_bitmap( httpContext, edtLegLicenFin_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtLegLicenFin_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_faltas_y_tardesGeneral.htm");
         httpContext.writeTextNL( "</div>") ;
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavCntdias_Internalname, GXutil.ltrim( localUtil.ntoc( AV15cntDias, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtavCntdias_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(AV15cntDias), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(AV15cntDias), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCntdias_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCntdias_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_faltas_y_tardesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, dynLegLicSitCodigo, dynLegLicSitCodigo.getInternalname(), GXutil.rtrim( A506LegLicSitCodigo), 1, dynLegLicSitCodigo.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, dynLegLicSitCodigo.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_faltas_y_tardesGeneral.htm");
         dynLegLicSitCodigo.setValue( GXutil.rtrim( A506LegLicSitCodigo) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, dynLegLicSitCodigo.getInternalname(), "Values", dynLegLicSitCodigo.ToJavascriptSource(), true);
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11cw1_client"+"'", TempTags, "", 2, "HLP_faltas_y_tardesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12cw1_client"+"'", TempTags, "", 2, "HLP_faltas_y_tardesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_faltas_y_tardesGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_faltas_y_tardesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void startCW2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "faltas_y_tardes General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxdlaleglicsitcodigoCW2( )
   {
      if ( ! httpContext.isAjaxRequest( ) )
      {
         httpContext.GX_webresponse.addHeader("Cache-Control", "no-store");
   ...
   public void gxaleglicsitcodigo_htmlCW2( )
   {
   ...
   protected void gxdlaleglicsitcodigo_dataCW2( )
   {
      ...
      {
         gxdynajaxctrlcodr.add(GXutil.rtrim( H00CW2_A506LegLicSitCodigo[0]));
         gxdynajaxctrldescr.add(H00CW2_A913sItDescAbrev[0]);
   ...
   {
      /* GeneXus formulas. */
      AV18Pgmname = "faltas_y_tardesGeneral" ;
      Gx_err = (short)(0) ;
      edtavCntdias_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavCntdias_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavCntdias_Enabled), 5, 0), true);
   }
   ...
   public void rfCW2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A506LegLicSitCodigo = H00CW3_A506LegLicSitCodigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A506LegLicSitCodigo", A506LegLicSitCodigo);
            A481LegLicenFin = H00CW3_A481LegLicenFin[0] ;
   ...
   public void strupCW0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCntdias_Internalname), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCntdias_Internalname), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep")) > 9999 ) ) )
         {
            ...
            wbErr = true ;
            AV15cntDias = (short)(0) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV15cntDias", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV15cntDias), 4, 0));
         }
         else
         {
            AV15cntDias = (short)(localUtil.ctol( httpContext.cgiGet( edtavCntdias_Internalname), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV15cntDias", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV15cntDias), 4, 0));
         }
   ...
   public void e13CW2( )
   {
      ...
      faltas_y_tardesgeneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV13CliCod = GXt_int1 ;
   ...
   protected void e14CW2( )
   {
      ...
      faltas_y_tardesgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "faltas_y_tardes" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "faltas_y_tardesgeneral", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202055150", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("faltas_y_tardesgeneral.js", "?202412202055150", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      edtavCntdias_Internalname = sPrefix+"vCNTDIAS" ;
      dynLegLicSitCodigo.setInternalname( sPrefix+"LEGLICSITCODIGO" );
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A76LegLicenIni',fld:'LEGLICENINI',pic:''},{av:'dynLegLicSitCodigo'},{av:'A506LegLicSitCodigo',fld:'LEGLICSITCODIGO',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e11CW1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A76LegLicenIni',fld:'LEGLICENINI',pic:''}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12CW1',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A76LegLicenIni',fld:'LEGLICENINI',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      gxwrpcisep = "" ;
      scmdbuf = "" ;
      H00CW2_A506LegLicSitCodigo = new String[] {""} ;
      H00CW2_A913sItDescAbrev = new String[] {""} ;
      H00CW2_n913sItDescAbrev = new boolean[] {false} ;
      H00CW2_A739SitLicCuentaTrab = new boolean[] {false} ;
      H00CW2_n739SitLicCuentaTrab = new boolean[] {false} ;
      H00CW2_A738SitEsLicencia = new boolean[] {false} ;
      H00CW2_n738SitEsLicencia = new boolean[] {false} ;
      H00CW2_A1598EstadoSitRevista = new short[1] ;
      H00CW2_n1598EstadoSitRevista = new boolean[] {false} ;
      AV18Pgmname = "" ;
      H00CW3_A3CliCod = new int[1] ;
      H00CW3_A1EmpCod = new short[1] ;
      H00CW3_A6LegNumero = new int[1] ;
      H00CW3_A76LegLicenIni = new java.util.Date[] {GXutil.nullDate()} ;
      H00CW3_A506LegLicSitCodigo = new String[] {""} ;
      H00CW3_A481LegLicenFin = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      sCtrlA6LegNumero = "" ;
      sCtrlA76LegLicenIni = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.faltas_y_tardesgeneral__default(),
         new Object[] {
             new Object[] {
            H00CW2_A506LegLicSitCodigo, H00CW2_A913sItDescAbrev, H00CW2_n913sItDescAbrev, H00CW2_A739SitLicCuentaTrab, H00CW2_n739SitLicCuentaTrab, H00CW2_A738SitEsLicencia, H00CW2_n738SitEsLicencia, H00CW2_A1598EstadoSitRevista, H00CW2_n1598EstadoSitRevista
            }
            , new Object[] {
            H00CW3_A3CliCod, H00CW3_A1EmpCod, H00CW3_A6LegNumero, H00CW3_A76LegLicenIni, H00CW3_A506LegLicSitCodigo, H00CW3_A481LegLicenFin
            }
         }
      );
      AV18Pgmname = "faltas_y_tardesGeneral" ;
   ...
   private String[] H00CW2_A506LegLicSitCodigo ;
   private String[] H00CW2_A913sItDescAbrev ;
   private boolean[] H00CW2_n913sItDescAbrev ;
   private boolean[] H00CW2_A739SitLicCuentaTrab ;
   private boolean[] H00CW2_n739SitLicCuentaTrab ;
   private boolean[] H00CW2_A738SitEsLicencia ;
   private boolean[] H00CW2_n738SitEsLicencia ;
   private short[] H00CW2_A1598EstadoSitRevista ;
   private boolean[] H00CW2_n1598EstadoSitRevista ;
   private int[] H00CW3_A3CliCod ;
   private short[] H00CW3_A1EmpCod ;
   private int[] H00CW3_A6LegNumero ;
   private java.util.Date[] H00CW3_A76LegLicenIni ;
   private String[] H00CW3_A506LegLicSitCodigo ;
   private java.util.Date[] H00CW3_A481LegLicenFin ;
...
final  class faltas_y_tardesgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00CW2", "SELECT SitCodigo AS LegLicSitCodigo, sItDescAbrev, SitLicCuentaTrab, SitEsLicencia, EstadoSitRevista FROM Estado WHERE (EstadoSitRevista IS NULL) AND (SitLicCuentaTrab = FALSE) AND (SitEsLicencia = FALSE) ORDER BY sItDescAbrev ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,0, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00CW3", "SELECT CliCod, EmpCod, LegNumero, LegLicenIni, LegLicSitCodigo, LegLicenFin FROM LegajoLicencias WHERE CliCod = ? and EmpCod = ? and LegNumero = ? and LegLicenIni = ? ORDER BY CliCod, EmpCod, LegNumero, LegLicenIni ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
