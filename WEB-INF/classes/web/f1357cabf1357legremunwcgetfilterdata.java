...
public final  class f1357cabf1357legremunwcgetfilterdata extends GXProcedure
{
   public f1357cabf1357legremunwcgetfilterdata( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( f1357cabf1357legremunwcgetfilterdata.class ), "" );
   }
   ...
   public String executeUdp( String aP0 ,
                             ...
                             String[] aP4 )
   {
      f1357cabf1357legremunwcgetfilterdata.this.aP5 = new String[] {""};
   ...
   private void execute_int( String aP0 ,
                             ...
                             String[] aP5 )
   {
      f1357cabf1357legremunwcgetfilterdata.this.AV16DDOName = aP0;
      f1357cabf1357legremunwcgetfilterdata.this.AV14SearchTxt = aP1;
      f1357cabf1357legremunwcgetfilterdata.this.AV15SearchTxtTo = aP2;
      f1357cabf1357legremunwcgetfilterdata.this.aP3 = aP3;
      f1357cabf1357legremunwcgetfilterdata.this.aP4 = aP4;
      f1357cabf1357legremunwcgetfilterdata.this.aP5 = aP5;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      f1357cabf1357legremunwcgetfilterdata.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S111( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV27Session.getValue("F1357CabF1357LegRemunWCGridState"), "") == 0 )
      {
         AV29GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "F1357CabF1357LegRemunWCGridState"), null, null);
      }
      else
      {
         AV29GridState.fromxml(AV27Session.getValue("F1357CabF1357LegRemunWCGridState"), null, null);
      }
      AV39GXV1 = 1 ;
   ...
   public void S121( )
   {
      ...
      {
         A6LegNumero = P00VB2_A6LegNumero[0] ;
         A250LegIdNomApe = P00VB2_A250LegIdNomApe[0] ;
         A778F1357CSec = P00VB2_A778F1357CSec[0] ;
         A777F1357CPer = P00VB2_A777F1357CPer[0] ;
         A784F1357CTipoPre = P00VB2_A784F1357CTipoPre[0] ;
         A1EmpCod = P00VB2_A1EmpCod[0] ;
         A3CliCod = P00VB2_A3CliCod[0] ;
         A797F1357LRTipReg = P00VB2_A797F1357LRTipReg[0] ;
         A250LegIdNomApe = P00VB2_A250LegIdNomApe[0] ;
   ...
   {
      this.aP3[0] = f1357cabf1357legremunwcgetfilterdata.this.AV20OptionsJson;
      this.aP4[0] = f1357cabf1357legremunwcgetfilterdata.this.AV23OptionsDescJson;
      this.aP5[0] = f1357cabf1357legremunwcgetfilterdata.this.AV25OptionIndexesJson;
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      A250LegIdNomApe = "" ;
      A777F1357CPer = "" ;
      P00VB2_A6LegNumero = new int[1] ;
      P00VB2_A250LegIdNomApe = new String[] {""} ;
      P00VB2_A778F1357CSec = new byte[1] ;
      P00VB2_A777F1357CPer = new String[] {""} ;
      P00VB2_A784F1357CTipoPre = new byte[1] ;
      P00VB2_A1EmpCod = new short[1] ;
      P00VB2_A3CliCod = new int[1] ;
      P00VB2_A797F1357LRTipReg = new String[] {""} ;
      A797F1357LRTipReg = "" ;
      AV18Option = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.f1357cabf1357legremunwcgetfilterdata__default(),
         new Object[] {
             new Object[] {
            P00VB2_A6LegNumero, P00VB2_A250LegIdNomApe, P00VB2_A778F1357CSec, P00VB2_A777F1357CPer, P00VB2_A784F1357CTipoPre, P00VB2_A1EmpCod, P00VB2_A3CliCod, P00VB2_A797F1357LRTipReg
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int[] P00VB2_A6LegNumero ;
   private String[] P00VB2_A250LegIdNomApe ;
   private byte[] P00VB2_A778F1357CSec ;
   private String[] P00VB2_A777F1357CPer ;
   private byte[] P00VB2_A784F1357CTipoPre ;
   private short[] P00VB2_A1EmpCod ;
   private int[] P00VB2_A3CliCod ;
   private String[] P00VB2_A797F1357LRTipReg ;
...
final  class f1357cabf1357legremunwcgetfilterdata__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00VB2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      scmdbuf = "SELECT T1.LegNumero, T2.LegIdNomApe, T1.F1357CSec, T1.F1357CPer, T1.F1357CTipoPre, T1.EmpCod, T1.CliCod, T1.F1357LRTipReg FROM (F1357LegRemun T1 INNER JOIN Legajo" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00VB2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).byteValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).byteValue() , ((Number) dynConstraints[9]).intValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).byteValue() , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00VB2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
