...
public final  class condicionafipview_impl extends GXDataArea
{
   public condicionafipview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public condicionafipview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( condicionafipview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10CondiCodigo = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10CondiCodigo", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CondiCodigo), 4, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONDICODIGO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CondiCodigo), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.condicionafipview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CondiCodigo,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CondiCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vCONDICODIGO", GXutil.ltrim( localUtil.ntoc( AV10CondiCodigo, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONDICODIGO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CondiCodigo), "ZZZ9")));
   ...
   {
      return formatLink("web.condicionafipview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CondiCodigo,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CondiCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "CondicionAFIPView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Condicion AFIPView", "") ;
   }
   ...
   public void wbG60( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_G62( true) ;
      }
      else
      {
         wb_table1_9_G62( false) ;
      }
      return  ;
   }

   public void wb_table1_9_G62e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startG62( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Condicion AFIPView", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupG60( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10CondiCodigo = (short)(localUtil.ctol( httpContext.cgiGet( "vCONDICODIGO"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11G62( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00G62 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10CondiCodigo)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A17CondiCodigo = H00G62_A17CondiCodigo[0] ;
         A144CondiDescri = H00G62_A144CondiDescri[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A144CondiDescri );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "CondicionAFIPGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.condicionafipgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "CondicionAFIPGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10CondiCodigo)});
   ...
   public void wb_table1_9_G62( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_CondicionAFIPView.htm");
         /* Div Control */
         ...
         wb_table1_9_G62e( true) ;
      }
      else
      {
         wb_table1_9_G62e( false) ;
      }
   }
   ...
   {
      AV10CondiCodigo = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10CondiCodigo", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CondiCodigo), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONDICODIGO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CondiCodigo), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019504068", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("condicionafipview.js", "?2024122019504069", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Condicion AFIPView", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CondiCodigo',fld:'vCONDICODIGO',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00G62_A17CondiCodigo = new short[1] ;
      H00G62_A144CondiDescri = new String[] {""} ;
      A144CondiDescri = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.condicionafipview__default(),
         new Object[] {
             new Object[] {
            H00G62_A17CondiCodigo, H00G62_A144CondiDescri
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10CondiCodigo ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10CondiCodigo ;
   private short wbEnd ;
   ...
   private short[] H00G62_A17CondiCodigo ;
   private String[] H00G62_A144CondiDescri ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class condicionafipview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00G62", "SELECT CondiCodigo, CondiDescri FROM CondicionAFIP WHERE CondiCodigo = ? ORDER BY CondiCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
