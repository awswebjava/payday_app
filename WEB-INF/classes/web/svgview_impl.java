...
public final  class svgview_impl extends GXDataArea
{
   public svgview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public svgview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( svgview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10SVGId = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10SVGId", AV10SVGId);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSVGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10SVGId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.svgview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10SVGId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"SVGId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vSVGID", GXutil.rtrim( AV10SVGId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSVGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10SVGId, ""))));
   ...
   {
      return formatLink("web.svgview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10SVGId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"SVGId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "SVGView", "") ;
   }
   ...
   public void wbLE0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_LE2( true) ;
      }
      else
      {
         wb_table1_9_LE2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_LE2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startLE2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "SVGView", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesLE2( )
   {
   }
   ...
   public void strupLE0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10SVGId = httpContext.cgiGet( "vSVGID") ;
   ...
   public void e11LE2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00LE2 */
      pr_default.execute(0, new Object[] {AV10SVGId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1935SVGId = H00LE2_A1935SVGId[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1935SVGId );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SVGGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.svggeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SVGGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10SVGId});
   ...
   public void wb_table1_9_LE2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_SVGView.htm");
         /* Div Control */
         ...
         wb_table1_9_LE2e( true) ;
      }
      else
      {
         wb_table1_9_LE2e( false) ;
      }
   }
   ...
   {
      AV10SVGId = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10SVGId", AV10SVGId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSVGID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10SVGId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020404089", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("svgview.js", "?2024122020404089", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "SVGView", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10SVGId',fld:'vSVGID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.svgview__default(),
         new Object[] {
             new Object[] {
            H00LE2_A1935SVGId
            }
   ...
   private int idxLst ;
   private String wcpOAV10SVGId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV10SVGId ;
   ...
   private String[] H00LE2_A1935SVGId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class svgview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00LE2", "SELECT SVGId FROM SVG WHERE SVGId = ( ?) ORDER BY SVGId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
