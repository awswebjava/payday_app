...
public final  class SdtprocesosSegundoPlanoPDF_soap extends GxUserType
{
   public SdtprocesosSegundoPlanoPDF_soap( )
   {
      this(  new ModelContext(SdtprocesosSegundoPlanoPDF_soap.class));
   }

   public SdtprocesosSegundoPlanoPDF_soap( ModelContext context )
   {
      super( context, "SdtprocesosSegundoPlanoPDF_soap");
   }

   public SdtprocesosSegundoPlanoPDF_soap( int remoteHandle ,
                                           ModelContext context )
   {
      super( remoteHandle, context, "SdtprocesosSegundoPlanoPDF_soap");
   }

   public SdtprocesosSegundoPlanoPDF_soap( StructSdtprocesosSegundoPlanoPDF_soap struct )
   {
      this();
      setStruct(struct);
   }
   ...
   public String execute( int gxTp_Clicod ,
                          short gxTp_Empcod ,
                          int gxTp_Liqnro ,
                          GXSimpleCollection<Integer> gxTp_Legnumero ,
                          String gxTp_Clientid )
   {
      ...
      SoapParm.assignlocationproperties( context, "procesosSegundoPlanoPDF_soap", GXSoapHTTPClient);
      if ( GXutil.strcmp(defaultExecute, "") == 0 )
      {
         targetResourceName = SoapParm.getresourcename(context, "procesosSegundoPlanoPDF_soap") ;
         if ( GXutil.strcmp(targetResourceName, "") == 0 )
         {
            execName = "com.paga.asoap_procesossegundoplanopdf" ;
         }
         else
         {
      ...
      GXSoapHTTPClient.addHeader("SOAPAction", "Pagaaction/ASOAP_PROCESOSSEGUNDOPLANOPDF.Execute");
      ...
      GXSoapXMLWriter.writeStartElement("soap_procesosSegundoPlanoPDF.Execute");
      ...
      GXSoapXMLWriter.writeAttribute("xmlns", "Paga");
      if ( gxTp_Legnumero != null )
      {
         gxTp_Legnumero.writexmlcollection(GXSoapXMLWriter, "Legnumero", "Paga", "item", "Paga");
      }
      ...
      if ( currSoapErr != 0 )
      {
         oLocation = SoapParm.getlocation(context, "procesosSegundoPlanoPDF_soap") ;
   ...
   public String getgxTv_SdtprocesosSegundoPlanoPDF_soap_DefaultExecute( )
   {
      return defaultExecute ;
   }

   public com.genexus.GxUnknownObjectCollection getgxTv_SdtprocesosSegundoPlanoPDF_soap_Soapheaders( )
   {
      if ( soapHeaders == null )
      {
   ...
   public String getgxTv_SdtprocesosSegundoPlanoPDF_soap_Soapheadersraw( )
   {
      if ( (GXutil.strcmp("", soapHeadersRaw)==0) )
      {
         soapHeadersRaw = "" ;
   ...
   public web.SdtprocesosSegundoPlanoPDF_soap Clone( )
   {
      return (web.SdtprocesosSegundoPlanoPDF_soap)(clone()) ;
   }

   public void setStruct( web.StructSdtprocesosSegundoPlanoPDF_soap struct )
   {
   }

   @SuppressWarnings("unchecked")
   public web.StructSdtprocesosSegundoPlanoPDF_soap getStruct( )
   {
      web.StructSdtprocesosSegundoPlanoPDF_soap struct = new web.StructSdtprocesosSegundoPlanoPDF_soap ();
      return struct ;
   }
