...
public final  class tipo_obligacionview_impl extends GXDataArea
{
   public tipo_obligacionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipo_obligacionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipo_obligacionview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10TipoOblSec = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TipoOblSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TipoOblSec), 4, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOOBLSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TipoOblSec), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.tipo_obligacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TipoOblSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipoOblSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vTIPOOBLSEC", GXutil.ltrim( localUtil.ntoc( AV10TipoOblSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOOBLSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TipoOblSec), "ZZZ9")));
   ...
   {
      return formatLink("web.tipo_obligacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TipoOblSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipoOblSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "tipo_obligacionView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "tipo_obligacion View", "") ;
   }
   ...
   public void wbC90( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_C92( true) ;
      }
      else
      {
         wb_table1_9_C92( false) ;
      }
      return  ;
   }

   public void wb_table1_9_C92e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startC92( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "tipo_obligacion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesC92( )
   {
   }
   ...
   public void strupC90( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10TipoOblSec = (short)(localUtil.ctol( httpContext.cgiGet( "vTIPOOBLSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11C92( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00C92 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10TipoOblSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1163TipoOblSec = H00C92_A1163TipoOblSec[0] ;
         A1164TipoOblCodigo = H00C92_A1164TipoOblCodigo[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1164TipoOblCodigo );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "tipo_obligacionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.tipo_obligaciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "tipo_obligacionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10TipoOblSec)});
   ...
   public void wb_table1_9_C92( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_tipo_obligacionView.htm");
         /* Div Control */
         ...
         wb_table1_9_C92e( true) ;
      }
      else
      {
         wb_table1_9_C92e( false) ;
      }
   }
   ...
   {
      AV10TipoOblSec = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TipoOblSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TipoOblSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOOBLSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TipoOblSec), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020432973", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipo_obligacionview.js", "?2024122020432973", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "tipo_obligacion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TipoOblSec',fld:'vTIPOOBLSEC',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00C92_A1163TipoOblSec = new short[1] ;
      H00C92_A1164TipoOblCodigo = new String[] {""} ;
      A1164TipoOblCodigo = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.tipo_obligacionview__default(),
         new Object[] {
             new Object[] {
            H00C92_A1163TipoOblSec, H00C92_A1164TipoOblCodigo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10TipoOblSec ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10TipoOblSec ;
   private short wbEnd ;
   ...
   private short[] H00C92_A1163TipoOblSec ;
   private String[] H00C92_A1164TipoOblCodigo ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipo_obligacionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00C92", "SELECT TipoOblSec, TipoOblCodigo FROM tipo_obligacion WHERE TipoOblSec = ? ORDER BY TipoOblSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
