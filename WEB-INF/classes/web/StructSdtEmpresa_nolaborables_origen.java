...
public final  class StructSdtEmpresa_nolaborables_origen implements Cloneable, java.io.Serializable
{
   public StructSdtEmpresa_nolaborables_origen( )
   {
      this( -1, new ModelContext( StructSdtEmpresa_nolaborables_origen.class ));
   }

   public StructSdtEmpresa_nolaborables_origen( int remoteHandle ,
   ...
   protected short gxTv_SdtEmpresa_nolaborables_origen_Modified ;
   protected short gxTv_SdtEmpresa_nolaborables_origen_Initialized ;
   protected String gxTv_SdtEmpresa_nolaborables_origen_Emporigen ;
   protected String gxTv_SdtEmpresa_nolaborables_origen_Mode ;
   protected String gxTv_SdtEmpresa_nolaborables_origen_Emporigen_Z ;
}
