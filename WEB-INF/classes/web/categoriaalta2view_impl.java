...
public final  class categoriaalta2view_impl extends GXDataArea
{
   public categoriaalta2view_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public categoriaalta2view_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( categoriaalta2view_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV17CliCod = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV17CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV17CliCod), 6, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV17CliCod), "ZZZZZ9")));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV21CliPaiConve = (short)(GXutil.lval( httpContext.GetPar( "CliPaiConve"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV21CliPaiConve", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV21CliPaiConve), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLIPAICONVE", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV21CliPaiConve), "ZZZ9")));
               AV22CliConvenio = httpContext.GetPar( "CliConvenio") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV22CliConvenio", AV22CliConvenio);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22CliConvenio, ""))));
               AV11CatCodigo = httpContext.GetPar( "CatCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11CatCodigo", AV11CatCodigo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11CatCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.categoriaalta2view", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV17CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV21CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV22CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV11CatCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CatCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV17CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vCLIPAICONVE", GXutil.ltrim( localUtil.ntoc( AV21CliPaiConve, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLIPAICONVE", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV21CliPaiConve), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vCLICONVENIO", GXutil.rtrim( AV22CliConvenio));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22CliConvenio, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCATCODIGO", GXutil.rtrim( AV11CatCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11CatCodigo, ""))));
   ...
   {
      return formatLink("web.categoriaalta2view", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV17CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV21CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV22CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV11CatCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","CatCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "CategoriaAlta2View" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Categoria Alta2 View", "") ;
   }
   ...
   public void wbAD0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_AD2( true) ;
      }
      else
      {
         wb_table1_9_AD2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_AD2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startAD2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Categoria Alta2 View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesAD2( )
   {
   }
   ...
   public void strupAD0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV17CliCod = (int)(localUtil.ctol( httpContext.cgiGet( "vCLICOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         AV21CliPaiConve = (short)(localUtil.ctol( httpContext.cgiGet( "vCLIPAICONVE"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         AV22CliConvenio = httpContext.cgiGet( "vCLICONVENIO") ;
         AV11CatCodigo = httpContext.cgiGet( "vCATCODIGO") ;
   ...
   public void e11AD2( )
   {
      ...
      AV25GXLvl11 = (byte)(0) ;
      /* Using cursor H00AD2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV17CliCod), Short.valueOf(AV21CliPaiConve), AV22CliConvenio, AV11CatCodigo, Integer.valueOf(AV17CliCod), Short.valueOf(AV21CliPaiConve), AV22CliConvenio, AV11CatCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A8CatCodigo = H00AD2_A8CatCodigo[0] ;
         A1565CliConvenio = H00AD2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00AD2_A1564CliPaiConve[0] ;
         A3CliCod = H00AD2_A3CliCod[0] ;
         A123CatDescrip = H00AD2_A123CatDescrip[0] ;
         AV25GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "CategoriaAlta2General")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.categoriaalta2general_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "CategoriaAlta2General" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV17CliCod),Short.valueOf(AV21CliPaiConve),AV22CliConvenio,AV11CatCodigo});
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "valores") == 0 ) )
      {
         /* Object Property */
         if ( true )
         {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Valoreswc_Component), GXutil.lower( "CategoriaAlta2valoresWC")) != 0 )
         {
            WebComp_Valoreswc = WebUtils.getWebComponent(getClass(), "web.categoriaalta2valoreswc_impl", remoteHandle, context);
            WebComp_Valoreswc_Component = "CategoriaAlta2valoresWC" ;
         }
         if ( GXutil.len( WebComp_Valoreswc_Component) != 0 )
         {
            WebComp_Valoreswc.setjustcreated();
            WebComp_Valoreswc.componentprepare(new Object[] {"W0031","",Integer.valueOf(AV17CliCod),Short.valueOf(AV21CliPaiConve),AV22CliConvenio,AV11CatCodigo});
   ...
   public void wb_table1_9_AD2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_CategoriaAlta2View.htm");
         /* Div Control */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblValores_title_Internalname, httpContext.getMessage( "Valores", ""), "", "", lblValores_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_CategoriaAlta2View.htm");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         wb_table1_9_AD2e( true) ;
      }
      else
      {
         wb_table1_9_AD2e( false) ;
      }
   }
   ...
   {
      AV17CliCod = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV17CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV17CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV17CliCod), "ZZZZZ9")));
      AV21CliPaiConve = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV21CliPaiConve", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV21CliPaiConve), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLIPAICONVE", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV21CliPaiConve), "ZZZ9")));
      AV22CliConvenio = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV22CliConvenio", AV22CliConvenio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICONVENIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV22CliConvenio, ""))));
      AV11CatCodigo = (String)getParm(obj,3) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11CatCodigo", AV11CatCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCATCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11CatCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025171326253", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("categoriaalta2view.js", "?2025171326254", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Categoria Alta2 View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV17CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV21CliPaiConve',fld:'vCLIPAICONVE',pic:'ZZZ9',hsh:true},{av:'AV22CliConvenio',fld:'vCLICONVENIO',pic:'',hsh:true},{av:'AV11CatCodigo',fld:'vCATCODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00AD2_A8CatCodigo = new String[] {""} ;
      H00AD2_A1565CliConvenio = new String[] {""} ;
      H00AD2_A1564CliPaiConve = new short[1] ;
      H00AD2_A3CliCod = new int[1] ;
      H00AD2_A123CatDescrip = new String[] {""} ;
      A8CatCodigo = "" ;
      A1565CliConvenio = "" ;
      A123CatDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.categoriaalta2view__default(),
         new Object[] {
             new Object[] {
            H00AD2_A8CatCodigo, H00AD2_A1565CliConvenio, H00AD2_A1564CliPaiConve, H00AD2_A3CliCod, H00AD2_A123CatDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV21CliPaiConve ;
   ...
   private int idxLst ;
   private String wcpOAV22CliConvenio ;
   ...
   private String[] H00AD2_A8CatCodigo ;
   private String[] H00AD2_A1565CliConvenio ;
   private short[] H00AD2_A1564CliPaiConve ;
   private int[] H00AD2_A3CliCod ;
   private String[] H00AD2_A123CatDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class categoriaalta2view__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00AD2", "SELECT CatCodigo, CliConvenio, CliPaiConve, CliCod, CatDescrip FROM Categoria1 WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CatCodigo = ( ?)) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and CatCodigo = ( ?)) ORDER BY CliCod, CliPaiConve, CliConvenio, CatCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
