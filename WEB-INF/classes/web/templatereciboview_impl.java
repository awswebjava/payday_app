...
public final  class templatereciboview_impl extends GXDataArea
{
   public templatereciboview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public templatereciboview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( templatereciboview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12TempRecSec = (short)(GXutil.lval( httpContext.GetPar( "TempRecSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12TempRecSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12TempRecSec), 4, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTEMPRECSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12TempRecSec), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.templatereciboview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12TempRecSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","TempRecSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vTEMPRECSEC", GXutil.ltrim( localUtil.ntoc( AV12TempRecSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTEMPRECSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12TempRecSec), "ZZZ9")));
   ...
   {
      return formatLink("web.templatereciboview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12TempRecSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","TempRecSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "TemplateReciboView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Template Recibo View", "") ;
   }
   ...
   public void wbAN0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_AN2( true) ;
      }
      else
      {
         wb_table1_9_AN2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_AN2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startAN2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Template Recibo View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupAN0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12TempRecSec = (short)(localUtil.ctol( httpContext.cgiGet( "vTEMPRECSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11AN2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00AN2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Short.valueOf(AV12TempRecSec), Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Short.valueOf(AV12TempRecSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A86TempRecSec = H00AN2_A86TempRecSec[0] ;
         A1EmpCod = H00AN2_A1EmpCod[0] ;
         A3CliCod = H00AN2_A3CliCod[0] ;
         A571TempRecDescrip = H00AN2_A571TempRecDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A571TempRecDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TemplateReciboGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.templaterecibogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TemplateReciboGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),Short.valueOf(AV12TempRecSec)});
   ...
   public void wb_table1_9_AN2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TemplateReciboView.htm");
         /* Div Control */
         ...
         wb_table1_9_AN2e( true) ;
      }
      else
      {
         wb_table1_9_AN2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12TempRecSec = ((Number) GXutil.testNumericType( getParm(obj,2), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12TempRecSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12TempRecSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTEMPRECSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12TempRecSec), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020415536", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("templatereciboview.js", "?2024122020415536", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Template Recibo View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12TempRecSec',fld:'vTEMPRECSEC',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00AN2_A86TempRecSec = new short[1] ;
      H00AN2_A1EmpCod = new short[1] ;
      H00AN2_A3CliCod = new int[1] ;
      H00AN2_A571TempRecDescrip = new String[] {""} ;
      A571TempRecDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.templatereciboview__default(),
         new Object[] {
             new Object[] {
            H00AN2_A86TempRecSec, H00AN2_A1EmpCod, H00AN2_A3CliCod, H00AN2_A571TempRecDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV12TempRecSec ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV11EmpCod ;
   private short AV12TempRecSec ;
   private short wbEnd ;
   ...
   private short[] H00AN2_A86TempRecSec ;
   private short[] H00AN2_A1EmpCod ;
   private int[] H00AN2_A3CliCod ;
   private String[] H00AN2_A571TempRecDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class templatereciboview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00AN2", "SELECT TempRecSec, EmpCod, CliCod, TempRecDescrip FROM TemplateRecibo WHERE (CliCod = ? and EmpCod = ? and TempRecSec = ?) AND (CliCod = ? and EmpCod = ? and TempRecSec = ?) ORDER BY CliCod, EmpCod, TempRecSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
