...
public final  class sexosview_impl extends GXDataArea
{
   public sexosview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public sexosview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( sexosview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10SexoId = (byte)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10SexoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10SexoId), 2, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSEXOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10SexoId), "Z9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.sexosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10SexoId,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"SexoId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vSEXOID", GXutil.ltrim( localUtil.ntoc( AV10SexoId, (byte)(2), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSEXOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10SexoId), "Z9")));
   ...
   {
      return formatLink("web.sexosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10SexoId,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"SexoId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Sexos View", "") ;
   }
   ...
   public void wbI30( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_I32( true) ;
      }
      else
      {
         wb_table1_9_I32( false) ;
      }
      return  ;
   }

   public void wb_table1_9_I32e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startI32( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Sexos View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesI32( )
   {
   }
   ...
   public void strupI30( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10SexoId = (byte)(localUtil.ctol( httpContext.cgiGet( "vSEXOID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11I32( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00I32 */
      pr_default.execute(0, new Object[] {Byte.valueOf(AV10SexoId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1743SexoId = H00I32_A1743SexoId[0] ;
         A1744SexoNombre = H00I32_A1744SexoNombre[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1744SexoNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SexosGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.sexosgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SexosGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Byte.valueOf(AV10SexoId)});
   ...
   public void wb_table1_9_I32( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_SexosView.htm");
         /* Div Control */
         ...
         wb_table1_9_I32e( true) ;
      }
      else
      {
         wb_table1_9_I32e( false) ;
      }
   }
   ...
   {
      AV10SexoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.BYTE)).byteValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10SexoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10SexoId), 2, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSEXOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10SexoId), "Z9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020392823", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("sexosview.js", "?2024122020392823", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Sexos View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10SexoId',fld:'vSEXOID',pic:'Z9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00I32_A1743SexoId = new byte[1] ;
      H00I32_A1744SexoNombre = new String[] {""} ;
      A1744SexoNombre = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.sexosview__default(),
         new Object[] {
             new Object[] {
            H00I32_A1743SexoId, H00I32_A1744SexoNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private byte wcpOAV10SexoId ;
   private byte nGotPars ;
   private byte GxWebError ;
   private byte AV10SexoId ;
   ...
   private byte[] H00I32_A1743SexoId ;
   private String[] H00I32_A1744SexoNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class sexosview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00I32", "SELECT SexoId, SexoNombre FROM Sexos WHERE SexoId = ? ORDER BY SexoId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
