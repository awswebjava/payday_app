...
@javax.ws.rs.Path("/deduccionesSolapaLoadDVCombo")
public final  class deduccionessolapaloaddvcombo_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.deduccionessolapaloaddvcombo_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      ...
      int AV27LegDedSec;
      AV27LegDedSec = (int)(GXutil.lval( entity.getLegDedSec())) ;
      ...
      if ( ! processHeaders("deduccionessolapaloaddvcombo",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.deduccionessolapaloaddvcombo worker = new web.deduccionessolapaloaddvcombo(remoteHandle, context);
         worker.execute(AV17ComboName,AV19TrnMode,AV24CliCod,AV25EmpCod,AV26LegNumero,AV27LegDedSec,AV16SelectedValue,AV14Combo_Data );
         web.deduccionessolapaloaddvcombo_RESTInterfaceOUT data = new web.deduccionessolapaloaddvcombo_RESTInterfaceOUT();
