...
public final  class StructSdtEmpresa_abm_1_conceptos_horanormal_mensualizados implements Cloneable, java.io.Serializable
{
   public StructSdtEmpresa_abm_1_conceptos_horanormal_mensualizados( )
   {
      this( -1, new ModelContext( StructSdtEmpresa_abm_1_conceptos_horanormal_mensualizados.class ));
   }

   public StructSdtEmpresa_abm_1_conceptos_horanormal_mensualizados( int remoteHandle ,
   ...
   protected short gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Modified ;
   protected short gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Initialized ;
   protected String gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Empmenconcodigo ;
   protected String gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Mode ;
   protected String gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Empmenconcodigo_Z ;
   protected boolean gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Empmenhabitual ;
   protected boolean gxTv_SdtEmpresa_abm_1_conceptos_horanormal_mensualizados_Empmenhabitual_Z ;
}
