...
public final  class lsd_reg1lsd_reg2wc_impl extends GXWebComponent
{
   public lsd_reg1lsd_reg2wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public lsd_reg1lsd_reg2wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( lsd_reg1lsd_reg2wc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8CliCod),Short.valueOf(AV9EmpCod),Integer.valueOf(AV10LSDSec)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      AV26IsAuthorized_Update = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_Update")) ;
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9EmpCod, AV10LSDSec, AV38Pgmname, AV16OrderedBy, AV17OrderedDsc, AV26IsAuthorized_Update, AV27IsAuthorized_Delete, A3CliCod, A1EmpCod, A1649LSDSec, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "LSD_reg1 LSD_reg2 WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.lsd_reg1lsd_reg2wc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV10LSDSec,8,0))}, new String[] {"CliCod","EmpCod","LSDSec"}) +"\">") ;
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV38Pgmname, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( sPrefix, AV26IsAuthorized_Update));
      ...
      forbiddenHiddens.add("hshsalt", sPrefix+"hsh"+"LSD_reg1LSD_reg2WC");
      ...
      GXutil.writeLogInfo("lsd_reg1lsd_reg2wc:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV38Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV38Pgmname, ""))));
      ...
      web.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV26IsAuthorized_Update);
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( sPrefix, AV26IsAuthorized_Update));
   ...
   public void renderHtmlCloseFormHH2( )
   {
   ...
   {
      return "LSD_reg1LSD_reg2WC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "LSD_reg1 LSD_reg2 WC", "") ;
   }
   ...
   public void wbHH0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.lsd_reg1lsd_reg2wc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 26 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_LSD_reg1LSD_reg2WC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_LSD_reg1LSD_reg2WC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLSDSec_Internalname, GXutil.ltrim( localUtil.ntoc( A1649LSDSec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1649LSDSec), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLSDSec_Jsonclick, 0, "Attribute", "", "", "", "", edtLSDSec_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_LSD_reg1LSD_reg2WC.htm");
         /* User Defined Control */
   ...
   public void startHH2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "LSD_reg1 LSD_reg2 WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV29TipoReg = httpContext.cgiGet( edtavTiporeg_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavTiporeg_Internalname, AV29TipoReg);
                           ...
                           A1663LSD2fechaPago_99_8 = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtLSD2fechaPago_99_8_Internalname), 0)) ;
                           A1664LSD2fechaRubrica_107_8 = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtLSD2fechaRubrica_107_8_Internalname), 0)) ;
                           A1665LSD2formaPago_115_1 = httpContext.cgiGet( edtLSD2formaPago_115_1_Internalname) ;
                           AV33Display = httpContext.cgiGet( edtavDisplay_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplay_Internalname, AV33Display);
                           AV34Update = httpContext.cgiGet( edtavUpdate_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavUpdate_Internalname, AV34Update);
                           AV35Delete = httpContext.cgiGet( edtavDelete_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV35Delete);
                           AV30VerSVG = httpContext.cgiGet( edtavVersvg_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavVersvg_Internalname, AV30VerSVG);
                           AV31ModificarSVG = httpContext.cgiGet( edtavModificarsvg_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavModificarsvg_Internalname, AV31ModificarSVG);
                           AV32EliminarSVG = httpContext.cgiGet( edtavEliminarsvg_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavEliminarsvg_Internalname, AV32EliminarSVG);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV26IsAuthorized_Update ,
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_LSD2SEC", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A1657LSD2Sec), "ZZZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LSD2SEC", GXutil.ltrim( localUtil.ntoc( A1657LSD2Sec, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV38Pgmname = "LSD_reg1LSD_reg2WC" ;
      Gx_err = (short)(0) ;
      edtavTiporeg_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavTiporeg_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavTiporeg_Enabled), 5, 0), !bGXsfl_26_Refreshing);
   ...
   public void rfHH2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT
                                              }
         });
         /* Using cursor H00HH2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV10LSDSec), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_26_idx = 1 ;
         sGXsfl_26_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_26_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_262( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A3CliCod = H00HH2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H00HH2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A1649LSDSec = H00HH2_A1649LSDSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1649LSDSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1649LSDSec), 8, 0));
            A1665LSD2formaPago_115_1 = H00HH2_A1665LSD2formaPago_115_1[0] ;
            A1664LSD2fechaRubrica_107_8 = H00HH2_A1664LSD2fechaRubrica_107_8[0] ;
            A1663LSD2fechaPago_99_8 = H00HH2_A1663LSD2fechaPago_99_8[0] ;
            A1662LSD2diasLiquidados_96_3 = H00HH2_A1662LSD2diasLiquidados_96_3[0] ;
            A1661LSD2cbuEmpleado_74_22 = H00HH2_A1661LSD2cbuEmpleado_74_22[0] ;
            A1660LSD2dependenciaRevista_24_50 = H00HH2_A1660LSD2dependenciaRevista_24_50[0] ;
            A1659LSD2legajoEmpleado_14_10 = H00HH2_A1659LSD2legajoEmpleado_14_10[0] ;
            A1658LSD2cuilEmpleado_3_11 = H00HH2_A1658LSD2cuilEmpleado_3_11[0] ;
            A1657LSD2Sec = H00HH2_A1657LSD2Sec[0] ;
            e17HH2 ();
   ...
   public void send_integrity_lvl_hashesHH2( )
   {
      ...
      web.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV27IsAuthorized_Delete);
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV27IsAuthorized_Delete));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_LSD2SEC"+"_"+sGXsfl_26_idx, getSecureSignedToken( sPrefix+sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A1657LSD2Sec), "ZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00HH3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV10LSDSec)});
   ...
   public void strupHH0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         {
            GXutil.writeLogError("lsd_reg1lsd_reg2wc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e16HH2( )
   {
      ...
      GXt_char4 = AV24GridAppliedFilters ;
      GXv_char5[0] = GXt_char4 ;
      new web.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV38Pgmname, GXv_char5) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_char4 = GXv_char5[0] ;
      AV24GridAppliedFilters = GXt_char4 ;
   ...
   private void e17HH2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      AV33Display = "<i class=\"fa fa-search\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDisplay_Internalname, AV33Display);
      edtavDisplay_Link = formatLink("web.lsd_reg2view", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A1649LSDSec,8,0)),GXutil.URLEncode(GXutil.ltrimstr(A1657LSD2Sec,8,0)),GXutil.URLEncode(GXutil.rtrim(httpContext.getMessage( "LSD_reg3", "")))}, new String[] {"CliCod","EmpCod","LSDSec","LSD2Sec","TabCode"})  ;
      AV34Update = "<i class=\"fa fa-pen\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavUpdate_Internalname, AV34Update);
      if ( AV26IsAuthorized_Update )
      {
         edtavUpdate_Link = formatLink("web.lsd_reg2", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A1649LSDSec,8,0)),GXutil.URLEncode(GXutil.ltrimstr(A1657LSD2Sec,8,0))}, new String[] {"Mode","CliCod","EmpCod","LSDSec","LSD2Sec"})  ;
      }
      AV35Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV35Delete);
      if ( AV27IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("web.lsd_reg2", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A1649LSDSec,8,0)),GXutil.URLEncode(GXutil.ltrimstr(A1657LSD2Sec,8,0))}, new String[] {"Mode","CliCod","EmpCod","LSDSec","LSD2Sec"})  ;
      }
      AV29TipoReg = "02" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavTiporeg_Internalname, AV29TipoReg);
      edtavVersvg_Format = (short)(1) ;
      GXt_char4 = AV30VerSVG ;
      GXv_char5[0] = GXt_char4 ;
      new web.recuperasvg(remoteHandle, context).execute( httpContext.getMessage( "ver", ""), GXv_char5) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_char4 = GXv_char5[0] ;
      AV30VerSVG = GXt_char4 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavVersvg_Internalname, AV30VerSVG);
      edtavVersvg_Link = edtavDisplay_Link ;
      edtavVersvg_Columnclass = httpContext.getMessage( "GridActionColumn", "") ;
      edtavDisplay_Visible = 0 ;
      edtavModificarsvg_Format = (short)(1) ;
      GXt_char4 = AV31ModificarSVG ;
      GXv_char5[0] = GXt_char4 ;
      new web.recuperasvg(remoteHandle, context).execute( httpContext.getMessage( "modificar", ""), GXv_char5) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_char4 = GXv_char5[0] ;
      AV31ModificarSVG = GXt_char4 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavModificarsvg_Internalname, AV31ModificarSVG);
      edtavModificarsvg_Link = edtavUpdate_Link ;
      edtavModificarsvg_Columnclass = httpContext.getMessage( "GridActionColumn", "") ;
      edtavUpdate_Visible = 0 ;
      edtavEliminarsvg_Format = (short)(1) ;
      GXt_char4 = AV32EliminarSVG ;
      GXv_char5[0] = GXt_char4 ;
      new web.recuperasvg(remoteHandle, context).execute( httpContext.getMessage( "eliminar", ""), GXv_char5) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_char4 = GXv_char5[0] ;
      AV32EliminarSVG = GXt_char4 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavEliminarsvg_Internalname, AV32EliminarSVG);
   ...
   public void e14HH2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("web.lsd_reg2", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(AV8CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV10LSDSec,8,0)),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","CliCod","EmpCod","LSDSec","LSD2Sec"}) );
   ...
   public void S142( )
   {
      ...
      returnInSub = false ;
      GXt_boolean6 = AV26IsAuthorized_Update ;
      GXv_boolean7[0] = GXt_boolean6 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWLSD_reg2_Update", GXv_boolean7) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      AV26IsAuthorized_Update = GXt_boolean6 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV26IsAuthorized_Update", AV26IsAuthorized_Update);
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( sPrefix, AV26IsAuthorized_Update));
      if ( ! ( AV26IsAuthorized_Update ) )
      {
         edtavUpdate_Visible = 0 ;
      ...
      GXt_boolean6 = AV27IsAuthorized_Delete ;
      GXv_boolean7[0] = GXt_boolean6 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWLSD_reg2_Delete", GXv_boolean7) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      AV27IsAuthorized_Delete = GXt_boolean6 ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWLSD_reg2_Insert", GXv_boolean7) ;
      lsd_reg1lsd_reg2wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      AV28TempBoolean = GXt_boolean6 ;
      if ( ! ( AV28TempBoolean ) )
      {
   ...
   public void S122( )
   {
      ...
      {
         AV14GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV38Pgmname+"GridState"), null, null);
      }
      else
      {
         AV14GridState.fromxml(AV18Session.getValue(AV38Pgmname+"GridState"), null, null);
      }
   ...
   public void S152( )
   {
      ...
      new web.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV38Pgmname+"GridState", AV14GridState.toxml(false, true, "WWPGridState", "PayDay")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV38Pgmname );
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "LSD_reg2" );
      ...
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
      AV13TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "LSDSec" );
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV10LSDSec, 8, 0) );
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "lsd_reg1lsd_reg2wc", GetJustCreated( ));
      ...
      wcpOAV9EmpCod = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9EmpCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV10LSDSec = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV10LSDSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( AV8CliCod != wcpOAV8CliCod ) || ( AV9EmpCod != wcpOAV9EmpCod ) || ( AV10LSDSec != wcpOAV10LSDSec ) ) )
      {
         setjustcreated();
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020255271", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("lsd_reg1lsd_reg2wc.js", "?2024122020255271", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtLSD2Sec_Internalname = sPrefix+"LSD2SEC_"+sGXsfl_26_idx ;
      edtavTiporeg_Internalname = sPrefix+"vTIPOREG_"+sGXsfl_26_idx ;
      edtLSD2cuilEmpleado_3_11_Internalname = sPrefix+"LSD2CUILEMPLEADO_3_11_"+sGXsfl_26_idx ;
      edtLSD2legajoEmpleado_14_10_Internalname = sPrefix+"LSD2LEGAJOEMPLEADO_14_10_"+sGXsfl_26_idx ;
      edtLSD2dependenciaRevista_24_50_Internalname = sPrefix+"LSD2DEPENDENCIAREVISTA_24_50_"+sGXsfl_26_idx ;
      edtLSD2cbuEmpleado_74_22_Internalname = sPrefix+"LSD2CBUEMPLEADO_74_22_"+sGXsfl_26_idx ;
      edtLSD2diasLiquidados_96_3_Internalname = sPrefix+"LSD2DIASLIQUIDADOS_96_3_"+sGXsfl_26_idx ;
      edtLSD2fechaPago_99_8_Internalname = sPrefix+"LSD2FECHAPAGO_99_8_"+sGXsfl_26_idx ;
      edtLSD2fechaRubrica_107_8_Internalname = sPrefix+"LSD2FECHARUBRICA_107_8_"+sGXsfl_26_idx ;
      edtLSD2formaPago_115_1_Internalname = sPrefix+"LSD2FORMAPAGO_115_1_"+sGXsfl_26_idx ;
   ...
   {
      edtLSD2Sec_Internalname = sPrefix+"LSD2SEC_"+sGXsfl_26_fel_idx ;
      edtavTiporeg_Internalname = sPrefix+"vTIPOREG_"+sGXsfl_26_fel_idx ;
      edtLSD2cuilEmpleado_3_11_Internalname = sPrefix+"LSD2CUILEMPLEADO_3_11_"+sGXsfl_26_fel_idx ;
      edtLSD2legajoEmpleado_14_10_Internalname = sPrefix+"LSD2LEGAJOEMPLEADO_14_10_"+sGXsfl_26_fel_idx ;
      edtLSD2dependenciaRevista_24_50_Internalname = sPrefix+"LSD2DEPENDENCIAREVISTA_24_50_"+sGXsfl_26_fel_idx ;
      edtLSD2cbuEmpleado_74_22_Internalname = sPrefix+"LSD2CBUEMPLEADO_74_22_"+sGXsfl_26_fel_idx ;
      edtLSD2diasLiquidados_96_3_Internalname = sPrefix+"LSD2DIASLIQUIDADOS_96_3_"+sGXsfl_26_fel_idx ;
      edtLSD2fechaPago_99_8_Internalname = sPrefix+"LSD2FECHAPAGO_99_8_"+sGXsfl_26_fel_idx ;
      edtLSD2fechaRubrica_107_8_Internalname = sPrefix+"LSD2FECHARUBRICA_107_8_"+sGXsfl_26_fel_idx ;
      edtLSD2formaPago_115_1_Internalname = sPrefix+"LSD2FORMAPAGO_115_1_"+sGXsfl_26_fel_idx ;
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2Sec_Internalname,GXutil.ltrim( localUtil.ntoc( A1657LSD2Sec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1657LSD2Sec), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2Sec_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTiporeg_Internalname,GXutil.rtrim( AV29TipoReg),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtavTiporeg_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(edtavTiporeg_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2cuilEmpleado_3_11_Internalname,GXutil.ltrim( localUtil.ntoc( A1658LSD2cuilEmpleado_3_11, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1658LSD2cuilEmpleado_3_11), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2cuilEmpleado_3_11_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2legajoEmpleado_14_10_Internalname,GXutil.rtrim( A1659LSD2legajoEmpleado_14_10),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2legajoEmpleado_14_10_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2dependenciaRevista_24_50_Internalname,GXutil.rtrim( A1660LSD2dependenciaRevista_24_50),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2dependenciaRevista_24_50_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(50),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2cbuEmpleado_74_22_Internalname,GXutil.rtrim( A1661LSD2cbuEmpleado_74_22),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2cbuEmpleado_74_22_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2diasLiquidados_96_3_Internalname,GXutil.ltrim( localUtil.ntoc( A1662LSD2diasLiquidados_96_3, (byte)(3), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1662LSD2diasLiquidados_96_3), "ZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2diasLiquidados_96_3_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(3),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2fechaPago_99_8_Internalname,localUtil.format(A1663LSD2fechaPago_99_8, "99/99/99"),localUtil.format( A1663LSD2fechaPago_99_8, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2fechaPago_99_8_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2fechaRubrica_107_8_Internalname,localUtil.format(A1664LSD2fechaRubrica_107_8, "99/99/99"),localUtil.format( A1664LSD2fechaRubrica_107_8, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2fechaRubrica_107_8_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD2formaPago_115_1_Internalname,GXutil.rtrim( A1665LSD2formaPago_115_1),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD2formaPago_115_1_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavDisplay_Internalname,GXutil.rtrim( AV33Display),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtavDisplay_Link,"",httpContext.getMessage( "GXM_display", ""),"",edtavDisplay_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWIconActionColumn","",Integer.valueOf(edtavDisplay_Visible),Integer.valueOf(edtavDisplay_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(1),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavDelete_Internalname,GXutil.rtrim( AV35Delete),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtavDelete_Link,"",httpContext.getMessage( "GX_BtnDelete", ""),"",edtavDelete_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWIconActionColumn","",Integer.valueOf(edtavDelete_Visible),Integer.valueOf(edtavDelete_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(1),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "GridAction" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavModificarsvg_Internalname,GXutil.rtrim( AV31ModificarSVG),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtavModificarsvg_Link,"","","",edtavModificarsvg_Jsonclick,Integer.valueOf(0),"GridAction","",ROClassString,edtavModificarsvg_Columnclass,"",Integer.valueOf(-1),Integer.valueOf(edtavModificarsvg_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(400),Integer.valueOf(0),Short.valueOf(edtavModificarsvg_Format),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Dependencia de revista", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "CBU", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Días liquidados", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Fecha de pago", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Fecha de rúbrica", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1657LSD2Sec, (byte)(8), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV29TipoReg));
         GridColumn.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavTiporeg_Enabled, (byte)(5), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1658LSD2cuilEmpleado_3_11, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1659LSD2legajoEmpleado_14_10));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1660LSD2dependenciaRevista_24_50));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1661LSD2cbuEmpleado_74_22));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1662LSD2diasLiquidados_96_3, (byte)(3), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A1663LSD2fechaPago_99_8, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A1664LSD2fechaRubrica_107_8, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1665LSD2formaPago_115_1));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV33Display));
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV30VerSVG));
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV31ModificarSVG));
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV32EliminarSVG));
   ...
   public void init_default_properties( )
   {
      ...
      edtavTiporeg_Internalname = sPrefix+"vTIPOREG" ;
      edtLSD2cuilEmpleado_3_11_Internalname = sPrefix+"LSD2CUILEMPLEADO_3_11" ;
      edtLSD2legajoEmpleado_14_10_Internalname = sPrefix+"LSD2LEGAJOEMPLEADO_14_10" ;
      edtLSD2dependenciaRevista_24_50_Internalname = sPrefix+"LSD2DEPENDENCIAREVISTA_24_50" ;
      edtLSD2cbuEmpleado_74_22_Internalname = sPrefix+"LSD2CBUEMPLEADO_74_22" ;
      edtLSD2diasLiquidados_96_3_Internalname = sPrefix+"LSD2DIASLIQUIDADOS_96_3" ;
      edtLSD2fechaPago_99_8_Internalname = sPrefix+"LSD2FECHAPAGO_99_8" ;
      edtLSD2fechaRubrica_107_8_Internalname = sPrefix+"LSD2FECHARUBRICA_107_8" ;
      edtLSD2formaPago_115_1_Internalname = sPrefix+"LSD2FORMAPAGO_115_1" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:LSD2cuilEmpleado_3_11|3:LSD2legajoEmpleado_14_10|4:LSD2dependenciaRevista_24_50|5:LSD2cbuEmpleado_74_22|6:LSD2diasLiquidados_96_3|7:LSD2fechaPago_99_8|8:LSD2fechaRubrica_107_8|9:LSD2formaPago_115_1" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV22GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV23GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV24GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11HH2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12HH2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13HH2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17HH2',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'A1657LSD2Sec',fld:'LSD2SEC',pic:'ZZZZZZZ9',hsh:true},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV33Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV34Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV35Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'AV29TipoReg',fld:'vTIPOREG',pic:''},{av:'edtavVersvg_Format',ctrl:'vVERSVG',prop:'Format'},{av:'AV30VerSVG',fld:'vVERSVG',pic:''},{av:'edtavVersvg_Link',ctrl:'vVERSVG',prop:'Link'},{av:'edtavVersvg_Columnclass',ctrl:'vVERSVG',prop:'Columnclass'},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'edtavModificarsvg_Format',ctrl:'vMODIFICARSVG',prop:'Format'},{av:'AV31ModificarSVG',fld:'vMODIFICARSVG',pic:''},{av:'edtavModificarsvg_Link',ctrl:'vMODIFICARSVG',prop:'Link'},{av:'edtavModificarsvg_Columnclass',ctrl:'vMODIFICARSVG',prop:'Columnclass'},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavEliminarsvg_Format',ctrl:'vELIMINARSVG',prop:'Format'},{av:'AV32EliminarSVG',fld:'vELIMINARSVG',pic:''},{av:'edtavEliminarsvg_Link',ctrl:'vELIMINARSVG',prop:'Link'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e14HH2',iparms:[{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'A1657LSD2Sec',fld:'LSD2SEC',pic:'ZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      AV32EliminarSVG = "" ;
      scmdbuf = "" ;
      H00HH2_A3CliCod = new int[1] ;
      H00HH2_A1EmpCod = new short[1] ;
      H00HH2_A1649LSDSec = new int[1] ;
      H00HH2_A1665LSD2formaPago_115_1 = new String[] {""} ;
      H00HH2_A1664LSD2fechaRubrica_107_8 = new java.util.Date[] {GXutil.nullDate()} ;
      H00HH2_A1663LSD2fechaPago_99_8 = new java.util.Date[] {GXutil.nullDate()} ;
      H00HH2_A1662LSD2diasLiquidados_96_3 = new short[1] ;
      H00HH2_A1661LSD2cbuEmpleado_74_22 = new String[] {""} ;
      H00HH2_A1660LSD2dependenciaRevista_24_50 = new String[] {""} ;
      H00HH2_A1659LSD2legajoEmpleado_14_10 = new String[] {""} ;
      H00HH2_A1658LSD2cuilEmpleado_3_11 = new long[1] ;
      H00HH2_A1657LSD2Sec = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.lsd_reg1lsd_reg2wc__default(),
         new Object[] {
             new Object[] {
            H00HH2_A3CliCod, H00HH2_A1EmpCod, H00HH2_A1649LSDSec, H00HH2_A1665LSD2formaPago_115_1, H00HH2_A1664LSD2fechaRubrica_107_8, H00HH2_A1663LSD2fechaPago_99_8, H00HH2_A1662LSD2diasLiquidados_96_3, H00HH2_A1661LSD2cbuEmpleado_74_22, H00HH2_A1660LSD2dependenciaRevista_24_50, H00HH2_A1659LSD2legajoEmpleado_14_10,
            H00HH2_A1658LSD2cuilEmpleado_3_11, H00HH2_A1657LSD2Sec
            }
            , new Object[] {
   ...
   private int edtavTiporeg_Enabled ;
   ...
   private String AV29TipoReg ;
   private String edtavTiporeg_Internalname ;
   ...
   private String AV30VerSVG ;
   private String edtavVersvg_Internalname ;
   private String AV31ModificarSVG ;
   private String edtavModificarsvg_Internalname ;
   private String AV32EliminarSVG ;
   ...
   private String edtavTiporeg_Jsonclick ;
   ...
   private boolean AV26IsAuthorized_Update ;
   ...
   private int[] H00HH2_A3CliCod ;
   private short[] H00HH2_A1EmpCod ;
   private int[] H00HH2_A1649LSDSec ;
   private String[] H00HH2_A1665LSD2formaPago_115_1 ;
   private java.util.Date[] H00HH2_A1664LSD2fechaRubrica_107_8 ;
   private java.util.Date[] H00HH2_A1663LSD2fechaPago_99_8 ;
   private short[] H00HH2_A1662LSD2diasLiquidados_96_3 ;
   private String[] H00HH2_A1661LSD2cbuEmpleado_74_22 ;
   private String[] H00HH2_A1660LSD2dependenciaRevista_24_50 ;
   private String[] H00HH2_A1659LSD2legajoEmpleado_14_10 ;
   private long[] H00HH2_A1658LSD2cuilEmpleado_3_11 ;
   private int[] H00HH2_A1657LSD2Sec ;
...
final  class lsd_reg1lsd_reg2wc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int A1649LSDSec )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, EmpCod, LSDSec, LSD2formaPago_115_1, LSD2fechaRubrica_107_8, LSD2fechaPago_99_8, LSD2diasLiquidados_96_3, LSD2cbuEmpleado_74_22, LSD2dependenciaRevista_24_50," ;
      sSelectString += " LSD2legajoEmpleado_14_10, LSD2cuilEmpleado_3_11, LSD2Sec" ;
      sFromString = " FROM LSD_reg2" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LSDSec = ?)");
      if ( ( AV16OrderedBy == 1 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2cuilEmpleado_3_11, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 1 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2cuilEmpleado_3_11 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2legajoEmpleado_14_10, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2legajoEmpleado_14_10 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 3 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2dependenciaRevista_24_50, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 3 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2dependenciaRevista_24_50 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 4 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2cbuEmpleado_74_22, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 4 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2cbuEmpleado_74_22 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 5 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2diasLiquidados_96_3, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 5 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2diasLiquidados_96_3 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 6 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2fechaPago_99_8, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 6 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2fechaPago_99_8 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 7 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2fechaRubrica_107_8, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 7 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2fechaRubrica_107_8 DESC, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 8 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2formaPago_115_1, LSD2Sec" ;
      }
      else if ( ( AV16OrderedBy == 8 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD2formaPago_115_1 DESC, LSD2Sec" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD2Sec" ;
      }
                                          ...
                                          int A1649LSDSec )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM LSD_reg2" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LSDSec = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00HH2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).intValue() , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).intValue() );
            case 1 :
                  return conditional_H00HH3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).intValue() , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).intValue() );
      }
