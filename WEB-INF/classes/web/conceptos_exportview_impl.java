...
public final  class conceptos_exportview_impl extends GXDataArea
{
   public conceptos_exportview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public conceptos_exportview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( conceptos_exportview_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.conceptos_exportview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11ConCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ConCodigo","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.conceptos_exportview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11ConCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ConCodigo","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Conceptos_exportView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Conceptos_export View", "") ;
   }
   ...
   public void wbIC0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_IC2( true) ;
      }
      else
      {
         wb_table1_9_IC2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_IC2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startIC2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Conceptos_export View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesIC2( )
   {
   }
   ...
   public void e11IC2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00IC2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11ConCodigo, Integer.valueOf(AV10CliCod), AV11ConCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A26ConCodigo = H00IC2_A26ConCodigo[0] ;
         A3CliCod = H00IC2_A3CliCod[0] ;
         A41ConDescrip = H00IC2_A41ConDescrip[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A41ConDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Conceptos_exportGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.conceptos_exportgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Conceptos_exportGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11ConCodigo});
   ...
   public void wb_table1_9_IC2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Conceptos_exportView.htm");
         /* Div Control */
         ...
         wb_table1_9_IC2e( true) ;
      }
      else
      {
         wb_table1_9_IC2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251816591216", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("conceptos_exportview.js", "?20251816591217", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Conceptos_export View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11ConCodigo',fld:'vCONCODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00IC2_A26ConCodigo = new String[] {""} ;
      H00IC2_A3CliCod = new int[1] ;
      H00IC2_A41ConDescrip = new String[] {""} ;
      A26ConCodigo = "" ;
      A41ConDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.conceptos_exportview__default(),
         new Object[] {
             new Object[] {
            H00IC2_A26ConCodigo, H00IC2_A3CliCod, H00IC2_A41ConDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00IC2_A26ConCodigo ;
   private int[] H00IC2_A3CliCod ;
   private String[] H00IC2_A41ConDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class conceptos_exportview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00IC2", "SELECT ConCodigo, CliCod, ConDescrip FROM Concepto WHERE (CliCod = ? and ConCodigo = ( ?)) AND (CliCod = ? and ConCodigo = ( ?)) ORDER BY CliCod, ConCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
