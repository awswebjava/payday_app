...
@javax.xml.bind.annotation.XmlType(name = "motivoegresorevistaafiploaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class motivoegresorevistaafiploaddvcombo_RESTInterfaceIN
{
   ...
   {
      if ( GXutil.strcmp(AV19MegCodigo, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV19MegCodigo ;
      }
   }
   ...
   @JsonProperty("MegSitRevista")
   public short getMegSitRevista( )
   {
      return AV20MegSitRevista ;
   }

   @JsonProperty("MegSitRevista")
   public void setMegSitRevista(  short Value )
   {
      AV20MegSitRevista= Value;
   }
