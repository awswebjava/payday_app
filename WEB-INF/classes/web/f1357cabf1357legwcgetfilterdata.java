...
public final  class f1357cabf1357legwcgetfilterdata extends GXProcedure
{
   public f1357cabf1357legwcgetfilterdata( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( f1357cabf1357legwcgetfilterdata.class ), "" );
   }
   ...
   public String executeUdp( String aP0 ,
                             ...
                             String[] aP4 )
   {
      f1357cabf1357legwcgetfilterdata.this.aP5 = new String[] {""};
   ...
   private void execute_int( String aP0 ,
                             ...
                             String[] aP5 )
   {
      f1357cabf1357legwcgetfilterdata.this.AV16DDOName = aP0;
      f1357cabf1357legwcgetfilterdata.this.AV14SearchTxt = aP1;
      f1357cabf1357legwcgetfilterdata.this.AV15SearchTxtTo = aP2;
      f1357cabf1357legwcgetfilterdata.this.aP3 = aP3;
      f1357cabf1357legwcgetfilterdata.this.aP4 = aP4;
      f1357cabf1357legwcgetfilterdata.this.aP5 = aP5;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      f1357cabf1357legwcgetfilterdata.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S111( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV27Session.getValue("F1357CabF1357LegWCGridState"), "") == 0 )
      {
         AV29GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "F1357CabF1357LegWCGridState"), null, null);
      }
      else
      {
         AV29GridState.fromxml(AV27Session.getValue("F1357CabF1357LegWCGridState"), null, null);
      }
      AV39GXV1 = 1 ;
   ...
   public void S121( )
   {
      ...
      {
         A6LegNumero = P00V92_A6LegNumero[0] ;
         A250LegIdNomApe = P00V92_A250LegIdNomApe[0] ;
         A778F1357CSec = P00V92_A778F1357CSec[0] ;
         A777F1357CPer = P00V92_A777F1357CPer[0] ;
         A784F1357CTipoPre = P00V92_A784F1357CTipoPre[0] ;
         A1EmpCod = P00V92_A1EmpCod[0] ;
         A3CliCod = P00V92_A3CliCod[0] ;
         A786F1357LTipoReg = P00V92_A786F1357LTipoReg[0] ;
         A250LegIdNomApe = P00V92_A250LegIdNomApe[0] ;
   ...
   {
      this.aP3[0] = f1357cabf1357legwcgetfilterdata.this.AV20OptionsJson;
      this.aP4[0] = f1357cabf1357legwcgetfilterdata.this.AV23OptionsDescJson;
      this.aP5[0] = f1357cabf1357legwcgetfilterdata.this.AV25OptionIndexesJson;
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      A250LegIdNomApe = "" ;
      A777F1357CPer = "" ;
      P00V92_A6LegNumero = new int[1] ;
      P00V92_A250LegIdNomApe = new String[] {""} ;
      P00V92_A778F1357CSec = new byte[1] ;
      P00V92_A777F1357CPer = new String[] {""} ;
      P00V92_A784F1357CTipoPre = new byte[1] ;
      P00V92_A1EmpCod = new short[1] ;
      P00V92_A3CliCod = new int[1] ;
      P00V92_A786F1357LTipoReg = new String[] {""} ;
      A786F1357LTipoReg = "" ;
      AV18Option = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.f1357cabf1357legwcgetfilterdata__default(),
         new Object[] {
             new Object[] {
            P00V92_A6LegNumero, P00V92_A250LegIdNomApe, P00V92_A778F1357CSec, P00V92_A777F1357CPer, P00V92_A784F1357CTipoPre, P00V92_A1EmpCod, P00V92_A3CliCod, P00V92_A786F1357LTipoReg
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int[] P00V92_A6LegNumero ;
   private String[] P00V92_A250LegIdNomApe ;
   private byte[] P00V92_A778F1357CSec ;
   private String[] P00V92_A777F1357CPer ;
   private byte[] P00V92_A784F1357CTipoPre ;
   private short[] P00V92_A1EmpCod ;
   private int[] P00V92_A3CliCod ;
   private String[] P00V92_A786F1357LTipoReg ;
...
final  class f1357cabf1357legwcgetfilterdata__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00V92( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      scmdbuf = "SELECT T1.LegNumero, T2.LegIdNomApe, T1.F1357CSec, T1.F1357CPer, T1.F1357CTipoPre, T1.EmpCod, T1.CliCod, T1.F1357LTipoReg FROM (F1357Leg T1 INNER JOIN Legajo T2" ;
      scmdbuf += " ON T2.CliCod = T1.CliCod AND T2.EmpCod = T1.EmpCod AND T2.LegNumero = T1.LegNumero)" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00V92(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).byteValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).byteValue() , ((Number) dynConstraints[9]).intValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).byteValue() , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00V92", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
