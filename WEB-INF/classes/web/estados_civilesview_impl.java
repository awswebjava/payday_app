...
public final  class estados_civilesview_impl extends GXDataArea
{
   public estados_civilesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public estados_civilesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( estados_civilesview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10EstaCivilCod = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10EstaCivilCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EstaCivilCod), 4, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vESTACIVILCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EstaCivilCod), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.estados_civilesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EstaCivilCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EstaCivilCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vESTACIVILCOD", GXutil.ltrim( localUtil.ntoc( AV10EstaCivilCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vESTACIVILCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EstaCivilCod), "ZZZ9")));
   ...
   {
      return formatLink("web.estados_civilesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EstaCivilCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EstaCivilCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Estados_civilesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Estados_civiles View", "") ;
   }
   ...
   public void wbI60( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_I62( true) ;
      }
      else
      {
         wb_table1_9_I62( false) ;
      }
      return  ;
   }

   public void wb_table1_9_I62e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startI62( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Estados_civiles View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesI62( )
   {
   }
   ...
   public void strupI60( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10EstaCivilCod = (short)(localUtil.ctol( httpContext.cgiGet( "vESTACIVILCOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11I62( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00I62 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10EstaCivilCod)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1748EstaCivilCod = H00I62_A1748EstaCivilCod[0] ;
         A1749EstaCivilDescrip = H00I62_A1749EstaCivilDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1749EstaCivilDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Estados_civilesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.estados_civilesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Estados_civilesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10EstaCivilCod)});
   ...
   public void wb_table1_9_I62( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Estados_civilesView.htm");
         /* Div Control */
         ...
         wb_table1_9_I62e( true) ;
      }
      else
      {
         wb_table1_9_I62e( false) ;
      }
   }
   ...
   {
      AV10EstaCivilCod = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10EstaCivilCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EstaCivilCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vESTACIVILCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EstaCivilCod), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202042012", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("estados_civilesview.js", "?202412202042012", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Estados_civiles View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10EstaCivilCod',fld:'vESTACIVILCOD',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00I62_A1748EstaCivilCod = new short[1] ;
      H00I62_A1749EstaCivilDescrip = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.estados_civilesview__default(),
         new Object[] {
             new Object[] {
            H00I62_A1748EstaCivilCod, H00I62_A1749EstaCivilDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10EstaCivilCod ;
   ...
   private short[] H00I62_A1748EstaCivilCod ;
   private String[] H00I62_A1749EstaCivilDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class estados_civilesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00I62", "SELECT EstaCivilCod, EstaCivilDescrip FROM Estados_civiles WHERE EstaCivilCod = ? ORDER BY EstaCivilCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
