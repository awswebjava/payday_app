...
public final  class f1357cabf1357legremunwc_impl extends GXWebComponent
{
   public f1357cabf1357legremunwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public f1357cabf1357legremunwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( f1357cabf1357legremunwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "F1357 Cab F1357 Leg Remun WC", "")) ;
   ...
   public void renderHtmlCloseForm9M2( )
   {
   ...
   {
      return "F1357CabF1357LegRemunWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "F1357 Cab F1357 Leg Remun WC", "") ;
   }
   ...
   public void wb9M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.f1357cabf1357legremunwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 22 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_F1357CabF1357LegRemunWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_F1357CabF1357LegRemunWC.htm");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbF1357CTipoPre, cmbF1357CTipoPre.getInternalname(), GXutil.trim( GXutil.str( A784F1357CTipoPre, 1, 0)), 1, cmbF1357CTipoPre.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbF1357CTipoPre.getVisible(), 0, 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_F1357CabF1357LegRemunWC.htm");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtF1357CPer_Internalname, GXutil.rtrim( A777F1357CPer), GXutil.rtrim( localUtil.format( A777F1357CPer, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtF1357CPer_Jsonclick, 0, "Attribute", "", "", "", "", edtF1357CPer_Visible, 0, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_F1357CabF1357LegRemunWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtF1357CSec_Internalname, GXutil.ltrim( localUtil.ntoc( A778F1357CSec, (byte)(2), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A778F1357CSec), "Z9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtF1357CSec_Jsonclick, 0, "Attribute", "", "", "", "", edtF1357CSec_Visible, 0, 0, "text", "1", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_F1357CabF1357LegRemunWC.htm");
         /* User Defined Control */
   ...
   public void start9M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "F1357 Cab F1357 Leg Remun WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV37Pgmname = "F1357CabF1357LegRemunWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf9M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A3CliCod = H009M2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H009M2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A784F1357CTipoPre = H009M2_A784F1357CTipoPre[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A784F1357CTipoPre", GXutil.str( A784F1357CTipoPre, 1, 0));
            A777F1357CPer = H009M2_A777F1357CPer[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A777F1357CPer", A777F1357CPer);
            A778F1357CSec = H009M2_A778F1357CSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A778F1357CSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A778F1357CSec), 2, 0));
            A801F1357LRExenta = H009M2_A801F1357LRExenta[0] ;
            A800F1357LRGravada = H009M2_A800F1357LRGravada[0] ;
            A799F1357LRRemuOtr = H009M2_A799F1357LRRemuOtr[0] ;
            A798F1357LRRemuneraciones = H009M2_A798F1357LRRemuneraciones[0] ;
            A797F1357LRTipReg = H009M2_A797F1357LRTipReg[0] ;
            A250LegIdNomApe = H009M2_A250LegIdNomApe[0] ;
            A6LegNumero = H009M2_A6LegNumero[0] ;
            A250LegIdNomApe = H009M2_A250LegIdNomApe[0] ;
            e169M2 ();
   ...
   public void e149M2( )
   {
      ...
      f1357cabf1357legremunwc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e159M2( )
   {
      ...
      f1357cabf1357legremunwc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV13TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "F1357LegRemun" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "f1357cabf1357legremunwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713385275", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("f1357cabf1357legremunwc.js", "?20251713385276", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_222( )
   {
      ...
      edtF1357LRTipReg_Internalname = sPrefix+"F1357LRTIPREG_"+sGXsfl_22_idx ;
      edtF1357LRRemuneraciones_Internalname = sPrefix+"F1357LRREMUNERACIONES_"+sGXsfl_22_idx ;
      edtF1357LRRemuOtr_Internalname = sPrefix+"F1357LRREMUOTR_"+sGXsfl_22_idx ;
      edtF1357LRGravada_Internalname = sPrefix+"F1357LRGRAVADA_"+sGXsfl_22_idx ;
      edtF1357LRExenta_Internalname = sPrefix+"F1357LREXENTA_"+sGXsfl_22_idx ;
   }
   ...
   public void subsflControlProps_fel_222( )
   {
      ...
      edtF1357LRTipReg_Internalname = sPrefix+"F1357LRTIPREG_"+sGXsfl_22_fel_idx ;
      edtF1357LRRemuneraciones_Internalname = sPrefix+"F1357LRREMUNERACIONES_"+sGXsfl_22_fel_idx ;
      edtF1357LRRemuOtr_Internalname = sPrefix+"F1357LRREMUOTR_"+sGXsfl_22_fel_idx ;
      edtF1357LRGravada_Internalname = sPrefix+"F1357LRGRAVADA_"+sGXsfl_22_fel_idx ;
      edtF1357LRExenta_Internalname = sPrefix+"F1357LREXENTA_"+sGXsfl_22_fel_idx ;
   }
   ...
   public void sendrow_222( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LRTipReg_Internalname,GXutil.rtrim( A797F1357LRTipReg),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LRTipReg_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LRRemuneraciones_Internalname,A798F1357LRRemuneraciones,A798F1357LRRemuneraciones,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LRRemuneraciones_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LRRemuOtr_Internalname,A799F1357LRRemuOtr,A799F1357LRRemuOtr,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LRRemuOtr_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LRGravada_Internalname,GXutil.ltrim( localUtil.ntoc( A800F1357LRGravada, (byte)(20), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A800F1357LRGravada, "Z,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LRGravada_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Importes16_2","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtF1357LRExenta_Internalname,GXutil.ltrim( localUtil.ntoc( A801F1357LRExenta, (byte)(20), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A801F1357LRExenta, "Z,ZZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtF1357LRExenta_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(22),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Importes16_2","right",Boolean.valueOf(false),""});
   ...
   public void startgridcontrol22( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "LRTip Reg", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Remuneraciones Otros Empleos", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Remuneraciones Otros empleos", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "REMUNERACIÓN GRAVADA", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "REMUNERACIÓN NO GRAVADA / NO ALCANZADA / EXENTA", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A797F1357LRTipReg));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A798F1357LRRemuneraciones);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", A799F1357LRRemuOtr);
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A800F1357LRGravada, (byte)(20), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A801F1357LRExenta, (byte)(20), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void init_default_properties( )
   {
      ...
      edtF1357LRTipReg_Internalname = sPrefix+"F1357LRTIPREG" ;
      edtF1357LRRemuneraciones_Internalname = sPrefix+"F1357LRREMUNERACIONES" ;
      edtF1357LRRemuOtr_Internalname = sPrefix+"F1357LRREMUOTR" ;
      edtF1357LRGravada_Internalname = sPrefix+"F1357LRGRAVADA" ;
      edtF1357LRExenta_Internalname = sPrefix+"F1357LREXENTA" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtF1357LRRemuOtr_Jsonclick = "" ;
      edtF1357LRRemuneraciones_Jsonclick = "" ;
      ...
      Ddo_grid_Datalistproc = "F1357CabF1357LegRemunWCGetFilterData" ;
      ...
      Ddo_grid_Columnids = "1:LegIdNomApe|3:F1357LRRemuneraciones|4:F1357LRRemuOtr|5:F1357LRGravada|6:F1357LRExenta" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e169M2',iparms:[]");
      ...
      setEventMetadata("NULL","{handler:'valid_F1357lrexenta',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV31TFLegIdNomApe = "" ;
      H009M2_A3CliCod = new int[1] ;
      H009M2_A1EmpCod = new short[1] ;
      H009M2_A784F1357CTipoPre = new byte[1] ;
      H009M2_A777F1357CPer = new String[] {""} ;
      H009M2_A778F1357CSec = new byte[1] ;
      H009M2_A801F1357LRExenta = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H009M2_A800F1357LRGravada = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H009M2_A799F1357LRRemuOtr = new String[] {""} ;
      H009M2_A798F1357LRRemuneraciones = new String[] {""} ;
      H009M2_A797F1357LRTipReg = new String[] {""} ;
      H009M2_A250LegIdNomApe = new String[] {""} ;
      H009M2_A6LegNumero = new int[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.f1357cabf1357legremunwc__default(),
         new Object[] {
             new Object[] {
            H009M2_A3CliCod, H009M2_A1EmpCod, H009M2_A784F1357CTipoPre, H009M2_A777F1357CPer, H009M2_A778F1357CSec, H009M2_A801F1357LRExenta, H009M2_A800F1357LRGravada, H009M2_A799F1357LRRemuOtr, H009M2_A798F1357LRRemuneraciones, H009M2_A797F1357LRTipReg,
            H009M2_A250LegIdNomApe, H009M2_A6LegNumero
            }
            , new Object[] {
   ...
   private String edtF1357LRRemuneraciones_Jsonclick ;
   private String edtF1357LRRemuOtr_Jsonclick ;
   ...
   private int[] H009M2_A3CliCod ;
   private short[] H009M2_A1EmpCod ;
   private byte[] H009M2_A784F1357CTipoPre ;
   private String[] H009M2_A777F1357CPer ;
   private byte[] H009M2_A778F1357CSec ;
   private java.math.BigDecimal[] H009M2_A801F1357LRExenta ;
   private java.math.BigDecimal[] H009M2_A800F1357LRGravada ;
   private String[] H009M2_A799F1357LRRemuOtr ;
   private String[] H009M2_A798F1357LRRemuneraciones ;
   private String[] H009M2_A797F1357LRTipReg ;
   private String[] H009M2_A250LegIdNomApe ;
   private int[] H009M2_A6LegNumero ;
...
final  class f1357cabf1357legremunwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H009M2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LRExenta, T1.F1357LRGravada, T1.F1357LRRemuOtr, T1.F1357LRRemuneraciones, T1.F1357LRTipReg," ;
      sSelectString += " T2.LegIdNomApe, T1.LegNumero" ;
      sFromString = " FROM (F1357LegRemun T1 INNER JOIN Legajo T2 ON T2.CliCod = T1.CliCod AND T2.EmpCod = T1.EmpCod AND T2.LegNumero = T1.LegNumero)" ;
      sOrderString = "" ;
      ...
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LRRemuneraciones, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 1 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LRRemuneraciones DESC, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LRRemuOtr, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LRRemuOtr DESC, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 3 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LRGravada, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 3 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LRGravada DESC, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 4 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.F1357LRExenta, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( ( AV17OrderedBy == 4 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.CliCod DESC, T1.EmpCod DESC, T1.F1357CTipoPre DESC, T1.F1357CPer DESC, T1.F1357CSec DESC, T1.F1357LRExenta DESC, T1.LegNumero, T1.F1357LRTipReg" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.CliCod, T1.EmpCod, T1.F1357CTipoPre, T1.F1357CPer, T1.F1357CSec, T1.LegNumero, T1.F1357LRTipReg" ;
      }
   ...
   protected Object[] conditional_H009M3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String A250LegIdNomApe ,
                                          GXSimpleCollection<String> AV32TFLegIdNomApe_Sels ,
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (F1357LegRemun T1 INNER JOIN Legajo T2 ON T2.CliCod = T1.CliCod AND T2.EmpCod = T1.EmpCod AND T2.LegNumero = T1.LegNumero)" ;
      addWhere(sWhereString, "(T1.CliCod = ? and T1.EmpCod = ? and T1.F1357CTipoPre = ? and T1.F1357CPer = ( ?) and T1.F1357CSec = ?)");
      if ( ( AV32TFLegIdNomApe_Sels_size == 0 ) && ( ! (GXutil.strcmp("", AV31TFLegIdNomApe)==0) ) )
      {
         addWhere(sWhereString, "(LOWER(T2.LegIdNomApe) like LOWER(?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H009M2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).byteValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).byteValue() , ((Number) dynConstraints[11]).intValue() , ((Number) dynConstraints[12]).shortValue() , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).byteValue() );
            case 1 :
                  return conditional_H009M3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).byteValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).byteValue() , ((Number) dynConstraints[11]).intValue() , ((Number) dynConstraints[12]).shortValue() , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).byteValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H009M2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H009M3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
