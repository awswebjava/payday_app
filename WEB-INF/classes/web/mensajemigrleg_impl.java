...
public final  class mensajemigrleg_impl extends GXWebComponent
{
   public mensajemigrleg_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public mensajemigrleg_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( mensajemigrleg_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV5CliCod),Short.valueOf(AV6EmpCod),Integer.valueOf(AV7MigrLegNumero)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Mensaje Migr Leg", "")) ;
   ...
   public void renderHtmlCloseForm0I2( )
   {
   ...
   {
      return "MensajeMigrLeg" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Mensaje Migr Leg", "") ;
   }
   ...
   public void wb0I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.mensajemigrleg");
         }
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavWarningstexto_Internalname, AV14warningsTexto, GXutil.rtrim( localUtil.format( AV14warningsTexto, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavWarningstexto_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavWarningstexto_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(1), 0, (byte)(0), (byte)(-1), (byte)(-1), false, "texto", "left", true, "", "HLP_MensajeMigrLeg.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0I2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Mensaje Migr Leg", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void e110I2( )
   {
      /* Start Routine */
      returnInSub = false ;
      GXv_char1[0] = AV13erroresTexto ;
      GXv_char2[0] = AV14warningsTexto ;
      new web.getmigrtexto(remoteHandle, context).execute( AV5CliCod, AV6EmpCod, AV7MigrLegNumero, GXv_char1, GXv_char2) ;
      mensajemigrleg_impl.this.AV13erroresTexto = GXv_char1[0] ;
      mensajemigrleg_impl.this.AV14warningsTexto = GXv_char2[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "mensajemigrleg", GetJustCreated( ));
      ...
      wcpOAV6EmpCod = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6EmpCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV7MigrLegNumero = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7MigrLegNumero"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( AV5CliCod != wcpOAV5CliCod ) || ( AV6EmpCod != wcpOAV6EmpCod ) || ( AV7MigrLegNumero != wcpOAV7MigrLegNumero ) ) )
      {
         setjustcreated();
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202028350", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("mensajemigrleg.js", "?202412202028350", false, true);
      }
