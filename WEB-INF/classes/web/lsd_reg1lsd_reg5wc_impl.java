...
public final  class lsd_reg1lsd_reg5wc_impl extends GXWebComponent
{
   public lsd_reg1lsd_reg5wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public lsd_reg1lsd_reg5wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( lsd_reg1lsd_reg5wc_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9EmpCod, AV10LSDSec, AV31Pgmname, AV16OrderedBy, AV17OrderedDsc, AV26IsAuthorized_Update, AV27IsAuthorized_Delete, A3CliCod, A1EmpCod, A1649LSDSec, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "LSD_reg1 LSD_reg5 WC", "")) ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", sPrefix+"hsh"+"LSD_reg1LSD_reg5WC");
      ...
      GXutil.writeLogInfo("lsd_reg1lsd_reg5wc:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void renderHtmlCloseFormHI2( )
   {
   ...
   {
      return "LSD_reg1LSD_reg5WC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "LSD_reg1 LSD_reg5 WC", "") ;
   }
   ...
   public void wbHI0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.lsd_reg1lsd_reg5wc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 26 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_LSD_reg1LSD_reg5WC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_LSD_reg1LSD_reg5WC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLSDSec_Internalname, GXutil.ltrim( localUtil.ntoc( A1649LSDSec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1649LSDSec), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLSDSec_Jsonclick, 0, "Attribute", "", "", "", "", edtLSDSec_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_LSD_reg1LSD_reg5WC.htm");
         /* User Defined Control */
   ...
   public void startHI2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "LSD_reg1 LSD_reg5 WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A1725LSD5fechaIngreso_24_8 = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtLSD5fechaIngreso_24_8_Internalname), 0)) ;
                           A1726LSD5fechaEgreso_32_8 = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtLSD5fechaEgreso_32_8_Internalname), 0)) ;
                           ...
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, cmbavGridactions.getInternalname(), GXutil.ltrimstr( DecimalUtil.doubleToDec(AV25GridActions), 4, 0));
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_LSD5SEC", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A1721LSD5Sec), "ZZZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LSD5SEC", GXutil.ltrim( localUtil.ntoc( A1721LSD5Sec, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV31Pgmname = "LSD_reg1LSD_reg5WC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfHI2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A3CliCod = H00HI2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H00HI2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A1649LSDSec = H00HI2_A1649LSDSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1649LSDSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1649LSDSec), 8, 0));
            A1728LSD5CUITEmpleador_55_11 = H00HI2_A1728LSD5CUITEmpleador_55_11[0] ;
            A1727LSD5importe_40_15 = H00HI2_A1727LSD5importe_40_15[0] ;
            A1726LSD5fechaEgreso_32_8 = H00HI2_A1726LSD5fechaEgreso_32_8[0] ;
            A1725LSD5fechaIngreso_24_8 = H00HI2_A1725LSD5fechaIngreso_24_8[0] ;
            A1724LSD5puestoDesempenado_20_4 = H00HI2_A1724LSD5puestoDesempenado_20_4[0] ;
            A1723LSD5categoriaProfesional_14_6 = H00HI2_A1723LSD5categoriaProfesional_14_6[0] ;
            A1722LSD5CUIL_3_11 = H00HI2_A1722LSD5CUIL_3_11[0] ;
            A1721LSD5Sec = H00HI2_A1721LSD5Sec[0] ;
            e17HI2 ();
   ...
   public void send_integrity_lvl_hashesHI2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV31Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV31Pgmname, ""))));
      web.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV26IsAuthorized_Update);
      ...
      web.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV27IsAuthorized_Delete);
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV27IsAuthorized_Delete));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_LSD5SEC"+"_"+sGXsfl_26_idx, getSecureSignedToken( sPrefix+sGXsfl_26_idx, localUtil.format( DecimalUtil.doubleToDec(A1721LSD5Sec), "ZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      GRID_nRecordCount = H00HI3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strupHI0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         {
            GXutil.writeLogError("lsd_reg1lsd_reg5wc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e16HI2( )
   {
      ...
      new web.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV31Pgmname, GXv_char5) ;
      lsd_reg1lsd_reg5wc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S142( )
   {
      ...
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWLSD_reg5_Update", GXv_boolean7) ;
      lsd_reg1lsd_reg5wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWLSD_reg5_Delete", GXv_boolean7) ;
      lsd_reg1lsd_reg5wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWLSD_reg5_Insert", GXv_boolean7) ;
      lsd_reg1lsd_reg5wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S162( )
   {
      /* 'DO UPDATE' Routine */
      returnInSub = false ;
      callWebObject(formatLink("web.lsd_reg5", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A1649LSDSec,8,0)),GXutil.URLEncode(GXutil.ltrimstr(A1721LSD5Sec,8,0))}, new String[] {"Mode","CliCod","EmpCod","LSDSec","LSD5Sec"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S172( )
   {
      /* 'DO DELETE' Routine */
      returnInSub = false ;
      callWebObject(formatLink("web.lsd_reg5", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A3CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(A1EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(A1649LSDSec,8,0)),GXutil.URLEncode(GXutil.ltrimstr(A1721LSD5Sec,8,0))}, new String[] {"Mode","CliCod","EmpCod","LSDSec","LSD5Sec"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV18Session.getValue(AV31Pgmname+"GridState"), "") == 0 )
      {
         AV14GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV31Pgmname+"GridState"), null, null);
      }
      else
      {
         AV14GridState.fromxml(AV18Session.getValue(AV31Pgmname+"GridState"), null, null);
      }
   ...
   public void S152( )
   {
      ...
      new web.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV31Pgmname+"GridState", AV14GridState.toxml(false, true, "WWPGridState", "PayDay")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV31Pgmname );
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "LSD_reg5" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "lsd_reg1lsd_reg5wc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020255564", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("lsd_reg1lsd_reg5wc.js", "?2024122020255564", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtLSD5Sec_Internalname = sPrefix+"LSD5SEC_"+sGXsfl_26_idx ;
      edtLSD5CUIL_3_11_Internalname = sPrefix+"LSD5CUIL_3_11_"+sGXsfl_26_idx ;
      edtLSD5categoriaProfesional_14_6_Internalname = sPrefix+"LSD5CATEGORIAPROFESIONAL_14_6_"+sGXsfl_26_idx ;
      edtLSD5puestoDesempenado_20_4_Internalname = sPrefix+"LSD5PUESTODESEMPENADO_20_4_"+sGXsfl_26_idx ;
      edtLSD5fechaIngreso_24_8_Internalname = sPrefix+"LSD5FECHAINGRESO_24_8_"+sGXsfl_26_idx ;
      edtLSD5fechaEgreso_32_8_Internalname = sPrefix+"LSD5FECHAEGRESO_32_8_"+sGXsfl_26_idx ;
      edtLSD5importe_40_15_Internalname = sPrefix+"LSD5IMPORTE_40_15_"+sGXsfl_26_idx ;
      edtLSD5CUITEmpleador_55_11_Internalname = sPrefix+"LSD5CUITEMPLEADOR_55_11_"+sGXsfl_26_idx ;
      cmbavGridactions.setInternalname( sPrefix+"vGRIDACTIONS_"+sGXsfl_26_idx );
   }

   public void subsflControlProps_fel_262( )
   {
      edtLSD5Sec_Internalname = sPrefix+"LSD5SEC_"+sGXsfl_26_fel_idx ;
      edtLSD5CUIL_3_11_Internalname = sPrefix+"LSD5CUIL_3_11_"+sGXsfl_26_fel_idx ;
      edtLSD5categoriaProfesional_14_6_Internalname = sPrefix+"LSD5CATEGORIAPROFESIONAL_14_6_"+sGXsfl_26_fel_idx ;
      edtLSD5puestoDesempenado_20_4_Internalname = sPrefix+"LSD5PUESTODESEMPENADO_20_4_"+sGXsfl_26_fel_idx ;
      edtLSD5fechaIngreso_24_8_Internalname = sPrefix+"LSD5FECHAINGRESO_24_8_"+sGXsfl_26_fel_idx ;
      edtLSD5fechaEgreso_32_8_Internalname = sPrefix+"LSD5FECHAEGRESO_32_8_"+sGXsfl_26_fel_idx ;
      edtLSD5importe_40_15_Internalname = sPrefix+"LSD5IMPORTE_40_15_"+sGXsfl_26_fel_idx ;
      edtLSD5CUITEmpleador_55_11_Internalname = sPrefix+"LSD5CUITEMPLEADOR_55_11_"+sGXsfl_26_fel_idx ;
   ...
   public void sendrow_262( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5Sec_Internalname,GXutil.ltrim( localUtil.ntoc( A1721LSD5Sec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1721LSD5Sec), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5Sec_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5CUIL_3_11_Internalname,GXutil.ltrim( localUtil.ntoc( A1722LSD5CUIL_3_11, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1722LSD5CUIL_3_11), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5CUIL_3_11_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5categoriaProfesional_14_6_Internalname,GXutil.ltrim( localUtil.ntoc( A1723LSD5categoriaProfesional_14_6, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1723LSD5categoriaProfesional_14_6), "ZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5categoriaProfesional_14_6_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(6),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5puestoDesempenado_20_4_Internalname,GXutil.ltrim( localUtil.ntoc( A1724LSD5puestoDesempenado_20_4, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1724LSD5puestoDesempenado_20_4), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5puestoDesempenado_20_4_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5fechaIngreso_24_8_Internalname,localUtil.format(A1725LSD5fechaIngreso_24_8, "99/99/99"),localUtil.format( A1725LSD5fechaIngreso_24_8, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5fechaIngreso_24_8_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5fechaEgreso_32_8_Internalname,localUtil.format(A1726LSD5fechaEgreso_32_8, "99/99/99"),localUtil.format( A1726LSD5fechaEgreso_32_8, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5fechaEgreso_32_8_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5importe_40_15_Internalname,GXutil.ltrim( localUtil.ntoc( A1727LSD5importe_40_15, (byte)(16), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A1727LSD5importe_40_15, "ZZZZZZZZZZZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5importe_40_15_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(16),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLSD5CUITEmpleador_55_11_Internalname,GXutil.ltrim( localUtil.ntoc( A1728LSD5CUITEmpleador_55_11, (byte)(11), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1728LSD5CUITEmpleador_55_11), "ZZZZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLSD5CUITEmpleador_55_11_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(11),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(26),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         }
         TempTags = " " + ((cmbavGridactions.getEnabled()!=0)&&(cmbavGridactions.getVisible()!=0) ? " onfocus=\"gx.evt.onfocus(this, 35,'"+sPrefix+"',false,'"+sGXsfl_26_idx+"',26)\"" : " ") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbavGridactions,cmbavGridactions.getInternalname(),GXutil.trim( GXutil.str( AV25GridActions, 4, 0)),Integer.valueOf(1),cmbavGridactions.getJsonclick(),Integer.valueOf(7),"'"+sPrefix+"'"+",false,"+"'"+"e18hi2_client"+"'","int","",Integer.valueOf(-1),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","",cmbavGridactions.getThemeClass(),"WWActionGroupColumn","",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((cmbavGridactions.getEnabled()!=0)&&(cmbavGridactions.getVisible()!=0) ? " onblur=\""+""+";gx.evt.onblur(this,35);\"" : " "),"",Boolean.valueOf(true),Integer.valueOf(0)});
         cmbavGridactions.setValue( GXutil.trim( GXutil.str( AV25GridActions, 4, 0)) );
   ...
   public void startgridcontrol26( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Fecha de egreso", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Importe", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "CUIT Empleador", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1721LSD5Sec, (byte)(8), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1722LSD5CUIL_3_11, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1723LSD5categoriaProfesional_14_6, (byte)(6), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1724LSD5puestoDesempenado_20_4, (byte)(4), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A1725LSD5fechaIngreso_24_8, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A1726LSD5fechaEgreso_32_8, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1727LSD5importe_40_15, (byte)(16), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1728LSD5CUITEmpleador_55_11, (byte)(11), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void init_default_properties( )
   {
      ...
      edtLSD5Sec_Internalname = sPrefix+"LSD5SEC" ;
      edtLSD5CUIL_3_11_Internalname = sPrefix+"LSD5CUIL_3_11" ;
      edtLSD5categoriaProfesional_14_6_Internalname = sPrefix+"LSD5CATEGORIAPROFESIONAL_14_6" ;
      edtLSD5puestoDesempenado_20_4_Internalname = sPrefix+"LSD5PUESTODESEMPENADO_20_4" ;
      edtLSD5fechaIngreso_24_8_Internalname = sPrefix+"LSD5FECHAINGRESO_24_8" ;
      edtLSD5fechaEgreso_32_8_Internalname = sPrefix+"LSD5FECHAEGRESO_32_8" ;
      edtLSD5importe_40_15_Internalname = sPrefix+"LSD5IMPORTE_40_15" ;
      edtLSD5CUITEmpleador_55_11_Internalname = sPrefix+"LSD5CUITEMPLEADOR_55_11" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:LSD5Sec|1:LSD5CUIL_3_11|2:LSD5categoriaProfesional_14_6|3:LSD5puestoDesempenado_20_4|4:LSD5fechaIngreso_24_8|5:LSD5fechaEgreso_32_8|6:LSD5importe_40_15|7:LSD5CUITEmpleador_55_11" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV31Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV22GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV23GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV24GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11HI2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'AV31Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12HI2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'AV31Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13HI2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'AV31Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17HI2',iparms:[{av:'AV26IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV27IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'cmbavGridactions'},{av:'AV25GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'}]}");
      setEventMetadata("VGRIDACTIONS.CLICK","{handler:'e18HI2',iparms:[{av:'cmbavGridactions'},{av:'AV25GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A1649LSDSec',fld:'LSDSEC',pic:'ZZZZZZZ9'},{av:'A1721LSD5Sec',fld:'LSD5SEC',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("VGRIDACTIONS.CLICK",",oparms:[{av:'cmbavGridactions'},{av:'AV25GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e14HI2',iparms:[{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LSDSec',fld:'vLSDSEC',pic:'ZZZZZZZ9'},{av:'A1721LSD5Sec',fld:'LSD5SEC',pic:'ZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00HI2_A3CliCod = new int[1] ;
      H00HI2_A1EmpCod = new short[1] ;
      H00HI2_A1649LSDSec = new int[1] ;
      H00HI2_A1728LSD5CUITEmpleador_55_11 = new long[1] ;
      H00HI2_A1727LSD5importe_40_15 = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00HI2_A1726LSD5fechaEgreso_32_8 = new java.util.Date[] {GXutil.nullDate()} ;
      H00HI2_A1725LSD5fechaIngreso_24_8 = new java.util.Date[] {GXutil.nullDate()} ;
      H00HI2_A1724LSD5puestoDesempenado_20_4 = new short[1] ;
      H00HI2_A1723LSD5categoriaProfesional_14_6 = new int[1] ;
      H00HI2_A1722LSD5CUIL_3_11 = new long[1] ;
      H00HI2_A1721LSD5Sec = new int[1] ;
      H00HI3_AGRID_nRecordCount = new long[1] ;
      hsh = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.lsd_reg1lsd_reg5wc__default(),
         new Object[] {
             new Object[] {
            H00HI2_A3CliCod, H00HI2_A1EmpCod, H00HI2_A1649LSDSec, H00HI2_A1728LSD5CUITEmpleador_55_11, H00HI2_A1727LSD5importe_40_15, H00HI2_A1726LSD5fechaEgreso_32_8, H00HI2_A1725LSD5fechaIngreso_24_8, H00HI2_A1724LSD5puestoDesempenado_20_4, H00HI2_A1723LSD5categoriaProfesional_14_6, H00HI2_A1722LSD5CUIL_3_11,
            H00HI2_A1721LSD5Sec
            }
            , new Object[] {
            H00HI3_AGRID_nRecordCount
            }
         }
      );
      AV31Pgmname = "LSD_reg1LSD_reg5WC" ;
   ...
   private int[] H00HI2_A3CliCod ;
   private short[] H00HI2_A1EmpCod ;
   private int[] H00HI2_A1649LSDSec ;
   private long[] H00HI2_A1728LSD5CUITEmpleador_55_11 ;
   private java.math.BigDecimal[] H00HI2_A1727LSD5importe_40_15 ;
   private java.util.Date[] H00HI2_A1726LSD5fechaEgreso_32_8 ;
   private java.util.Date[] H00HI2_A1725LSD5fechaIngreso_24_8 ;
   private short[] H00HI2_A1724LSD5puestoDesempenado_20_4 ;
   private int[] H00HI2_A1723LSD5categoriaProfesional_14_6 ;
   private long[] H00HI2_A1722LSD5CUIL_3_11 ;
   private int[] H00HI2_A1721LSD5Sec ;
   private long[] H00HI3_AGRID_nRecordCount ;
...
final  class lsd_reg1lsd_reg5wc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00HI2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          int A1649LSDSec )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, EmpCod, LSDSec, LSD5CUITEmpleador_55_11, LSD5importe_40_15, LSD5fechaEgreso_32_8, LSD5fechaIngreso_24_8, LSD5puestoDesempenado_20_4, LSD5categoriaProfesional_14_6," ;
      sSelectString += " LSD5CUIL_3_11, LSD5Sec" ;
      sFromString = " FROM LSD_reg5" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LSDSec = ?)");
      if ( ( AV16OrderedBy == 1 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 1 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5Sec DESC" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5CUIL_3_11, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5CUIL_3_11 DESC, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 3 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5categoriaProfesional_14_6, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 3 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5categoriaProfesional_14_6 DESC, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 4 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5puestoDesempenado_20_4, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 4 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5puestoDesempenado_20_4 DESC, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 5 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5fechaIngreso_24_8, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 5 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5fechaIngreso_24_8 DESC, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 6 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5fechaEgreso_32_8, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 6 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5fechaEgreso_32_8 DESC, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 7 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5importe_40_15, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 7 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5importe_40_15 DESC, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 8 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5CUITEmpleador_55_11, LSD5Sec" ;
      }
      else if ( ( AV16OrderedBy == 8 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LSDSec DESC, LSD5CUITEmpleador_55_11 DESC, LSD5Sec" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LSDSec, LSD5Sec" ;
   ...
   protected Object[] conditional_H00HI3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV16OrderedBy ,
                                          boolean AV17OrderedDsc ,
                                          ...
                                          int A1649LSDSec )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM LSD_reg5" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LSDSec = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00HI2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).intValue() , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).intValue() );
            case 1 :
                  return conditional_H00HI3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).intValue() , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00HI2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00HI3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
