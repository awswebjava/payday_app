...
public final  class convenioview_impl extends GXDataArea
{
   public convenioview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenioview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenioview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV19PaiCod = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV19PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV19PaiCod), 4, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV19PaiCod), "ZZZ9")));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV11ConveCodigo = httpContext.GetPar( "ConveCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11ConveCodigo", AV11ConveCodigo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVECODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ConveCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV19PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11ConveCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","ConveCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vPAICOD", GXutil.ltrim( localUtil.ntoc( AV19PaiCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV19PaiCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONVECODIGO", GXutil.rtrim( AV11ConveCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVECODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ConveCodigo, ""))));
   ...
   {
      return formatLink("web.convenioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV19PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11ConveCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","ConveCodigo","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Convenio View", "") ;
   }
   ...
   public void wb0W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_0W2( true) ;
      }
      else
      {
         wb_table1_9_0W2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_0W2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Convenio View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup0W0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV19PaiCod = (short)(localUtil.ctol( httpContext.cgiGet( "vPAICOD"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         AV11ConveCodigo = httpContext.cgiGet( "vCONVECODIGO") ;
   ...
   public void e110W2( )
   {
      ...
      AV22GXLvl11 = (byte)(0) ;
      /* Using cursor H000W2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV19PaiCod), AV11ConveCodigo, Short.valueOf(AV19PaiCod), AV11ConveCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A9ConveCodigo = H000W2_A9ConveCodigo[0] ;
         A46PaiCod = H000W2_A46PaiCod[0] ;
         A160ConveDescri = H000W2_A160ConveDescri[0] ;
         AV22GXLvl11 = (byte)(1) ;
         Form.setCaption( A160ConveDescri );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ConvenioGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.conveniogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ConvenioGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV19PaiCod),AV11ConveCodigo});
   ...
   public void wb_table1_9_0W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ConvenioView.htm");
         /* Div Control */
         ...
         wb_table1_9_0W2e( true) ;
      }
      else
      {
         wb_table1_9_0W2e( false) ;
      }
   }
   ...
   {
      AV19PaiCod = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV19PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV19PaiCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV19PaiCod), "ZZZ9")));
      AV11ConveCodigo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11ConveCodigo", AV11ConveCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVECODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11ConveCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025171332477", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("convenioview.js", "?2025171332477", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Convenio View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV19PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11ConveCodigo',fld:'vCONVECODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000W2_A9ConveCodigo = new String[] {""} ;
      H000W2_A46PaiCod = new short[1] ;
      H000W2_A160ConveDescri = new String[] {""} ;
      A9ConveCodigo = "" ;
      A160ConveDescri = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenioview__default(),
         new Object[] {
             new Object[] {
            H000W2_A9ConveCodigo, H000W2_A46PaiCod, H000W2_A160ConveDescri
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11ConveCodigo ;
   ...
   private String[] H000W2_A9ConveCodigo ;
   private short[] H000W2_A46PaiCod ;
   private String[] H000W2_A160ConveDescri ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class convenioview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000W2", "SELECT ConveCodigo, PaiCod, ConveDescri FROM Convenio WHERE (PaiCod = ? and ConveCodigo = ( ?)) AND (PaiCod = ? and ConveCodigo = ( ?)) ORDER BY PaiCod, ConveCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
