...
public final  class tipoliquidacionview_impl extends GXDataArea
{
   public tipoliquidacionview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipoliquidacionview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipoliquidacionview_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.tipoliquidacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9TLiqCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","TLiqCod","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("web.tipoliquidacionview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9TLiqCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","TLiqCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "TipoLiquidacionView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Liquidacion View", "") ;
   }
   ...
   public void wb1E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1E2( true) ;
      }
      else
      {
         wb_table1_9_1E2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1E2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1E2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Liquidacion View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e111E2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H001E2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV12CliCod), AV9TLiqCod, Integer.valueOf(AV12CliCod), AV9TLiqCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A32TLiqCod = H001E2_A32TLiqCod[0] ;
         A3CliCod = H001E2_A3CliCod[0] ;
         A340TliqDesc = H001E2_A340TliqDesc[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A340TliqDesc );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TipoLiquidacionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.tipoliquidaciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TipoLiquidacionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV12CliCod),AV9TLiqCod});
   ...
   public void wb_table1_9_1E2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TipoLiquidacionView.htm");
         /* Div Control */
         ...
         wb_table1_9_1E2e( true) ;
      }
      else
      {
         wb_table1_9_1E2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      AV9TLiqCod = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9TLiqCod", AV9TLiqCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTLIQCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9TLiqCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025139545935", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipoliquidacionview.js", "?2025139545935", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Tipo Liquidacion View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV9TLiqCod',fld:'vTLIQCOD',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001E2_A32TLiqCod = new String[] {""} ;
      H001E2_A3CliCod = new int[1] ;
      H001E2_A340TliqDesc = new String[] {""} ;
      A32TLiqCod = "" ;
      A340TliqDesc = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.tipoliquidacionview__default(),
         new Object[] {
             new Object[] {
            H001E2_A32TLiqCod, H001E2_A3CliCod, H001E2_A340TliqDesc
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H001E2_A32TLiqCod ;
   private int[] H001E2_A3CliCod ;
   private String[] H001E2_A340TliqDesc ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipoliquidacionview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001E2", "SELECT TLiqCod, CliCod, TliqDesc FROM TipoLiquidacion WHERE (CliCod = ? and TLiqCod = ( ?)) AND (CliCod = ? and TLiqCod = ( ?)) ORDER BY CliCod, TLiqCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
