...
public final  class puestoview_impl extends GXDataArea
{
   public puestoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public puestoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( puestoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11PuestoCodigo = httpContext.GetPar( "PuestoCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11PuestoCodigo", AV11PuestoCodigo);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPUESTOCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11PuestoCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.puestoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11PuestoCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","PuestoCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vPUESTOCODIGO", GXutil.rtrim( AV11PuestoCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPUESTOCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11PuestoCodigo, ""))));
   ...
   {
      return formatLink("web.puestoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11PuestoCodigo)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","PuestoCodigo","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Puesto View", "") ;
   }
   ...
   public void wbCO0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_CO2( true) ;
      }
      else
      {
         wb_table1_9_CO2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_CO2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startCO2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Puesto View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupCO0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11PuestoCodigo = httpContext.cgiGet( "vPUESTOCODIGO") ;
   ...
   public void e11CO2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00CO2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11PuestoCodigo, Integer.valueOf(AV10CliCod), AV11PuestoCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1240PuestoCodigo = H00CO2_A1240PuestoCodigo[0] ;
         A3CliCod = H00CO2_A3CliCod[0] ;
         A1241PuestoDescrip = H00CO2_A1241PuestoDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1241PuestoDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "PuestoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.puestogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PuestoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11PuestoCodigo});
   ...
   public void wb_table1_9_CO2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PuestoView.htm");
         /* Div Control */
         ...
         wb_table1_9_CO2e( true) ;
      }
      else
      {
         wb_table1_9_CO2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11PuestoCodigo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11PuestoCodigo", AV11PuestoCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPUESTOCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11PuestoCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202038426", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("puestoview.js", "?202412202038426", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Puesto View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11PuestoCodigo',fld:'vPUESTOCODIGO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00CO2_A13SecCodigo = new String[] {""} ;
      H00CO2_A1240PuestoCodigo = new String[] {""} ;
      H00CO2_A3CliCod = new int[1] ;
      H00CO2_A1241PuestoDescrip = new String[] {""} ;
      A1240PuestoCodigo = "" ;
      A1241PuestoDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.puestoview__default(),
         new Object[] {
             new Object[] {
            H00CO2_A13SecCodigo, H00CO2_A1240PuestoCodigo, H00CO2_A3CliCod, H00CO2_A1241PuestoDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11PuestoCodigo ;
   ...
   private String[] H00CO2_A13SecCodigo ;
   private String[] H00CO2_A1240PuestoCodigo ;
   private int[] H00CO2_A3CliCod ;
   private String[] H00CO2_A1241PuestoDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class puestoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00CO2", "SELECT SecCodigo, PuestoCodigo, CliCod, PuestoDescrip FROM Puesto WHERE (CliCod = ?) AND (PuestoCodigo = ( ?)) AND (CliCod = ? and PuestoCodigo = ( ?)) ORDER BY CliCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
