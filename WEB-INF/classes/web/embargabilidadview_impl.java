...
public final  class embargabilidadview_impl extends GXDataArea
{
   public embargabilidadview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public embargabilidadview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( embargabilidadview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10EmbargaSec = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10EmbargaSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EmbargaSec), 4, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMBARGASEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EmbargaSec), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.embargabilidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EmbargaSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EmbargaSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vEMBARGASEC", GXutil.ltrim( localUtil.ntoc( AV10EmbargaSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMBARGASEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EmbargaSec), "ZZZ9")));
   ...
   {
      return formatLink("web.embargabilidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EmbargaSec,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EmbargaSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "embargabilidadView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "embargabilidad View", "") ;
   }
   ...
   public void wbCD0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_CD2( true) ;
      }
      else
      {
         wb_table1_9_CD2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_CD2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startCD2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "embargabilidad View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesCD2( )
   {
   }
   ...
   public void strupCD0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10EmbargaSec = (short)(localUtil.ctol( httpContext.cgiGet( "vEMBARGASEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11CD2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00CD2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10EmbargaSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1161EmbargaSec = H00CD2_A1161EmbargaSec[0] ;
         A1162EmbargaDescrip = H00CD2_A1162EmbargaDescrip[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A1162EmbargaDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "embargabilidadGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.embargabilidadgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "embargabilidadGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10EmbargaSec)});
   ...
   public void wb_table1_9_CD2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_embargabilidadView.htm");
         /* Div Control */
         ...
         wb_table1_9_CD2e( true) ;
      }
      else
      {
         wb_table1_9_CD2e( false) ;
      }
   }
   ...
   {
      AV10EmbargaSec = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10EmbargaSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EmbargaSec), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMBARGASEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EmbargaSec), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019565519", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("embargabilidadview.js", "?2024122019565519", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "embargabilidad View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10EmbargaSec',fld:'vEMBARGASEC',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00CD2_A1161EmbargaSec = new short[1] ;
      H00CD2_A1162EmbargaDescrip = new String[] {""} ;
      A1162EmbargaDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.embargabilidadview__default(),
         new Object[] {
             new Object[] {
            H00CD2_A1161EmbargaSec, H00CD2_A1162EmbargaDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10EmbargaSec ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10EmbargaSec ;
   private short wbEnd ;
   ...
   private short[] H00CD2_A1161EmbargaSec ;
   private String[] H00CD2_A1162EmbargaDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class embargabilidadview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00CD2", "SELECT EmbargaSec, EmbargaDescrip FROM embargabilidad WHERE EmbargaSec = ? ORDER BY EmbargaSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
