...
public final  class deduccionessolapaview_impl extends GXDataArea
{
   public deduccionessolapaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public deduccionessolapaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( deduccionessolapaview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV13LegDedSec = (int)(GXutil.lval( httpContext.GetPar( "LegDedSec"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV13LegDedSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13LegDedSec), 8, 0));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGDEDSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13LegDedSec), "ZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.deduccionessolapaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV13LegDedSec,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegDedSec","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGNUMERO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LegNumero), "ZZZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vLEGDEDSEC", GXutil.ltrim( localUtil.ntoc( AV13LegDedSec, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGDEDSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13LegDedSec), "ZZZZZZZ9")));
   ...
   {
      return formatLink("web.deduccionessolapaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV13LegDedSec,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegDedSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "deduccionesSolapaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "deducciones Solapa View", "") ;
   }
   ...
   public void wb1Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1Q2( true) ;
      }
      else
      {
         wb_table1_9_1Q2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1Q2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "deducciones Solapa View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup1Q0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV13LegDedSec = (int)(localUtil.ctol( httpContext.cgiGet( "vLEGDEDSEC"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e111Q2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H001Q2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Integer.valueOf(AV12LegNumero), Integer.valueOf(AV13LegDedSec), Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), Integer.valueOf(AV12LegNumero), Integer.valueOf(AV13LegDedSec)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A83LegDedSec = H001Q2_A83LegDedSec[0] ;
         A6LegNumero = H001Q2_A6LegNumero[0] ;
         A1EmpCod = H001Q2_A1EmpCod[0] ;
         A3CliCod = H001Q2_A3CliCod[0] ;
         A556LegDedFchDes = H001Q2_A556LegDedFchDes[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( localUtil.dtoc( A556LegDedFchDes, localUtil.mapDateFormat( httpContext.getLanguageProperty( "date_fmt")), "/") );
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "deduccionesSolapaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.deduccionessolapageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "deduccionesSolapaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),Integer.valueOf(AV12LegNumero),Integer.valueOf(AV13LegDedSec)});
   ...
   public void wb_table1_9_1Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_deduccionesSolapaView.htm");
         /* Div Control */
         ...
         wb_table1_9_1Q2e( true) ;
      }
      else
      {
         wb_table1_9_1Q2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12LegNumero), 8, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGNUMERO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12LegNumero), "ZZZZZZZ9")));
      AV13LegDedSec = ((Number) GXutil.testNumericType( getParm(obj,3), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13LegDedSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV13LegDedSec), 8, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLEGDEDSEC", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13LegDedSec), "ZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181704421", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("deduccionessolapaview.js", "?2025181704421", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "deducciones Solapa View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9',hsh:true},{av:'AV13LegDedSec',fld:'vLEGDEDSEC',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001Q2_A83LegDedSec = new int[1] ;
      H001Q2_A6LegNumero = new int[1] ;
      H001Q2_A1EmpCod = new short[1] ;
      H001Q2_A3CliCod = new int[1] ;
      H001Q2_A556LegDedFchDes = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.deduccionessolapaview__default(),
         new Object[] {
             new Object[] {
            H001Q2_A83LegDedSec, H001Q2_A6LegNumero, H001Q2_A1EmpCod, H001Q2_A3CliCod, H001Q2_A556LegDedFchDes
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int wcpOAV13LegDedSec ;
   private int AV10CliCod ;
   private int AV12LegNumero ;
   private int AV13LegDedSec ;
   ...
   private int[] H001Q2_A83LegDedSec ;
   private int[] H001Q2_A6LegNumero ;
   private short[] H001Q2_A1EmpCod ;
   private int[] H001Q2_A3CliCod ;
   private java.util.Date[] H001Q2_A556LegDedFchDes ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class deduccionessolapaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001Q2", "SELECT LegDedSec, LegNumero, EmpCod, CliCod, LegDedFchDes FROM legajo_deducciones WHERE (CliCod = ? and EmpCod = ? and LegNumero = ? and LegDedSec = ?) AND (CliCod = ? and EmpCod = ? and LegNumero = ? and LegDedSec = ?) ORDER BY CliCod, EmpCod, LegNumero, LegDedSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
