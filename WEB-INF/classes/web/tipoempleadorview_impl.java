...
public final  class tipoempleadorview_impl extends GXDataArea
{
   public tipoempleadorview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipoempleadorview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipoempleadorview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "TipEmpleCod") ;
         ...
         {
            AV10TipEmpleCod = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TipEmpleCod", AV10TipEmpleCod);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPEMPLECOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10TipEmpleCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.tipoempleadorview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10TipEmpleCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipEmpleCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vTIPEMPLECOD", GXutil.rtrim( AV10TipEmpleCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPEMPLECOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10TipEmpleCod, ""))));
   ...
   {
      return formatLink("web.tipoempleadorview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10TipEmpleCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipEmpleCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "TipoEmpleadorView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Empleador View", "") ;
   }
   ...
   public void wbEJ0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_EJ2( true) ;
      }
      else
      {
         wb_table1_9_EJ2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_EJ2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startEJ2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Empleador View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesEJ2( )
   {
   }
   ...
   public void strupEJ0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10TipEmpleCod = httpContext.cgiGet( "vTIPEMPLECOD") ;
   ...
   public void e11EJ2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00EJ2 */
      pr_default.execute(0, new Object[] {AV10TipEmpleCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A45TipEmpleCod = H00EJ2_A45TipEmpleCod[0] ;
         A339TipEmpleDescri = H00EJ2_A339TipEmpleDescri[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A339TipEmpleDescri );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TipoEmpleadorGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.tipoempleadorgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TipoEmpleadorGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10TipEmpleCod});
   ...
   public void wb_table1_9_EJ2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TipoEmpleadorView.htm");
         /* Div Control */
         ...
         wb_table1_9_EJ2e( true) ;
      }
      else
      {
         wb_table1_9_EJ2e( false) ;
      }
   }
   ...
   {
      AV10TipEmpleCod = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TipEmpleCod", AV10TipEmpleCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPEMPLECOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10TipEmpleCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020422438", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipoempleadorview.js", "?2024122020422438", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Tipo Empleador View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TipEmpleCod',fld:'vTIPEMPLECOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00EJ2_A45TipEmpleCod = new String[] {""} ;
      H00EJ2_A339TipEmpleDescri = new String[] {""} ;
      A45TipEmpleCod = "" ;
      A339TipEmpleDescri = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.tipoempleadorview__default(),
         new Object[] {
             new Object[] {
            H00EJ2_A45TipEmpleCod, H00EJ2_A339TipEmpleDescri
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10TipEmpleCod ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV10TipEmpleCod ;
   ...
   private String[] H00EJ2_A45TipEmpleCod ;
   private String[] H00EJ2_A339TipEmpleDescri ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipoempleadorview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00EJ2", "SELECT TipEmpleCod, TipEmpleDescri FROM TipoEmpleador WHERE TipEmpleCod = ( ?) ORDER BY TipEmpleCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
