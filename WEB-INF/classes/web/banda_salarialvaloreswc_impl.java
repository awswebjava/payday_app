...
public final  class banda_salarialvaloreswc_impl extends GXWebComponent
{
   public banda_salarialvaloreswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public banda_salarialvaloreswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( banda_salarialvaloreswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV10BanSalCod = GXutil.strToGuid(httpContext.GetPar( "BanSalCod")) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10BanSalCod", AV10BanSalCod.toString());
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8CliCod),Short.valueOf(AV9EmpCod),AV10BanSalCod});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9EmpCod, AV10BanSalCod, AV27Pgmname, AV16OrderedBy, AV17OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "banda_salarialvalores WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.banda_salarialvaloreswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(AV10BanSalCod.toString())}, new String[] {"CliCod","EmpCod","BanSalCod"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV10BanSalCod", wcpOAV10BanSalCod.toString());
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vBANSALCOD", AV10BanSalCod.toString());
   ...
   public void renderHtmlCloseFormPR2( )
   {
   ...
   {
      return "banda_salarialvaloresWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "banda_salarialvalores WC", "") ;
   }
   ...
   public void wbPR0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.banda_salarialvaloreswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_banda_salarialvaloresWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_banda_salarialvaloresWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtBanSalCod_Internalname, A2418BanSalCod.toString(), A2418BanSalCod.toString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBanSalCod_Jsonclick, 0, "Attribute", "", "", "", "", edtBanSalCod_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, (byte)(0), (short)(0), 0, (byte)(0), (byte)(0), (byte)(0), true, "", "", false, "", "HLP_banda_salarialvaloresWC.htm");
         /* User Defined Control */
   ...
   public void startPR2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "banda_salarialvalores WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV27Pgmname = "banda_salarialvaloresWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfPR2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A2418BanSalCod } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.UUID, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.UUID
                                              }
         });
         /* Using cursor H00PR2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), AV10BanSalCod, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A3CliCod = H00PR2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H00PR2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A2418BanSalCod = H00PR2_A2418BanSalCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A2418BanSalCod", A2418BanSalCod.toString());
            A2424BanSalValor = H00PR2_A2424BanSalValor[0] ;
            A2423BanSalVigencia = H00PR2_A2423BanSalVigencia[0] ;
            e16PR2 ();
   ...
   public void send_integrity_lvl_hashesPR2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV27Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV27Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00PR3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), AV10BanSalCod});
   ...
   public void strupPR0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV10BanSalCod = GXutil.strToGuid(httpContext.cgiGet( sPrefix+"wcpOAV10BanSalCod")) ;
   ...
   public void e14PR2( )
   {
      ...
      banda_salarialvaloreswc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      ...
      edtBanSalCod_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtBanSalCod_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtBanSalCod_Visible), 5, 0), true);
   ...
   public void e15PR2( )
   {
      ...
      banda_salarialvaloreswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "banda_salarial" );
      ...
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
      AV13TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "BanSalCod" );
      AV13TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( AV10BanSalCod.toString() );
      AV12TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV13TrnContextAtt, 0);
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9EmpCod), 4, 0));
      AV10BanSalCod = (java.util.UUID)getParm(obj,2,TypeConstants.UUID) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10BanSalCod", AV10BanSalCod.toString());
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV10BanSalCod = (String)getParm(obj,2,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "banda_salarialvaloreswc", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9EmpCod), 4, 0));
         AV10BanSalCod = (java.util.UUID)getParm(obj,4,TypeConstants.UUID) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10BanSalCod", AV10BanSalCod.toString());
      }
      wcpOAV8CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV9EmpCod = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9EmpCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV10BanSalCod = GXutil.strToGuid(httpContext.cgiGet( sPrefix+"wcpOAV10BanSalCod")) ;
      if ( ! GetJustCreated( ) && ( ( AV8CliCod != wcpOAV8CliCod ) || ( AV9EmpCod != wcpOAV9EmpCod ) || !( AV10BanSalCod.equals( wcpOAV10BanSalCod ) ) ) )
      {
         setjustcreated();
      }
      wcpOAV8CliCod = AV8CliCod ;
      wcpOAV9EmpCod = AV9EmpCod ;
      wcpOAV10BanSalCod = AV10BanSalCod ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlAV10BanSalCod = httpContext.cgiGet( sPrefix+"AV10BanSalCod_CTRL") ;
      if ( GXutil.len( sCtrlAV10BanSalCod) > 0 )
      {
         AV10BanSalCod = GXutil.strToGuid(httpContext.cgiGet( sCtrlAV10BanSalCod)) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10BanSalCod", AV10BanSalCod.toString());
      }
      else
      {
         AV10BanSalCod = GXutil.strToGuid(httpContext.cgiGet( sPrefix+"AV10BanSalCod_PARM")) ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV10BanSalCod_PARM", AV10BanSalCod.toString());
      if ( GXutil.len( GXutil.rtrim( sCtrlAV10BanSalCod)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV10BanSalCod_CTRL", GXutil.rtrim( sCtrlAV10BanSalCod));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713253569", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("banda_salarialvaloreswc.js", "?20251713253569", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtBanSalVigencia_Internalname = sPrefix+"BANSALVIGENCIA_"+sGXsfl_15_idx ;
      edtBanSalValor_Internalname = sPrefix+"BANSALVALOR_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtBanSalVigencia_Internalname = sPrefix+"BANSALVIGENCIA_"+sGXsfl_15_fel_idx ;
      edtBanSalValor_Internalname = sPrefix+"BANSALVALOR_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBanSalVigencia_Internalname,GXutil.ltrim( localUtil.ntoc( A2423BanSalVigencia, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A2423BanSalVigencia), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtBanSalVigencia_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBanSalValor_Internalname,GXutil.ltrim( localUtil.ntoc( A2424BanSalValor, (byte)(17), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A2424BanSalValor, "ZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtBanSalValor_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(17),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Importes","right",Boolean.valueOf(false),""});
         send_integrity_lvl_hashesPR2( ) ;
   ...
   public void startgridcontrol15( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Sal Vigencia", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Sal Valor", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A2423BanSalVigencia, (byte)(4), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A2424BanSalValor, (byte)(17), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtBanSalVigencia_Internalname = sPrefix+"BANSALVIGENCIA" ;
      edtBanSalValor_Internalname = sPrefix+"BANSALVALOR" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:BanSalVigencia|1:BanSalValor" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10BanSalCod',fld:'vBANSALCOD',pic:''},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11PR2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10BanSalCod',fld:'vBANSALCOD',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12PR2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10BanSalCod',fld:'vBANSALCOD',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13PR2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10BanSalCod',fld:'vBANSALCOD',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16PR2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Bansalvalor',iparms:[]");
   ...
   {
      wcpOAV10BanSalCod = java.util.UUID.fromString("00000000-0000-0000-0000-000000000000") ;
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV10BanSalCod = java.util.UUID.fromString("00000000-0000-0000-0000-000000000000") ;
      AV27Pgmname = "" ;
      ...
      scmdbuf = "" ;
      H00PR2_A3CliCod = new int[1] ;
      H00PR2_A1EmpCod = new short[1] ;
      H00PR2_A2418BanSalCod = new java.util.UUID[] {java.util.UUID.fromString("00000000-0000-0000-0000-000000000000")} ;
      H00PR2_A2424BanSalValor = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00PR2_A2423BanSalVigencia = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.banda_salarialvaloreswc__default(),
         new Object[] {
             new Object[] {
            H00PR2_A3CliCod, H00PR2_A1EmpCod, H00PR2_A2418BanSalCod, H00PR2_A2424BanSalValor, H00PR2_A2423BanSalVigencia
            }
            , new Object[] {
   ...
   private int edtBanSalCod_Visible ;
   ...
   private String sCtrlAV10BanSalCod ;
   ...
   private java.util.UUID wcpOAV10BanSalCod ;
   private java.util.UUID AV10BanSalCod ;
   ...
   private int[] H00PR2_A3CliCod ;
   private short[] H00PR2_A1EmpCod ;
   private java.util.UUID[] H00PR2_A2418BanSalCod ;
   private java.math.BigDecimal[] H00PR2_A2424BanSalValor ;
   private short[] H00PR2_A2423BanSalVigencia ;
...
final  class banda_salarialvaloreswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00PR2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          java.util.UUID A2418BanSalCod )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, EmpCod, BanSalCod, BanSalValor, BanSalVigencia" ;
      sFromString = " FROM banda_salarialvalores" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and BanSalCod = ?)");
      if ( ( AV16OrderedBy == 1 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, BanSalCod, BanSalVigencia" ;
      }
      else if ( ( AV16OrderedBy == 1 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, BanSalCod DESC, BanSalVigencia DESC" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, BanSalCod, BanSalValor, BanSalVigencia" ;
      }
      else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, BanSalCod DESC, BanSalValor DESC, BanSalVigencia" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, BanSalCod, BanSalVigencia" ;
   ...
   protected Object[] conditional_H00PR3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV16OrderedBy ,
                                          boolean AV17OrderedDsc ,
                                          ...
                                          java.util.UUID A2418BanSalCod )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM banda_salarialvalores" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and BanSalCod = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00PR2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (java.util.UUID)dynConstraints[4] , ((Number) dynConstraints[5]).intValue() , ((Number) dynConstraints[6]).shortValue() , (java.util.UUID)dynConstraints[7] );
            case 1 :
                  return conditional_H00PR3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (java.util.UUID)dynConstraints[4] , ((Number) dynConstraints[5]).intValue() , ((Number) dynConstraints[6]).shortValue() , (java.util.UUID)dynConstraints[7] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00PR2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00PR3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
                              ...
                              Object[] parms ) throws SQLException
   {
      ...
      switch ( cursor )
      {
            case 0 :
               ...
               {
                  sIdx = (short)(sIdx+1) ;
                  stmt.setGUID(sIdx, (java.util.UUID)parms[8]);
               }
            ...
            case 1 :
               ...
               {
                  sIdx = (short)(sIdx+1) ;
                  stmt.setGUID(sIdx, (java.util.UUID)parms[5]);
               }
               return;
      }
   }
