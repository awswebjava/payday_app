...
public final  class f1357cabf1357lcalculowcgetfilterdata extends GXProcedure
{
   public f1357cabf1357lcalculowcgetfilterdata( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( f1357cabf1357lcalculowcgetfilterdata.class ), "" );
   }
   ...
   public String executeUdp( String aP0 ,
                             ...
                             String[] aP4 )
   {
      f1357cabf1357lcalculowcgetfilterdata.this.aP5 = new String[] {""};
   ...
   private void execute_int( String aP0 ,
                             ...
                             String[] aP5 )
   {
      f1357cabf1357lcalculowcgetfilterdata.this.AV16DDOName = aP0;
      f1357cabf1357lcalculowcgetfilterdata.this.AV14SearchTxt = aP1;
      f1357cabf1357lcalculowcgetfilterdata.this.AV15SearchTxtTo = aP2;
      f1357cabf1357lcalculowcgetfilterdata.this.aP3 = aP3;
      f1357cabf1357lcalculowcgetfilterdata.this.aP4 = aP4;
      f1357cabf1357lcalculowcgetfilterdata.this.aP5 = aP5;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      f1357cabf1357lcalculowcgetfilterdata.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S111( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV27Session.getValue("F1357CabF1357LCalculoWCGridState"), "") == 0 )
      {
         AV29GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( "F1357CabF1357LCalculoWCGridState"), null, null);
      }
      else
      {
         AV29GridState.fromxml(AV27Session.getValue("F1357CabF1357LCalculoWCGridState"), null, null);
      }
      AV43GXV1 = 1 ;
      while ( AV43GXV1 <= AV29GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         ...
         {
            AV40F1357CTipoPre = (byte)(GXutil.lval( AV30GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value())) ;
         }
   ...
   public void S121( )
   {
      ...
      /* Using cursor P00VA2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV32CliCod), Short.valueOf(AV33EmpCod), Byte.valueOf(AV40F1357CTipoPre), AV34F1357CPer, Byte.valueOf(AV35F1357CSec), lV12TFLegIdNomApe});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A6LegNumero = P00VA2_A6LegNumero[0] ;
         A250LegIdNomApe = P00VA2_A250LegIdNomApe[0] ;
         A778F1357CSec = P00VA2_A778F1357CSec[0] ;
         A777F1357CPer = P00VA2_A777F1357CPer[0] ;
         A784F1357CTipoPre = P00VA2_A784F1357CTipoPre[0] ;
         A1EmpCod = P00VA2_A1EmpCod[0] ;
         A3CliCod = P00VA2_A3CliCod[0] ;
         A861F1357LCTipReg = P00VA2_A861F1357LCTipReg[0] ;
         A250LegIdNomApe = P00VA2_A250LegIdNomApe[0] ;
   ...
   {
      this.aP3[0] = f1357cabf1357lcalculowcgetfilterdata.this.AV20OptionsJson;
      this.aP4[0] = f1357cabf1357lcalculowcgetfilterdata.this.AV23OptionsDescJson;
      this.aP5[0] = f1357cabf1357lcalculowcgetfilterdata.this.AV25OptionIndexesJson;
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      A250LegIdNomApe = "" ;
      A777F1357CPer = "" ;
      P00VA2_A6LegNumero = new int[1] ;
      P00VA2_A250LegIdNomApe = new String[] {""} ;
      P00VA2_A778F1357CSec = new byte[1] ;
      P00VA2_A777F1357CPer = new String[] {""} ;
      P00VA2_A784F1357CTipoPre = new byte[1] ;
      P00VA2_A1EmpCod = new short[1] ;
      P00VA2_A3CliCod = new int[1] ;
      P00VA2_A861F1357LCTipReg = new String[] {""} ;
      A861F1357LCTipReg = "" ;
      AV18Option = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.f1357cabf1357lcalculowcgetfilterdata__default(),
         new Object[] {
             new Object[] {
            P00VA2_A6LegNumero, P00VA2_A250LegIdNomApe, P00VA2_A778F1357CSec, P00VA2_A777F1357CPer, P00VA2_A784F1357CTipoPre, P00VA2_A1EmpCod, P00VA2_A3CliCod, P00VA2_A861F1357LCTipReg
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int[] P00VA2_A6LegNumero ;
   private String[] P00VA2_A250LegIdNomApe ;
   private byte[] P00VA2_A778F1357CSec ;
   private String[] P00VA2_A777F1357CPer ;
   private byte[] P00VA2_A784F1357CTipoPre ;
   private short[] P00VA2_A1EmpCod ;
   private int[] P00VA2_A3CliCod ;
   private String[] P00VA2_A861F1357LCTipReg ;
...
final  class f1357cabf1357lcalculowcgetfilterdata__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00VA2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          byte A778F1357CSec )
   {
      ...
      scmdbuf = "SELECT T1.LegNumero, T2.LegIdNomApe, T1.F1357CSec, T1.F1357CPer, T1.F1357CTipoPre, T1.EmpCod, T1.CliCod, T1.F1357LCTipReg FROM (F1357LCalculo T1 INNER JOIN Legajo" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00VA2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).byteValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).byteValue() , ((Number) dynConstraints[9]).intValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).byteValue() , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00VA2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
