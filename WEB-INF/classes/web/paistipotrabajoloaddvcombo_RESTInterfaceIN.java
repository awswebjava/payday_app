...
@javax.xml.bind.annotation.XmlType(name = "paistipotrabajoloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class paistipotrabajoloaddvcombo_RESTInterfaceIN
{
   ...
   {
      if ( GXutil.strcmp(AV19PaiTipoTraId, null) == 0 )
      {
         return "" ;
      }
      else
      {
         return AV19PaiTipoTraId ;
      }
   }
