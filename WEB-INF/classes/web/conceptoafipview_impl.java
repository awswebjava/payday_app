...
public final  class conceptoafipview_impl extends GXDataArea
{
   public conceptoafipview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public conceptoafipview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( conceptoafipview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV17ConCodPropio = httpContext.GetPar( "ConCodPropio") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV17ConCodPropio", AV17ConCodPropio);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCODPROPIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV17ConCodPropio, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.conceptoafipview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV17ConCodPropio)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ConCodPropio","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONCODPROPIO", GXutil.rtrim( AV17ConCodPropio));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCODPROPIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV17ConCodPropio, ""))));
   ...
   {
      return formatLink("web.conceptoafipview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV17ConCodPropio)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","ConCodPropio","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ConceptoAFIPView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Concepto AFIPView", "") ;
   }
   ...
   public void wb_table1_9_0V2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start0V2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Concepto AFIPView", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup0V0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV17ConCodPropio = httpContext.cgiGet( "vCONCODPROPIO") ;
   ...
   public void e110V2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H000V2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV17ConCodPropio, Integer.valueOf(AV10CliCod), AV17ConCodPropio});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A73ConCodPropio = H000V2_A73ConCodPropio[0] ;
         A3CliCod = H000V2_A3CliCod[0] ;
         AV20GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ConceptoAFIPGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.conceptoafipgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ConceptoAFIPGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV17ConCodPropio});
   ...
   public void wb_table1_9_0V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ConceptoAFIPView.htm");
         /* Div Control */
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV17ConCodPropio = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV17ConCodPropio", AV17ConCodPropio);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONCODPROPIO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV17ConCodPropio, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019463935", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("conceptoafipview.js", "?2024122019463935", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Concepto AFIPView", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV17ConCodPropio',fld:'vCONCODPROPIO',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000V2_A73ConCodPropio = new String[] {""} ;
      H000V2_A3CliCod = new int[1] ;
      A73ConCodPropio = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.conceptoafipview__default(),
         new Object[] {
             new Object[] {
            H000V2_A73ConCodPropio, H000V2_A3CliCod
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV17ConCodPropio ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV17ConCodPropio ;
   ...
   private String[] H000V2_A73ConCodPropio ;
   private int[] H000V2_A3CliCod ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class conceptoafipview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000V2", "SELECT ConCodPropio, CliCod FROM ConceptoAFIP WHERE (CliCod = ? and ConCodPropio = ( ?)) AND (CliCod = ? and ConCodPropio = ( ?)) ORDER BY CliCod, ConCodPropio ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
