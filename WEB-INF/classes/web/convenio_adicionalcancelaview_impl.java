...
public final  class convenio_adicionalcancelaview_impl extends GXDataArea
{
   public convenio_adicionalcancelaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_adicionalcancelaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_adicionalcancelaview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV14ConveAdiSitCancela = httpContext.GetPar( "ConveAdiSitCancela") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14ConveAdiSitCancela", AV14ConveAdiSitCancela);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADISITCANCELA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14ConveAdiSitCancela, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_adicionalcancelaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13ConveAdicod)),GXutil.URLEncode(GXutil.rtrim(AV14ConveAdiSitCancela)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiSitCancela","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONVEADISITCANCELA", GXutil.rtrim( AV14ConveAdiSitCancela));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADISITCANCELA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14ConveAdiSitCancela, ""))));
   ...
   {
      return formatLink("web.convenio_adicionalcancelaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13ConveAdicod)),GXutil.URLEncode(GXutil.rtrim(AV14ConveAdiSitCancela)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiSitCancela","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "convenio_adicionalCancelaView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "convenio_adicional Cancela View", "") ;
   }
   ...
   public void wbJL0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_JL2( true) ;
      }
      else
      {
         wb_table1_9_JL2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_JL2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startJL2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "convenio_adicional Cancela View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupJL0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14ConveAdiSitCancela = httpContext.cgiGet( "vCONVEADISITCANCELA") ;
   ...
   public void e11JL2( )
   {
      ...
      AV23GXLvl11 = (byte)(0) ;
      /* Using cursor H00JL2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13ConveAdicod, AV14ConveAdiSitCancela, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13ConveAdicod, AV14ConveAdiSitCancela});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1824ConveAdiSitCancela = H00JL2_A1824ConveAdiSitCancela[0] ;
         A996ConveAdicod = H00JL2_A996ConveAdicod[0] ;
         A1565CliConvenio = H00JL2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00JL2_A1564CliPaiConve[0] ;
         A3CliCod = H00JL2_A3CliCod[0] ;
         A1825ConveAdiSitCancDes = H00JL2_A1825ConveAdiSitCancDes[0] ;
         A1825ConveAdiSitCancDes = H00JL2_A1825ConveAdiSitCancDes[0] ;
         AV23GXLvl11 = (byte)(1) ;
         Form.setCaption( A1825ConveAdiSitCancDes );
   ...
   public void S112( )
   {
      ...
      if ( AV15LoadAllTabs || ( GXutil.strcmp(AV16SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV16SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "convenio_adicionalCancelaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.convenio_adicionalcancelageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "convenio_adicionalCancelaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13ConveAdicod,AV14ConveAdiSitCancela});
   ...
   public void wb_table1_9_JL2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_convenio_adicionalCancelaView.htm");
         /* Div Control */
         ...
         wb_table1_9_JL2e( true) ;
      }
      else
      {
         wb_table1_9_JL2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13ConveAdicod", AV13ConveAdicod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
      AV14ConveAdiSitCancela = (String)getParm(obj,4) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14ConveAdiSitCancela", AV14ConveAdiSitCancela);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADISITCANCELA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14ConveAdiSitCancela, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025171333917", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("convenio_adicionalcancelaview.js", "?2025171333917", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "convenio_adicional Cancela View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00JL2_A1824ConveAdiSitCancela = new String[] {""} ;
      H00JL2_A996ConveAdicod = new String[] {""} ;
      H00JL2_A1565CliConvenio = new String[] {""} ;
      H00JL2_A1564CliPaiConve = new short[1] ;
      H00JL2_A3CliCod = new int[1] ;
      H00JL2_A1825ConveAdiSitCancDes = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_adicionalcancelaview__default(),
         new Object[] {
             new Object[] {
            H00JL2_A1824ConveAdiSitCancela, H00JL2_A996ConveAdicod, H00JL2_A1565CliConvenio, H00JL2_A1564CliPaiConve, H00JL2_A3CliCod, H00JL2_A1825ConveAdiSitCancDes
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String wcpOAV14ConveAdiSitCancela ;
   ...
   private String AV14ConveAdiSitCancela ;
   ...
   private String[] H00JL2_A1824ConveAdiSitCancela ;
   private String[] H00JL2_A996ConveAdicod ;
   private String[] H00JL2_A1565CliConvenio ;
   private short[] H00JL2_A1564CliPaiConve ;
   private int[] H00JL2_A3CliCod ;
   private String[] H00JL2_A1825ConveAdiSitCancDes ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class convenio_adicionalcancelaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00JL2", "SELECT T1.ConveAdiSitCancela AS ConveAdiSitCancela, T1.ConveAdicod, T1.CliConvenio, T1.CliPaiConve, T1.CliCod, T2.SitDescrip AS ConveAdiSitCancDes FROM (convenio_adicionalCancela T1 INNER JOIN Estado T2 ON T2.SitCodigo = T1.ConveAdiSitCancela) WHERE (T1.CliCod = ? and T1.CliPaiConve = ? and T1.CliConvenio = ( ?) and T1.ConveAdicod = ( ?) and T1.ConveAdiSitCancela = ( ?)) AND (T1.CliCod = ? and T1.CliPaiConve = ? and T1.CliConvenio = ( ?) and T1.ConveAdicod = ( ?) and T1.ConveAdiSitCancela = ( ?)) ORDER BY T1.CliCod, T1.CliPaiConve, T1.CliConvenio, T1.ConveAdicod, T1.ConveAdiSitCancela ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
