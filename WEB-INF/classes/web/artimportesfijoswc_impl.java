...
public final  class artimportesfijoswc_impl extends GXWebComponent
{
   public artimportesfijoswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public artimportesfijoswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( artimportesfijoswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8ARTSec = (short)(GXutil.lval( httpContext.GetPar( "ARTSec"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ARTSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ARTSec), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8ARTSec)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8ARTSec, AV27Pgmname, AV14OrderedBy, AV15OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "ARTImportes Fijos WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.artimportesfijoswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ARTSec,4,0))}, new String[] {"ARTSec"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8ARTSec", GXutil.ltrim( localUtil.ntoc( wcpOAV8ARTSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vARTSEC", GXutil.ltrim( localUtil.ntoc( AV8ARTSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseFormC52( )
   {
   ...
   {
      return "ARTImportesFijosWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "ARTImportes Fijos WC", "") ;
   }
   ...
   public void wbC50( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.artimportesfijoswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtARTSec_Internalname, GXutil.ltrim( localUtil.ntoc( A1151ARTSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1151ARTSec), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtARTSec_Jsonclick, 0, "Attribute", "", "", "", "", edtARTSec_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_ARTImportesFijosWC.htm");
         /* User Defined Control */
   ...
   public void startC52( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "ARTImportes Fijos WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A1156ARTImpFijFecha = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtARTImpFijFecha_Internalname), 0)) ;
   ...
   {
      /* GeneXus formulas. */
      AV27Pgmname = "ARTImportesFijosWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfC52( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8ARTSec) ,
                                              Short.valueOf(A1151ARTSec) } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         /* Using cursor H00C52 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8ARTSec), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A1151ARTSec = H00C52_A1151ARTSec[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1151ARTSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1151ARTSec), 4, 0));
            A1154ARTFijo = H00C52_A1154ARTFijo[0] ;
            A1156ARTImpFijFecha = H00C52_A1156ARTImpFijFecha[0] ;
            A1155ARTImpFijSec = H00C52_A1155ARTImpFijSec[0] ;
            e16C52 ();
   ...
   public void send_integrity_lvl_hashesC52( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV27Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV27Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00C53 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8ARTSec)});
      GRID_nRecordCount = H00C53_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strupC50( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8ARTSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ARTSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e14C52( )
   {
      ...
      artimportesfijoswc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV23CliCod = GXt_int1 ;
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      ...
      edtARTSec_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtARTSec_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtARTSec_Visible), 5, 0), true);
   ...
   public void e15C52( )
   {
      ...
      artimportesfijoswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ARTSec" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8ARTSec, 4, 0) );
   ...
   {
      AV8ARTSec = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ARTSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ARTSec), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8ARTSec = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "artimportesfijoswc", GetJustCreated( ));
      ...
      {
         AV8ARTSec = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ARTSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ARTSec), 4, 0));
      }
      wcpOAV8ARTSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ARTSec"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( AV8ARTSec != wcpOAV8ARTSec ) ) )
      {
         setjustcreated();
      }
      wcpOAV8ARTSec = AV8ARTSec ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8ARTSec = httpContext.cgiGet( sPrefix+"AV8ARTSec_CTRL") ;
      if ( GXutil.len( sCtrlAV8ARTSec) > 0 )
      {
         AV8ARTSec = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8ARTSec), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ARTSec", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ARTSec), 4, 0));
      }
      else
      {
         AV8ARTSec = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8ARTSec_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
   }
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ARTSec_PARM", GXutil.ltrim( localUtil.ntoc( AV8ARTSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8ARTSec)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ARTSec_CTRL", GXutil.rtrim( sCtrlAV8ARTSec));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412201941888", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("artimportesfijoswc.js", "?202412201941888", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtARTImpFijSec_Internalname = sPrefix+"ARTIMPFIJSEC_"+sGXsfl_15_idx ;
      edtARTImpFijFecha_Internalname = sPrefix+"ARTIMPFIJFECHA_"+sGXsfl_15_idx ;
      edtARTFijo_Internalname = sPrefix+"ARTFIJO_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtARTImpFijSec_Internalname = sPrefix+"ARTIMPFIJSEC_"+sGXsfl_15_fel_idx ;
      edtARTImpFijFecha_Internalname = sPrefix+"ARTIMPFIJFECHA_"+sGXsfl_15_fel_idx ;
      edtARTFijo_Internalname = sPrefix+"ARTFIJO_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtARTImpFijSec_Internalname,GXutil.ltrim( localUtil.ntoc( A1155ARTImpFijSec, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1155ARTImpFijSec), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtARTImpFijSec_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtARTImpFijFecha_Internalname,localUtil.format(A1156ARTImpFijFecha, "99/99/9999"),localUtil.format( A1156ARTImpFijFecha, "99/99/9999"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtARTImpFijFecha_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Fecha","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtARTFijo_Internalname,GXutil.ltrim( localUtil.ntoc( A1154ARTFijo, (byte)(17), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( A1154ARTFijo, "ZZ,ZZZ,ZZZ,ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtARTFijo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(17),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Importes","right",Boolean.valueOf(false),""});
         send_integrity_lvl_hashesC52( ) ;
   ...
   public void startgridcontrol15( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Fij Sec", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Fecha de vigencia", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Importe Fijo", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1155ARTImpFijSec, (byte)(4), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", localUtil.format(A1156ARTImpFijFecha, "99/99/9999"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A1154ARTFijo, (byte)(17), (byte)(2), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtARTImpFijSec_Internalname = sPrefix+"ARTIMPFIJSEC" ;
      edtARTImpFijFecha_Internalname = sPrefix+"ARTIMPFIJFECHA" ;
      edtARTFijo_Internalname = sPrefix+"ARTFIJO" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:ARTImpFijSec|1:ARTImpFijFecha|2:ARTFijo" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8ARTSec',fld:'vARTSEC',pic:'ZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16C52',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00C52_A1151ARTSec = new short[1] ;
      H00C52_A1154ARTFijo = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00C52_A1156ARTImpFijFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H00C52_A1155ARTImpFijSec = new short[1] ;
      H00C53_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.artimportesfijoswc__default(),
         new Object[] {
             new Object[] {
            H00C52_A1151ARTSec, H00C52_A1154ARTFijo, H00C52_A1156ARTImpFijFecha, H00C52_A1155ARTImpFijSec
            }
            , new Object[] {
            H00C53_AGRID_nRecordCount
            }
         }
      );
      AV27Pgmname = "ARTImportesFijosWC" ;
   ...
   private short wcpOAV8ARTSec ;
   private short AV8ARTSec ;
   ...
   private short[] H00C52_A1151ARTSec ;
   private java.math.BigDecimal[] H00C52_A1154ARTFijo ;
   private java.util.Date[] H00C52_A1156ARTImpFijFecha ;
   private short[] H00C52_A1155ARTImpFijSec ;
   private long[] H00C53_AGRID_nRecordCount ;
...
final  class artimportesfijoswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00C52( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A1151ARTSec )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " ARTSec, ARTFijo, ARTImpFijFecha, ARTImpFijSec" ;
      sFromString = " FROM ARTImportesFijos" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(ARTSec = ?)");
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY ARTSec, ARTImpFijSec" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY ARTSec DESC, ARTImpFijSec DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY ARTSec, ARTImpFijFecha, ARTImpFijSec" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY ARTSec DESC, ARTImpFijFecha DESC, ARTImpFijSec" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY ARTSec, ARTFijo, ARTImpFijSec" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY ARTSec DESC, ARTFijo DESC, ARTImpFijSec" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY ARTSec, ARTImpFijSec" ;
   ...
   protected Object[] conditional_H00C53( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          ...
                                          short A1151ARTSec )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ARTImportesFijos" ;
      addWhere(sWhereString, "(ARTSec = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00C52(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
            case 1 :
                  return conditional_H00C53(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00C52", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00C53", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
