...
public final  class StructSdtEmpresa_abm_1_promedio_horanormal_mensualizados implements Cloneable, java.io.Serializable
{
   public StructSdtEmpresa_abm_1_promedio_horanormal_mensualizados( )
   {
      this( -1, new ModelContext( StructSdtEmpresa_abm_1_promedio_horanormal_mensualizados.class ));
   }

   public StructSdtEmpresa_abm_1_promedio_horanormal_mensualizados( int remoteHandle ,
   ...
   protected short gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Modified ;
   protected short gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Initialized ;
   protected String gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Tipoconcod ;
   protected String gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Emppromfijvar ;
   protected String gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Mode ;
   protected String gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Tipoconcod_Z ;
   protected String gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Emppromfijvar_Z ;
   protected boolean gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Emppromhabitual ;
   protected boolean gxTv_SdtEmpresa_abm_1_promedio_horanormal_mensualizados_Emppromhabitual_Z ;
}
