...
public final  class afipconceptoview_impl extends GXDataArea
{
   public afipconceptoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public afipconceptoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( afipconceptoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10AFIPConCod = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10AFIPConCod", AV10AFIPConCod);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAFIPCONCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10AFIPConCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.afipconceptoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10AFIPConCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"AFIPConCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vAFIPCONCOD", GXutil.rtrim( AV10AFIPConCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAFIPCONCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10AFIPConCod, ""))));
   ...
   {
      return formatLink("web.afipconceptoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10AFIPConCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"AFIPConCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "AFIPConceptoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "AFIPConcepto View", "") ;
   }
   ...
   public void wbH50( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_H52( true) ;
      }
      else
      {
         wb_table1_9_H52( false) ;
      }
      return  ;
   }

   public void wb_table1_9_H52e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startH52( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "AFIPConcepto View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesH52( )
   {
   }
   ...
   public void strupH50( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10AFIPConCod = httpContext.cgiGet( "vAFIPCONCOD") ;
   ...
   public void e11H52( )
   {
      ...
      {
         A72AFIPConCod = H00H52_A72AFIPConCod[0] ;
         A369AFIPConDescrip = H00H52_A369AFIPConDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A369AFIPConDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "AFIPConceptoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.afipconceptogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "AFIPConceptoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10AFIPConCod});
   ...
   public void wb_table1_9_H52( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_AFIPConceptoView.htm");
         /* Div Control */
         ...
         wb_table1_9_H52e( true) ;
      }
      else
      {
         wb_table1_9_H52e( false) ;
      }
   }
   ...
   {
      AV10AFIPConCod = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10AFIPConCod", AV10AFIPConCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vAFIPCONCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10AFIPConCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019401893", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("afipconceptoview.js", "?2024122019401893", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "AFIPConcepto View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10AFIPConCod',fld:'vAFIPCONCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00H52_A72AFIPConCod = new String[] {""} ;
      H00H52_A369AFIPConDescrip = new String[] {""} ;
      A72AFIPConCod = "" ;
      A369AFIPConDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.afipconceptoview__default(),
         new Object[] {
             new Object[] {
            H00H52_A72AFIPConCod, H00H52_A369AFIPConDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10AFIPConCod ;
   ...
   private String[] H00H52_A72AFIPConCod ;
   private String[] H00H52_A369AFIPConDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class afipconceptoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00H52", "SELECT AFIPConCod, AFIPConDescrip FROM AFIPConcepto WHERE AFIPConCod = ( ?) ORDER BY AFIPConCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
