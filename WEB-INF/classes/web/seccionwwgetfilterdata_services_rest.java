...
@javax.ws.rs.Path("/SeccionWWGetFilterData")
public final  class seccionwwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.seccionwwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV17DDOName;
      ...
      if ( ! processHeaders("seccionwwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.seccionwwgetfilterdata worker = new web.seccionwwgetfilterdata(remoteHandle, context);
         worker.execute(AV17DDOName,AV15SearchTxt,AV16SearchTxtTo,AV21OptionsJson,AV24OptionsDescJson,AV26OptionIndexesJson );
         web.seccionwwgetfilterdata_RESTInterfaceOUT data = new web.seccionwwgetfilterdata_RESTInterfaceOUT();
