...
public final  class importccimportexcel extends GXProcedure
{
   public importccimportexcel( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( importccimportexcel.class ), "" );
   }
   ...
   {
      importccimportexcel.this.aP3 = new boolean[] {false};
   ...
   private void execute_int( String aP0 ,
                             ...
                             boolean[] aP3 )
   {
      importccimportexcel.this.AV22FilePath = aP0;
      importccimportexcel.this.AV29ExtraParmsJson = aP1;
      importccimportexcel.this.aP2 = aP2;
      importccimportexcel.this.aP3 = aP3;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      importccimportexcel.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S131( )
   {
      ...
      returnInSub = false ;
      Application.commitDataStores(context, remoteHandle, pr_default, "importccimportexcel");
   }
   ...
   public void S191( )
   {
      ...
      AV39ImpLiqConExtCods = new GXSimpleCollection<String>(String.class, "internal", "") ;
      /* Using cursor P00NV2 */
      pr_default.execute(0);
      while ( (pr_default.getStatus(0) != 101) )
      {
         A3CliCod = P00NV2_A3CliCod[0] ;
         A1EmpCod = P00NV2_A1EmpCod[0] ;
         A88ImpLiqSec = P00NV2_A88ImpLiqSec[0] ;
         A89ImpLiqConExtCod = P00NV2_A89ImpLiqConExtCod[0] ;
         AV33CliCods.add((int)(A3CliCod), 0);
         AV35EmpCods.add((short)(A1EmpCod), 0);
         AV37ImpLiqSecs.add((short)(A88ImpLiqSec), 0);
         AV39ImpLiqConExtCods.add(A89ImpLiqConExtCod, 0);
   ...
   public void S161( )
   {
      ...
      AV28TitleNames.add(httpContext.getMessage( "Tipo", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Concepto Externo", ""), 0);
      AV28TitleNames.add(httpContext.getMessage( "Concepto AFIP", ""), 0);
      ...
      importccimportexcel.this.AV13DiscardedColumns = GXv_char4[0] ;
      AV27TitleIndexes = GXv_objcol_int5[0] ;
      importccimportexcel.this.AV11ColumnsCount = GXv_int6[0] ;
      importccimportexcel.this.AV12ColumnsFound = GXv_int7[0] ;
   ...
   public void S171( )
   {
      ...
      returnInSub = false ;
      AV19IsLineOk = true ;
      AV31importacion_conceptos = (web.Sdtimportacion_conceptos)new web.Sdtimportacion_conceptos( remoteHandle, context);
      ...
      else
      {
         if ( AV16DoUpdate )
         {
            ...
            if ( AV14DoDelete )
            {
               ...
               S221 ();
               if (returnInSub) return;
               AV31importacion_conceptos.Load(AV32CliCod, AV34EmpCod, AV36ImpLiqSec, AV38ImpLiqConExtCod);
            }
            if ( ! AV31importacion_conceptos.Success() )
            {
               GXv_objcol_SdtMessages_Message3[0] = AV26Messages ;
               new web.wwpbaseobjects.wwp_addimporterrormessages(remoteHandle, context).execute( GXv_objcol_SdtMessages_Message3, GXutil.trim( GXutil.str( AV24LineNumber, 10, 0)), AV31importacion_conceptos.GetMessages()) ;
               AV26Messages = GXv_objcol_SdtMessages_Message3[0] ;
               AV19IsLineOk = false ;
            }
         }
      ...
      if ( AV19IsLineOk )
      {
         ...
         if ( AV19IsLineOk )
         {
            AV31importacion_conceptos.Save();
            if ( ! AV31importacion_conceptos.Success() )
            {
               GXv_objcol_SdtMessages_Message3[0] = AV26Messages ;
               new web.wwpbaseobjects.wwp_addimporterrormessages(remoteHandle, context).execute( GXv_objcol_SdtMessages_Message3, GXutil.trim( GXutil.str( AV24LineNumber, 10, 0)), AV31importacion_conceptos.GetMessages()) ;
   ...
   public void S231( )
   {
      ...
      {
         if ( GXutil.strcmp(new web.wwpbaseobjects.wwp_export_undosecuretext(remoteHandle, context).executeUdp( AV42ExcelDocument.Cells((int)(AV24LineNumber), ((Number) AV27TitleIndexes.elementAt(-1+2)).shortValue(), 1, 1).getText()), httpContext.getMessage( "Remunerativo", "")) == 0 )
         {
            AV31importacion_conceptos.setgxTv_Sdtimportacion_conceptos_Impliqtipoconcod( "REM_ARG" );
         }
         else if ( GXutil.strcmp(new web.wwpbaseobjects.wwp_export_undosecuretext(remoteHandle, context).executeUdp( AV42ExcelDocument.Cells((int)(AV24LineNumber), ((Number) AV27TitleIndexes.elementAt(-1+2)).shortValue(), 1, 1).getText()), httpContext.getMessage( "No Remunerativo", "")) == 0 )
         {
            AV31importacion_conceptos.setgxTv_Sdtimportacion_conceptos_Impliqtipoconcod( "NRE_ARG" );
         }
         else if ( GXutil.strcmp(new web.wwpbaseobjects.wwp_export_undosecuretext(remoteHandle, context).executeUdp( AV42ExcelDocument.Cells((int)(AV24LineNumber), ((Number) AV27TitleIndexes.elementAt(-1+2)).shortValue(), 1, 1).getText()), httpContext.getMessage( "Retención", "")) == 0 )
         {
            AV31importacion_conceptos.setgxTv_Sdtimportacion_conceptos_Impliqtipoconcod( "DES_ARG" );
         }
         else if ( GXutil.strcmp(new web.wwpbaseobjects.wwp_export_undosecuretext(remoteHandle, context).executeUdp( AV42ExcelDocument.Cells((int)(AV24LineNumber), ((Number) AV27TitleIndexes.elementAt(-1+2)).shortValue(), 1, 1).getText()), httpContext.getMessage( "Cálculo", "")) == 0 )
         {
            AV31importacion_conceptos.setgxTv_Sdtimportacion_conceptos_Impliqtipoconcod( "CAL_ARG" );
         }
      }
      if ( ((Number) AV27TitleIndexes.elementAt(-1+4)).shortValue() > 0 )
      {
         ...
         importccimportexcel.this.GXt_char8 = GXv_char4[0] ;
         AV31importacion_conceptos.setgxTv_Sdtimportacion_conceptos_Impliqafipcodmasdesc( GXt_char8 );
      }
      if ( ((Number) AV27TitleIndexes.elementAt(-1+5)).shortValue() > 0 )
      {
         ...
         importccimportexcel.this.GXt_char8 = GXv_char4[0] ;
         AV31importacion_conceptos.setgxTv_Sdtimportacion_conceptos_Impliqconsiscodydescrip( GXt_char8 );
      }
   }
   ...
   public void S221( )
   {
      ...
      AV39ImpLiqConExtCods.removeItem((int)(AV23Index));
   }
   ...
   public void S211( )
   {
      ...
      if ( AV14DoDelete )
      {
         ...
         {
            if ( ( ((Number) AV33CliCods.elementAt(-1+(int)(AV40i))).intValue() == AV32CliCod ) && ( ((Number) AV35EmpCods.elementAt(-1+(int)(AV40i))).shortValue() == AV34EmpCod ) && ( ((Number) AV37ImpLiqSecs.elementAt(-1+(int)(AV40i))).shortValue() == AV36ImpLiqSec ) && ( GXutil.strcmp((String)AV39ImpLiqConExtCods.elementAt(-1+(int)(AV40i)), AV38ImpLiqConExtCod) == 0 ) )
            {
               AV23Index = AV40i ;
               if (true) break;
            }
   ...
   {
      this.aP2[0] = importccimportexcel.this.AV26Messages;
      this.aP3[0] = importccimportexcel.this.AV20IsOk;
      CloseOpenCursors();
   ...
   public void initialize( )
   {
      ...
      AV39ImpLiqConExtCods = new GXSimpleCollection<String>(String.class, "internal", "");
      scmdbuf = "" ;
      P00NV2_A3CliCod = new int[1] ;
      P00NV2_A1EmpCod = new short[1] ;
      P00NV2_A88ImpLiqSec = new short[1] ;
      P00NV2_A89ImpLiqConExtCod = new String[] {""} ;
      A89ImpLiqConExtCod = "" ;
      AV28TitleNames = new GXSimpleCollection<String>(String.class, "internal", "");
      ...
      AV31importacion_conceptos = new web.Sdtimportacion_conceptos(remoteHandle);
      AV38ImpLiqConExtCod = "" ;
      GXt_char8 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.importccimportexcel__default(),
         new Object[] {
             new Object[] {
            P00NV2_A3CliCod, P00NV2_A1EmpCod, P00NV2_A88ImpLiqSec, P00NV2_A89ImpLiqConExtCod
            }
         }
      );
      AV49Pgmname = "ImportCCImportExcel" ;
      /* GeneXus formulas. */
      AV49Pgmname = "ImportCCImportExcel" ;
      Gx_err = (short)(0) ;
   }
   ...
   private String AV38ImpLiqConExtCod ;
   ...
   private int[] P00NV2_A3CliCod ;
   private short[] P00NV2_A1EmpCod ;
   private short[] P00NV2_A88ImpLiqSec ;
   private String[] P00NV2_A89ImpLiqConExtCod ;
   private com.genexus.gxoffice.ExcelDoc AV42ExcelDocument ;
   private GXSimpleCollection<String> AV39ImpLiqConExtCods ;
   ...
   private web.Sdtimportacion_conceptos AV31importacion_conceptos ;
}

final  class importccimportexcel__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("P00NV2", "SELECT CliCod, EmpCod, ImpLiqSec, ImpLiqConExtCod FROM importacion_conceptos ORDER BY CliCod, EmpCod, ImpLiqSec, ImpLiqConExtCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
