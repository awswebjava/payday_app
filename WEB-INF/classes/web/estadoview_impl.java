...
public final  class estadoview_impl extends GXDataArea
{
   public estadoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public estadoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( estadoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV9SitCodigo = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV9SitCodigo", AV9SitCodigo);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSITCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SitCodigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.estadoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV9SitCodigo)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"SitCodigo","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vSITCODIGO", GXutil.rtrim( AV9SitCodigo));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSITCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SitCodigo, ""))));
   ...
   {
      return formatLink("web.estadoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV9SitCodigo)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"SitCodigo","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Estado View", "") ;
   }
   ...
   public void wb1D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_1D2( true) ;
      }
      else
      {
         wb_table1_9_1D2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_1D2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start1D2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Estado View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup1D0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV9SitCodigo = httpContext.cgiGet( "vSITCODIGO") ;
   ...
   public void e111D2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H001D2 */
      pr_default.execute(0, new Object[] {AV9SitCodigo});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A16SitCodigo = H001D2_A16SitCodigo[0] ;
         A334SitDescrip = H001D2_A334SitDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A334SitDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SituacionGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.situaciongeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SituacionGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV9SitCodigo});
   ...
   public void wb_table1_9_1D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EstadoView.htm");
         /* Div Control */
         ...
         wb_table1_9_1D2e( true) ;
      }
      else
      {
         wb_table1_9_1D2e( false) ;
      }
   }
   ...
   {
      AV9SitCodigo = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9SitCodigo", AV9SitCodigo);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSITCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9SitCodigo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202042915", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("estadoview.js", "?202412202042915", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Estado View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV9SitCodigo',fld:'vSITCODIGO',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001D2_A16SitCodigo = new String[] {""} ;
      H001D2_A334SitDescrip = new String[] {""} ;
      A16SitCodigo = "" ;
      A334SitDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.estadoview__default(),
         new Object[] {
             new Object[] {
            H001D2_A16SitCodigo, H001D2_A334SitDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV9SitCodigo ;
   private String wcpOAV7TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV9SitCodigo ;
   ...
   private String[] H001D2_A16SitCodigo ;
   private String[] H001D2_A334SitDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class estadoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001D2", "SELECT SitCodigo, SitDescrip FROM Estado WHERE SitCodigo = ( ?) ORDER BY SitCodigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
