...
public final  class convenio_adicional_importesview_impl extends GXDataArea
{
   public convenio_adicional_importesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public convenio_adicional_importesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( convenio_adicional_importesview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV14ConveAdiVig = localUtil.parseDateParm( httpContext.GetPar( "ConveAdiVig")) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14ConveAdiVig", localUtil.format(AV14ConveAdiVig, "99/99/99"));
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADIVIG", getSecureSignedToken( "", AV14ConveAdiVig));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.convenio_adicional_importesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13ConveAdicod)),GXutil.URLEncode(GXutil.formatDateParm(AV14ConveAdiVig)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiVig","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vCONVEADIVIG", localUtil.dtoc( AV14ConveAdiVig, 0, "/"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADIVIG", getSecureSignedToken( "", AV14ConveAdiVig));
   ...
   {
      return formatLink("web.convenio_adicional_importesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11CliPaiConve,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12CliConvenio)),GXutil.URLEncode(GXutil.rtrim(AV13ConveAdicod)),GXutil.URLEncode(GXutil.formatDateParm(AV14ConveAdiVig)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","CliPaiConve","CliConvenio","ConveAdicod","ConveAdiVig","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "Convenio_Adicional_ImportesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Convenio_Adicional_Importes View", "") ;
   }
   ...
   public void wbEW0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_EW2( true) ;
      }
      else
      {
         wb_table1_9_EW2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_EW2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startEW2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Convenio_Adicional_Importes View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesEW2( )
   {
   }
   ...
   public void strupEW0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14ConveAdiVig = localUtil.ctod( httpContext.cgiGet( "vCONVEADIVIG"), 0) ;
   ...
   public void e11EW2( )
   {
      ...
      AV21GXLvl11 = (byte)(0) ;
      /* Using cursor H00EW2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13ConveAdicod, AV14ConveAdiVig, Integer.valueOf(AV10CliCod), Short.valueOf(AV11CliPaiConve), AV12CliConvenio, AV13ConveAdicod, AV14ConveAdiVig});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A999ConveAdiVig = H00EW2_A999ConveAdiVig[0] ;
         A996ConveAdicod = H00EW2_A996ConveAdicod[0] ;
         A1565CliConvenio = H00EW2_A1565CliConvenio[0] ;
         A1564CliPaiConve = H00EW2_A1564CliPaiConve[0] ;
         A3CliCod = H00EW2_A3CliCod[0] ;
         A1000ConveAdiImporte = H00EW2_A1000ConveAdiImporte[0] ;
         AV21GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1000ConveAdiImporte, 14, 2) );
   ...
   public void S112( )
   {
      ...
      if ( AV15LoadAllTabs || ( GXutil.strcmp(AV16SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV16SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "Convenio_Adicional_ImportesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.convenio_adicional_importesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "Convenio_Adicional_ImportesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11CliPaiConve),AV12CliConvenio,AV13ConveAdicod,AV14ConveAdiVig});
   ...
   public void wb_table1_9_EW2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_Convenio_Adicional_ImportesView.htm");
         /* Div Control */
         ...
         wb_table1_9_EW2e( true) ;
      }
      else
      {
         wb_table1_9_EW2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13ConveAdicod", AV13ConveAdicod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADICOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13ConveAdicod, ""))));
      AV14ConveAdiVig = (java.util.Date)getParm(obj,4) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14ConveAdiVig", localUtil.format(AV14ConveAdiVig, "99/99/99"));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCONVEADIVIG", getSecureSignedToken( "", AV14ConveAdiVig));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713334499", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("convenio_adicional_importesview.js", "?20251713334499", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Convenio_Adicional_Importes View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      wcpOAV12CliConvenio = "" ;
      wcpOAV13ConveAdicod = "" ;
      wcpOAV14ConveAdiVig = GXutil.nullDate() ;
      wcpOAV8TabCode = "" ;
      ...
      AV12CliConvenio = "" ;
      AV13ConveAdicod = "" ;
      AV14ConveAdiVig = GXutil.nullDate() ;
      AV8TabCode = "" ;
      ...
      scmdbuf = "" ;
      H00EW2_A999ConveAdiVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00EW2_A996ConveAdicod = new String[] {""} ;
      H00EW2_A1565CliConvenio = new String[] {""} ;
      H00EW2_A1564CliPaiConve = new short[1] ;
      H00EW2_A3CliCod = new int[1] ;
      H00EW2_A1000ConveAdiImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.convenio_adicional_importesview__default(),
         new Object[] {
             new Object[] {
            H00EW2_A999ConveAdiVig, H00EW2_A996ConveAdicod, H00EW2_A1565CliConvenio, H00EW2_A1564CliPaiConve, H00EW2_A3CliCod, H00EW2_A1000ConveAdiImporte
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private java.util.Date wcpOAV14ConveAdiVig ;
   private java.util.Date AV14ConveAdiVig ;
   ...
   private java.util.Date[] H00EW2_A999ConveAdiVig ;
   private String[] H00EW2_A996ConveAdicod ;
   private String[] H00EW2_A1565CliConvenio ;
   private short[] H00EW2_A1564CliPaiConve ;
   private int[] H00EW2_A3CliCod ;
   private java.math.BigDecimal[] H00EW2_A1000ConveAdiImporte ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class convenio_adicional_importesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00EW2", "SELECT ConveAdiVig, ConveAdicod, CliConvenio, CliPaiConve, CliCod, ConveAdiImporte FROM convenio_adicionalimportes WHERE (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveAdicod = ( ?) and ConveAdiVig = ?) AND (CliCod = ? and CliPaiConve = ? and CliConvenio = ( ?) and ConveAdicod = ( ?) and ConveAdiVig = ?) ORDER BY CliCod, CliPaiConve, CliConvenio, ConveAdicod, ConveAdiVig ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
