...
public final  class tipotrabajoview_impl extends GXDataArea
{
   public tipotrabajoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public tipotrabajoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( tipotrabajoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10TipoTraId = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TipoTraId", AV10TipoTraId);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10TipoTraId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.tipotrabajoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10TipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipoTraId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vTIPOTRAID", GXutil.rtrim( AV10TipoTraId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10TipoTraId, ""))));
   ...
   {
      return formatLink("web.tipotrabajoview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10TipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TipoTraId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "TipoTrabajoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Tipo Trabajo View", "") ;
   }
   ...
   public void wbHW0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_HW2( true) ;
      }
      else
      {
         wb_table1_9_HW2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_HW2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startHW2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Tipo Trabajo View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesHW2( )
   {
   }
   ...
   public void strupHW0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10TipoTraId = httpContext.cgiGet( "vTIPOTRAID") ;
   ...
   public void e11HW2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00HW2 */
      pr_default.execute(0, new Object[] {AV10TipoTraId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1292TipoTraId = H00HW2_A1292TipoTraId[0] ;
         A1293TipoTraNom = H00HW2_A1293TipoTraNom[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1293TipoTraNom );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "TipoTrabajoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.tipotrabajogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "TipoTrabajoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10TipoTraId});
   ...
   public void wb_table1_9_HW2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_TipoTrabajoView.htm");
         /* Div Control */
         ...
         wb_table1_9_HW2e( true) ;
      }
      else
      {
         wb_table1_9_HW2e( false) ;
      }
   }
   ...
   {
      AV10TipoTraId = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TipoTraId", AV10TipoTraId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10TipoTraId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020424525", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tipotrabajoview.js", "?2024122020424525", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Tipo Trabajo View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TipoTraId',fld:'vTIPOTRAID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00HW2_A1292TipoTraId = new String[] {""} ;
      H00HW2_A1293TipoTraNom = new String[] {""} ;
      A1292TipoTraId = "" ;
      A1293TipoTraNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.tipotrabajoview__default(),
         new Object[] {
             new Object[] {
            H00HW2_A1292TipoTraId, H00HW2_A1293TipoTraNom
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV10TipoTraId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV10TipoTraId ;
   ...
   private String[] H00HW2_A1292TipoTraId ;
   private String[] H00HW2_A1293TipoTraNom ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class tipotrabajoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00HW2", "SELECT TipoTraId, TipoTraNom FROM TipoTrabajo WHERE TipoTraId = ( ?) ORDER BY TipoTraId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
