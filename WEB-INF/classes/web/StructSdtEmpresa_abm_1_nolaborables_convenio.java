...
public final  class StructSdtEmpresa_abm_1_nolaborables_convenio implements Cloneable, java.io.Serializable
{
   public StructSdtEmpresa_abm_1_nolaborables_convenio( )
   {
      this( -1, new ModelContext( StructSdtEmpresa_abm_1_nolaborables_convenio.class ));
   }

   public StructSdtEmpresa_abm_1_nolaborables_convenio( int remoteHandle ,
   ...
   protected short gxTv_SdtEmpresa_abm_1_nolaborables_convenio_Modified ;
   protected short gxTv_SdtEmpresa_abm_1_nolaborables_convenio_Initialized ;
   protected String gxTv_SdtEmpresa_abm_1_nolaborables_convenio_Empconvenio ;
   protected String gxTv_SdtEmpresa_abm_1_nolaborables_convenio_Mode ;
   protected String gxTv_SdtEmpresa_abm_1_nolaborables_convenio_Empconvenio_Z ;
}
