...
public final  class empresaorigenesview_impl extends GXDataArea
{
   public empresaorigenesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresaorigenesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresaorigenesview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12EmpOrigen = httpContext.GetPar( "EmpOrigen") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12EmpOrigen", AV12EmpOrigen);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpOrigen, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.empresaorigenesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12EmpOrigen)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpOrigen","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vEMPORIGEN", GXutil.rtrim( AV12EmpOrigen));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpOrigen, ""))));
   ...
   {
      return formatLink("web.empresaorigenesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12EmpOrigen)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpOrigen","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EmpresaOrigenesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Empresa Origenes View", "") ;
   }
   ...
   public void wbKA0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_KA2( true) ;
      }
      else
      {
         wb_table1_9_KA2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_KA2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startKA2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Empresa Origenes View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesKA2( )
   {
   }
   ...
   public void strupKA0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12EmpOrigen = httpContext.cgiGet( "vEMPORIGEN") ;
   ...
   public void e11KA2( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00KA2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12EmpOrigen, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12EmpOrigen});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1238EmpOrigen = H00KA2_A1238EmpOrigen[0] ;
         A1EmpCod = H00KA2_A1EmpCod[0] ;
         A3CliCod = H00KA2_A3CliCod[0] ;
         AV20GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EmpresaOrigenesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.empresaorigenesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EmpresaOrigenesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),AV12EmpOrigen});
   ...
   public void wb_table1_9_KA2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaOrigenesView.htm");
         /* Div Control */
         ...
         wb_table1_9_KA2e( true) ;
      }
      else
      {
         wb_table1_9_KA2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12EmpOrigen = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12EmpOrigen", AV12EmpOrigen);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpOrigen, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412201959425", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresaorigenesview.js", "?202412201959425", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Empresa Origenes View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12EmpOrigen',fld:'vEMPORIGEN',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00KA2_A1238EmpOrigen = new String[] {""} ;
      H00KA2_A1EmpCod = new short[1] ;
      H00KA2_A3CliCod = new int[1] ;
      A1238EmpOrigen = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.empresaorigenesview__default(),
         new Object[] {
             new Object[] {
            H00KA2_A1238EmpOrigen, H00KA2_A1EmpCod, H00KA2_A3CliCod
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV12EmpOrigen ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12EmpOrigen ;
   ...
   private String[] H00KA2_A1238EmpOrigen ;
   private short[] H00KA2_A1EmpCod ;
   private int[] H00KA2_A3CliCod ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class empresaorigenesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00KA2", "SELECT EmpOrigen, EmpCod, CliCod FROM Empresanolaborables_origen WHERE (CliCod = ? and EmpCod = ? and EmpOrigen = ( ?)) AND (CliCod = ? and EmpCod = ? and EmpOrigen = ( ?)) ORDER BY CliCod, EmpCod, EmpOrigen ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
