...
public final  class paistipotrabajoview_impl extends GXDataArea
{
   public paistipotrabajoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public paistipotrabajoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( paistipotrabajoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11PaiTipoTraId = httpContext.GetPar( "PaiTipoTraId") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11PaiTipoTraId", AV11PaiTipoTraId);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11PaiTipoTraId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.paistipotrabajoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","PaiTipoTraId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vPAITIPOTRAID", GXutil.rtrim( AV11PaiTipoTraId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11PaiTipoTraId, ""))));
   ...
   {
      return formatLink("web.paistipotrabajoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PaiCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV11PaiTipoTraId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PaiCod","PaiTipoTraId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "PaisTipoTrabajoView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Pais Tipo Trabajo View", "") ;
   }
   ...
   public void wbGT0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_GT2( true) ;
      }
      else
      {
         wb_table1_9_GT2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_GT2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startGT2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Pais Tipo Trabajo View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesGT2( )
   {
   }
   ...
   public void strupGT0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11PaiTipoTraId = httpContext.cgiGet( "vPAITIPOTRAID") ;
   ...
   public void e11GT2( )
   {
      ...
      AV19GXLvl11 = (byte)(0) ;
      /* Using cursor H00GT2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PaiCod), AV11PaiTipoTraId, Short.valueOf(AV10PaiCod), AV11PaiTipoTraId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1292TipoTraId = H00GT2_A1292TipoTraId[0] ;
         A1293TipoTraNom = H00GT2_A1293TipoTraNom[0] ;
         A1294PaiTipoTraId = H00GT2_A1294PaiTipoTraId[0] ;
         A46PaiCod = H00GT2_A46PaiCod[0] ;
         AV19GXLvl11 = (byte)(1) ;
         Form.setCaption( A1295PaiTipoTraNom );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "PaisTipoTrabajoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.paistipotrabajogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PaisTipoTrabajoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Short.valueOf(AV10PaiCod),AV11PaiTipoTraId});
   ...
   public void wb_table1_9_GT2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PaisTipoTrabajoView.htm");
         /* Div Control */
         ...
         wb_table1_9_GT2e( true) ;
      }
      else
      {
         wb_table1_9_GT2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10PaiCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PaiCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PaiCod), "ZZZ9")));
      AV11PaiTipoTraId = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11PaiTipoTraId", AV11PaiTipoTraId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAITIPOTRAID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11PaiTipoTraId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181765548", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paistipotrabajoview.js", "?2025181765549", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Pais Tipo Trabajo View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PaiCod',fld:'vPAICOD',pic:'ZZZ9',hsh:true},{av:'AV11PaiTipoTraId',fld:'vPAITIPOTRAID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00GT2_A1292TipoTraId = new String[] {""} ;
      H00GT2_A1293TipoTraNom = new String[] {""} ;
      H00GT2_A1294PaiTipoTraId = new String[] {""} ;
      H00GT2_A46PaiCod = new short[1] ;
      A1292TipoTraId = "" ;
      A1293TipoTraNom = "" ;
      A1294PaiTipoTraId = "" ;
      A1295PaiTipoTraNom = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.paistipotrabajoview__default(),
         new Object[] {
             new Object[] {
            H00GT2_A1292TipoTraId, H00GT2_A1293TipoTraNom, H00GT2_A1294PaiTipoTraId, H00GT2_A46PaiCod
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11PaiTipoTraId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11PaiTipoTraId ;
   ...
   private String[] H00GT2_A1292TipoTraId ;
   private String[] H00GT2_A1293TipoTraNom ;
   private String[] H00GT2_A1294PaiTipoTraId ;
   private short[] H00GT2_A46PaiCod ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class paistipotrabajoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00GT2", "SELECT T2.TipoTraId, T2.TipoTraNom, T1.PaiTipoTraId, T1.PaiCod FROM (PaisTipoTrabajo T1 INNER JOIN TipoTrabajo T2 ON T2.TipoTraId = T1.PaiTipoTraId) WHERE (T1.PaiCod = ? and T1.PaiTipoTraId = ( ?)) AND (T1.PaiCod = ? and T1.PaiTipoTraId = ( ?)) ORDER BY T1.PaiCod, T1.PaiTipoTraId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
