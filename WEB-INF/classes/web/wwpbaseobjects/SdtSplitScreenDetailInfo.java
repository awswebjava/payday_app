...
public final  class SdtSplitScreenDetailInfo extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtSplitScreenDetailInfo Clone( )
   {
      return (web.wwpbaseobjects.SdtSplitScreenDetailInfo)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtSplitScreenDetailInfo struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtSplitScreenDetailInfo getStruct( )
   {
      web.wwpbaseobjects.StructSdtSplitScreenDetailInfo struct = new web.wwpbaseobjects.StructSdtSplitScreenDetailInfo ();
