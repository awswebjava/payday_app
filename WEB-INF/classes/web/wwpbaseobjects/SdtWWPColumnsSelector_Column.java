...
public final  class SdtWWPColumnsSelector_Column extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtWWPColumnsSelector_Column Clone( )
   {
      return (web.wwpbaseobjects.SdtWWPColumnsSelector_Column)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWWPColumnsSelector_Column struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtWWPColumnsSelector_Column getStruct( )
   {
      web.wwpbaseobjects.StructSdtWWPColumnsSelector_Column struct = new web.wwpbaseobjects.StructSdtWWPColumnsSelector_Column ();
