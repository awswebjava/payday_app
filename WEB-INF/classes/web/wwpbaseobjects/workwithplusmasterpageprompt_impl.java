...
public final  class workwithplusmasterpageprompt_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm0B2( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?202412202045870", false, true);
   ...
   public void wb0B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 CellContentHolder", "left", "top", "", "", "div");
         if ( httpContext.isSpaRequest( ) )
         {
            httpContext.enableOutput();
         }
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtavPickerdummyvariable_Internalname, localUtil.format(AV11PickerDummyVariable, "99/99/99"), localUtil.format( AV11PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), false, "", "right", false, "", "HLP_WWPBaseObjects\\WorkWithPlusMasterPagePrompt.htm");
   ...
   {
      /* GeneXus formulas. */
      AV14Pgmname = "WWPBaseObjects.WorkWithPlusMasterPagePrompt" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void e110B2( )
   {
      ...
      workwithplusmasterpageprompt_impl.this.GXt_int1 = GXv_int2[0] ;
      AV9CliCod = GXt_int1 ;
      GXt_boolean3 = AV7IsAuthorized ;
      GXv_boolean4[0] = GXt_boolean3 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "MasterPageFrame", GXv_boolean4) ;
      workwithplusmasterpageprompt_impl.this.GXt_boolean3 = GXv_boolean4[0] ;
      AV7IsAuthorized = GXt_boolean3 ;
      if ( ! AV7IsAuthorized )
      {
      ...
      {
         GXt_SdtWWP_DesignSystemSettings5 = AV6WWP_DesignSystemSettings;
         GXv_SdtWWP_DesignSystemSettings6[0] = GXt_SdtWWP_DesignSystemSettings5;
         new web.wwpbaseobjects.wwp_getdesignsystemsettings(remoteHandle, context).execute( GXv_SdtWWP_DesignSystemSettings6) ;
         GXt_SdtWWP_DesignSystemSettings5 = GXv_SdtWWP_DesignSystemSettings6[0] ;
         AV6WWP_DesignSystemSettings = GXt_SdtWWP_DesignSystemSettings5;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202412202045912", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?202412202045912", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void initialize( )
   {
      ...
      TempTags = "" ;
      AV11PickerDummyVariable = GXutil.nullDate() ;
      sEvt = "" ;
      EvtGridId = "" ;
      EvtRowId = "" ;
      sEvtType = "" ;
      ...
      GXt_SdtWWP_DesignSystemSettings5 = new web.wwpbaseobjects.SdtWWP_DesignSystemSettings(remoteHandle, context);
      GXv_SdtWWP_DesignSystemSettings6 = new web.wwpbaseobjects.SdtWWP_DesignSystemSettings[1] ;
      GXv_int2 = new int[1] ;
   ...
   private java.util.Date AV11PickerDummyVariable ;
   ...
   private web.wwpbaseobjects.SdtWWP_DesignSystemSettings GXt_SdtWWP_DesignSystemSettings5 ;
   private web.wwpbaseobjects.SdtWWP_DesignSystemSettings GXv_SdtWWP_DesignSystemSettings6[] ;
}
