...
public final  class SdtDVB_SDTDropDownOptionsData_Item extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item Clone( )
   {
      return (web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item getStruct( )
   {
      web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item struct = new web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item ();
