...
public final  class SdtWWPTransactionContext_Attribute extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtWWPTransactionContext_Attribute Clone( )
   {
      return (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute getStruct( )
   {
      web.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute struct = new web.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute ();
