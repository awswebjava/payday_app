...
public final  class SdtWizardSteps_WizardStepsItem extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtWizardSteps_WizardStepsItem Clone( )
   {
      return (web.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem getStruct( )
   {
      web.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem struct = new web.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem ();
