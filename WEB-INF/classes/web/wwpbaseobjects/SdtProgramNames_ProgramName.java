...
public final  class SdtProgramNames_ProgramName extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtProgramNames_ProgramName Clone( )
   {
      return (web.wwpbaseobjects.SdtProgramNames_ProgramName)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtProgramNames_ProgramName struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtProgramNames_ProgramName getStruct( )
   {
      web.wwpbaseobjects.StructSdtProgramNames_ProgramName struct = new web.wwpbaseobjects.StructSdtProgramNames_ProgramName ();
