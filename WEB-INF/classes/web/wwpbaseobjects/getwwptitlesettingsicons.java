...
public final  class getwwptitlesettingsicons extends GXProcedure
{
   ...
   public web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons executeUdp( )
   {
      getwwptitlesettingsicons.this.aP0 = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons[] {new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons()};
      execute_int(aP0);
      return aP0[0];
   }

   public void execute( web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons[] aP0 )
   {
      execute_int(aP0);
   }

   private void execute_int( web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons[] aP0 )
   {
   ...
   {
      AV8TitleSettingsIcons = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      /* GeneXus formulas. */
      Gx_err = (short)(0) ;
   }

   private short Gx_err ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons[] aP0 ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV8TitleSettingsIcons ;
}
