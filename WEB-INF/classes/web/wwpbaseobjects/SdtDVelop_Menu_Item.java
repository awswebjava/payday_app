...
public final  class SdtDVelop_Menu_Item extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "subItems") )
            {
               ...
               {
                  gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item>(web.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "PayDay", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item> getgxTv_SdtDVelop_Menu_Item_Subitems( )
   {
      if ( gxTv_SdtDVelop_Menu_Item_Subitems == null )
      {
         gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item>(web.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "PayDay", remoteHandle);
   ...
   public void setgxTv_SdtDVelop_Menu_Item_Subitems( GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item> value )
   {
      gxTv_SdtDVelop_Menu_Item_Subitems_N = (byte)(0) ;
      gxTv_SdtDVelop_Menu_Item_N = (byte)(0) ;
   ...
   public web.wwpbaseobjects.SdtDVelop_Menu_Item Clone( )
   {
      return (web.wwpbaseobjects.SdtDVelop_Menu_Item)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtDVelop_Menu_Item struct )
   {
      ...
      GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux = new GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item>(web.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "PayDay", remoteHandle);
      Vector<web.wwpbaseobjects.StructSdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux1 = struct.getSubitems();
      if (gxTv_SdtDVelop_Menu_Item_Subitems_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtDVelop_Menu_Item_Subitems_aux1.size(); i++)
         {
            gxTv_SdtDVelop_Menu_Item_Subitems_aux.add(new web.wwpbaseobjects.SdtDVelop_Menu_Item(gxTv_SdtDVelop_Menu_Item_Subitems_aux1.elementAt(i)));
         }
      }
   ...
   public web.wwpbaseobjects.StructSdtDVelop_Menu_Item getStruct( )
   {
      web.wwpbaseobjects.StructSdtDVelop_Menu_Item struct = new web.wwpbaseobjects.StructSdtDVelop_Menu_Item ();
   ...
   protected GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux ;
   protected GXBaseCollection<web.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems=null ;
}
