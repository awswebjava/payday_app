...
public final  class SdtWWPContext extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtWWPContext Clone( )
   {
      return (web.wwpbaseobjects.SdtWWPContext)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWWPContext struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtWWPContext getStruct( )
   {
      web.wwpbaseobjects.StructSdtWWPContext struct = new web.wwpbaseobjects.StructSdtWWPContext ();
