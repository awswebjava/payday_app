...
public final  class secuserwwgetfilterdata_services_rest extends GxRestService
{
   ...
   public javax.ws.rs.core.Response execute( web.wwpbaseobjects.secuserwwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV19DDOName;
      ...
      try
      {
         web.wwpbaseobjects.secuserwwgetfilterdata worker = new web.wwpbaseobjects.secuserwwgetfilterdata(remoteHandle, context);
         worker.execute(AV19DDOName,AV17SearchTxt,AV18SearchTxtTo,AV23OptionsJson,AV26OptionsDescJson,AV28OptionIndexesJson );
         web.wwpbaseobjects.secuserwwgetfilterdata_RESTInterfaceOUT data = new web.wwpbaseobjects.secuserwwgetfilterdata_RESTInterfaceOUT();
