...
public final  class SdtDVB_SDTDropDownOptionsTitleSettingsIcons extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons Clone( )
   {
      return (web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons getStruct( )
   {
      web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons struct = new web.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsTitleSettingsIcons ();
