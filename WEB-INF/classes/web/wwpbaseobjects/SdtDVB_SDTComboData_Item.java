...
public final  class SdtDVB_SDTComboData_Item extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Children") && ( oReader.getNodeType() != 2 ) && ( GXutil.strcmp(oReader.getNamespaceURI(), "") == 0 ) )
            {
               ...
               {
                  gxTv_SdtDVB_SDTComboData_Item_Children = new GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item>(web.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
               }
   ...
   public GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item> getgxTv_SdtDVB_SDTComboData_Item_Children( )
   {
      if ( gxTv_SdtDVB_SDTComboData_Item_Children == null )
      {
         gxTv_SdtDVB_SDTComboData_Item_Children = new GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item>(web.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
   ...
   public void setgxTv_SdtDVB_SDTComboData_Item_Children( GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item> value )
   {
      gxTv_SdtDVB_SDTComboData_Item_Children_N = (byte)(0) ;
      gxTv_SdtDVB_SDTComboData_Item_N = (byte)(0) ;
   ...
   public web.wwpbaseobjects.SdtDVB_SDTComboData_Item Clone( )
   {
      return (web.wwpbaseobjects.SdtDVB_SDTComboData_Item)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtDVB_SDTComboData_Item struct )
   {
      setgxTv_SdtDVB_SDTComboData_Item_Id(struct.getId());
      setgxTv_SdtDVB_SDTComboData_Item_Title(struct.getTitle());
      GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children_aux = new GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item>(web.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
      Vector<web.wwpbaseobjects.StructSdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children_aux1 = struct.getChildren();
      if (gxTv_SdtDVB_SDTComboData_Item_Children_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtDVB_SDTComboData_Item_Children_aux1.size(); i++)
         {
            gxTv_SdtDVB_SDTComboData_Item_Children_aux.add(new web.wwpbaseobjects.SdtDVB_SDTComboData_Item(gxTv_SdtDVB_SDTComboData_Item_Children_aux1.elementAt(i)));
         }
      }
   ...
   public web.wwpbaseobjects.StructSdtDVB_SDTComboData_Item getStruct( )
   {
      web.wwpbaseobjects.StructSdtDVB_SDTComboData_Item struct = new web.wwpbaseobjects.StructSdtDVB_SDTComboData_Item ();
   ...
   protected GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children_aux ;
   protected GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children=null ;
}
