...
public final  class SdtWWPColumnsSelector extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Columns") )
            {
               ...
               {
                  gxTv_SdtWWPColumnsSelector_Columns = new GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column>(web.wwpbaseobjects.SdtWWPColumnsSelector_Column.class, "WWPColumnsSelector.Column", "PayDay", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column> getgxTv_SdtWWPColumnsSelector_Columns( )
   {
      if ( gxTv_SdtWWPColumnsSelector_Columns == null )
      {
         gxTv_SdtWWPColumnsSelector_Columns = new GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column>(web.wwpbaseobjects.SdtWWPColumnsSelector_Column.class, "WWPColumnsSelector.Column", "PayDay", remoteHandle);
   ...
   public void setgxTv_SdtWWPColumnsSelector_Columns( GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column> value )
   {
      gxTv_SdtWWPColumnsSelector_Columns_N = (byte)(0) ;
      gxTv_SdtWWPColumnsSelector_N = (byte)(0) ;
   ...
   public web.wwpbaseobjects.SdtWWPColumnsSelector Clone( )
   {
      return (web.wwpbaseobjects.SdtWWPColumnsSelector)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWWPColumnsSelector struct )
   {
      GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column> gxTv_SdtWWPColumnsSelector_Columns_aux = new GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column>(web.wwpbaseobjects.SdtWWPColumnsSelector_Column.class, "WWPColumnsSelector.Column", "PayDay", remoteHandle);
      Vector<web.wwpbaseobjects.StructSdtWWPColumnsSelector_Column> gxTv_SdtWWPColumnsSelector_Columns_aux1 = struct.getColumns();
      if (gxTv_SdtWWPColumnsSelector_Columns_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPColumnsSelector_Columns_aux1.size(); i++)
         {
            gxTv_SdtWWPColumnsSelector_Columns_aux.add(new web.wwpbaseobjects.SdtWWPColumnsSelector_Column(gxTv_SdtWWPColumnsSelector_Columns_aux1.elementAt(i)));
         }
      }
   ...
   public web.wwpbaseobjects.StructSdtWWPColumnsSelector getStruct( )
   {
      web.wwpbaseobjects.StructSdtWWPColumnsSelector struct = new web.wwpbaseobjects.StructSdtWWPColumnsSelector ();
   ...
   protected GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column> gxTv_SdtWWPColumnsSelector_Columns_aux ;
   protected GXBaseCollection<web.wwpbaseobjects.SdtWWPColumnsSelector_Column> gxTv_SdtWWPColumnsSelector_Columns=null ;
}
