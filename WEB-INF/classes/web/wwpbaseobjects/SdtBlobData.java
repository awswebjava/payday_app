...
public final  class SdtBlobData extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtBlobData Clone( )
   {
      return (web.wwpbaseobjects.SdtBlobData)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtBlobData struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtBlobData getStruct( )
   {
      web.wwpbaseobjects.StructSdtBlobData struct = new web.wwpbaseobjects.StructSdtBlobData ();
