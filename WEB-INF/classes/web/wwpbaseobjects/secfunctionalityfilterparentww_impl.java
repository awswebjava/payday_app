...
public final  class secfunctionalityfilterparentww_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECPARENTFUNCTIONALITYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV8SecParentFunctionalityId), "ZZZZZZZZZ9")));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV84TFSecFunctionalityKey_Sels);
      AV43TFSecFunctionalityDescription = httpContext.GetPar( "TFSecFunctionalityDescription") ;
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV86TFSecFunctionalityDescription_Sels);
      ...
      httpContext.ajax_req_read_hidden_sdt(httpContext.GetNextPar( ), AV88TFSecParentFunctionalityDescription_Sels);
      ...
      gxgrgrid_refresh( subGrid_Rows, AV69ColumnsSelector, AV98Pgmname, AV8SecParentFunctionalityId, AV39TFSecFunctionalityKey, AV84TFSecFunctionalityKey_Sels, AV43TFSecFunctionalityDescription, AV86TFSecFunctionalityDescription_Sels, AV78TFSecFunctionalityType_Sels, AV50TFSecParentFunctionalityDescription, AV88TFSecParentFunctionalityDescription_Sels, AV26OrderedBy, AV27OrderedDsc, AV22IsAuthorized_Update, AV23IsAuthorized_Delete) ;
   ...
   {
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV98Pgmname, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( "", AV22IsAuthorized_Update));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV23IsAuthorized_Delete));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECPARENTFUNCTIONALITYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV8SecParentFunctionalityId), "ZZZZZZZZZ9")));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV80GridCurrentPage, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV81GridPageCount, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "vGRIDAPPLIEDFILTERS", AV89GridAppliedFilters);
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vAGEXPORTDATA", AV91AGExportData);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vAGEXPORTDATA", AV91AGExportData);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV98Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV98Pgmname, ""))));
      web.GxWebStd.gx_hidden_field( httpContext, "vSECPARENTFUNCTIONALITYID", GXutil.ltrim( localUtil.ntoc( AV8SecParentFunctionalityId, (byte)(10), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECPARENTFUNCTIONALITYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV8SecParentFunctionalityId), "ZZZZZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vTFSECFUNCTIONALITYKEY", AV39TFSecFunctionalityKey);
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vTFSECFUNCTIONALITYKEY_SELS", AV84TFSecFunctionalityKey_Sels);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vTFSECFUNCTIONALITYKEY_SELS", AV84TFSecFunctionalityKey_Sels);
      }
      web.GxWebStd.gx_hidden_field( httpContext, "vTFSECFUNCTIONALITYDESCRIPTION", AV43TFSecFunctionalityDescription);
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vTFSECFUNCTIONALITYDESCRIPTION_SELS", AV86TFSecFunctionalityDescription_Sels);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vTFSECFUNCTIONALITYDESCRIPTION_SELS", AV86TFSecFunctionalityDescription_Sels);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vTFSECPARENTFUNCTIONALITYDESCRIPTION", AV50TFSecParentFunctionalityDescription);
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS", AV88TFSecParentFunctionalityDescription_Sels);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS", AV88TFSecParentFunctionalityDescription_Sels);
      }
      web.GxWebStd.gx_hidden_field( httpContext, "vORDEREDBY", GXutil.ltrim( localUtil.ntoc( AV26OrderedBy, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "vORDEREDDSC", AV27OrderedDsc);
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_UPDATE", AV22IsAuthorized_Update);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( "", AV22IsAuthorized_Update));
      web.GxWebStd.gx_boolean_hidden_field( httpContext, "vISAUTHORIZED_DELETE", AV23IsAuthorized_Delete);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV23IsAuthorized_Delete));
   ...
   {
      return formatLink("web.wwpbaseobjects.secfunctionalityfilterparentww", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SecParentFunctionalityId,10,0))}, new String[] {"SecParentFunctionalityId"})  ;
   }
   ...
   public void wb2W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, httpContext.getMessage( "Functionality", ""), "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\SecFunctionalityFilterParentWW.htm");
      ...
      if ( wbEnd == 32 )
      {
         ...
         ucGridpaginationbar.setProperty("AppliedFilters", AV89GridAppliedFilters);
         ...
         ucDdo_agexport.setProperty("DropDownOptionsData", AV91AGExportData);
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV90GridActions = (short)(GXutil.lval( httpContext.cgiGet( cmbavGridactions.getInternalname()))) ;
                           httpContext.ajax_rsp_assign_attri("", false, cmbavGridactions.getInternalname(), GXutil.ltrimstr( DecimalUtil.doubleToDec(AV90GridActions), 4, 0));
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 web.wwpbaseobjects.SdtWWPColumnsSelector AV69ColumnsSelector ,
                                 String AV98Pgmname ,
                                 long AV8SecParentFunctionalityId ,
                                 String AV39TFSecFunctionalityKey ,
                                 GXSimpleCollection<String> AV84TFSecFunctionalityKey_Sels ,
                                 String AV43TFSecFunctionalityDescription ,
                                 GXSimpleCollection<String> AV86TFSecFunctionalityDescription_Sels ,
                                 GXSimpleCollection<Byte> AV78TFSecFunctionalityType_Sels ,
                                 String AV50TFSecParentFunctionalityDescription ,
                                 GXSimpleCollection<String> AV88TFSecParentFunctionalityDescription_Sels ,
                                 short AV26OrderedBy ,
   ...
   {
      /* GeneXus formulas. */
      AV98Pgmname = "WWPBaseObjects.SecFunctionalityFilterParentWW" ;
      Gx_err = (short)(0) ;
      edtavDisplay_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavDisplay_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtavDisplay_Enabled), 5, 0), !bGXsfl_32_Refreshing);
   }
   ...
   public void rf2W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels ,
                                              A350SecFunctionalityDescription ,
                                              AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels ,
                                              Byte.valueOf(A351SecFunctionalityType) ,
                                              AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels ,
                                              A353SecParentFunctionalityDescript ,
                                              AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels ,
                                              Integer.valueOf(AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels.size()) ,
                                              AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey ,
                                              Integer.valueOf(AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels.size()) ,
                                              AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription ,
                                              Integer.valueOf(AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels.size()) ,
                                              Integer.valueOf(AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels.size()) ,
                                              AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription ,
                                              Short.valueOf(AV26OrderedBy) ,
                                              Boolean.valueOf(AV27OrderedDsc) ,
                                              Long.valueOf(A63SecParentFunctionalityId) ,
                                              Long.valueOf(AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid) } ,
                                              new int[]{
                                              ...
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.LONG
                                              }
         });
         lV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey = GXutil.concat( GXutil.rtrim( AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey), "%", "") ;
         lV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription = GXutil.concat( GXutil.rtrim( AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription), "%", "") ;
         lV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription = GXutil.concat( GXutil.rtrim( AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription), "%", "") ;
         /* Using cursor H002W2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid), lV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey, lV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription, lV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_32_idx = 1 ;
         sGXsfl_32_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_32_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_322( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A349SecFunctionalityActive = H002W2_A349SecFunctionalityActive[0] ;
            A353SecParentFunctionalityDescript = H002W2_A353SecParentFunctionalityDescript[0] ;
            A63SecParentFunctionalityId = H002W2_A63SecParentFunctionalityId[0] ;
            n63SecParentFunctionalityId = H002W2_n63SecParentFunctionalityId[0] ;
            A351SecFunctionalityType = H002W2_A351SecFunctionalityType[0] ;
            A350SecFunctionalityDescription = H002W2_A350SecFunctionalityDescription[0] ;
            A64SecFunctionalityKey = H002W2_A64SecFunctionalityKey[0] ;
            A62SecFunctionalityId = H002W2_A62SecFunctionalityId[0] ;
            A353SecParentFunctionalityDescript = H002W2_A353SecParentFunctionalityDescript[0] ;
            e192W2 ();
   ...
   {
      AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid = AV8SecParentFunctionalityId ;
      AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey = AV39TFSecFunctionalityKey ;
      AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels = AV84TFSecFunctionalityKey_Sels ;
      AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription = AV43TFSecFunctionalityDescription ;
      AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels = AV86TFSecFunctionalityDescription_Sels ;
      AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels = AV78TFSecFunctionalityType_Sels ;
      AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription = AV50TFSecParentFunctionalityDescription ;
      AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels = AV88TFSecParentFunctionalityDescription_Sels ;
      ...
      lV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription = GXutil.concat( GXutil.rtrim( AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription), "%", "") ;
      /* Using cursor H002W3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid), lV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey, lV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription, lV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription});
   ...
   public void strup2W0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vAGEXPORTDATA"), AV91AGExportData);
         ...
         AV89GridAppliedFilters = httpContext.cgiGet( "vGRIDAPPLIEDFILTERS") ;
   ...
   public void e172W2( )
   {
      ...
      secfunctionalityfilterparentww_impl.this.GXt_int1 = GXv_int2[0] ;
      AV93CliCod = GXt_int1 ;
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, "GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      ...
      AV91AGExportData = new GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle) ;
      AV92AGExportDataItem = (web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(remoteHandle, context);
      AV92AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Title( httpContext.getMessage( "WWP_ExportCaption", "") );
      AV92AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Eventkey( "Export" );
      AV92AGExportDataItem.setgxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider( false );
      AV91AGExportData.add(AV92AGExportDataItem, 0);
      ...
      GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 = AV53DDO_TitleSettingsIcons;
      GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4[0] = GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3;
      new web.wwpbaseobjects.getwwptitlesettingsicons(remoteHandle, context).execute( GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4) ;
      GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 = GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4[0] ;
      AV53DDO_TitleSettingsIcons = GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3;
      ...
      {
         A63SecParentFunctionalityId = H002W4_A63SecParentFunctionalityId[0] ;
         n63SecParentFunctionalityId = H002W4_n63SecParentFunctionalityId[0] ;
         A353SecParentFunctionalityDescript = H002W4_A353SecParentFunctionalityDescript[0] ;
         A353SecParentFunctionalityDescript = H002W4_A353SecParentFunctionalityDescript[0] ;
         Form.setCaption( GXutil.format( httpContext.getMessage( "Functionalities of Functionality :: %1", ""), A353SecParentFunctionalityDescript, "", "", "", "", "", "", "", "") );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
   ...
   public void e182W2( )
   {
      ...
      secfunctionalityfilterparentww_impl.this.GXt_int1 = GXv_int2[0] ;
      AV93CliCod = GXt_int1 ;
      GXv_SdtWWPContext5[0] = AV76WWPContext;
      new web.wwpbaseobjects.loadwwpcontext(remoteHandle, context).execute( GXv_SdtWWPContext5) ;
      AV76WWPContext = GXv_SdtWWPContext5[0] ;
      ...
      edtSecFunctionalityKey_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV69ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+1)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      edtSecFunctionalityDescription_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV69ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+2)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      cmbSecFunctionalityType.setVisible( (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV69ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+3)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) );
      ...
      edtSecParentFunctionalityDescript_Visible = (((web.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV69ColumnsSelector.getgxTv_SdtWWPColumnsSelector_Columns().elementAt(-1+4)).getgxTv_SdtWWPColumnsSelector_Column_Isvisible() ? 1 : 0) ;
      ...
      GXt_char6 = AV89GridAppliedFilters ;
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV98Pgmname, GXv_char7) ;
      secfunctionalityfilterparentww_impl.this.GXt_char6 = GXv_char7[0] ;
      AV89GridAppliedFilters = GXt_char6 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV89GridAppliedFilters", AV89GridAppliedFilters);
      AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid = AV8SecParentFunctionalityId ;
      AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey = AV39TFSecFunctionalityKey ;
      AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels = AV84TFSecFunctionalityKey_Sels ;
      AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription = AV43TFSecFunctionalityDescription ;
   ...
   public void e142W2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
      {
         if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "SecFunctionalityKey") == 0 )
         {
            ...
            AV83TFSecFunctionalityKey_SelsJson = Ddo_grid_Selectedvalue_get ;
            httpContext.ajax_rsp_assign_attri("", false, "AV83TFSecFunctionalityKey_SelsJson", AV83TFSecFunctionalityKey_SelsJson);
            AV84TFSecFunctionalityKey_Sels.fromJSonString(AV83TFSecFunctionalityKey_SelsJson, null);
         }
         else if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "SecFunctionalityDescription") == 0 )
         {
            ...
            AV85TFSecFunctionalityDescription_SelsJson = Ddo_grid_Selectedvalue_get ;
            httpContext.ajax_rsp_assign_attri("", false, "AV85TFSecFunctionalityDescription_SelsJson", AV85TFSecFunctionalityDescription_SelsJson);
            AV86TFSecFunctionalityDescription_Sels.fromJSonString(AV85TFSecFunctionalityDescription_SelsJson, null);
         }
         ...
         else if ( GXutil.strcmp(Ddo_grid_Selectedcolumn, "SecParentFunctionalityDescription") == 0 )
         {
            ...
            AV87TFSecParentFunctionalityDescription_SelsJson = Ddo_grid_Selectedvalue_get ;
            httpContext.ajax_rsp_assign_attri("", false, "AV87TFSecParentFunctionalityDescription_SelsJson", AV87TFSecParentFunctionalityDescription_SelsJson);
            AV88TFSecParentFunctionalityDescription_Sels.fromJSonString(AV87TFSecParentFunctionalityDescription_SelsJson, null);
         }
         subgrid_firstpage( ) ;
      }
      /*  Sending Event outputs  */
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV84TFSecFunctionalityKey_Sels", AV84TFSecFunctionalityKey_Sels);
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV86TFSecFunctionalityDescription_Sels", AV86TFSecFunctionalityDescription_Sels);
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV78TFSecFunctionalityType_Sels", AV78TFSecFunctionalityType_Sels);
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV88TFSecParentFunctionalityDescription_Sels", AV88TFSecParentFunctionalityDescription_Sels);
   }
   ...
   private void e192W2( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, edtavDisplay_Internalname, AV29Display);
      edtavDisplay_Link = formatLink("web.wwpbaseobjects.secfunctionalityview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A62SecFunctionalityId,10,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"SecFunctionalityId","TabCode"})  ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(32) ;
      ...
      /*  Sending Event outputs  */
      cmbavGridactions.setValue( GXutil.trim( GXutil.str( AV90GridActions, 4, 0)) );
   }
   ...
   public void e152W2( )
   {
      ...
      new web.wwpbaseobjects.savecolumnsselectorstate(remoteHandle, context).execute( "WWPBaseObjects.SecFunctionalityFilterParentWWColumnsSelector", ((GXutil.strcmp("", AV57ColumnsSelectorXML)==0) ? "" : AV69ColumnsSelector.toxml(false, true, "WWPColumnsSelector", "PayDay"))) ;
   ...
   public void S162( )
   {
      ...
      returnInSub = false ;
      AV69ColumnsSelector = (web.wwpbaseobjects.SdtWWPColumnsSelector)new web.wwpbaseobjects.SdtWWPColumnsSelector(remoteHandle, context);
      ...
      secfunctionalityfilterparentww_impl.this.GXt_char6 = GXv_char7[0] ;
      AV64UserCustomValue = GXt_char6 ;
      if ( ! ( (GXutil.strcmp("", AV64UserCustomValue)==0) ) )
      {
         AV82ColumnsSelectorAux.fromxml(AV64UserCustomValue, null, null);
         GXv_SdtWWPColumnsSelector8[0] = AV82ColumnsSelectorAux;
         GXv_SdtWWPColumnsSelector9[0] = AV69ColumnsSelector;
         new web.wwpbaseobjects.wwp_columnselector_updatecolumns(remoteHandle, context).execute( GXv_SdtWWPColumnsSelector8, GXv_SdtWWPColumnsSelector9) ;
         AV82ColumnsSelectorAux = GXv_SdtWWPColumnsSelector8[0] ;
         AV69ColumnsSelector = GXv_SdtWWPColumnsSelector9[0] ;
      }
   }
   ...
   public void S142( )
   {
      ...
      returnInSub = false ;
      GXt_boolean10 = AV22IsAuthorized_Update ;
      GXv_boolean11[0] = GXt_boolean10 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWFunctionality", GXv_boolean11) ;
      secfunctionalityfilterparentww_impl.this.GXt_boolean10 = GXv_boolean11[0] ;
      AV22IsAuthorized_Update = GXt_boolean10 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV22IsAuthorized_Update", AV22IsAuthorized_Update);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_UPDATE", getSecureSignedToken( "", AV22IsAuthorized_Update));
      GXt_boolean10 = AV23IsAuthorized_Delete ;
      GXv_boolean11[0] = GXt_boolean10 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWFunctionality", GXv_boolean11) ;
      secfunctionalityfilterparentww_impl.this.GXt_boolean10 = GXv_boolean11[0] ;
      AV23IsAuthorized_Delete = GXt_boolean10 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV23IsAuthorized_Delete", AV23IsAuthorized_Delete);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( "", AV23IsAuthorized_Delete));
      GXt_boolean10 = AV20TempBoolean ;
      GXv_boolean11[0] = GXt_boolean10 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWFunctionality", GXv_boolean11) ;
      secfunctionalityfilterparentww_impl.this.GXt_boolean10 = GXv_boolean11[0] ;
      AV20TempBoolean = GXt_boolean10 ;
      if ( ! ( AV20TempBoolean ) )
      {
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV17Session.getValue(AV98Pgmname+"GridState"), "") == 0 )
      {
         AV24GridState.fromxml(new web.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV98Pgmname+"GridState"), null, null);
      }
      else
      {
         AV24GridState.fromxml(AV17Session.getValue(AV98Pgmname+"GridState"), null, null);
      }
      ...
      if (returnInSub) return;
      AV107GXV1 = 1 ;
      while ( AV107GXV1 <= AV24GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV25GridStateFilterValue = (web.wwpbaseobjects.SdtWWPGridState_FilterValue)((web.wwpbaseobjects.SdtWWPGridState_FilterValue)AV24GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV107GXV1));
         if ( GXutil.strcmp(AV25GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Name(), "TFSECFUNCTIONALITYKEY") == 0 )
         {
         ...
         {
            AV83TFSecFunctionalityKey_SelsJson = AV25GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV83TFSecFunctionalityKey_SelsJson", AV83TFSecFunctionalityKey_SelsJson);
            AV84TFSecFunctionalityKey_Sels.fromJSonString(AV83TFSecFunctionalityKey_SelsJson, null);
         }
         ...
         {
            AV85TFSecFunctionalityDescription_SelsJson = AV25GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV85TFSecFunctionalityDescription_SelsJson", AV85TFSecFunctionalityDescription_SelsJson);
            AV86TFSecFunctionalityDescription_Sels.fromJSonString(AV85TFSecFunctionalityDescription_SelsJson, null);
         }
         ...
         {
            AV87TFSecParentFunctionalityDescription_SelsJson = AV25GridStateFilterValue.getgxTv_SdtWWPGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV87TFSecParentFunctionalityDescription_SelsJson", AV87TFSecParentFunctionalityDescription_SelsJson);
            AV88TFSecParentFunctionalityDescription_Sels.fromJSonString(AV87TFSecParentFunctionalityDescription_SelsJson, null);
         }
      ...
      GXt_char6 = "" ;
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (AV84TFSecFunctionalityKey_Sels.size()==0), AV83TFSecFunctionalityKey_SelsJson, GXv_char7) ;
      secfunctionalityfilterparentww_impl.this.GXt_char6 = GXv_char7[0] ;
      GXt_char12 = "" ;
      GXv_char13[0] = GXt_char12 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (AV86TFSecFunctionalityDescription_Sels.size()==0), AV85TFSecFunctionalityDescription_SelsJson, GXv_char13) ;
      secfunctionalityfilterparentww_impl.this.GXt_char12 = GXv_char13[0] ;
      GXt_char14 = "" ;
      GXv_char15[0] = GXt_char14 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (AV88TFSecParentFunctionalityDescription_Sels.size()==0), AV87TFSecParentFunctionalityDescription_SelsJson, GXv_char15) ;
      secfunctionalityfilterparentww_impl.this.GXt_char14 = GXv_char15[0] ;
      Ddo_grid_Selectedvalue_set = GXt_char6+"|"+GXt_char12+"|"+((AV78TFSecFunctionalityType_Sels.size()==0) ? "" : AV77TFSecFunctionalityType_SelsJson)+"|"+GXt_char14 ;
      ucDdo_grid.sendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
      GXt_char14 = "" ;
      GXv_char15[0] = GXt_char14 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (GXutil.strcmp("", AV39TFSecFunctionalityKey)==0), AV39TFSecFunctionalityKey, GXv_char15) ;
      secfunctionalityfilterparentww_impl.this.GXt_char14 = GXv_char15[0] ;
      GXt_char12 = "" ;
      GXv_char13[0] = GXt_char12 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (GXutil.strcmp("", AV43TFSecFunctionalityDescription)==0), AV43TFSecFunctionalityDescription, GXv_char13) ;
      secfunctionalityfilterparentww_impl.this.GXt_char12 = GXv_char13[0] ;
      GXt_char6 = "" ;
      GXv_char7[0] = GXt_char6 ;
      new web.wwpbaseobjects.wwp_getfilterval(remoteHandle, context).execute( (GXutil.strcmp("", AV50TFSecParentFunctionalityDescription)==0), AV50TFSecParentFunctionalityDescription, GXv_char7) ;
      secfunctionalityfilterparentww_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S152( )
   {
      ...
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState16, "TFSECFUNCTIONALITYKEY", httpContext.getMessage( "Key", ""), !(GXutil.strcmp("", AV39TFSecFunctionalityKey)==0), (short)(0), AV39TFSecFunctionalityKey, "", !(AV84TFSecFunctionalityKey_Sels.size()==0), AV84TFSecFunctionalityKey_Sels.toJSonString(false), "") ;
      AV24GridState = GXv_SdtWWPGridState16[0] ;
      GXv_SdtWWPGridState16[0] = AV24GridState;
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState16, "TFSECFUNCTIONALITYDESCRIPTION", httpContext.getMessage( "Description", ""), !(GXutil.strcmp("", AV43TFSecFunctionalityDescription)==0), (short)(0), AV43TFSecFunctionalityDescription, "", !(AV86TFSecFunctionalityDescription_Sels.size()==0), AV86TFSecFunctionalityDescription_Sels.toJSonString(false), "") ;
      AV24GridState = GXv_SdtWWPGridState16[0] ;
      GXv_SdtWWPGridState16[0] = AV24GridState;
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState16, "TFSECFUNCTIONALITYTYPE_SEL", httpContext.getMessage( "Type", ""), !(AV78TFSecFunctionalityType_Sels.size()==0), (short)(0), AV78TFSecFunctionalityType_Sels.toJSonString(false), "") ;
      AV24GridState = GXv_SdtWWPGridState16[0] ;
      GXv_SdtWWPGridState16[0] = AV24GridState;
      new web.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(remoteHandle, context).execute( GXv_SdtWWPGridState16, "TFSECPARENTFUNCTIONALITYDESCRIPTION", httpContext.getMessage( "Parent Functionality", ""), !(GXutil.strcmp("", AV50TFSecParentFunctionalityDescription)==0), (short)(0), AV50TFSecParentFunctionalityDescription, "", !(AV88TFSecParentFunctionalityDescription_Sels.size()==0), AV88TFSecParentFunctionalityDescription_Sels.toJSonString(false), "") ;
      AV24GridState = GXv_SdtWWPGridState16[0] ;
      if ( ! (0==AV8SecParentFunctionalityId) )
      {
         AV25GridStateFilterValue = (web.wwpbaseobjects.SdtWWPGridState_FilterValue)new web.wwpbaseobjects.SdtWWPGridState_FilterValue(remoteHandle, context);
      ...
      new web.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV98Pgmname+"GridState", AV24GridState.toxml(false, true, "WWPGridState", "PayDay")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV98Pgmname );
      ...
      AV17Session.setValue("TrnContext", AV10TrnContext.toxml(false, true, "WWPTransactionContext", "PayDay"));
   }
   ...
   public void S192( )
   {
      /* 'DOEXPORT' Routine */
      returnInSub = false ;
      GXv_char15[0] = AV30ExcelFilename ;
      GXv_char13[0] = AV31ErrorMessage ;
      new web.wwpbaseobjects.secfunctionalityfilterparentwwexport(remoteHandle, context).execute( GXv_char15, GXv_char13) ;
      secfunctionalityfilterparentww_impl.this.AV30ExcelFilename = GXv_char15[0] ;
      secfunctionalityfilterparentww_impl.this.AV31ErrorMessage = GXv_char13[0] ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020405388", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/secfunctionalityfilterparentww.js", "?2024122020405388", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void sendrow_322( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_32_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         if ( ( cmbavGridactions.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            ...
            {
               AV90GridActions = (short)(GXutil.lval( cmbavGridactions.getValidValue(GXutil.trim( GXutil.str( AV90GridActions, 4, 0))))) ;
               httpContext.ajax_rsp_assign_attri("", false, cmbavGridactions.getInternalname(), GXutil.ltrimstr( DecimalUtil.doubleToDec(AV90GridActions), 4, 0));
            }
         }
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbavGridactions,cmbavGridactions.getInternalname(),GXutil.trim( GXutil.str( AV90GridActions, 4, 0)),Integer.valueOf(1),cmbavGridactions.getJsonclick(),Integer.valueOf(7),"'"+""+"'"+",false,"+"'"+"e202w2_client"+"'","int","",Integer.valueOf(-1),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","",cmbavGridactions.getThemeClass(),"WWActionGroupColumn","",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((cmbavGridactions.getEnabled()!=0)&&(cmbavGridactions.getVisible()!=0) ? " onblur=\""+""+";gx.evt.onblur(this,33);\"" : " "),"",Boolean.valueOf(true),Integer.valueOf(0)});
         cmbavGridactions.setValue( GXutil.trim( GXutil.str( AV90GridActions, 4, 0)) );
         ...
         /* Single line edit */
         TempTags = " " + ((edtavDisplay_Enabled!=0)&&(edtavDisplay_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 34,'',false,'"+sGXsfl_32_idx+"',32)\"" : " ") ;
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavDisplay_Internalname,GXutil.rtrim( AV29Display),"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavDisplay_Enabled!=0)&&(edtavDisplay_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,34);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'",edtavDisplay_Link,"",httpContext.getMessage( "GXM_display", ""),"",edtavDisplay_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWIconActionColumn","",Integer.valueOf(-1),Integer.valueOf(edtavDisplay_Enabled),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(1),Integer.valueOf(32),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void startgridcontrol32( )
   {
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( AV90GridActions, (byte)(4), (byte)(0), ".", "")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV98Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8SecParentFunctionalityId',fld:'vSECPARENTFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV39TFSecFunctionalityKey',fld:'vTFSECFUNCTIONALITYKEY',pic:''},{av:'AV84TFSecFunctionalityKey_Sels',fld:'vTFSECFUNCTIONALITYKEY_SELS',pic:''},{av:'AV43TFSecFunctionalityDescription',fld:'vTFSECFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV86TFSecFunctionalityDescription_Sels',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV78TFSecFunctionalityType_Sels',fld:'vTFSECFUNCTIONALITYTYPE_SELS',pic:''},{av:'AV50TFSecParentFunctionalityDescription',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV88TFSecParentFunctionalityDescription_Sels',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV26OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV27OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtSecFunctionalityKey_Visible',ctrl:'SECFUNCTIONALITYKEY',prop:'Visible'},{av:'edtSecFunctionalityDescription_Visible',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Visible'},{av:'cmbSecFunctionalityType'},{av:'edtSecParentFunctionalityDescript_Visible',ctrl:'SECPARENTFUNCTIONALITYDESCRIPT',prop:'Visible'},{av:'AV80GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV81GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV89GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e112W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV98Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8SecParentFunctionalityId',fld:'vSECPARENTFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV39TFSecFunctionalityKey',fld:'vTFSECFUNCTIONALITYKEY',pic:''},{av:'AV84TFSecFunctionalityKey_Sels',fld:'vTFSECFUNCTIONALITYKEY_SELS',pic:''},{av:'AV43TFSecFunctionalityDescription',fld:'vTFSECFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV86TFSecFunctionalityDescription_Sels',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV78TFSecFunctionalityType_Sels',fld:'vTFSECFUNCTIONALITYTYPE_SELS',pic:''},{av:'AV50TFSecParentFunctionalityDescription',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV88TFSecParentFunctionalityDescription_Sels',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV26OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV27OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e122W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV98Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8SecParentFunctionalityId',fld:'vSECPARENTFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV39TFSecFunctionalityKey',fld:'vTFSECFUNCTIONALITYKEY',pic:''},{av:'AV84TFSecFunctionalityKey_Sels',fld:'vTFSECFUNCTIONALITYKEY_SELS',pic:''},{av:'AV43TFSecFunctionalityDescription',fld:'vTFSECFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV86TFSecFunctionalityDescription_Sels',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV78TFSecFunctionalityType_Sels',fld:'vTFSECFUNCTIONALITYTYPE_SELS',pic:''},{av:'AV50TFSecParentFunctionalityDescription',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV88TFSecParentFunctionalityDescription_Sels',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV26OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV27OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e142W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV98Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8SecParentFunctionalityId',fld:'vSECPARENTFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV39TFSecFunctionalityKey',fld:'vTFSECFUNCTIONALITYKEY',pic:''},{av:'AV84TFSecFunctionalityKey_Sels',fld:'vTFSECFUNCTIONALITYKEY_SELS',pic:''},{av:'AV43TFSecFunctionalityDescription',fld:'vTFSECFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV86TFSecFunctionalityDescription_Sels',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV78TFSecFunctionalityType_Sels',fld:'vTFSECFUNCTIONALITYTYPE_SELS',pic:''},{av:'AV50TFSecParentFunctionalityDescription',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV88TFSecParentFunctionalityDescription_Sels',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV26OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV27OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'}]");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV26OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV27OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV39TFSecFunctionalityKey',fld:'vTFSECFUNCTIONALITYKEY',pic:''},{av:'AV83TFSecFunctionalityKey_SelsJson',fld:'vTFSECFUNCTIONALITYKEY_SELSJSON',pic:''},{av:'AV84TFSecFunctionalityKey_Sels',fld:'vTFSECFUNCTIONALITYKEY_SELS',pic:''},{av:'AV43TFSecFunctionalityDescription',fld:'vTFSECFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV85TFSecFunctionalityDescription_SelsJson',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELSJSON',pic:''},{av:'AV86TFSecFunctionalityDescription_Sels',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV77TFSecFunctionalityType_SelsJson',fld:'vTFSECFUNCTIONALITYTYPE_SELSJSON',pic:''},{av:'AV78TFSecFunctionalityType_Sels',fld:'vTFSECFUNCTIONALITYTYPE_SELS',pic:''},{av:'AV50TFSecParentFunctionalityDescription',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV87TFSecParentFunctionalityDescription_SelsJson',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELSJSON',pic:''},{av:'AV88TFSecParentFunctionalityDescription_Sels',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e192W2',iparms:[{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A62SecFunctionalityId',fld:'SECFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'cmbavGridactions'},{av:'AV90GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'AV29Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'}]}");
      setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'e152W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV98Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8SecParentFunctionalityId',fld:'vSECPARENTFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV39TFSecFunctionalityKey',fld:'vTFSECFUNCTIONALITYKEY',pic:''},{av:'AV84TFSecFunctionalityKey_Sels',fld:'vTFSECFUNCTIONALITYKEY_SELS',pic:''},{av:'AV43TFSecFunctionalityDescription',fld:'vTFSECFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV86TFSecFunctionalityDescription_Sels',fld:'vTFSECFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV78TFSecFunctionalityType_Sels',fld:'vTFSECFUNCTIONALITYTYPE_SELS',pic:''},{av:'AV50TFSecParentFunctionalityDescription',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION',pic:''},{av:'AV88TFSecParentFunctionalityDescription_Sels',fld:'vTFSECPARENTFUNCTIONALITYDESCRIPTION_SELS',pic:''},{av:'AV26OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV27OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
      setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV69ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtSecFunctionalityKey_Visible',ctrl:'SECFUNCTIONALITYKEY',prop:'Visible'},{av:'edtSecFunctionalityDescription_Visible',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Visible'},{av:'cmbSecFunctionalityType'},{av:'edtSecParentFunctionalityDescript_Visible',ctrl:'SECPARENTFUNCTIONALITYDESCRIPT',prop:'Visible'},{av:'AV80GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV81GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV89GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV22IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV23IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'}]}");
      setEventMetadata("VGRIDACTIONS.CLICK","{handler:'e202W2',iparms:[{av:'cmbavGridactions'},{av:'AV90GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'A62SecFunctionalityId',fld:'SECFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("VGRIDACTIONS.CLICK",",oparms:[{av:'cmbavGridactions'},{av:'AV90GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e162W2',iparms:[{av:'A62SecFunctionalityId',fld:'SECFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'e132W2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'}]");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV69ColumnsSelector = new web.wwpbaseobjects.SdtWWPColumnsSelector(remoteHandle, context);
      AV98Pgmname = "" ;
      AV39TFSecFunctionalityKey = "" ;
      AV84TFSecFunctionalityKey_Sels = new GXSimpleCollection<String>(String.class, "internal", "");
      AV43TFSecFunctionalityDescription = "" ;
      AV86TFSecFunctionalityDescription_Sels = new GXSimpleCollection<String>(String.class, "internal", "");
      AV78TFSecFunctionalityType_Sels = new GXSimpleCollection<Byte>(Byte.class, "internal", "");
      AV50TFSecParentFunctionalityDescription = "" ;
      AV88TFSecParentFunctionalityDescription_Sels = new GXSimpleCollection<String>(String.class, "internal", "");
      Form = new com.genexus.webpanels.GXWebForm();
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      GXKey = "" ;
      AV89GridAppliedFilters = "" ;
      AV91AGExportData = new GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle);
      AV53DDO_TitleSettingsIcons = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      ...
      A350SecFunctionalityDescription = "" ;
      A353SecParentFunctionalityDescript = "" ;
      AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels = new GXSimpleCollection<String>(String.class, "internal", "");
      AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels = new GXSimpleCollection<String>(String.class, "internal", "");
      AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels = new GXSimpleCollection<Byte>(Byte.class, "internal", "");
      AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels = new GXSimpleCollection<String>(String.class, "internal", "");
      scmdbuf = "" ;
      lV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey = "" ;
      lV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription = "" ;
      lV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription = "" ;
      ...
      AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription = "" ;
      AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription = "" ;
      H002W2_A349SecFunctionalityActive = new boolean[] {false} ;
      H002W2_A353SecParentFunctionalityDescript = new String[] {""} ;
      H002W2_A63SecParentFunctionalityId = new long[1] ;
      H002W2_n63SecParentFunctionalityId = new boolean[] {false} ;
      H002W2_A351SecFunctionalityType = new byte[1] ;
      H002W2_A350SecFunctionalityDescription = new String[] {""} ;
      H002W2_A64SecFunctionalityKey = new String[] {""} ;
      H002W2_A62SecFunctionalityId = new long[1] ;
      H002W3_AGRID_nRecordCount = new long[1] ;
      AV92AGExportDataItem = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(remoteHandle, context);
      GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4 = new web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons[1] ;
      H002W4_A62SecFunctionalityId = new long[1] ;
      H002W4_A63SecParentFunctionalityId = new long[1] ;
      H002W4_n63SecParentFunctionalityId = new boolean[] {false} ;
      H002W4_A353SecParentFunctionalityDescript = new String[] {""} ;
      GXv_int2 = new int[1] ;
      AV76WWPContext = new web.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext5 = new web.wwpbaseobjects.SdtWWPContext[1] ;
      AV17Session = httpContext.getWebSession();
      AV57ColumnsSelectorXML = "" ;
      AV83TFSecFunctionalityKey_SelsJson = "" ;
      AV85TFSecFunctionalityDescription_SelsJson = "" ;
      AV77TFSecFunctionalityType_SelsJson = "" ;
      AV87TFSecParentFunctionalityDescription_SelsJson = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.wwpbaseobjects.secfunctionalityfilterparentww__default(),
         new Object[] {
             new Object[] {
            H002W2_A349SecFunctionalityActive, H002W2_A353SecParentFunctionalityDescript, H002W2_A63SecParentFunctionalityId, H002W2_n63SecParentFunctionalityId, H002W2_A351SecFunctionalityType, H002W2_A350SecFunctionalityDescription, H002W2_A64SecFunctionalityKey, H002W2_A62SecFunctionalityId
            }
            , new Object[] {
            H002W3_AGRID_nRecordCount
            }
            , new Object[] {
            H002W4_A62SecFunctionalityId, H002W4_A63SecParentFunctionalityId, H002W4_n63SecParentFunctionalityId, H002W4_A353SecParentFunctionalityDescript
            }
         }
      );
      AV98Pgmname = "WWPBaseObjects.SecFunctionalityFilterParentWW" ;
   ...
   private int AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels_size ;
   private int AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels_size ;
   private int AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels_size ;
   private int AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels_size ;
   ...
   private long AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid ;
   ...
   private String AV83TFSecFunctionalityKey_SelsJson ;
   private String AV85TFSecFunctionalityDescription_SelsJson ;
   private String AV77TFSecFunctionalityType_SelsJson ;
   private String AV87TFSecParentFunctionalityDescription_SelsJson ;
   ...
   private String AV89GridAppliedFilters ;
   ...
   private String lV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey ;
   private String lV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription ;
   private String lV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription ;
   private String AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey ;
   private String AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription ;
   private String AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription ;
   private String AV30ExcelFilename ;
   private String AV31ErrorMessage ;
   private GXSimpleCollection<Byte> AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels ;
   ...
   private GXSimpleCollection<String> AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels ;
   private GXSimpleCollection<String> AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels ;
   private GXSimpleCollection<String> AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels ;
   private HTMLChoice cmbavGridactions ;
   private HTMLChoice cmbSecFunctionalityType ;
   private ICheckbox chkSecFunctionalityActive ;
   private IDataStoreProvider pr_default ;
   private boolean[] H002W2_A349SecFunctionalityActive ;
   private String[] H002W2_A353SecParentFunctionalityDescript ;
   private long[] H002W2_A63SecParentFunctionalityId ;
   private boolean[] H002W2_n63SecParentFunctionalityId ;
   private byte[] H002W2_A351SecFunctionalityType ;
   private String[] H002W2_A350SecFunctionalityDescription ;
   private String[] H002W2_A64SecFunctionalityKey ;
   private long[] H002W2_A62SecFunctionalityId ;
   private long[] H002W3_AGRID_nRecordCount ;
   private long[] H002W4_A62SecFunctionalityId ;
   private long[] H002W4_A63SecParentFunctionalityId ;
   private boolean[] H002W4_n63SecParentFunctionalityId ;
   private String[] H002W4_A353SecParentFunctionalityDescript ;
   private com.genexus.webpanels.GXWebForm Form ;
   private GXSimpleCollection<String> AV84TFSecFunctionalityKey_Sels ;
   private GXSimpleCollection<String> AV86TFSecFunctionalityDescription_Sels ;
   private GXSimpleCollection<String> AV88TFSecParentFunctionalityDescription_Sels ;
   private GXBaseCollection<web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV91AGExportData ;
   private web.wwpbaseobjects.SdtWWPContext AV76WWPContext ;
   ...
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item AV92AGExportDataItem ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV53DDO_TitleSettingsIcons ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 ;
   private web.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXv_SdtDVB_SDTDropDownOptionsTitleSettingsIcons4[] ;
   private web.wwpbaseobjects.SdtWWPColumnsSelector AV69ColumnsSelector ;
...
{
   protected Object[] conditional_H002W2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String A64SecFunctionalityKey ,
                                          GXSimpleCollection<String> AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels ,
                                          String A350SecFunctionalityDescription ,
                                          GXSimpleCollection<String> AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels ,
                                          byte A351SecFunctionalityType ,
                                          GXSimpleCollection<Byte> AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels ,
                                          String A353SecParentFunctionalityDescript ,
                                          GXSimpleCollection<String> AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels ,
                                          int AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels_size ,
                                          String AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey ,
                                          int AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels_size ,
                                          String AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription ,
                                          int AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels_size ,
                                          int AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels_size ,
                                          String AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription ,
                                          short AV26OrderedBy ,
                                          boolean AV27OrderedDsc ,
                                          long A63SecParentFunctionalityId ,
                                          long AV99Wwpbaseobjects_secfunctionalityfilterparentwwds_1_secparentfunctionalityid )
   {
      ...
      if ( ( AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels_size == 0 ) && ( ! (GXutil.strcmp("", AV100Wwpbaseobjects_secfunctionalityfilterparentwwds_2_tfsecfunctionalitykey)==0) ) )
      {
      ...
      if ( AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels_size > 0 )
      {
         addWhere(sWhereString, "("+GXutil.toValueList("postgresql", AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels, "T1.SecFunctionalityKey IN (", ")")+")");
      }
      if ( ( AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels_size == 0 ) && ( ! (GXutil.strcmp("", AV102Wwpbaseobjects_secfunctionalityfilterparentwwds_4_tfsecfunctionalitydescription)==0) ) )
      {
      ...
      if ( AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels_size > 0 )
      {
         addWhere(sWhereString, "("+GXutil.toValueList("postgresql", AV103Wwpbaseobjects_secfunctionalityfilterparentwwds_5_tfsecfunctionalitydescription_sels, "T1.SecFunctionalityDescription IN (", ")")+")");
      }
      if ( AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels_size > 0 )
      {
         addWhere(sWhereString, "("+GXutil.toValueList("postgresql", AV104Wwpbaseobjects_secfunctionalityfilterparentwwds_6_tfsecfunctionalitytype_sels, "T1.SecFunctionalityType IN (", ")")+")");
      }
      if ( ( AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels_size == 0 ) && ( ! (GXutil.strcmp("", AV105Wwpbaseobjects_secfunctionalityfilterparentwwds_7_tfsecparentfunctionalitydescription)==0) ) )
      {
      ...
      if ( AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels_size > 0 )
      {
         addWhere(sWhereString, "("+GXutil.toValueList("postgresql", AV106Wwpbaseobjects_secfunctionalityfilterparentwwds_8_tfsecparentfunctionalitydescription_sels, "T2.SecFunctionalityDescription IN (", ")")+")");
      }
   ...
   protected Object[] conditional_H002W3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String A64SecFunctionalityKey ,
                                          GXSimpleCollection<String> AV101Wwpbaseobjects_secfunctionalityfilterparentwwds_3_tfsecfunctionalitykey_sels ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002W2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (GXSimpleCollection<String>)dynConstraints[1] , (String)dynConstraints[2] , (GXSimpleCollection<String>)dynConstraints[3] , ((Number) dynConstraints[4]).byteValue() , (GXSimpleCollection<Byte>)dynConstraints[5] , (String)dynConstraints[6] , (GXSimpleCollection<String>)dynConstraints[7] , ((Number) dynConstraints[8]).intValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).intValue() , (String)dynConstraints[11] , ((Number) dynConstraints[12]).intValue() , ((Number) dynConstraints[13]).intValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).shortValue() , ((Boolean) dynConstraints[16]).booleanValue() , ((Number) dynConstraints[17]).longValue() , ((Number) dynConstraints[18]).longValue() );
            case 1 :
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H002W2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H002W3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H002W4", "SELECT T1.SecFunctionalityId, T1.SecParentFunctionalityId AS SecParentFunctionalityId, T2.SecFunctionalityDescription AS SecParentFunctionalityDescript FROM (SecFunctionality T1 LEFT JOIN SecFunctionality T2 ON T2.SecFunctionalityId = T1.SecParentFunctionalityId) WHERE T1.SecParentFunctionalityId = ? ORDER BY T1.SecParentFunctionalityId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
      };
   }
