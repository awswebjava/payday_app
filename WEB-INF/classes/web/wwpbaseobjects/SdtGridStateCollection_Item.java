...
public final  class SdtGridStateCollection_Item extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtGridStateCollection_Item Clone( )
   {
      return (web.wwpbaseobjects.SdtGridStateCollection_Item)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtGridStateCollection_Item struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtGridStateCollection_Item getStruct( )
   {
      web.wwpbaseobjects.StructSdtGridStateCollection_Item struct = new web.wwpbaseobjects.StructSdtGridStateCollection_Item ();
