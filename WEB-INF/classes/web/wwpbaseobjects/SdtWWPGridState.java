...
public final  class SdtWWPGridState extends GxUserType
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "FilterValues") )
            {
               ...
               {
                  gxTv_SdtWWPGridState_Filtervalues = new GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue>(web.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "PayDay", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "DynamicFilters") )
            {
               ...
               {
                  gxTv_SdtWWPGridState_Dynamicfilters = new GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(web.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "PayDay", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue> getgxTv_SdtWWPGridState_Filtervalues( )
   {
      if ( gxTv_SdtWWPGridState_Filtervalues == null )
      {
         gxTv_SdtWWPGridState_Filtervalues = new GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue>(web.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "PayDay", remoteHandle);
   ...
   public void setgxTv_SdtWWPGridState_Filtervalues( GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue> value )
   {
      gxTv_SdtWWPGridState_Filtervalues_N = (byte)(0) ;
      gxTv_SdtWWPGridState_N = (byte)(0) ;
   ...
   public GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter> getgxTv_SdtWWPGridState_Dynamicfilters( )
   {
      if ( gxTv_SdtWWPGridState_Dynamicfilters == null )
      {
         gxTv_SdtWWPGridState_Dynamicfilters = new GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(web.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "PayDay", remoteHandle);
   ...
   public void setgxTv_SdtWWPGridState_Dynamicfilters( GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter> value )
   {
      gxTv_SdtWWPGridState_Dynamicfilters_N = (byte)(0) ;
      gxTv_SdtWWPGridState_N = (byte)(0) ;
   ...
   public web.wwpbaseobjects.SdtWWPGridState Clone( )
   {
      return (web.wwpbaseobjects.SdtWWPGridState)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWWPGridState struct )
   {
      ...
      GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux = new GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue>(web.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "PayDay", remoteHandle);
      Vector<web.wwpbaseobjects.StructSdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux1 = struct.getFiltervalues();
      if (gxTv_SdtWWPGridState_Filtervalues_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPGridState_Filtervalues_aux1.size(); i++)
         {
            gxTv_SdtWWPGridState_Filtervalues_aux.add(new web.wwpbaseobjects.SdtWWPGridState_FilterValue(gxTv_SdtWWPGridState_Filtervalues_aux1.elementAt(i)));
         }
      }
      setgxTv_SdtWWPGridState_Filtervalues(gxTv_SdtWWPGridState_Filtervalues_aux);
      GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux = new GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(web.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "PayDay", remoteHandle);
      Vector<web.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux1 = struct.getDynamicfilters();
      if (gxTv_SdtWWPGridState_Dynamicfilters_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPGridState_Dynamicfilters_aux1.size(); i++)
         {
            gxTv_SdtWWPGridState_Dynamicfilters_aux.add(new web.wwpbaseobjects.SdtWWPGridState_DynamicFilter(gxTv_SdtWWPGridState_Dynamicfilters_aux1.elementAt(i)));
         }
      }
   ...
   public web.wwpbaseobjects.StructSdtWWPGridState getStruct( )
   {
      web.wwpbaseobjects.StructSdtWWPGridState struct = new web.wwpbaseobjects.StructSdtWWPGridState ();
   ...
   protected GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux ;
   protected GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux ;
   protected GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues=null ;
   protected GXBaseCollection<web.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters=null ;
}
