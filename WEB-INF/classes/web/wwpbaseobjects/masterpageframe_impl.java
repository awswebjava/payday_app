...
public final  class masterpageframe_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm0O2( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202412202030434", false, true);
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "WWPBaseObjects.MasterPageFrame" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void e110O2( )
   {
      ...
      masterpageframe_impl.this.GXt_int1 = GXv_int2[0] ;
      AV11CliCod = GXt_int1 ;
      GXt_boolean3 = AV9IsAuthorized ;
      ...
      masterpageframe_impl.this.GXt_boolean3 = GXv_boolean4[0] ;
      AV9IsAuthorized = GXt_boolean3 ;
      if ( ! AV9IsAuthorized )
      {
      ...
      {
         GXt_SdtWWP_DesignSystemSettings5 = AV5WWP_DesignSystemSettings;
         ...
         AV5WWP_DesignSystemSettings = GXt_SdtWWP_DesignSystemSettings5;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202412202030476", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202412202030476", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
