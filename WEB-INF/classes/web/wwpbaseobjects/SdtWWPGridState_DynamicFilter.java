...
public final  class SdtWWPGridState_DynamicFilter extends GxUserType
{
   ...
   public web.wwpbaseobjects.SdtWWPGridState_DynamicFilter Clone( )
   {
      return (web.wwpbaseobjects.SdtWWPGridState_DynamicFilter)(clone()) ;
   }

   public void setStruct( web.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter struct )
   {
   ...
   public web.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter getStruct( )
   {
      web.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter struct = new web.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter ();
