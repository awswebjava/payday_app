...
public final  class managefilters_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14UserKey, ""))));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vUSERKEY", AV14UserKey);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14UserKey, ""))));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage, (byte)(15), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nEOF", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nEOF, (byte)(1), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_Rows", GXutil.ltrim( localUtil.ntoc( subGridgridstatecollections_Rows, (byte)(6), (byte)(0), ".", "")));
      web.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_EMPOWERER_Gridinternalname", GXutil.rtrim( Gridgridstatecollections_empowerer_Gridinternalname));
   }
   ...
   {
      return formatLink("web.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim(AV14UserKey))}, new String[] {"UserKey"})  ;
   }
   ...
   public void wb390( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 PopupContentCell", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, divTablecontent_Internalname, 1, 0, "px", 0, "px", "TableContent", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 EditableGridCell_LinedAtts HasGridEmpowerer", "left", "top", "", "", "div");
         /*  Grid Control  */
      ...
      if ( wbEnd == 15 )
      {
         ...
         else
         {
            ...
            {
               web.GxWebStd.gx_hidden_field( httpContext, "GridgridstatecollectionsContainerData", GridgridstatecollectionsContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               web.GxWebStd.gx_hidden_field( httpContext, "GridgridstatecollectionsContainerData"+"V", GridgridstatecollectionsContainer.GridValuesHidden());
            }
            else
            {
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, divHtml_usertable_utpaneldummy_Internalname, 1, 0, "px", 0, "px", "Section", "left", "top", "", "", "div");
         wb_table1_31_392( true) ;
      }
      else
      {
         wb_table1_31_392( false) ;
      }
      return  ;
   }

   public void wb_table1_31_392e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_checkbox_ctrl( httpContext, chkavCollectionisempty.getInternalname(), GXutil.booltostr( AV5CollectionIsEmpty), "", "", chkavCollectionisempty.getVisible(), 1, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(39, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,39);\"");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 29), "GRIDGRIDSTATECOLLECTIONS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "VUDELETE.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "VUDELETE.CLICK") == 0 ) )
                        {
                           ...
                           {
                              AV6GridStateCollection.currentItem( ((web.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)) );
   ...
   public short subgridgridstatecollections_firstpage( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage, (byte)(15), (byte)(0), ".", "")));
      if ( isFullAjaxMode( ) )
      {
         gxgrgridgridstatecollections_refresh( subGridgridstatecollections_Rows, AV14UserKey, AV5CollectionIsEmpty) ;
      }
   ...
   public void e12392( )
   {
      ...
      {
         AV6GridStateCollection.fromxml(new web.wwpbaseobjects.loadmanagefiltersstate(remoteHandle, context).executeUdp( AV14UserKey), null, null);
         gx_BV15 = true ;
      }
   }
   ...
   private void e13392( )
   {
      ...
      while ( AV19GXV1 <= AV6GridStateCollection.size() )
      {
         ...
         if ( ( subGridgridstatecollections_Islastpage == 1 ) || ( subGridgridstatecollections_Rows == 0 ) || ( ( GRIDGRIDSTATECOLLECTIONS_nCurrentRecord >= GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage ) && ( GRIDGRIDSTATECOLLECTIONS_nCurrentRecord < GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage + subgridgridstatecollections_fnc_recordsperpage( ) ) ) )
         {
            ...
            web.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nEOF", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nEOF, (byte)(1), (byte)(0), ".", "")));
   ...
   public void e11392( )
   {
      ...
      {
         AV7GridStateCollectionItem = (web.wwpbaseobjects.SdtGridStateCollection_Item)((web.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV22GXV4));
      ...
      if ( AV10IsOK )
      {
         ...
         {
            AV6GridStateCollection = new GXBaseCollection<web.wwpbaseobjects.SdtGridStateCollection_Item>(web.wwpbaseobjects.SdtGridStateCollection_Item.class, "Item", "", remoteHandle) ;
            gx_BV15 = true ;
         }
         new web.wwpbaseobjects.savemanagefiltersstate(remoteHandle, context).execute( AV14UserKey, AV6GridStateCollection.toxml(false, true, "Items", "")) ;
         if ( GXutil.strcmp(GXutil.lower( AV14UserKey), "appbookmarks") == 0 )
         {
         }
   ...
   public void e15392( )
   {
      ...
      returnInSub = false ;
      AV9i = (short)(AV6GridStateCollection.indexof(((web.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.currentItem()))) ;
      if ( AV9i > 1 )
      {
         AV7GridStateCollectionItem = (web.wwpbaseobjects.SdtGridStateCollection_Item)((web.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV9i));
   ...
   public void wb_table1_31_392( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         web.GxWebStd.gx_table_start( httpContext, tblUtpaneldummy_Internalname, tblUtpaneldummy_Internalname, "", "Invisible", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_31_392e( true) ;
      }
      else
      {
         wb_table1_31_392e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202030389", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?202412202030389", false, true);
      httpContext.AddJavascriptSource("Shared/jquery/jquery1.9.1.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void startgridcontrol15( )
   {
      if ( GridgridstatecollectionsContainer.GetWrapped() == 1 )
      {
         ...
         sStyleString = "" ;
         web.GxWebStd.gx_table_start( httpContext, subGridgridstatecollections_Internalname, subGridgridstatecollections_Internalname, "", "WorkWith", 0, "", "", 1, 2, sStyleString, "", "", 0);
         /* Subfile titles */
         httpContext.writeText( "<tr") ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD","{handler:'e13392',iparms:[]");
      ...
      setEventMetadata("ENTER","{handler:'e11392',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'}]");
      ...
      setEventMetadata("VMOVEUP.CLICK","{handler:'e15392',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
      ...
      setEventMetadata("VMOVEDOWN.CLICK","{handler:'e16392',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
      ...
      setEventMetadata("VUDELETE.CLICK","{handler:'e17392',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      AV7GridStateCollectionItem = new web.wwpbaseobjects.SdtGridStateCollection_Item(remoteHandle, context);
   ...
   private GXBaseCollection<web.wwpbaseobjects.SdtGridStateCollection_Item> AV6GridStateCollection ;
   private web.wwpbaseobjects.SdtGridStateCollection_Item AV7GridStateCollectionItem ;
}
