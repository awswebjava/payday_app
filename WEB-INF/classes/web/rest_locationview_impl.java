...
public final  class rest_locationview_impl extends GXDataArea
{
   public rest_locationview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public rest_locationview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( rest_locationview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV11RestLocId = httpContext.GetPar( "RestLocId") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV11RestLocId", AV11RestLocId);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRESTLOCID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11RestLocId, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.rest_locationview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11RestLocId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","RestLocId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vRESTLOCID", GXutil.rtrim( AV11RestLocId));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRESTLOCID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11RestLocId, ""))));
   ...
   {
      return formatLink("web.rest_locationview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11RestLocId)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","RestLocId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "rest_locationView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "rest_location View", "") ;
   }
   ...
   public void wbOT0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_OT2( true) ;
      }
      else
      {
         wb_table1_9_OT2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_OT2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startOT2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "rest_location View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesOT2( )
   {
   }
   ...
   public void strupOT0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11RestLocId = httpContext.cgiGet( "vRESTLOCID") ;
   ...
   public void e11OT2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00OT2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), AV11RestLocId, Integer.valueOf(AV10CliCod), AV11RestLocId});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A2171RestLocId = H00OT2_A2171RestLocId[0] ;
         A3CliCod = H00OT2_A3CliCod[0] ;
         A2172RestLocHab = H00OT2_A2172RestLocHab[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( GXutil.booltostr( A2172RestLocHab) );
   ...
   public void S112( )
   {
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV13SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV13SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "rest_locationGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.rest_locationgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "rest_locationGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11RestLocId});
   ...
   public void wb_table1_9_OT2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_rest_locationView.htm");
         /* Div Control */
         ...
         wb_table1_9_OT2e( true) ;
      }
      else
      {
         wb_table1_9_OT2e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10CliCod), "ZZZZZ9")));
      AV11RestLocId = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11RestLocId", AV11RestLocId);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRESTLOCID", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV11RestLocId, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020383811", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("rest_locationview.js", "?2024122020383811", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "rest_location View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11RestLocId',fld:'vRESTLOCID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00OT2_A2171RestLocId = new String[] {""} ;
      H00OT2_A3CliCod = new int[1] ;
      H00OT2_A2172RestLocHab = new boolean[] {false} ;
      A2171RestLocId = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.rest_locationview__default(),
         new Object[] {
             new Object[] {
            H00OT2_A2171RestLocId, H00OT2_A3CliCod, H00OT2_A2172RestLocHab
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV11RestLocId ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV11RestLocId ;
   ...
   private String[] H00OT2_A2171RestLocId ;
   private int[] H00OT2_A3CliCod ;
   private boolean[] H00OT2_A2172RestLocHab ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class rest_locationview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00OT2", "SELECT RestLocId, CliCod, RestLocHab FROM rest_location WHERE (CliCod = ? and RestLocId = ( ?)) AND (CliCod = ? and RestLocId = ( ?)) ORDER BY CliCod, RestLocId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
