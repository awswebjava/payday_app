...
@javax.xml.bind.annotation.XmlType(name = "tipo_obligacionloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class tipo_obligacionloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("TipoOblSec")
   public short getTipoOblSec( )
   {
      return AV18TipoOblSec ;
   }

   @JsonProperty("TipoOblSec")
   public void setTipoOblSec(  short Value )
   {
      AV18TipoOblSec= Value;
   }
