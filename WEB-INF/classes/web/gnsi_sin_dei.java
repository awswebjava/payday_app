...
public final  class gnsi_sin_dei extends GXProcedure
{
   public gnsi_sin_dei( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gnsi_sin_dei.class ), "" );
   }
   ...
   public String executeUdp( int aP0 ,
                             ...
                             byte[] aP8 )
   {
      gnsi_sin_dei.this.aP9 = new String[] {""};
   ...
   private void execute_int( int aP0 ,
                             ...
                             String[] aP9 )
   {
      gnsi_sin_dei.this.AV10CliCod = aP0;
      gnsi_sin_dei.this.AV11EmpCod = aP1;
      gnsi_sin_dei.this.AV12LiqNro = aP2;
      gnsi_sin_dei.this.AV13LegNumero = aP3;
      gnsi_sin_dei.this.AV21LiqPeriodo = aP4;
      gnsi_sin_dei.this.AV14ProcesoLiquidacion = aP5;
      gnsi_sin_dei.this.aP6 = aP6;
      gnsi_sin_dei.this.aP7 = aP7;
      gnsi_sin_dei.this.aP8 = aP8;
      gnsi_sin_dei.this.aP9 = aP9;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      new web.gannetsujimp_codigoparam(remoteHandle, context).execute( GXv_char3) ;
      gnsi_sin_dei.this.GXt_char2 = GXv_char3[0] ;
      GXv_char4[0] = GXt_char1 ;
      new web.getparametro(remoteHandle, context).execute( AV10CliCod, GXt_char2, GXv_char4) ;
      gnsi_sin_dei.this.GXt_char1 = GXv_char4[0] ;
      ...
      gnsi_sin_dei.this.AV15auxLiqDImpCalcu = GXv_decimal5[0] ;
      gnsi_sin_dei.this.AV16existe = GXv_boolean6[0] ;
      gnsi_sin_dei.this.AV17auxLiqDCalculado = GXv_int7[0] ;
      ...
      AV19LiqDLog = httpContext.getMessage( "Se inicializa con valor ", "") + GXutil.trim( GXutil.str( AV18Importes, 14, 2)) + httpContext.getMessage( " de concepto \"GANANCIA NETA SUJETA A IMPUESTOS\"", "") ;
      GXt_char2 = AV9auxConCodigo ;
      GXt_char1 = AV9auxConCodigo ;
      GXv_char4[0] = GXt_char1 ;
      ...
      if ( ! (DecimalUtil.compareTo(DecimalUtil.ZERO, AV15auxLiqDImpCalcu)==0) )
      {
         ...
         AV19LiqDLog += httpContext.getMessage( ". Se resta el valor ", "") + GXutil.trim( GXutil.str( AV15auxLiqDImpCalcu, 14, 2)) + httpContext.getMessage( " de concepto \"Deducción especial incrementada\"", "") ;
      }
      cleanup();
   }
   ...
   {
      this.aP6[0] = gnsi_sin_dei.this.AV18Importes;
      this.aP7[0] = gnsi_sin_dei.this.AV19LiqDLog;
      this.aP8[0] = gnsi_sin_dei.this.AV8LiqDCalculado;
      this.aP9[0] = gnsi_sin_dei.this.AV20error;
      CloseOpenCursors();
      exitApp();
   }
