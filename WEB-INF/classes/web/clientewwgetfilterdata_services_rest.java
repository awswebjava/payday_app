...
@javax.ws.rs.Path("/ClienteWWGetFilterData")
public final  class clientewwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.clientewwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV40DDOName;
      ...
      if ( ! processHeaders("clientewwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.clientewwgetfilterdata worker = new web.clientewwgetfilterdata(remoteHandle, context);
         worker.execute(AV40DDOName,AV41SearchTxt,AV42SearchTxtTo,AV43OptionsJson,AV44OptionsDescJson,AV45OptionIndexesJson );
         web.clientewwgetfilterdata_RESTInterfaceOUT data = new web.clientewwgetfilterdata_RESTInterfaceOUT();
