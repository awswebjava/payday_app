...
public final  class rolusuarioview_impl extends GXDataArea
{
   public rolusuarioview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public rolusuarioview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( rolusuarioview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10RolId = (byte)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10RolId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10RolId), 2, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vROLID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10RolId), "Z9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.rolusuarioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10RolId,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"RolId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vROLID", GXutil.ltrim( localUtil.ntoc( AV10RolId, (byte)(2), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vROLID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10RolId), "Z9")));
   ...
   {
      return formatLink("web.rolusuarioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10RolId,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"RolId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "RolUsuarioView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Rol Usuario View", "") ;
   }
   ...
   public void wbLC0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_LC2( true) ;
      }
      else
      {
         wb_table1_9_LC2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_LC2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startLC2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Rol Usuario View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupLC0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10RolId = (byte)(localUtil.ctol( httpContext.cgiGet( "vROLID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11LC2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00LC2 */
      pr_default.execute(0, new Object[] {Byte.valueOf(AV10RolId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1923RolId = H00LC2_A1923RolId[0] ;
         A1924RolNombre = H00LC2_A1924RolNombre[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1924RolNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "RolUsuarioGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.rolusuariogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "RolUsuarioGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Byte.valueOf(AV10RolId)});
   ...
   public void wb_table1_9_LC2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_RolUsuarioView.htm");
         /* Div Control */
         ...
         wb_table1_9_LC2e( true) ;
      }
      else
      {
         wb_table1_9_LC2e( false) ;
      }
   }
   ...
   {
      AV10RolId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.BYTE)).byteValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10RolId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10RolId), 2, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vROLID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10RolId), "Z9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020385378", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("rolusuarioview.js", "?2024122020385378", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Rol Usuario View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10RolId',fld:'vROLID',pic:'Z9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00LC2_A1923RolId = new byte[1] ;
      H00LC2_A1924RolNombre = new String[] {""} ;
      A1924RolNombre = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.rolusuarioview__default(),
         new Object[] {
             new Object[] {
            H00LC2_A1923RolId, H00LC2_A1924RolNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private byte wcpOAV10RolId ;
   private byte nGotPars ;
   private byte GxWebError ;
   private byte AV10RolId ;
   ...
   private byte[] H00LC2_A1923RolId ;
   private String[] H00LC2_A1924RolNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class rolusuarioview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00LC2", "SELECT RolId, RolNombre FROM RolUsuario WHERE RolId = ? ORDER BY RolId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
