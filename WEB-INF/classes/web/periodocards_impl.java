...
public final  class periodocards_impl extends GXDataArea
{
   public void initenv( )
   {
      if ( GxWebError != 0 )
   ...
   public void inittrn( )
   {
      ...
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel2"+"_"+"PERIODOESTADO") == 0 )
      {
         ...
         gx2asaperiodoestado6J233( A3CliCod, A1EmpCod, A1729PeriodoLiq) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel3"+"_"+"PERIODOCNTLIQ") == 0 )
      {
         ...
         gx3asaperiodocntliq6J233( A3CliCod, A1EmpCod, A1729PeriodoLiq) ;
         return  ;
      }
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Periodo Cards", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public periodocards_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public periodocards_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( periodocards_impl.class ));
   }
   ...
   public void drawControls( )
   {
      ...
      web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,22);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCliCod_Enabled, 1, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_PeriodoCards.htm");
      ...
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
      /* Div Control */
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtPeriodoLiq_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      web.GxWebStd.gx_label_element( httpContext, edtPeriodoLiq_Internalname, httpContext.getMessage( "Liq", ""), "col-sm-3 AttributeDateLabel", 1, true, "");
      /* Div Control */
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
      /* Single line edit */
      ...
      web.GxWebStd.gx_single_line_edit( httpContext, edtPeriodoLiq_Internalname, localUtil.format(A1729PeriodoLiq, "99/99/99"), localUtil.format( A1729PeriodoLiq, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'"+httpContext.getLanguageProperty( "date_fmt")+"',0,"+httpContext.getLanguageProperty( "time_fmt")+",'"+httpContext.getLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,32);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPeriodoLiq_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtPeriodoLiq_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Periodo", "right", false, "", "HLP_PeriodoCards.htm");
      web.GxWebStd.gx_bitmap( httpContext, edtPeriodoLiq_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtPeriodoLiq_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_PeriodoCards.htm");
      ...
      /* ComboBox */
      web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbPeriodoMes, cmbPeriodoMes.getInternalname(), GXutil.trim( GXutil.str( A1731PeriodoMes, 2, 0)), 1, cmbPeriodoMes.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbPeriodoMes.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,42);\"", "", true, (byte)(0), "HLP_PeriodoCards.htm");
      cmbPeriodoMes.setValue( GXutil.trim( GXutil.str( A1731PeriodoMes, 2, 0)) );
      httpContext.ajax_rsp_assign_prop("", false, cmbPeriodoMes.getInternalname(), "Values", cmbPeriodoMes.ToJavascriptSource(), true);
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
      /* Div Control */
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtPeriodoDescrip_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      web.GxWebStd.gx_label_element( httpContext, edtPeriodoDescrip_Internalname, httpContext.getMessage( "Descripción", ""), "col-sm-3 AttributeLabel", 1, true, "");
      /* Div Control */
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
      /* Multiple line edit */
      ...
      ClassString = "Attribute" ;
      StyleString = "" ;
      web.GxWebStd.gx_html_textarea( httpContext, edtPeriodoDescrip_Internalname, A1732PeriodoDescrip, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,47);\"", (short)(0), 1, edtPeriodoDescrip_Enabled, 0, 80, "chr", 5, "row", (byte)(0), StyleString, ClassString, "", "", "400", -1, 0, "", "", (byte)(-1), true, "Descrip", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_PeriodoCards.htm");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      StyleString = "" ;
      web.GxWebStd.gx_button_ctrl( httpContext, bttBtntrn_cancel_Internalname, "", httpContext.getMessage( "GX_BtnCancel", ""), bttBtntrn_cancel_Jsonclick, 1, httpContext.getMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, bttBtntrn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_PeriodoCards.htm");
      web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      /* Div Control */
      web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
   ...
   public void standaloneStartupServer( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
         {
            ...
            forbiddenHiddens.add("hshsalt", "hsh"+"PeriodoCards");
            ...
            {
               GXutil.writeLogError("periodocards:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
               GxWebError = (byte)(1) ;
   ...
   public void confirm_6J0( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( isDlt( ) )
         {
            onDeleteControls6J233( ) ;
         }
         else
         {
            checkExtendedTable6J233( ) ;
            closeExtendedTableCursors6J233( ) ;
         }
      }
      if ( AnyError == 0 )
      {
   ...
   public void e116J2( )
   {
      ...
      if ( GXutil.strcmp(Gx_mode, "INS") == 0 )
      {
         ...
         new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPeriodoCards_Insert", GXv_boolean3) ;
         periodocards_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
      ...
      if ( GXutil.strcmp(Gx_mode, "UPD") == 0 )
      {
         GXt_boolean2 = AV11IsAuthorized ;
         GXv_boolean3[0] = GXt_boolean2 ;
         new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPeriodoCards_Update", GXv_boolean3) ;
         periodocards_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         AV11IsAuthorized = GXt_boolean2 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11IsAuthorized", AV11IsAuthorized);
      }
      if ( GXutil.strcmp(Gx_mode, "DLT") == 0 )
      {
         GXt_boolean2 = AV11IsAuthorized ;
         GXv_boolean3[0] = GXt_boolean2 ;
         new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPeriodoCards_Delete", GXv_boolean3) ;
         periodocards_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         AV11IsAuthorized = GXt_boolean2 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11IsAuthorized", AV11IsAuthorized);
      }
   ...
   public void zm6J233( int GX_JID )
   {
      if ( ( GX_JID == 13 ) || ( GX_JID == 0 ) )
      {
         if ( ! isIns( ) )
         {
            Z1730PeriodoAnio = T006J3_A1730PeriodoAnio[0] ;
            Z1731PeriodoMes = T006J3_A1731PeriodoMes[0] ;
            Z1732PeriodoDescrip = T006J3_A1732PeriodoDescrip[0] ;
            Z2103PeriodoAnioMes = T006J3_A2103PeriodoAnioMes[0] ;
         }
         else
         {
   ...
   public void standaloneModal( )
   {
      ...
      {
         AV24Pgmname = "PeriodoCards" ;
         httpContext.ajax_rsp_assign_attri("", false, "AV24Pgmname", AV24Pgmname);
         GXt_int4 = A1819PeriodoEstado ;
         GXv_int5[0] = GXt_int4 ;
         new web.getperiodoestado(remoteHandle, context).execute( A3CliCod, A1EmpCod, A1729PeriodoLiq, GXv_int5) ;
         periodocards_impl.this.GXt_int4 = GXv_int5[0] ;
         A1819PeriodoEstado = GXt_int4 ;
         httpContext.ajax_rsp_assign_attri("", false, "A1819PeriodoEstado", GXutil.str( A1819PeriodoEstado, 1, 0));
         GXt_int6 = A1735PeriodoCntLiq ;
         GXv_int7[0] = GXt_int6 ;
         new web.periodocantliq(remoteHandle, context).execute( A3CliCod, A1EmpCod, A1729PeriodoLiq, GXv_int7) ;
         periodocards_impl.this.GXt_int6 = GXv_int7[0] ;
         A1735PeriodoCntLiq = GXt_int6 ;
   ...
   public void load6J233( )
   {
      ...
      {
         RcdFound233 = (short)(1) ;
         A1730PeriodoAnio = T006J5_A1730PeriodoAnio[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1730PeriodoAnio", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1730PeriodoAnio), 4, 0));
         A1731PeriodoMes = T006J5_A1731PeriodoMes[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1731PeriodoMes", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1731PeriodoMes), 2, 0));
         A1732PeriodoDescrip = T006J5_A1732PeriodoDescrip[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1732PeriodoDescrip", A1732PeriodoDescrip);
         A2103PeriodoAnioMes = T006J5_A2103PeriodoAnioMes[0] ;
         zm6J233( -13) ;
      }
      pr_default.close(3);
      onLoadActions6J233( ) ;
   ...
   public void onLoadActions6J233( )
   {
      AV24Pgmname = "PeriodoCards" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV24Pgmname", AV24Pgmname);
      GXt_int4 = A1819PeriodoEstado ;
   ...
   public void checkExtendedTable6J233( )
   {
   ...
   public void closeExtendedTableCursors6J233( )
   {
      pr_default.close(2);
   }
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm6J233( 13) ;
         RcdFound233 = (short)(1) ;
         A1729PeriodoLiq = T006J3_A1729PeriodoLiq[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1729PeriodoLiq", localUtil.format(A1729PeriodoLiq, "99/99/99"));
         A1730PeriodoAnio = T006J3_A1730PeriodoAnio[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1730PeriodoAnio", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1730PeriodoAnio), 4, 0));
         A1731PeriodoMes = T006J3_A1731PeriodoMes[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1731PeriodoMes", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1731PeriodoMes), 2, 0));
         A1732PeriodoDescrip = T006J3_A1732PeriodoDescrip[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1732PeriodoDescrip", A1732PeriodoDescrip);
         A2103PeriodoAnioMes = T006J3_A2103PeriodoAnioMes[0] ;
         A3CliCod = T006J3_A3CliCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
         A1EmpCod = T006J3_A1EmpCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
         Z3CliCod = A3CliCod ;
         Z1EmpCod = A1EmpCod ;
         Z1729PeriodoLiq = A1729PeriodoLiq ;
   ...
   public void move_next( )
   {
      ...
      {
         while ( (pr_default.getStatus(6) != 101) && ( ( T006J8_A3CliCod[0] < A3CliCod ) || ( T006J8_A3CliCod[0] == A3CliCod ) && ( T006J8_A1EmpCod[0] < A1EmpCod ) || ( T006J8_A1EmpCod[0] == A1EmpCod ) && ( T006J8_A3CliCod[0] == A3CliCod ) && GXutil.resetTime(T006J8_A1729PeriodoLiq[0]).before( GXutil.resetTime( A1729PeriodoLiq )) ) )
         {
            pr_default.readNext(6);
         }
         if ( (pr_default.getStatus(6) != 101) && ( ( T006J8_A3CliCod[0] > A3CliCod ) || ( T006J8_A3CliCod[0] == A3CliCod ) && ( T006J8_A1EmpCod[0] > A1EmpCod ) || ( T006J8_A1EmpCod[0] == A1EmpCod ) && ( T006J8_A3CliCod[0] == A3CliCod ) && GXutil.resetTime(T006J8_A1729PeriodoLiq[0]).after( GXutil.resetTime( A1729PeriodoLiq )) ) )
         {
            A3CliCod = T006J8_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = T006J8_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A1729PeriodoLiq = T006J8_A1729PeriodoLiq[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1729PeriodoLiq", localUtil.format(A1729PeriodoLiq, "99/99/99"));
            RcdFound233 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      ...
      {
         while ( (pr_default.getStatus(7) != 101) && ( ( T006J9_A3CliCod[0] > A3CliCod ) || ( T006J9_A3CliCod[0] == A3CliCod ) && ( T006J9_A1EmpCod[0] > A1EmpCod ) || ( T006J9_A1EmpCod[0] == A1EmpCod ) && ( T006J9_A3CliCod[0] == A3CliCod ) && GXutil.resetTime(T006J9_A1729PeriodoLiq[0]).after( GXutil.resetTime( A1729PeriodoLiq )) ) )
         {
            pr_default.readNext(7);
         }
         if ( (pr_default.getStatus(7) != 101) && ( ( T006J9_A3CliCod[0] < A3CliCod ) || ( T006J9_A3CliCod[0] == A3CliCod ) && ( T006J9_A1EmpCod[0] < A1EmpCod ) || ( T006J9_A1EmpCod[0] == A1EmpCod ) && ( T006J9_A3CliCod[0] == A3CliCod ) && GXutil.resetTime(T006J9_A1729PeriodoLiq[0]).before( GXutil.resetTime( A1729PeriodoLiq )) ) )
         {
            A3CliCod = T006J9_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = T006J9_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A1729PeriodoLiq = T006J9_A1729PeriodoLiq[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A1729PeriodoLiq", localUtil.format(A1729PeriodoLiq, "99/99/99"));
            RcdFound233 = (short)(1) ;
         }
      }
   ...
   public void checkOptimisticConcurrency6J233( )
   {
      if ( ! isIns( ) )
      {
         /* Using cursor T006J2 */
         ...
         if ( (pr_default.getStatus(0) == 101) || ( Z1730PeriodoAnio != T006J2_A1730PeriodoAnio[0] ) || ( Z1731PeriodoMes != T006J2_A1731PeriodoMes[0] ) || ( GXutil.strcmp(Z1732PeriodoDescrip, T006J2_A1732PeriodoDescrip[0]) != 0 ) || ( Z2103PeriodoAnioMes != T006J2_A2103PeriodoAnioMes[0] ) )
         {
            if ( Z1730PeriodoAnio != T006J2_A1730PeriodoAnio[0] )
            {
               GXutil.writeLogln("periodocards:[seudo value changed for attri]"+"PeriodoAnio");
               GXutil.writeLogRaw("Old: ",Z1730PeriodoAnio);
               GXutil.writeLogRaw("Current: ",T006J2_A1730PeriodoAnio[0]);
            }
            if ( Z1731PeriodoMes != T006J2_A1731PeriodoMes[0] )
            {
               GXutil.writeLogln("periodocards:[seudo value changed for attri]"+"PeriodoMes");
               GXutil.writeLogRaw("Old: ",Z1731PeriodoMes);
               GXutil.writeLogRaw("Current: ",T006J2_A1731PeriodoMes[0]);
            }
            if ( GXutil.strcmp(Z1732PeriodoDescrip, T006J2_A1732PeriodoDescrip[0]) != 0 )
            {
               GXutil.writeLogln("periodocards:[seudo value changed for attri]"+"PeriodoDescrip");
               GXutil.writeLogRaw("Old: ",Z1732PeriodoDescrip);
               GXutil.writeLogRaw("Current: ",T006J2_A1732PeriodoDescrip[0]);
            }
            if ( Z2103PeriodoAnioMes != T006J2_A2103PeriodoAnioMes[0] )
            {
               GXutil.writeLogln("periodocards:[seudo value changed for attri]"+"PeriodoAnioMes");
               GXutil.writeLogRaw("Old: ",Z2103PeriodoAnioMes);
               GXutil.writeLogRaw("Current: ",T006J2_A2103PeriodoAnioMes[0]);
            }
   ...
   public void insert6J233( )
   {
      ...
      {
         zm6J233( 0) ;
         checkOptimisticConcurrency6J233( ) ;
         if ( AnyError == 0 )
         {
            afterConfirm6J233( ) ;
            if ( AnyError == 0 )
   ...
   public void deferredUpdate6J233( )
   {
   }
   ...
   public void onDeleteControls6J233( )
   {
      standaloneModal( ) ;
      if ( AnyError == 0 )
      {
   ...
   public void endLevel6J233( )
   {
      ...
      if ( AnyError == 0 )
      {
         Application.commitDataStores(context, remoteHandle, pr_default, "periodocards");
         if ( AnyError == 0 )
         {
            confirmValues6J0( ) ;
         }
      ...
      {
         Application.rollbackDataStores(context, remoteHandle, pr_default, "periodocards");
      }
      IsModified = (short)(0) ;
      if ( AnyError != 0 )
      {
   ...
   public void scanStart6J233( )
   {
      ...
      {
         RcdFound233 = (short)(1) ;
         A3CliCod = T006J14_A3CliCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
         A1EmpCod = T006J14_A1EmpCod[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
         A1729PeriodoLiq = T006J14_A1729PeriodoLiq[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1729PeriodoLiq", localUtil.format(A1729PeriodoLiq, "99/99/99"));
      }
      /* Load Subordinate Levels */
   }

   public void scanNext6J233( )
   {
      /* Scan next routine */
   ...
   public void scanEnd6J233( )
   {
      pr_default.close(12);
   }

   public void afterConfirm6J233( )
   {
      /* After Confirm Rules */
   }

   public void beforeInsert6J233( )
   {
      /* Before Insert Rules */
   }

   public void beforeUpdate6J233( )
   {
      /* Before Update Rules */
   }

   public void beforeDelete6J233( )
   {
      /* Before Delete Rules */
   }

   public void beforeComplete6J233( )
   {
      /* Before Complete Rules */
   }

   public void beforeValidate6J233( )
   {
      /* Before Validate Rules */
   }

   public void disableAttributes6J233( )
   {
      edtCliCod_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtCliCod_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtCliCod_Enabled), 5, 0), true);
      edtEmpCod_Enabled = 0 ;
   ...
   public void send_integrity_lvl_hashes6J233( )
   {
   }
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      GXutil.writeLogInfo("periodocards:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   {
      return formatLink("web.periodocards", new String[] {GXutil.URLEncode(GXutil.rtrim(Gx_mode)),GXutil.URLEncode(GXutil.ltrimstr(AV7CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV8EmpCod,4,0)),GXutil.URLEncode(GXutil.formatDateParm(AV9PeriodoLiq))}, new String[] {"Gx_mode","CliCod","EmpCod","PeriodoLiq"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Periodo Cards", "") ;
   }

   public void initializeNonKey6J233( )
   {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713575254", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("periodocards.js", "?20251713575254", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Periodo Cards", "") );
      bttBtntrn_delete_Enabled = 0 ;
   ...
   public void gx2asaperiodoestado6J233( int A3CliCod ,
                                         short A1EmpCod ,
   ...
   public void gx3asaperiodocntliq6J233( int A3CliCod ,
                                         short A1EmpCod ,
                                         java.util.Date A1729PeriodoLiq )
   {
      GXt_int6 = A1735PeriodoCntLiq ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("AFTER TRN","{handler:'e126J2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      T006J5_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      T006J5_A1730PeriodoAnio = new short[1] ;
      T006J5_A1731PeriodoMes = new byte[1] ;
      T006J5_A1732PeriodoDescrip = new String[] {""} ;
      T006J5_A2103PeriodoAnioMes = new int[1] ;
      T006J5_A3CliCod = new int[1] ;
      T006J5_A1EmpCod = new short[1] ;
      T006J4_A3CliCod = new int[1] ;
      T006J6_A3CliCod = new int[1] ;
      T006J7_A3CliCod = new int[1] ;
      T006J7_A1EmpCod = new short[1] ;
      T006J7_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      T006J3_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      T006J3_A1730PeriodoAnio = new short[1] ;
      T006J3_A1731PeriodoMes = new byte[1] ;
      T006J3_A1732PeriodoDescrip = new String[] {""} ;
      T006J3_A2103PeriodoAnioMes = new int[1] ;
      T006J3_A3CliCod = new int[1] ;
      T006J3_A1EmpCod = new short[1] ;
      T006J8_A3CliCod = new int[1] ;
      T006J8_A1EmpCod = new short[1] ;
      T006J8_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      T006J9_A3CliCod = new int[1] ;
      T006J9_A1EmpCod = new short[1] ;
      T006J9_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      T006J2_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      T006J2_A1730PeriodoAnio = new short[1] ;
      T006J2_A1731PeriodoMes = new byte[1] ;
      T006J2_A1732PeriodoDescrip = new String[] {""} ;
      T006J2_A2103PeriodoAnioMes = new int[1] ;
      T006J2_A3CliCod = new int[1] ;
      T006J2_A1EmpCod = new short[1] ;
      T006J13_A3CliCod = new int[1] ;
      T006J13_A1EmpCod = new short[1] ;
      T006J13_A31LiqNro = new int[1] ;
      T006J14_A3CliCod = new int[1] ;
      T006J14_A1EmpCod = new short[1] ;
      T006J14_A1729PeriodoLiq = new java.util.Date[] {GXutil.nullDate()} ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      T006J15_A3CliCod = new int[1] ;
      GXv_int5 = new byte[1] ;
      GXv_int7 = new short[1] ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.periodocards__default(),
         new Object[] {
             new Object[] {
            T006J2_A1729PeriodoLiq, T006J2_A1730PeriodoAnio, T006J2_A1731PeriodoMes, T006J2_A1732PeriodoDescrip, T006J2_A2103PeriodoAnioMes, T006J2_A3CliCod, T006J2_A1EmpCod
            }
            , new Object[] {
            T006J3_A1729PeriodoLiq, T006J3_A1730PeriodoAnio, T006J3_A1731PeriodoMes, T006J3_A1732PeriodoDescrip, T006J3_A2103PeriodoAnioMes, T006J3_A3CliCod, T006J3_A1EmpCod
            }
            , new Object[] {
            T006J4_A3CliCod
            }
            , new Object[] {
            T006J5_A1729PeriodoLiq, T006J5_A1730PeriodoAnio, T006J5_A1731PeriodoMes, T006J5_A1732PeriodoDescrip, T006J5_A2103PeriodoAnioMes, T006J5_A3CliCod, T006J5_A1EmpCod
            }
            , new Object[] {
            T006J6_A3CliCod
            }
            , new Object[] {
            T006J7_A3CliCod, T006J7_A1EmpCod, T006J7_A1729PeriodoLiq
            }
            , new Object[] {
            T006J8_A3CliCod, T006J8_A1EmpCod, T006J8_A1729PeriodoLiq
            }
            , new Object[] {
            T006J9_A3CliCod, T006J9_A1EmpCod, T006J9_A1729PeriodoLiq
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            T006J13_A3CliCod, T006J13_A1EmpCod, T006J13_A31LiqNro
            }
            , new Object[] {
            T006J14_A3CliCod, T006J14_A1EmpCod, T006J14_A1729PeriodoLiq
            }
            , new Object[] {
            T006J15_A3CliCod
            }
   ...
   private java.util.Date[] T006J5_A1729PeriodoLiq ;
   private short[] T006J5_A1730PeriodoAnio ;
   private byte[] T006J5_A1731PeriodoMes ;
   private String[] T006J5_A1732PeriodoDescrip ;
   private int[] T006J5_A2103PeriodoAnioMes ;
   private int[] T006J5_A3CliCod ;
   private short[] T006J5_A1EmpCod ;
   private int[] T006J4_A3CliCod ;
   private int[] T006J6_A3CliCod ;
   private int[] T006J7_A3CliCod ;
   private short[] T006J7_A1EmpCod ;
   private java.util.Date[] T006J7_A1729PeriodoLiq ;
   private java.util.Date[] T006J3_A1729PeriodoLiq ;
   private short[] T006J3_A1730PeriodoAnio ;
   private byte[] T006J3_A1731PeriodoMes ;
   private String[] T006J3_A1732PeriodoDescrip ;
   private int[] T006J3_A2103PeriodoAnioMes ;
   private int[] T006J3_A3CliCod ;
   private short[] T006J3_A1EmpCod ;
   private int[] T006J8_A3CliCod ;
   private short[] T006J8_A1EmpCod ;
   private java.util.Date[] T006J8_A1729PeriodoLiq ;
   private int[] T006J9_A3CliCod ;
   private short[] T006J9_A1EmpCod ;
   private java.util.Date[] T006J9_A1729PeriodoLiq ;
   private java.util.Date[] T006J2_A1729PeriodoLiq ;
   private short[] T006J2_A1730PeriodoAnio ;
   private byte[] T006J2_A1731PeriodoMes ;
   private String[] T006J2_A1732PeriodoDescrip ;
   private int[] T006J2_A2103PeriodoAnioMes ;
   private int[] T006J2_A3CliCod ;
   private short[] T006J2_A1EmpCod ;
   private int[] T006J13_A3CliCod ;
   private short[] T006J13_A1EmpCod ;
   private int[] T006J13_A31LiqNro ;
   private int[] T006J14_A3CliCod ;
   private short[] T006J14_A1EmpCod ;
   private java.util.Date[] T006J14_A1729PeriodoLiq ;
   private int[] T006J15_A3CliCod ;
...
final  class periodocards__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("T006J2", "SELECT PeriodoLiq, PeriodoAnio, PeriodoMes, PeriodoDescrip, PeriodoAnioMes, CliCod, EmpCod FROM Periodo WHERE CliCod = ? AND EmpCod = ? AND PeriodoLiq = ?  FOR UPDATE OF Periodo NOWAIT",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J3", "SELECT PeriodoLiq, PeriodoAnio, PeriodoMes, PeriodoDescrip, PeriodoAnioMes, CliCod, EmpCod FROM Periodo WHERE CliCod = ? AND EmpCod = ? AND PeriodoLiq = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J4", "SELECT CliCod FROM Empresa WHERE CliCod = ? AND EmpCod = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J5", "SELECT TM1.PeriodoLiq, TM1.PeriodoAnio, TM1.PeriodoMes, TM1.PeriodoDescrip, TM1.PeriodoAnioMes, TM1.CliCod, TM1.EmpCod FROM Periodo TM1 WHERE TM1.CliCod = ? and TM1.EmpCod = ? and TM1.PeriodoLiq = ? ORDER BY TM1.CliCod, TM1.EmpCod, TM1.PeriodoLiq ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J6", "SELECT CliCod FROM Empresa WHERE CliCod = ? AND EmpCod = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J7", "SELECT CliCod, EmpCod, PeriodoLiq FROM Periodo WHERE CliCod = ? AND EmpCod = ? AND PeriodoLiq = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J8", "SELECT CliCod, EmpCod, PeriodoLiq FROM Periodo WHERE ( CliCod > ? or CliCod = ? and EmpCod > ? or EmpCod = ? and CliCod = ? and PeriodoLiq > ?) ORDER BY CliCod, EmpCod, PeriodoLiq  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("T006J9", "SELECT CliCod, EmpCod, PeriodoLiq FROM Periodo WHERE ( CliCod < ? or CliCod = ? and EmpCod < ? or EmpCod = ? and CliCod = ? and PeriodoLiq < ?) ORDER BY CliCod DESC, EmpCod DESC, PeriodoLiq DESC  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new UpdateCursor("T006J10", "SAVEPOINT gxupdate;INSERT INTO Periodo(PeriodoLiq, PeriodoAnio, PeriodoMes, PeriodoDescrip, PeriodoAnioMes, CliCod, EmpCod) VALUES(?, ?, ?, ?, ?, ?, ?);RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T006J11", "SAVEPOINT gxupdate;UPDATE Periodo SET PeriodoAnio=?, PeriodoMes=?, PeriodoDescrip=?, PeriodoAnioMes=?  WHERE CliCod = ? AND EmpCod = ? AND PeriodoLiq = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T006J12", "SAVEPOINT gxupdate;DELETE FROM Periodo  WHERE CliCod = ? AND EmpCod = ? AND PeriodoLiq = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new ForEachCursor("T006J13", "SELECT CliCod, EmpCod, LiqNro FROM Liquidacion WHERE CliCod = ? AND EmpCod = ? AND PeriodoLiq = ?  LIMIT 1",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("T006J14", "SELECT CliCod, EmpCod, PeriodoLiq FROM Periodo ORDER BY CliCod, EmpCod, PeriodoLiq ",true, GX_NOMASK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("T006J15", "SELECT CliCod FROM Empresa WHERE CliCod = ? AND EmpCod = ? ",true, GX_NOMASK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
