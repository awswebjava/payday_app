...
public final  class legajo_deduccionesview_impl extends GXDataArea
{
   public legajo_deduccionesview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public legajo_deduccionesview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( legajo_deduccionesview_impl.class ));
   }
   ...
   {
      return formatLink("web.legajo_deduccionesview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV12LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV13LegDedSec,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","LegNumero","LegDedSec","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "legajo_deduccionesView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "legajo_deducciones View", "") ;
   }
   ...
   public void wb7S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_7S2( true) ;
      }
      else
      {
         wb_table1_9_7S2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_7S2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start7S2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "legajo_deducciones View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes7S2( )
   {
   }
   ...
   public void e117S2( )
   {
      ...
      {
         A83LegDedSec = H007S2_A83LegDedSec[0] ;
         A6LegNumero = H007S2_A6LegNumero[0] ;
         A1EmpCod = H007S2_A1EmpCod[0] ;
         A3CliCod = H007S2_A3CliCod[0] ;
         A556LegDedFchDes = H007S2_A556LegDedFchDes[0] ;
         AV19GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "legajo_deduccionesGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.legajo_deduccionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "legajo_deduccionesGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
   ...
   public void wb_table1_9_7S2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_legajo_deduccionesView.htm");
         /* Div Control */
         ...
         wb_table1_9_7S2e( true) ;
      }
      else
      {
         wb_table1_9_7S2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181751282", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("legajo_deduccionesview.js", "?2025181751282", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "legajo_deducciones View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H007S2_A83LegDedSec = new int[1] ;
      H007S2_A6LegNumero = new int[1] ;
      H007S2_A1EmpCod = new short[1] ;
      H007S2_A3CliCod = new int[1] ;
      H007S2_A556LegDedFchDes = new java.util.Date[] {GXutil.nullDate()} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.legajo_deduccionesview__default(),
         new Object[] {
             new Object[] {
            H007S2_A83LegDedSec, H007S2_A6LegNumero, H007S2_A1EmpCod, H007S2_A3CliCod, H007S2_A556LegDedFchDes
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int[] H007S2_A83LegDedSec ;
   private int[] H007S2_A6LegNumero ;
   private short[] H007S2_A1EmpCod ;
   private int[] H007S2_A3CliCod ;
   private java.util.Date[] H007S2_A556LegDedFchDes ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class legajo_deduccionesview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H007S2", "SELECT LegDedSec, LegNumero, EmpCod, CliCod, LegDedFchDes FROM legajo_deducciones WHERE (CliCod = ? and EmpCod = ? and LegNumero = ? and LegDedSec = ?) AND (CliCod = ? and EmpCod = ? and LegNumero = ? and LegDedSec = ?) ORDER BY CliCod, EmpCod, LegNumero, LegDedSec ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
