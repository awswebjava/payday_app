...
public final  class legajo_cuenta_licenciasaprobacioneswc_impl extends GXWebComponent
{
   public legajo_cuenta_licenciasaprobacioneswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public legajo_cuenta_licenciasaprobacioneswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( legajo_cuenta_licenciasaprobacioneswc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "legajo_cuenta_licenciasaprobaciones WC", "")) ;
   ...
   public void renderHtmlCloseFormOX2( )
   {
   ...
   {
      return "legajo_cuenta_licenciasaprobacionesWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "legajo_cuenta_licenciasaprobaciones WC", "") ;
   }
   ...
   public void wbOX0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.legajo_cuenta_licenciasaprobacioneswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_legajo_cuenta_licenciasaprobacionesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_legajo_cuenta_licenciasaprobacionesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegNumero_Internalname, GXutil.ltrim( localUtil.ntoc( A6LegNumero, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6LegNumero), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegNumero_Jsonclick, 0, "Attribute", "", "", "", "", edtLegNumero_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoMedio", "right", false, "", "HLP_legajo_cuenta_licenciasaprobacionesWC.htm");
         /* ComboBox */
         web.GxWebStd.gx_combobox_ctrl1( httpContext, cmbLegCuenLicTpo, cmbLegCuenLicTpo.getInternalname(), GXutil.rtrim( A2243LegCuenLicTpo), 1, cmbLegCuenLicTpo.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", cmbLegCuenLicTpo.getVisible(), 0, 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", "", "", "", true, (byte)(0), "HLP_legajo_cuenta_licenciasaprobacionesWC.htm");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegCuenAnio_Internalname, GXutil.ltrim( localUtil.ntoc( A2266LegCuenAnio, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A2266LegCuenAnio), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegCuenAnio_Jsonclick, 0, "Attribute", "", "", "", "", edtLegCuenAnio_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Anio", "right", false, "", "HLP_legajo_cuenta_licenciasaprobacionesWC.htm");
         /* User Defined Control */
   ...
   public void startOX2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "legajo_cuenta_licenciasaprobaciones WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A2324LegCuLAprLicFch = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtLegCuLAprLicFch_Internalname), 0)) ;
   ...
   {
      /* GeneXus formulas. */
      AV31Pgmname = "legajo_cuenta_licenciasaprobacionesWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfOX2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            ...
            A2326LegCuLAprLicOri = H00OX2_A2326LegCuLAprLicOri[0] ;
            A2325LegCuLAprLicCnt = H00OX2_A2325LegCuLAprLicCnt[0] ;
            A2324LegCuLAprLicFch = H00OX2_A2324LegCuLAprLicFch[0] ;
            e16OX2 ();
   ...
   public void send_integrity_lvl_hashesOX2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV31Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV31Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      GRID_nRecordCount = H00OX3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e14OX2( )
   {
      ...
      legajo_cuenta_licenciasaprobacioneswc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e15OX2( )
   {
      ...
      legajo_cuenta_licenciasaprobacioneswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "legajo_cuenta_licenciasaprobacioneswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020194188", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("legajo_cuenta_licenciasaprobacioneswc.js", "?2024122020194188", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtLegCuLAprLicFch_Internalname = sPrefix+"LEGCULAPRLICFCH_"+sGXsfl_15_idx ;
      edtLegCuLAprLicCnt_Internalname = sPrefix+"LEGCULAPRLICCNT_"+sGXsfl_15_idx ;
      cmbLegCuLAprLicOri.setInternalname( sPrefix+"LEGCULAPRLICORI_"+sGXsfl_15_idx );
   }

   public void subsflControlProps_fel_152( )
   {
      edtLegCuLAprLicFch_Internalname = sPrefix+"LEGCULAPRLICFCH_"+sGXsfl_15_fel_idx ;
      edtLegCuLAprLicCnt_Internalname = sPrefix+"LEGCULAPRLICCNT_"+sGXsfl_15_fel_idx ;
      cmbLegCuLAprLicOri.setInternalname( sPrefix+"LEGCULAPRLICORI_"+sGXsfl_15_fel_idx );
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLegCuLAprLicFch_Internalname,localUtil.format(A2324LegCuLAprLicFch, "99/99/99"),localUtil.format( A2324LegCuLAprLicFch, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLegCuLAprLicFch_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLegCuLAprLicCnt_Internalname,GXutil.ltrim( localUtil.ntoc( A2325LegCuLAprLicCnt, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A2325LegCuLAprLicCnt), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLegCuLAprLicCnt_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbLegCuLAprLicOri.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "LEGCULAPRLICORI_" + sGXsfl_15_idx ;
            ...
            {
               A2326LegCuLAprLicOri = cmbLegCuLAprLicOri.getValidValue(A2326LegCuLAprLicOri) ;
            }
         }
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbLegCuLAprLicOri,cmbLegCuLAprLicOri.getInternalname(),GXutil.rtrim( A2326LegCuLAprLicOri),Integer.valueOf(1),cmbLegCuLAprLicOri.getJsonclick(),Integer.valueOf(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(0)});
         cmbLegCuLAprLicOri.setValue( GXutil.rtrim( A2326LegCuLAprLicOri) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbLegCuLAprLicOri.getInternalname(), "Values", cmbLegCuLAprLicOri.ToJavascriptSource(), !bGXsfl_15_Refreshing);
         send_integrity_lvl_hashesOX2( ) ;
   ...
   public void startgridcontrol15( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Cantidad de días", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", localUtil.format(A2324LegCuLAprLicFch, "99/99/99"));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A2325LegCuLAprLicCnt, (byte)(4), (byte)(0), ".", "")));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A2326LegCuLAprLicOri));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtLegCuLAprLicFch_Internalname = sPrefix+"LEGCULAPRLICFCH" ;
      edtLegCuLAprLicCnt_Internalname = sPrefix+"LEGCULAPRLICCNT" ;
      cmbLegCuLAprLicOri.setInternalname( sPrefix+"LEGCULAPRLICORI" );
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:LegCuLAprLicFch|1:LegCuLAprLicCnt|2:LegCuLAprLicOri" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16OX2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Legculaprlicori',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00OX2_A3CliCod = new int[1] ;
      H00OX2_A1EmpCod = new short[1] ;
      H00OX2_A6LegNumero = new int[1] ;
      H00OX2_A2243LegCuenLicTpo = new String[] {""} ;
      H00OX2_A2266LegCuenAnio = new short[1] ;
      H00OX2_A2326LegCuLAprLicOri = new String[] {""} ;
      H00OX2_A2325LegCuLAprLicCnt = new short[1] ;
      H00OX2_A2324LegCuLAprLicFch = new java.util.Date[] {GXutil.nullDate()} ;
      H00OX3_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.legajo_cuenta_licenciasaprobacioneswc__default(),
         new Object[] {
             new Object[] {
            H00OX2_A3CliCod, H00OX2_A1EmpCod, H00OX2_A6LegNumero, H00OX2_A2243LegCuenLicTpo, H00OX2_A2266LegCuenAnio, H00OX2_A2326LegCuLAprLicOri, H00OX2_A2325LegCuLAprLicCnt, H00OX2_A2324LegCuLAprLicFch
            }
            , new Object[] {
            H00OX3_AGRID_nRecordCount
            }
         }
      );
      AV31Pgmname = "legajo_cuenta_licenciasaprobacionesWC" ;
   ...
   private int[] H00OX2_A3CliCod ;
   private short[] H00OX2_A1EmpCod ;
   private int[] H00OX2_A6LegNumero ;
   private String[] H00OX2_A2243LegCuenLicTpo ;
   private short[] H00OX2_A2266LegCuenAnio ;
   private String[] H00OX2_A2326LegCuLAprLicOri ;
   private short[] H00OX2_A2325LegCuLAprLicCnt ;
   private java.util.Date[] H00OX2_A2324LegCuLAprLicFch ;
   private long[] H00OX3_AGRID_nRecordCount ;
...
final  class legajo_cuenta_licenciasaprobacioneswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00OX2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A2266LegCuenAnio )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, EmpCod, LegNumero, LegCuenLicTpo, LegCuenAnio, LegCuLAprLicOri, LegCuLAprLicCnt, LegCuLAprLicFch" ;
      sFromString = " FROM legajo_cuenta_licenciasaprobaciones" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LegNumero = ? and LegCuenLicTpo = ( ?) and LegCuenAnio = ?)");
      if ( ( AV18OrderedBy == 1 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, LegCuenLicTpo, LegCuenAnio, LegCuLAprLicFch" ;
      }
      else if ( ( AV18OrderedBy == 1 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LegNumero DESC, LegCuenLicTpo DESC, LegCuenAnio DESC, LegCuLAprLicFch DESC" ;
      }
      else if ( ( AV18OrderedBy == 2 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, LegCuenLicTpo, LegCuenAnio, LegCuLAprLicCnt, LegCuLAprLicFch" ;
      }
      else if ( ( AV18OrderedBy == 2 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LegNumero DESC, LegCuenLicTpo DESC, LegCuenAnio DESC, LegCuLAprLicCnt DESC, LegCuLAprLicFch" ;
      }
      else if ( ( AV18OrderedBy == 3 ) && ! AV19OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, LegCuenLicTpo, LegCuenAnio, LegCuLAprLicOri, LegCuLAprLicFch" ;
      }
      else if ( ( AV18OrderedBy == 3 ) && ( AV19OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LegNumero DESC, LegCuenLicTpo DESC, LegCuenAnio DESC, LegCuLAprLicOri DESC, LegCuLAprLicFch" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, LegCuenLicTpo, LegCuenAnio, LegCuLAprLicFch" ;
   ...
   protected Object[] conditional_H00OX3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV18OrderedBy ,
                                          boolean AV19OrderedDsc ,
                                          ...
                                          short A2266LegCuenAnio )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM legajo_cuenta_licenciasaprobaciones" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LegNumero = ? and LegCuenLicTpo = ( ?) and LegCuenAnio = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00OX2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).intValue() , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() );
            case 1 :
                  return conditional_H00OX3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).intValue() , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00OX2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00OX3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
