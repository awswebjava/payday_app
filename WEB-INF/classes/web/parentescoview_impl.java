...
public final  class parentescoview_impl extends GXDataArea
{
   public parentescoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public parentescoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( parentescoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV9ParCod = httpContext.GetPar( "ParCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9ParCod", AV9ParCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPARCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9ParCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.parentescoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9ParCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","ParCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vPARCOD", GXutil.rtrim( AV9ParCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPARCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9ParCod, ""))));
   ...
   {
      return formatLink("web.parentescoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV9ParCod)),GXutil.URLEncode(GXutil.rtrim(AV7TabCode))}, new String[] {"CliCod","ParCod","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Parentesco View", "") ;
   }
   ...
   public void wb180( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_182( true) ;
      }
      else
      {
         wb_table1_9_182( false) ;
      }
      return  ;
   }

   public void wb_table1_9_182e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start182( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Parentesco View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup180( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV9ParCod = httpContext.cgiGet( "vPARCOD") ;
   ...
   public void e11182( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00182 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV12CliCod), AV9ParCod, Integer.valueOf(AV12CliCod), AV9ParCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A30ParCod = H00182_A30ParCod[0] ;
         A3CliCod = H00182_A3CliCod[0] ;
         A313ParDescrip = H00182_A313ParDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A313ParDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV10LoadAllTabs || ( GXutil.strcmp(AV11SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV11SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ParentescoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.parentescogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ParentescoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV12CliCod),AV9ParCod});
   ...
   public void wb_table1_9_182( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ParentescoView.htm");
         /* Div Control */
         ...
         wb_table1_9_182e( true) ;
      }
      else
      {
         wb_table1_9_182e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12CliCod), 6, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vCLICOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12CliCod), "ZZZZZ9")));
      AV9ParCod = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9ParCod", AV9ParCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPARCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV9ParCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020362990", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("parentescoview.js", "?2024122020362991", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Parentesco View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV9ParCod',fld:'vPARCOD',pic:'',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00182_A30ParCod = new String[] {""} ;
      H00182_A3CliCod = new int[1] ;
      H00182_A313ParDescrip = new String[] {""} ;
      A30ParCod = "" ;
      A313ParDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.parentescoview__default(),
         new Object[] {
             new Object[] {
            H00182_A30ParCod, H00182_A3CliCod, H00182_A313ParDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00182_A30ParCod ;
   private int[] H00182_A3CliCod ;
   private String[] H00182_A313ParDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class parentescoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00182", "SELECT ParCod, CliCod, ParDescrip FROM Parentesco WHERE (CliCod = ? and ParCod = ( ?)) AND (CliCod = ? and ParCod = ( ?)) ORDER BY CliCod, ParCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
