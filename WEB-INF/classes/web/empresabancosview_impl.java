...
public final  class empresabancosview_impl extends GXDataArea
{
   public empresabancosview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public empresabancosview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( empresabancosview_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV12EmpBanCod = httpContext.GetPar( "EmpBanCod") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12EmpBanCod", AV12EmpBanCod);
               web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPBANCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpBanCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.empresabancosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12EmpBanCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpBanCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      web.GxWebStd.gx_hidden_field( httpContext, "vEMPBANCOD", GXutil.rtrim( AV12EmpBanCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPBANCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpBanCod, ""))));
   ...
   {
      return formatLink("web.empresabancosview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11EmpCod,4,0)),GXutil.URLEncode(GXutil.rtrim(AV12EmpBanCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","EmpCod","EmpBanCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "EmpresaBancosView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Empresa Bancos View", "") ;
   }
   ...
   public void wbO50( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_O52( true) ;
      }
      else
      {
         wb_table1_9_O52( false) ;
      }
      return  ;
   }

   public void wb_table1_9_O52e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startO52( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Empresa Bancos View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesO52( )
   {
   }
   ...
   public void strupO50( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV12EmpBanCod = httpContext.cgiGet( "vEMPBANCOD") ;
   ...
   public void e11O52( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00O52 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12EmpBanCod, Integer.valueOf(AV10CliCod), Short.valueOf(AV11EmpCod), AV12EmpBanCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1966EmpBanCod = H00O52_A1966EmpBanCod[0] ;
         A1EmpCod = H00O52_A1EmpCod[0] ;
         A3CliCod = H00O52_A3CliCod[0] ;
         A1967EmpBanDescrip = H00O52_A1967EmpBanDescrip[0] ;
         A1967EmpBanDescrip = H00O52_A1967EmpBanDescrip[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1967EmpBanDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EmpresaBancosGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.empresabancosgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EmpresaBancosGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),Short.valueOf(AV11EmpCod),AV12EmpBanCod});
   ...
   public void wb_table1_9_O52( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_EmpresaBancosView.htm");
         /* Div Control */
         ...
         wb_table1_9_O52e( true) ;
      }
      else
      {
         wb_table1_9_O52e( false) ;
      }
   }
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11EmpCod), 4, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPCOD", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV11EmpCod), "ZZZ9")));
      AV12EmpBanCod = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12EmpBanCod", AV12EmpBanCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPBANCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV12EmpBanCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019575665", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("empresabancosview.js", "?2024122019575665", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Empresa Bancos View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11EmpCod',fld:'vEMPCOD',pic:'ZZZ9',hsh:true},{av:'AV12EmpBanCod',fld:'vEMPBANCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00O52_A1966EmpBanCod = new String[] {""} ;
      H00O52_A1EmpCod = new short[1] ;
      H00O52_A3CliCod = new int[1] ;
      H00O52_A1967EmpBanDescrip = new String[] {""} ;
      A1966EmpBanCod = "" ;
      A1967EmpBanDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.empresabancosview__default(),
         new Object[] {
             new Object[] {
            H00O52_A1966EmpBanCod, H00O52_A1EmpCod, H00O52_A3CliCod, H00O52_A1967EmpBanDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int idxLst ;
   private String wcpOAV12EmpBanCod ;
   private String wcpOAV8TabCode ;
   private String Tabs_Activepagecontrolname ;
   private String gxfirstwebparm ;
   private String gxfirstwebparm_bkp ;
   private String AV12EmpBanCod ;
   ...
   private String[] H00O52_A1966EmpBanCod ;
   private short[] H00O52_A1EmpCod ;
   private int[] H00O52_A3CliCod ;
   private String[] H00O52_A1967EmpBanDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class empresabancosview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00O52", "SELECT T1.EmpBanCod AS EmpBanCod, T1.EmpCod, T1.CliCod, T2.BanDescrip AS EmpBanDescrip FROM (EmpresaBancos T1 INNER JOIN Banco T2 ON T2.CliCod = T1.CliCod AND T2.BanCod = T1.EmpBanCod) WHERE (T1.CliCod = ? and T1.EmpCod = ? and T1.EmpBanCod = ( ?)) AND (T1.CliCod = ? and T1.EmpCod = ? and T1.EmpBanCod = ( ?)) ORDER BY T1.CliCod, T1.EmpCod, T1.EmpBanCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
