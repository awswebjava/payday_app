...
@javax.ws.rs.Path("/CategoriaLoadDVCombo")
public final  class categorialoaddvcombo_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.categorialoaddvcombo_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      ...
      if ( ! processHeaders("categorialoaddvcombo",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.categorialoaddvcombo worker = new web.categorialoaddvcombo(remoteHandle, context);
         ...
         web.categorialoaddvcombo_RESTInterfaceOUT data = new web.categorialoaddvcombo_RESTInterfaceOUT();
