...
public final  class modalidadafipview_impl extends GXDataArea
{
   public modalidadafipview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public modalidadafipview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( modalidadafipview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "MprCod") ;
         ...
         {
            AV10MprCod = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10MprCod", AV10MprCod);
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMPRCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10MprCod, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.modalidadafipview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10MprCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"MprCod","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vMPRCOD", GXutil.rtrim( AV10MprCod));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMPRCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10MprCod, ""))));
   ...
   {
      return formatLink("web.modalidadafipview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV10MprCod)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"MprCod","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ModalidadAFIPView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Modalidad AFIPView", "") ;
   }
   ...
   public void wbB50( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_B52( true) ;
      }
      else
      {
         wb_table1_9_B52( false) ;
      }
      return  ;
   }

   public void wb_table1_9_B52e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startB52( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Modalidad AFIPView", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesB52( )
   {
   }
   ...
   public void strupB50( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10MprCod = httpContext.cgiGet( "vMPRCOD") ;
   ...
   public void e11B52( )
   {
      ...
      AV20GXLvl11 = (byte)(0) ;
      /* Using cursor H00B52 */
      pr_default.execute(0, new Object[] {AV10MprCod});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A18MprCod = H00B52_A18MprCod[0] ;
         A303MprDescrip = H00B52_A303MprDescrip[0] ;
         AV20GXLvl11 = (byte)(1) ;
         Form.setCaption( A303MprDescrip );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ModalidadGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.modalidadgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ModalidadGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",AV10MprCod});
   ...
   public void wb_table1_9_B52( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ModalidadAFIPView.htm");
         /* Div Control */
         ...
         wb_table1_9_B52e( true) ;
      }
      else
      {
         wb_table1_9_B52e( false) ;
      }
   }
   ...
   {
      AV10MprCod = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10MprCod", AV10MprCod);
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMPRCOD", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV10MprCod, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020292413", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("modalidadafipview.js", "?2024122020292413", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Modalidad AFIPView", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10MprCod',fld:'vMPRCOD',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00B52_A18MprCod = new String[] {""} ;
      H00B52_A303MprDescrip = new String[] {""} ;
      A18MprCod = "" ;
      A303MprDescrip = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.modalidadafipview__default(),
         new Object[] {
             new Object[] {
            H00B52_A18MprCod, H00B52_A303MprDescrip
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00B52_A18MprCod ;
   private String[] H00B52_A303MprDescrip ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class modalidadafipview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00B52", "SELECT MprCod, MprDescrip FROM ModalidadAFIP WHERE MprCod = ( ?) ORDER BY MprCod ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
