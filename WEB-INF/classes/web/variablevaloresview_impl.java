...
public final  class variablevaloresview_impl extends GXDataArea
{
   public variablevaloresview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public variablevaloresview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( variablevaloresview_impl.class ));
   }
   ...
   {
      return formatLink("web.variablevaloresview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10CliCod,6,0)),GXutil.URLEncode(GXutil.rtrim(AV11OpeCliId)),GXutil.URLEncode(GXutil.formatDateParm(AV12OpeCliVig)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"CliCod","OpeCliId","OpeCliVig","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "VariableValoresView" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Variable Valores View", "") ;
   }
   ...
   public void wbI90( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_I92( true) ;
      }
      else
      {
         wb_table1_9_I92( false) ;
      }
      return  ;
   }

   public void wb_table1_9_I92e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startI92( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Variable Valores View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashesI92( )
   {
   }
   ...
   public void strupI90( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11OpeCliId = httpContext.cgiGet( "vOPECLIID") ;
         AV12OpeCliVig = localUtil.ctod( httpContext.cgiGet( "vOPECLIVIG"), 0) ;
   ...
   public void e11I92( )
   {
      ...
      {
         A754OpeCliVig = H00I92_A754OpeCliVig[0] ;
         A82OpeCliId = H00I92_A82OpeCliId[0] ;
         A3CliCod = H00I92_A3CliCod[0] ;
         A924OpeCliVPropagar = H00I92_A924OpeCliVPropagar[0] ;
         n924OpeCliVPropagar = H00I92_n924OpeCliVPropagar[0] ;
         AV19GXLvl11 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( AV13LoadAllTabs || ( GXutil.strcmp(AV14SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV14SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "VariableValoresGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.variablevaloresgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "VariableValoresGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Integer.valueOf(AV10CliCod),AV11OpeCliId,AV12OpeCliVig});
   ...
   public void wb_table1_9_I92( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_VariableValoresView.htm");
         /* Div Control */
         ...
         wb_table1_9_I92e( true) ;
      }
      else
      {
         wb_table1_9_I92e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202412202044066", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("variablevaloresview.js", "?202412202044066", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Variable Valores View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10CliCod',fld:'vCLICOD',pic:'ZZZZZ9',hsh:true},{av:'AV11OpeCliId',fld:'vOPECLIID',pic:'',hsh:true},{av:'AV12OpeCliVig',fld:'vOPECLIVIG',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00I92_A754OpeCliVig = new java.util.Date[] {GXutil.nullDate()} ;
      H00I92_A82OpeCliId = new String[] {""} ;
      H00I92_A3CliCod = new int[1] ;
      H00I92_A924OpeCliVPropagar = new boolean[] {false} ;
      H00I92_n924OpeCliVPropagar = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.variablevaloresview__default(),
         new Object[] {
             new Object[] {
            H00I92_A754OpeCliVig, H00I92_A82OpeCliId, H00I92_A3CliCod, H00I92_A924OpeCliVPropagar, H00I92_n924OpeCliVPropagar
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private java.util.Date[] H00I92_A754OpeCliVig ;
   private String[] H00I92_A82OpeCliId ;
   private int[] H00I92_A3CliCod ;
   private boolean[] H00I92_A924OpeCliVPropagar ;
   private boolean[] H00I92_n924OpeCliVPropagar ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class variablevaloresview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00I92", "SELECT OpeCliVig, OpeCliId, CliCod, OpeCliVPropagar FROM variable_valores WHERE (CliCod = ? and OpeCliId = ( ?) and OpeCliVig = ?) AND (CliCod = ? and OpeCliId = ( ?) and OpeCliVig = ?) ORDER BY CliCod, OpeCliId, OpeCliVig ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
