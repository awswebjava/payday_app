...
@javax.xml.bind.annotation.XmlType(name = "sexosloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class sexosloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("SexoId")
   public void setSexoId(  byte Value )
   {
      AV18SexoId= Value;
   }
