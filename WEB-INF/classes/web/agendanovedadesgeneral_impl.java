...
public final  class agendanovedadesgeneral_impl extends GXWebComponent
{
   public agendanovedadesgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public agendanovedadesgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( agendanovedadesgeneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Agenda Novedades General", "")) ;
   ...
   {
      return "AgendaNovedadesGeneral" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Agenda Novedades General", "") ;
   }
   ...
   public void wb610( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.agendanovedadesgeneral");
         }
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblTextblockageimporte_Internalname, httpContext.getMessage( "Importe", ""), "", "", lblTextblockageimporte_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, (short)(0), "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
         wb_table1_27_612( true) ;
      }
      else
      {
         wb_table1_27_612( false) ;
      }
      return  ;
   }

   public void wb_table1_27_612e( boolean wbgen )
   {
      if ( wbgen )
      {
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtAgeFecDes_Internalname, localUtil.format(A111AgeFecDes, "99/99/9999"), localUtil.format( A111AgeFecDes, "99/99/9999"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeFecDes_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAgeFecDes_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Fecha", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_bitmap( httpContext, edtAgeFecDes_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtAgeFecDes_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_AgendaNovedadesGeneral.htm");
         ...
         web.GxWebStd.gx_single_line_edit( httpContext, edtAgeFecHas_Internalname, localUtil.format(A112AgeFecHas, "99/99/9999"), localUtil.format( A112AgeFecHas, "99/99/9999"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeFecHas_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAgeFecHas_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Fecha", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_bitmap( httpContext, edtAgeFecHas_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtAgeFecHas_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_AgendaNovedadesGeneral.htm");
         httpContext.writeTextNL( "</div>") ;
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", httpContext.getMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, httpContext.getMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11611_client"+"'", TempTags, "", 2, "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         web.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", httpContext.getMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, httpContext.getMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12611_client"+"'", TempTags, "", 2, "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegNumero_Internalname, GXutil.ltrim( localUtil.ntoc( A6LegNumero, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6LegNumero), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegNumero_Jsonclick, 0, "Attribute", "", "", "", "", edtLegNumero_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoMedio", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtAgeVUnit_Internalname, GXutil.ltrim( localUtil.ntoc( A115AgeVUnit, (byte)(17), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( A115AgeVUnit, "ZZ,ZZZ,ZZZ,ZZ9.99")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeVUnit_Jsonclick, 0, "Attribute", "", "", "", "", edtAgeVUnit_Visible, 0, 0, "text", "", 17, "chr", 1, "row", 17, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Importes", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start612( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Agenda Novedades General", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "AgendaNovedadesGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void e13612( )
   {
      ...
      agendanovedadesgeneral_impl.this.GXt_int1 = GXv_int2[0] ;
      AV11CliCod = GXt_int1 ;
   ...
   protected void e14612( )
   {
      ...
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWAgendaNovedades_Update", GXv_boolean5) ;
      agendanovedadesgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      ...
      GXt_boolean4 = AV14TempBoolean ;
      GXv_boolean5[0] = GXt_boolean4 ;
      new web.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWAgendaNovedades_Delete", GXv_boolean5) ;
      agendanovedadesgeneral_impl.this.GXt_boolean4 = GXv_boolean5[0] ;
      AV14TempBoolean = GXt_boolean4 ;
      if ( ! ( AV14TempBoolean ) )
      {
   ...
   public void S112( )
   {
      ...
      AV7TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "AgendaNovedades" );
   ...
   public void wb_table1_27_612( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtAgeImporte_Internalname, GXutil.ltrim( localUtil.ntoc( A113AgeImporte, (byte)(17), (byte)(2), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( ((edtAgeImporte_Enabled!=0) ? localUtil.format( A113AgeImporte, "ZZ,ZZZ,ZZZ,ZZ9.99") : localUtil.format( A113AgeImporte, "ZZ,ZZZ,ZZZ,ZZ9.99"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeImporte_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAgeImporte_Enabled, 0, "text", "", 17, "chr", 1, "row", 17, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "Importes", "right", false, "", "HLP_AgendaNovedadesGeneral.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblAgeimporte_righttext_Internalname, httpContext.getMessage( "Si ingresa valor en importe, se sobreescribirá la fórmula con este valor", ""), "", "", lblAgeimporte_righttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataDescription", 0, "", 1, 1, 0, (short)(0), "HLP_AgendaNovedadesGeneral.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_27_612e( true) ;
      }
      else
      {
         wb_table1_27_612e( false) ;
      }
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "agendanovedadesgeneral", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019403039", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("agendanovedadesgeneral.js", "?2024122019403039", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e11611',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A25AgeOrden',fld:'AGEORDEN',pic:'ZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e12611',iparms:[{av:'A3CliCod',fld:'CLICOD',pic:'ZZZZZ9'},{av:'A1EmpCod',fld:'EMPCOD',pic:'ZZZ9'},{av:'A6LegNumero',fld:'LEGNUMERO',pic:'ZZZZZZZ9'},{av:'A25AgeOrden',fld:'AGEORDEN',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00612_A3CliCod = new int[1] ;
      H00612_A1EmpCod = new short[1] ;
      H00612_A6LegNumero = new int[1] ;
      H00612_A25AgeOrden = new short[1] ;
      H00612_A115AgeVUnit = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00612_n115AgeVUnit = new boolean[] {false} ;
      H00612_A112AgeFecHas = new java.util.Date[] {GXutil.nullDate()} ;
      H00612_n112AgeFecHas = new boolean[] {false} ;
      H00612_A111AgeFecDes = new java.util.Date[] {GXutil.nullDate()} ;
      H00612_n111AgeFecDes = new boolean[] {false} ;
      H00612_A113AgeImporte = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00612_n113AgeImporte = new boolean[] {false} ;
      H00612_A110AgeCanti = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00612_n110AgeCanti = new boolean[] {false} ;
      H00612_A26ConCodigo = new String[] {""} ;
      ...
      sCtrlA6LegNumero = "" ;
      sCtrlA25AgeOrden = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new web.agendanovedadesgeneral__default(),
         new Object[] {
             new Object[] {
            H00612_A3CliCod, H00612_A1EmpCod, H00612_A6LegNumero, H00612_A25AgeOrden, H00612_A115AgeVUnit, H00612_n115AgeVUnit, H00612_A112AgeFecHas, H00612_n112AgeFecHas, H00612_A111AgeFecDes, H00612_n111AgeFecDes,
            H00612_A113AgeImporte, H00612_n113AgeImporte, H00612_A110AgeCanti, H00612_n110AgeCanti, H00612_A26ConCodigo
            }
         }
      );
      AV17Pgmname = "AgendaNovedadesGeneral" ;
   ...
   private int[] H00612_A3CliCod ;
   private short[] H00612_A1EmpCod ;
   private int[] H00612_A6LegNumero ;
   private short[] H00612_A25AgeOrden ;
   private java.math.BigDecimal[] H00612_A115AgeVUnit ;
   private boolean[] H00612_n115AgeVUnit ;
   private java.util.Date[] H00612_A112AgeFecHas ;
   private boolean[] H00612_n112AgeFecHas ;
   private java.util.Date[] H00612_A111AgeFecDes ;
   private boolean[] H00612_n111AgeFecDes ;
   private java.math.BigDecimal[] H00612_A113AgeImporte ;
   private boolean[] H00612_n113AgeImporte ;
   private java.math.BigDecimal[] H00612_A110AgeCanti ;
   private boolean[] H00612_n110AgeCanti ;
   private String[] H00612_A26ConCodigo ;
