...
public final  class conceptosafipwizardinicio_impl extends GXWebComponent
{
   public conceptosafipwizardinicio_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public conceptosafipwizardinicio_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( conceptosafipwizardinicio_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Conceptos Afip Wizard Inicio", "")) ;
   ...
   public void renderHtmlCloseForm6W2( )
   {
   ...
   {
      return "ConceptosAfipWizardInicio" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Conceptos Afip Wizard Inicio", "") ;
   }
   ...
   public void wb6W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.conceptosafipwizardinicio");
            httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
         ...
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblWelcometitle_Internalname, httpContext.getMessage( "WWP_WizardWelcomeCaption", ""), "", "", lblWelcometitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardTextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ConceptosAfipWizardInicio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 TextBlockWizardDescriptionCell", "left", "top", "", "", "div");
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblExplanation_Internalname, lblExplanation_Caption, "", "", lblExplanation_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardTextBlockDescription", 0, "", 1, 1, 0, (short)(0), "HLP_ConceptosAfipWizardInicio.htm");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         web.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6W2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Conceptos Afip Wizard Inicio", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void e116W2( )
   {
      ...
      conceptosafipwizardinicio_impl.this.GXt_int1 = GXv_int2[0] ;
      AV12CliCod = GXt_int1 ;
      ...
      new web.getparametro(remoteHandle, context).execute( AV12CliCod, httpContext.getMessage( "expl_CAfip", ""), GXv_char4) ;
      conceptosafipwizardinicio_impl.this.GXt_char3 = GXv_char4[0] ;
      lblExplanation_Caption = GXt_char3 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, lblExplanation_Internalname, "Caption", lblExplanation_Caption, true);
   }
   ...
   public void e136W2( )
   {
      ...
      if ( true )
      {
         if ( ! AV10HasValidationErrors )
         {
            ...
            S132 ();
            if (returnInSub) return;
            AV14proximoPaso = AV5WebSession.getValue(httpContext.getMessage( "proximoPaso", "")) ;
            callWebObject(formatLink("web.conceptosafipwizard", new String[] {GXutil.URLEncode(GXutil.rtrim("Inicio")),GXutil.URLEncode(GXutil.rtrim(GXutil.trim( AV14proximoPaso))),GXutil.URLEncode(GXutil.booltostr(false))}, new String[] {"PreviousStep","CurrentStep","GoingBack"}) );
      ...
      else
      {
         if ( ! AV10HasValidationErrors )
         {
            ...
            S132 ();
            if (returnInSub) return;
            callWebObject(formatLink("web.conceptosafipwizard", new String[] {GXutil.URLEncode(GXutil.rtrim("Inicio")),GXutil.URLEncode(GXutil.rtrim("Concepto1")),GXutil.URLEncode(GXutil.booltostr(false))}, new String[] {"PreviousStep","CurrentStep","GoingBack"}) );
            httpContext.wjLocDisableFrm = (byte)(1) ;
         }
      }
      /*  Sending Event outputs  */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "conceptosafipwizardinicio", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122019472694", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("conceptosafipwizardinicio.js", "?2024122019472694", false, true);
      httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      lblExplanation_Caption = httpContext.getMessage( "Modifique este texto con una explicación del propósito del asistente, los pasos que lo conforman, etc.", "") ;
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("ENTER","{handler:'e136W2',iparms:[{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV6WebSessionKey',fld:'vWEBSESSIONKEY',pic:''}]");
      setEventMetadata("ENTER",",oparms:[]}");
      setEventMetadata("'WIZARDPREVIOUS'","{handler:'e146W2',iparms:[]");
   ...
   private String lblExplanation_Caption ;
   ...
   private String AV14proximoPaso ;
