...
public final  class sucursallegajowc_impl extends GXWebComponent
{
   public sucursallegajowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public sucursallegajowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( sucursallegajowc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Sucursal Legajo WC", "")) ;
   ...
   public void renderHtmlCloseFormPK2( )
   {
   ...
   {
      return "SucursalLegajoWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Sucursal Legajo WC", "") ;
   }
   ...
   public void wbPK0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.sucursallegajowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 22 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_SucursalLegajoWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_SucursalLegajoWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegSucCodigo_Internalname, GXutil.rtrim( A1577LegSucCodigo), GXutil.rtrim( localUtil.format( A1577LegSucCodigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegSucCodigo_Jsonclick, 0, "Attribute", "", "", "", "", edtLegSucCodigo_Visible, 0, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "CodigoCaracter", "left", true, "", "HLP_SucursalLegajoWC.htm");
         /* User Defined Control */
   ...
   public void startPK2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Sucursal Legajo WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rfPK2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1030LegFotoNom = H00PK2_A1030LegFotoNom[0] ;
            edtLegFoto_Filename = A1030LegFotoNom ;
            A1031LegFotoExt = H00PK2_A1031LegFotoExt[0] ;
            ...
            A3CliCod = H00PK2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H00PK2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A1577LegSucCodigo = H00PK2_A1577LegSucCodigo[0] ;
            n1577LegSucCodigo = H00PK2_n1577LegSucCodigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1577LegSucCodigo", A1577LegSucCodigo);
            A255LegLocNom = H00PK2_A255LegLocNom[0] ;
            A24LegLocCod = H00PK2_A24LegLocCod[0] ;
            n24LegLocCod = H00PK2_n24LegLocCod[0] ;
            A260LegProvNom = H00PK2_A260LegProvNom[0] ;
            A23LegProvCod = H00PK2_A23LegProvCod[0] ;
            n23LegProvCod = H00PK2_n23LegProvCod[0] ;
            A258LegPaiNom = H00PK2_A258LegPaiNom[0] ;
            A22LegPaiCod = H00PK2_A22LegPaiCod[0] ;
            n22LegPaiCod = H00PK2_n22LegPaiCod[0] ;
            A236LegCodPos = H00PK2_A236LegCodPos[0] ;
            A479LegEmail = H00PK2_A479LegEmail[0] ;
            A242LegDomici = H00PK2_A242LegDomici[0] ;
            A241LegDiscapacidad = H00PK2_A241LegDiscapacidad[0] ;
            A239LegCUIL = H00PK2_A239LegCUIL[0] ;
            A256LegNacionalidad = H00PK2_A256LegNacionalidad[0] ;
            A21LegNacionCod = H00PK2_A21LegNacionCod[0] ;
            n21LegNacionCod = H00PK2_n21LegNacionCod[0] ;
            A243LegEstadoCivil = H00PK2_A243LegEstadoCivil[0] ;
            n243LegEstadoCivil = H00PK2_n243LegEstadoCivil[0] ;
            A263LegSexo = H00PK2_A263LegSexo[0] ;
            n263LegSexo = H00PK2_n263LegSexo[0] ;
            A246LegFecNac = H00PK2_A246LegFecNac[0] ;
            A257LegNumDoc = H00PK2_A257LegNumDoc[0] ;
            A266LegTipDoc = H00PK2_A266LegTipDoc[0] ;
            A249LegFoto = H00PK2_A249LegFoto[0] ;
            n249LegFoto = H00PK2_n249LegFoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLegFoto_Internalname, "URL", httpContext.getResourceRelative(A249LegFoto), !bGXsfl_22_Refreshing);
            A251LegNombre = H00PK2_A251LegNombre[0] ;
            A230LegApellido = H00PK2_A230LegApellido[0] ;
            A6LegNumero = H00PK2_A6LegNumero[0] ;
            A2EmpNom = H00PK2_A2EmpNom[0] ;
            A2EmpNom = H00PK2_A2EmpNom[0] ;
            A258LegPaiNom = H00PK2_A258LegPaiNom[0] ;
            A260LegProvNom = H00PK2_A260LegProvNom[0] ;
            A255LegLocNom = H00PK2_A255LegLocNom[0] ;
   ...
   public void send_integrity_lvl_hashesPK2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV27Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV27Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      GRID_nRecordCount = H00PK3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e14PK2( )
   {
      ...
      sucursallegajowc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e15PK2( )
   {
      ...
      sucursallegajowc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Legajo" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "sucursallegajowc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20251713584978", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("sucursallegajowc.js", "?20251713584978", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16PK2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A255LegLocNom = "" ;
      scmdbuf = "" ;
      H00PK2_A1030LegFotoNom = new String[] {""} ;
      H00PK2_A1031LegFotoExt = new String[] {""} ;
      H00PK2_A3CliCod = new int[1] ;
      H00PK2_A1EmpCod = new short[1] ;
      H00PK2_A1577LegSucCodigo = new String[] {""} ;
      H00PK2_n1577LegSucCodigo = new boolean[] {false} ;
      H00PK2_A255LegLocNom = new String[] {""} ;
      H00PK2_A24LegLocCod = new short[1] ;
      H00PK2_n24LegLocCod = new boolean[] {false} ;
      H00PK2_A260LegProvNom = new String[] {""} ;
      H00PK2_A23LegProvCod = new short[1] ;
      H00PK2_n23LegProvCod = new boolean[] {false} ;
      H00PK2_A258LegPaiNom = new String[] {""} ;
      H00PK2_A22LegPaiCod = new short[1] ;
      H00PK2_n22LegPaiCod = new boolean[] {false} ;
      H00PK2_A236LegCodPos = new String[] {""} ;
      H00PK2_A479LegEmail = new String[] {""} ;
      H00PK2_A242LegDomici = new String[] {""} ;
      H00PK2_A241LegDiscapacidad = new byte[1] ;
      H00PK2_A239LegCUIL = new long[1] ;
      H00PK2_A256LegNacionalidad = new String[] {""} ;
      H00PK2_A21LegNacionCod = new short[1] ;
      H00PK2_n21LegNacionCod = new boolean[] {false} ;
      H00PK2_A243LegEstadoCivil = new short[1] ;
      H00PK2_n243LegEstadoCivil = new boolean[] {false} ;
      H00PK2_A263LegSexo = new byte[1] ;
      H00PK2_n263LegSexo = new boolean[] {false} ;
      H00PK2_A246LegFecNac = new java.util.Date[] {GXutil.nullDate()} ;
      H00PK2_A257LegNumDoc = new String[] {""} ;
      H00PK2_A266LegTipDoc = new byte[1] ;
      H00PK2_A249LegFoto = new String[] {""} ;
      H00PK2_n249LegFoto = new boolean[] {false} ;
      H00PK2_A251LegNombre = new String[] {""} ;
      H00PK2_A230LegApellido = new String[] {""} ;
      H00PK2_A6LegNumero = new int[1] ;
      H00PK2_A2EmpNom = new String[] {""} ;
      A1030LegFotoNom = "" ;
      edtLegFoto_Filename = "" ;
      A1031LegFotoExt = "" ;
      H00PK3_AGRID_nRecordCount = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.sucursallegajowc__default(),
         new Object[] {
             new Object[] {
            H00PK2_A1030LegFotoNom, H00PK2_A1031LegFotoExt, H00PK2_A3CliCod, H00PK2_A1EmpCod, H00PK2_A1577LegSucCodigo, H00PK2_n1577LegSucCodigo, H00PK2_A255LegLocNom, H00PK2_A24LegLocCod, H00PK2_n24LegLocCod, H00PK2_A260LegProvNom,
            H00PK2_A23LegProvCod, H00PK2_n23LegProvCod, H00PK2_A258LegPaiNom, H00PK2_A22LegPaiCod, H00PK2_n22LegPaiCod, H00PK2_A236LegCodPos, H00PK2_A479LegEmail, H00PK2_A242LegDomici, H00PK2_A241LegDiscapacidad, H00PK2_A239LegCUIL,
            H00PK2_A256LegNacionalidad, H00PK2_A21LegNacionCod, H00PK2_n21LegNacionCod, H00PK2_A243LegEstadoCivil, H00PK2_n243LegEstadoCivil, H00PK2_A263LegSexo, H00PK2_n263LegSexo, H00PK2_A246LegFecNac, H00PK2_A257LegNumDoc, H00PK2_A266LegTipDoc,
            H00PK2_A249LegFoto, H00PK2_n249LegFoto, H00PK2_A251LegNombre, H00PK2_A230LegApellido, H00PK2_A6LegNumero, H00PK2_A2EmpNom
            }
            , new Object[] {
            H00PK3_AGRID_nRecordCount
            }
         }
      );
      AV27Pgmname = "SucursalLegajoWC" ;
   ...
   private String[] H00PK2_A1030LegFotoNom ;
   private String[] H00PK2_A1031LegFotoExt ;
   private int[] H00PK2_A3CliCod ;
   private short[] H00PK2_A1EmpCod ;
   private String[] H00PK2_A1577LegSucCodigo ;
   private boolean[] H00PK2_n1577LegSucCodigo ;
   private String[] H00PK2_A255LegLocNom ;
   private short[] H00PK2_A24LegLocCod ;
   private boolean[] H00PK2_n24LegLocCod ;
   private String[] H00PK2_A260LegProvNom ;
   private short[] H00PK2_A23LegProvCod ;
   private boolean[] H00PK2_n23LegProvCod ;
   private String[] H00PK2_A258LegPaiNom ;
   private short[] H00PK2_A22LegPaiCod ;
   private boolean[] H00PK2_n22LegPaiCod ;
   private String[] H00PK2_A236LegCodPos ;
   private String[] H00PK2_A479LegEmail ;
   private String[] H00PK2_A242LegDomici ;
   private byte[] H00PK2_A241LegDiscapacidad ;
   private long[] H00PK2_A239LegCUIL ;
   private String[] H00PK2_A256LegNacionalidad ;
   private short[] H00PK2_A21LegNacionCod ;
   private boolean[] H00PK2_n21LegNacionCod ;
   private short[] H00PK2_A243LegEstadoCivil ;
   private boolean[] H00PK2_n243LegEstadoCivil ;
   private byte[] H00PK2_A263LegSexo ;
   private boolean[] H00PK2_n263LegSexo ;
   private java.util.Date[] H00PK2_A246LegFecNac ;
   private String[] H00PK2_A257LegNumDoc ;
   private byte[] H00PK2_A266LegTipDoc ;
   private String[] H00PK2_A249LegFoto ;
   private boolean[] H00PK2_n249LegFoto ;
   private String[] H00PK2_A251LegNombre ;
   private String[] H00PK2_A230LegApellido ;
   private int[] H00PK2_A6LegNumero ;
   private String[] H00PK2_A2EmpNom ;
   private long[] H00PK3_AGRID_nRecordCount ;
...
final  class sucursallegajowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00PK2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00PK3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV16OrderedBy ,
                                          boolean AV17OrderedDsc ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00PK2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() );
            case 1 :
                  return conditional_H00PK3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00PK2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00PK3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
