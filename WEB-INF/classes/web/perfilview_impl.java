...
public final  class perfilview_impl extends GXDataArea
{
   public perfilview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public perfilview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( perfilview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10PerfilId = (byte)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10PerfilId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PerfilId), 2, 0));
            web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPERFILID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PerfilId), "Z9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.perfilview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PerfilId,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PerfilId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, "vPERFILID", GXutil.ltrim( localUtil.ntoc( AV10PerfilId, (byte)(2), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPERFILID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PerfilId), "Z9")));
   ...
   {
      return formatLink("web.perfilview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PerfilId,2,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PerfilId","TabCode"})  ;
   }
   ...
   {
      return httpContext.getMessage( "Perfil View", "") ;
   }
   ...
   public void wbLD0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         web.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         wb_table1_9_LD2( true) ;
      }
      else
      {
         wb_table1_9_LD2( false) ;
      }
      return  ;
   }

   public void wb_table1_9_LD2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void startLD2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", httpContext.getMessage( "Perfil View", ""), (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strupLD0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10PerfilId = (byte)(localUtil.ctol( httpContext.cgiGet( "vPERFILID"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e11LD2( )
   {
      ...
      AV18GXLvl11 = (byte)(0) ;
      /* Using cursor H00LD2 */
      pr_default.execute(0, new Object[] {Byte.valueOf(AV10PerfilId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A1925PerfilId = H00LD2_A1925PerfilId[0] ;
         A1926PerfilNombre = H00LD2_A1926PerfilNombre[0] ;
         AV18GXLvl11 = (byte)(1) ;
         Form.setCaption( A1926PerfilNombre );
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "PerfilGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "web.perfilgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "PerfilGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0023","",Byte.valueOf(AV10PerfilId)});
   ...
   public void wb_table1_9_LD2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         web.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, httpContext.getMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PerfilView.htm");
         /* Div Control */
         ...
         wb_table1_9_LD2e( true) ;
      }
      else
      {
         wb_table1_9_LD2e( false) ;
      }
   }
   ...
   {
      AV10PerfilId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.BYTE)).byteValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10PerfilId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PerfilId), 2, 0));
      web.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPERFILID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PerfilId), "Z9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2024122020364061", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("perfilview.js", "?2024122020364061", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( httpContext.getMessage( "Perfil View", "") );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PerfilId',fld:'vPERFILID',pic:'Z9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00LD2_A1925PerfilId = new byte[1] ;
      H00LD2_A1926PerfilNombre = new String[] {""} ;
      A1926PerfilNombre = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new web.perfilview__default(),
         new Object[] {
             new Object[] {
            H00LD2_A1925PerfilId, H00LD2_A1926PerfilNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private byte[] H00LD2_A1925PerfilId ;
   private String[] H00LD2_A1926PerfilNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private web.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private web.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class perfilview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00LD2", "SELECT PerfilId, PerfilNombre FROM Perfil WHERE PerfilId = ? ORDER BY PerfilId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
