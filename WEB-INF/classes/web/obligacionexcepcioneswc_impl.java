...
public final  class obligacionexcepcioneswc_impl extends GXWebComponent
{
   public obligacionexcepcioneswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public obligacionexcepcioneswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( obligacionexcepcioneswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV11OblSecuencial = (short)(GXutil.lval( httpContext.GetPar( "OblSecuencial"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11OblSecuencial", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11OblSecuencial), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8CliCod),Short.valueOf(AV9EmpCod),Integer.valueOf(AV10LegNumero),Short.valueOf(AV11OblSecuencial)});
               componentstart();
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV8CliCod, AV9EmpCod, AV10LegNumero, AV11OblSecuencial, AV29Pgmname, AV17OrderedBy, AV18OrderedDsc, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Obligacion Excepciones WC", "")) ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("web.obligacionexcepcioneswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CliCod,6,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9EmpCod,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV10LegNumero,8,0)),GXutil.URLEncode(GXutil.ltrimstr(AV11OblSecuencial,4,0))}, new String[] {"CliCod","EmpCod","LegNumero","OblSecuencial"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV11OblSecuencial", GXutil.ltrim( localUtil.ntoc( wcpOAV11OblSecuencial, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vOBLSECUENCIAL", GXutil.ltrim( localUtil.ntoc( AV11OblSecuencial, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
   ...
   public void renderHtmlCloseFormCG2( )
   {
   ...
   {
      return "ObligacionExcepcionesWC" ;
   }

   public String getPgmdesc( )
   {
      return httpContext.getMessage( "Obligacion Excepciones WC", "") ;
   }
   ...
   public void wbCG0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "web.obligacionexcepcioneswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtCliCod_Internalname, GXutil.ltrim( localUtil.ntoc( A3CliCod, (byte)(6), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3CliCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCliCod_Jsonclick, 0, "Attribute", "", "", "", "", edtCliCod_Visible, 0, 0, "text", "1", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_ObligacionExcepcionesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtEmpCod_Internalname, GXutil.ltrim( localUtil.ntoc( A1EmpCod, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1EmpCod), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpCod_Jsonclick, 0, "Attribute", "", "", "", "", edtEmpCod_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoChico", "right", false, "", "HLP_ObligacionExcepcionesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtLegNumero_Internalname, GXutil.ltrim( localUtil.ntoc( A6LegNumero, (byte)(8), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6LegNumero), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLegNumero_Jsonclick, 0, "Attribute", "", "", "", "", edtLegNumero_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "CodigoMedio", "right", false, "", "HLP_ObligacionExcepcionesWC.htm");
         /* Single line edit */
         web.GxWebStd.gx_single_line_edit( httpContext, edtOblSecuencial_Internalname, GXutil.ltrim( localUtil.ntoc( A1172OblSecuencial, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1172OblSecuencial), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOblSecuencial_Jsonclick, 0, "Attribute", "", "", "", "", edtOblSecuencial_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_ObligacionExcepcionesWC.htm");
         /* User Defined Control */
   ...
   public void startCG2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", httpContext.getMessage( "Obligacion Excepciones WC", ""), (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A1183OblExcTipo = httpContext.cgiGet( edtOblExcTipo_Internalname) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      /* GeneXus formulas. */
      AV29Pgmname = "ObligacionExcepcionesWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rfCG2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV11OblSecuencial) ,
                                              Integer.valueOf(A3CliCod) ,
                                              Short.valueOf(A1EmpCod) ,
                                              Integer.valueOf(A6LegNumero) ,
                                              Short.valueOf(A1172OblSecuencial) } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT
                                              }
         });
         /* Using cursor H00CG2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV10LegNumero), Short.valueOf(AV11OblSecuencial), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A3CliCod = H00CG2_A3CliCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A3CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A3CliCod), 6, 0));
            A1EmpCod = H00CG2_A1EmpCod[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(A1EmpCod), 4, 0));
            A6LegNumero = H00CG2_A6LegNumero[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6LegNumero), 8, 0));
            A1172OblSecuencial = H00CG2_A1172OblSecuencial[0] ;
            ...
            A1183OblExcTipo = H00CG2_A1183OblExcTipo[0] ;
            A1170OblExcConCOdigo = H00CG2_A1170OblExcConCOdigo[0] ;
            e16CG2 ();
   ...
   public void send_integrity_lvl_hashesCG2( )
   {
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV29Pgmname));
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV29Pgmname, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H00CG3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CliCod), Short.valueOf(AV9EmpCod), Integer.valueOf(AV10LegNumero), Short.valueOf(AV11OblSecuencial)});
      GRID_nRecordCount = H00CG3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strupCG0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV11OblSecuencial = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV11OblSecuencial"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
   ...
   public void e14CG2( )
   {
      ...
      obligacionexcepcioneswc_impl.this.GXt_int1 = GXv_int2[0] ;
      AV8CliCod = GXt_int1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8CliCod", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8CliCod), 6, 0));
      subGrid_Rows = 10 ;
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
   ...
   public void e15CG2( )
   {
      ...
      obligacionexcepcioneswc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      AV13TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Obligacion" );
      ...
      AV14TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV10LegNumero, 8, 0) );
      AV13TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV14TrnContextAtt, 0);
      AV14TrnContextAtt = (web.wwpbaseobjects.SdtWWPTransactionContext_Attribute)new web.wwpbaseobjects.SdtWWPTransactionContext_Attribute(remoteHandle, context);
      AV14TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "OblSecuencial" );
      AV14TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV11OblSecuencial, 4, 0) );
      AV13TrnContext.getgxTv_SdtWWPTransactionContext_Attributes().add(AV14TrnContextAtt, 0);
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LegNumero), 8, 0));
      AV11OblSecuencial = ((Number) GXutil.testNumericType( getParm(obj,3,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11OblSecuencial", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11OblSecuencial), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV11OblSecuencial = (String)getParm(obj,3,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "obligacionexcepcioneswc", GetJustCreated( ));
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10LegNumero", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LegNumero), 8, 0));
         AV11OblSecuencial = ((Number) GXutil.testNumericType( getParm(obj,5,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11OblSecuencial", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11OblSecuencial), 4, 0));
      }
      wcpOAV8CliCod = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8CliCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV9EmpCod = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9EmpCod"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV10LegNumero = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV10LegNumero"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      wcpOAV11OblSecuencial = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV11OblSecuencial"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      if ( ! GetJustCreated( ) && ( ( AV8CliCod != wcpOAV8CliCod ) || ( AV9EmpCod != wcpOAV9EmpCod ) || ( AV10LegNumero != wcpOAV10LegNumero ) || ( AV11OblSecuencial != wcpOAV11OblSecuencial ) ) )
      {
         setjustcreated();
      }
      ...
      wcpOAV11OblSecuencial = AV11OblSecuencial ;
   }
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlAV11OblSecuencial = httpContext.cgiGet( sPrefix+"AV11OblSecuencial_CTRL") ;
      if ( GXutil.len( sCtrlAV11OblSecuencial) > 0 )
      {
         AV11OblSecuencial = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV11OblSecuencial), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV11OblSecuencial", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV11OblSecuencial), 4, 0));
      }
      else
      {
         AV11OblSecuencial = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV11OblSecuencial_PARM"), httpContext.getLanguageProperty( "decimal_point"), httpContext.getLanguageProperty( "thousand_sep"))) ;
      }
   }
   ...
   public void wcparametersset( )
   {
      ...
      web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11OblSecuencial_PARM", GXutil.ltrim( localUtil.ntoc( AV11OblSecuencial, (byte)(4), (byte)(0), httpContext.getLanguageProperty( "decimal_point"), "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV11OblSecuencial)) > 0 )
      {
         web.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11OblSecuencial_CTRL", GXutil.rtrim( sCtrlAV11OblSecuencial));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025181755625", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("obligacionexcepcioneswc.js", "?2025181755625", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtOblExcConCOdigo_Internalname = sPrefix+"OBLEXCCONCODIGO_"+sGXsfl_15_idx ;
      edtOblExcTipo_Internalname = sPrefix+"OBLEXCTIPO_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtOblExcConCOdigo_Internalname = sPrefix+"OBLEXCCONCODIGO_"+sGXsfl_15_fel_idx ;
      edtOblExcTipo_Internalname = sPrefix+"OBLEXCTIPO_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void sendrow_152( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtOblExcConCOdigo_Internalname,GXutil.rtrim( A1170OblExcConCOdigo),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtOblExcConCOdigo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(10),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"CodConcepto","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtOblExcTipo_Internalname,GXutil.rtrim( A1183OblExcTipo),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtOblExcTipo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         send_integrity_lvl_hashesCG2( ) ;
   ...
   public void startgridcontrol15( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeValue( httpContext.getMessage( "Con COdigo", "")) ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( httpContext.getMessage( "Incluir/Excluir", "")) ;
         httpContext.writeTextNL( "</th>") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1170OblExcConCOdigo));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", GXutil.rtrim( A1183OblExcTipo));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   {
      edtOblExcConCOdigo_Internalname = sPrefix+"OBLEXCCONCODIGO" ;
      edtOblExcTipo_Internalname = sPrefix+"OBLEXCTIPO" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:OblExcConCOdigo|1:OblExcTipo" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV11OblSecuencial',fld:'vOBLSECUENCIAL',pic:'ZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11CG2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV11OblSecuencial',fld:'vOBLSECUENCIAL',pic:'ZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12CG2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV11OblSecuencial',fld:'vOBLSECUENCIAL',pic:'ZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13CG2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CliCod',fld:'vCLICOD',pic:'ZZZZZ9'},{av:'AV9EmpCod',fld:'vEMPCOD',pic:'ZZZ9'},{av:'AV10LegNumero',fld:'vLEGNUMERO',pic:'ZZZZZZZ9'},{av:'AV11OblSecuencial',fld:'vOBLSECUENCIAL',pic:'ZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e16CG2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Oblexctipo',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      A1183OblExcTipo = "" ;
      scmdbuf = "" ;
      H00CG2_A3CliCod = new int[1] ;
      H00CG2_A1EmpCod = new short[1] ;
      H00CG2_A6LegNumero = new int[1] ;
      H00CG2_A1172OblSecuencial = new short[1] ;
      H00CG2_A1183OblExcTipo = new String[] {""} ;
      H00CG2_A1170OblExcConCOdigo = new String[] {""} ;
      H00CG3_AGRID_nRecordCount = new long[1] ;
      ...
      sCtrlAV9EmpCod = "" ;
      sCtrlAV10LegNumero = "" ;
      sCtrlAV11OblSecuencial = "" ;
      subGrid_Linesclass = "" ;
      ROClassString = "" ;
      GridColumn = new com.genexus.webpanels.GXWebColumn();
      pr_default = new DataStoreProvider(context, remoteHandle, new web.obligacionexcepcioneswc__default(),
         new Object[] {
             new Object[] {
            H00CG2_A3CliCod, H00CG2_A1EmpCod, H00CG2_A6LegNumero, H00CG2_A1172OblSecuencial, H00CG2_A1183OblExcTipo, H00CG2_A1170OblExcConCOdigo
            }
            , new Object[] {
            H00CG3_AGRID_nRecordCount
            }
         }
      );
      AV29Pgmname = "ObligacionExcepcionesWC" ;
   ...
   private short wcpOAV11OblSecuencial ;
   ...
   private String edtOblExcTipo_Internalname ;
   ...
   private String sCtrlAV11OblSecuencial ;
   private String sGXsfl_15_fel_idx="0001" ;
   private String subGrid_Class ;
   private String subGrid_Linesclass ;
   private String ROClassString ;
   private String edtOblExcConCOdigo_Jsonclick ;
   private String edtOblExcTipo_Jsonclick ;
   ...
   private int[] H00CG2_A3CliCod ;
   private short[] H00CG2_A1EmpCod ;
   private int[] H00CG2_A6LegNumero ;
   private short[] H00CG2_A1172OblSecuencial ;
   private String[] H00CG2_A1183OblExcTipo ;
   private String[] H00CG2_A1170OblExcConCOdigo ;
   private long[] H00CG3_AGRID_nRecordCount ;
...
final  class obligacionexcepcioneswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00CG2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A1172OblSecuencial )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " CliCod, EmpCod, LegNumero, OblSecuencial, OblExcTipo, OblExcConCOdigo" ;
      sFromString = " FROM ObligacionExcepciones" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LegNumero = ? and OblSecuencial = ?)");
      if ( ( AV17OrderedBy == 1 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, OblSecuencial, OblExcConCOdigo" ;
      }
      else if ( ( AV17OrderedBy == 1 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LegNumero DESC, OblSecuencial DESC, OblExcConCOdigo DESC" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ! AV18OrderedDsc )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, OblSecuencial, OblExcTipo, OblExcConCOdigo" ;
      }
      else if ( ( AV17OrderedBy == 2 ) && ( AV18OrderedDsc ) )
      {
         sOrderString += " ORDER BY CliCod DESC, EmpCod DESC, LegNumero DESC, OblSecuencial DESC, OblExcTipo DESC, OblExcConCOdigo" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY CliCod, EmpCod, LegNumero, OblSecuencial, OblExcConCOdigo" ;
   ...
   protected Object[] conditional_H00CG3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV17OrderedBy ,
                                          boolean AV18OrderedDsc ,
                                          ...
                                          short A1172OblSecuencial )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ObligacionExcepciones" ;
      addWhere(sWhereString, "(CliCod = ? and EmpCod = ? and LegNumero = ? and OblSecuencial = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00CG2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).intValue() , ((Number) dynConstraints[9]).shortValue() );
            case 1 :
                  return conditional_H00CG3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).intValue() , ((Number) dynConstraints[9]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00CG2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00CG3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
