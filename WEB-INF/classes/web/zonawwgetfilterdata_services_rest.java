...
@javax.ws.rs.Path("/ZonaWWGetFilterData")
public final  class zonawwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_JSON})
   @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public javax.ws.rs.core.Response execute( web.zonawwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV18DDOName;
      ...
      if ( ! processHeaders("zonawwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         web.zonawwgetfilterdata worker = new web.zonawwgetfilterdata(remoteHandle, context);
         worker.execute(AV18DDOName,AV16SearchTxt,AV17SearchTxtTo,AV22OptionsJson,AV25OptionsDescJson,AV27OptionIndexesJson );
         web.zonawwgetfilterdata_RESTInterfaceOUT data = new web.zonawwgetfilterdata_RESTInterfaceOUT();
